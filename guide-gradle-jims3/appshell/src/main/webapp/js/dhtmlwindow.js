...
var dhtmlwindow={
imagefiles:[correctedPath+'images/min.gif', correctedPath+'images/close.gif', correctedPath+'images/restore.gif', correctedPath+'images/resize.gif'], //Path to 4 images used by script, in that order
