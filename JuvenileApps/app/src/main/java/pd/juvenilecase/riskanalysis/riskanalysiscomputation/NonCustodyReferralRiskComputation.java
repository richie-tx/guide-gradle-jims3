...
public class NonCustodyReferralRiskComputation extends RiskComputation  {
	...
	public NonCustodyReferralRiskComputation(SaveReferralAssessmentEvent saveReferralAssessmentEvent) {
		...
		this.juvenileDelinquencyHistory = 
			JuvenileDelinquencyHistory.findbyRiskAnalysisId(saveReferralAssessmentEvent.getRiskAnalysisId());
	...
	private RiskFinalScore riskAssessmentScore() {
		...
		Iterator<RiskResultGroup> riskResultGroups = RiskResultGroup.findAllByAttributeName("description", "NCReferralRisk");
	...
	public RiskComputationReponseEvent compute() throws ComputationValidationException {
		...
		nonCustodyRefRiskCompRespEvent.setTotalScores(finalScores()); //used in calculation
