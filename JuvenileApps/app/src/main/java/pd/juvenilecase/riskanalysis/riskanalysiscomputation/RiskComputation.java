...
public abstract class RiskComputation {
	...
	protected abstract Collection finalScores();
	...
	public static RiskComputation getRiskComputation(IEvent event) {
		...
		} else if (event instanceof SaveCourtReferralAssessmentEvent) {
			return (RiskComputation)new CourtReferralRiskComputation((SaveCourtReferralAssessmentEvent)event);
		} else {
			return null;
		}
