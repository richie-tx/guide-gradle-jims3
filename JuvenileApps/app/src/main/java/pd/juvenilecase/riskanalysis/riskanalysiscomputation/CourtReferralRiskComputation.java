...
public class CourtReferralRiskComputation extends RiskComputation  {
	...
	private RiskFinalScore riskAssessmentScore() {
		...
		Iterator<RiskResultGroup> riskResultGroups = RiskResultGroup.findAllByAttributeName("description", "TJPCRisk");
	...
	private RiskFinalScore needsAssessmentScore() {
		...
		Iterator<RiskResultGroup> riskResultGroups = RiskResultGroup.findAllByAttributeName("description", "TJPCNeeds");
	...
	protected void setWeightOfQuestions() {
		...
		HashMap hmQuestionWeights = RiskComputationUtil.getQuestionWeights(saveCourtReferralAssessEvent);
