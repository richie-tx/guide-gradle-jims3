...
public class GetJJSReferralWithoutFilterCommand implements ICommand {
	

	/**
	 * @roseuid 4328435B0083
	 */
	public GetJJSReferralWithoutFilterCommand()
	{
	...
	{
	    	GetJJSReferralWithoutFilterEvent refEvent = (GetJJSReferralWithoutFilterEvent) event;
		Iterator<JJSReferral> referralList = JJSReferral.findAllWithoutFilter(refEvent);
