...
public class GetReferralListwithDALognumCommand implements ICommand
{

    /**
     * @roseuid 4328435B0083
     */
    public GetReferralListwithDALognumCommand()
    {
    ...
    {
	GetReferralListwithDALognumEvent refEvent = (GetReferralListwithDALognumEvent) event;
	...
	while (referralList.hasNext())
	{
	    ...
	    resp.setJuvNum(ref.getJuvenileNum());
	    ...
	    jjsevent.setJuvenileNumber(ref.getJuvenileNum());//find juvnum from ref rec
