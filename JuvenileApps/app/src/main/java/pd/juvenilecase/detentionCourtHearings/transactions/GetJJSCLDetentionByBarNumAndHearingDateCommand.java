 ...
 * @author sthyagarajan
 */
public class GetJJSCLDetentionByBarNumAndHearingDateCommand implements ICommand
{
	...
	GetJJSCLDetentionByBarNumAndHearingDateEvent evt = (GetJJSCLDetentionByBarNumAndHearingDateEvent) event;
