 ...
 * @author sthyagarajan
 */
public class GetJJSCLDetentionByDateRangeCommand implements ICommand
{

    @Override
    public void execute(IEvent event) throws Exception
    {
	GetJJSCLDetentionByDateRangeEvent evt = (GetJJSCLDetentionByDateRangeEvent) event;
	...
	Iterator<JJSCLDetention> iter = JJSCLDetention.findAll(evt);
