...
public class GetJJSCLDetentionByJuvNumRefNumCommand implements ICommand
{

    @Override
    public void execute(IEvent event) throws Exception
    {
	GetJJSCLDetentionByJuvNumRefNumEvent evt = (GetJJSCLDetentionByJuvNumRefNumEvent) event;
