...
public class GetJJSCLDetentionByBarNumAndJuvNumCommand implements ICommand
{
	...
	GetJJSCLDetentionByBarNumAndJuvNumEvent evt = (GetJJSCLDetentionByBarNumAndJuvNumEvent) event;
	...
	if (evt.getBarNumber() != null && !evt.getBarNumber().isEmpty() && evt.getJuvenileNumber() != null && !evt.getJuvenileNumber().isEmpty())
	{
