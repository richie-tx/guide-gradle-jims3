...
/**
 * Bar Num and Hearing Date
 * 
 * @author sthyagarajan
 */
public class GetJJSCLDetentionByHearingDateCommand implements ICommand
{
	...
	GetJJSCLDetentionByHearingDateEvent evt = (GetJJSCLDetentionByHearingDateEvent) event;
	...
	if (evt.getJuvNumber()!= null && !evt.getJuvNumber().isEmpty() &&evt.getCourtDate() != null && !evt.getCourtDate().isEmpty())
	{
