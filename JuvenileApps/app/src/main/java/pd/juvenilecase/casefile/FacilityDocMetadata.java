...
public class FacilityDocMetadata extends PersistentObject 
{
    ...
    */
	public static FacilityDocMetadata find( String facilityDocId )
	{
		return (FacilityDocMetadata)new Home().find( facilityDocId, FacilityDocMetadata.class );
	}
	
	static public Iterator findAll(IEvent event)
	{
		IHome home = new Home();
		return home.findAll(event, FacilityDocMetadata.class);
	}
	...
	{
		return new Home().findAll( "casefileId", casefileId, FacilityDocMetadata.class );
	}
	...
	{
		IHome home = new Home();
		Iterator notices = home.findAll(attrName, attrValue, FacilityDocMetadata.class);
		return notices;
	}
