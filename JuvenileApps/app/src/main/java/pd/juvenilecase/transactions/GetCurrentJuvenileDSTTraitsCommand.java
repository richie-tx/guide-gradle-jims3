...
public class GetCurrentJuvenileDSTTraitsCommand implements ICommand
{

	/**
	 * @roseuid 42A7588D01A1
	 */
	public GetCurrentJuvenileDSTTraitsCommand()
	{
	...
	{
	    GetCurrentJuvenileDSTTraitsEvent traitsEvt = (GetCurrentJuvenileDSTTraitsEvent) event;
