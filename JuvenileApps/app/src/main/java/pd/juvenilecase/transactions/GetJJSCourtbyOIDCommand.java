 ...
 *
 */
public class GetJJSCourtbyOIDCommand implements ICommand{

    @Override
    public void execute(IEvent event) throws Exception {
	GetJJSCourtbyOIDEvent crtevt =(GetJJSCourtbyOIDEvent)event;
	JJSCourt court = JJSCourt.find(crtevt.getId());
