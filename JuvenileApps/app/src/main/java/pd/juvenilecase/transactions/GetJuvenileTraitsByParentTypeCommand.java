 ...
 */
public class GetJuvenileTraitsByParentTypeCommand implements ICommand {

	@Override
	public void execute(IEvent event) throws Exception {
		GetJuvenileTraitsByParentTypeEvent traitEvent = (GetJuvenileTraitsByParentTypeEvent) event;
		IDispatch dispatch = EventManager.getSharedInstance(EventManager.REPLY);
			
		Iterator<JuvenileTrait> i = null;
	
		if(traitEvent.getJuvenileNum() != null && traitEvent.getTraitType()!=null )
		{
