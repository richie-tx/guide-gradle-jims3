 ...
 * 
 */
public class GetCasefileReferralsCommand implements ICommand
{

    /**
     * @roseuid 42791F9003A9
     */
    public GetCasefileReferralsCommand()
    {
	...
	GetCasefileReferralsEvent searchEvent = (GetCasefileReferralsEvent) event;
