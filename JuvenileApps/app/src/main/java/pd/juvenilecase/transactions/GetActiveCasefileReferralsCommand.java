 ...
 * 
 */
public class GetActiveCasefileReferralsCommand implements ICommand
{

    /**
     * @roseuid 42791F9003A9
     */
    public GetActiveCasefileReferralsCommand()
    {
	...
	GetActiveCasefileReferralsEvent searchEvent = (GetActiveCasefileReferralsEvent) event;
