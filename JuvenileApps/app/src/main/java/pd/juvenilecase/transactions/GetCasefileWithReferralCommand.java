 ...
 * 
 */
public class GetCasefileWithReferralCommand implements ICommand
{

	/**
	 * @roseuid 42791F9003A9
	 */
	public GetCasefileWithReferralCommand()
	{
	...
	public void execute(IEvent event)
	{
		...
		GetCasefileWithReferralEvent searchEvent = (GetCasefileWithReferralEvent)event;	
