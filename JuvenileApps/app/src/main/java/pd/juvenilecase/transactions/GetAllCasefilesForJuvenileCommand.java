 ...
 * 
 */
public class GetAllCasefilesForJuvenileCommand implements ICommand
{

    /**
     * @roseuid 42791F9003A9
     */
    public GetAllCasefilesForJuvenileCommand()
    {
	...
	GetAllCasefilesForJuvenileEvent searchEvent = (GetAllCasefilesForJuvenileEvent) event;
