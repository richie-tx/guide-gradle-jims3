 ...
 *
 */
public class UpdateFamilyMemSSNCommand implements ICommand {

	/* (non-Javadoc)
	 * @see mojo.km.context.ICommand#execute(mojo.km.messaging.IEvent)
	 */
	public void execute(IEvent event) throws Exception {
		UpdateFamilyMemSSNEvent updateEvent = (UpdateFamilyMemSSNEvent) event;
		
		FamilyMember member = FamilyMember.find(updateEvent.getFamilyMemID());
		if(member!=null)
			member.setSsn(updateEvent.getSsn());
	}
