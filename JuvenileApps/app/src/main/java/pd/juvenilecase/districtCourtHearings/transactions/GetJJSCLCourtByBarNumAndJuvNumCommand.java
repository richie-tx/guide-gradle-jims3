 ...
 * @author sthyagarajan
 */
public class GetJJSCLCourtByBarNumAndJuvNumCommand implements ICommand
{

    @Override
    public void execute(IEvent event) throws Exception
    {
	GetJJSCLCourtByBarNumAndJuvNumEvent evt = (GetJJSCLCourtByBarNumAndJuvNumEvent) event;
