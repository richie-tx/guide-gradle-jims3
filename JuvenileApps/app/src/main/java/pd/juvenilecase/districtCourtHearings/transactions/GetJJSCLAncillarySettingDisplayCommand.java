 ...
 * @author nemathew
 */
public class GetJJSCLAncillarySettingDisplayCommand implements ICommand
{

    @Override
    public void execute(IEvent event) throws Exception
    {
	GetJJSCLAncillarySettingDisplayEvent evt = (GetJJSCLAncillarySettingDisplayEvent) event;
