...
public class GetJJSCLCourtByChainAndSeqNumCommand implements ICommand
{

    @Override
    public void execute(IEvent event) throws Exception
    {
	GetJJSCLCourtByChainAndSeqNumEvent evt = (GetJJSCLCourtByChainAndSeqNumEvent) event;
	...
	{
	    Iterator<JJSCourt> courtItr = JJSCourt.findAll("chainNumber", evt.getChainNumber());
	    while (courtItr.hasNext())
	    {
		JJSCourt court = (JJSCourt) courtItr.next();
		if (court != null)
