 ...
 * @author sthyagarajan
 */
public class GetJJSCLCourtByBarNumCommand implements ICommand
{
    @Override
    public void execute(IEvent event) throws Exception
    {
	GetJJSCLCourtByBarNumEvent evt = (GetJJSCLCourtByBarNumEvent) event;
	...
	//search by juvenile or bar num
	if (evt.getBarNumber() != null && !evt.getBarNumber().isEmpty())
	{
