...
public class GetProductionSupportJuvenileProgramReferralCommentsbyDateCommand implements ICommand {
	/**
	 * @roseuid 4278CAAA00AA
	 */
	public GetProductionSupportJuvenileProgramReferralCommentsbyDateCommand() {
	...
	public void execute(IEvent event) {
		...
		GetProductionSupportJuvenileProgramReferralCommentsbyDateEvent getJuvenileProgramReferralsEvent = (GetProductionSupportJuvenileProgramReferralCommentsbyDateEvent) event;
		
		//search by juvenile 
		if (getJuvenileProgramReferralsEvent.getJuvenileProgramReferralNum() != null && !getJuvenileProgramReferralsEvent.getJuvenileProgramReferralNum().isEmpty())
		{
		    Iterator<JuvenileProgramReferralComment> commentItr = JuvenileProgramReferralComment.findAll(getJuvenileProgramReferralsEvent);
		    while (commentItr.hasNext())
		    {
			JuvenileProgramReferralComment comment = (JuvenileProgramReferralComment) commentItr.next();
