 ...
 * @author ryoung
 */
public class JuvenileOffenderTracking extends PersistentObject implements IJuvenileAssociatesInfo
{
     ...
     */
    public JuvenileOffenderTracking()
    {
    }
    ...
    {
      /*  if (this.dateOfBirth == 0 || !this.dateOfBirth.equals(aDateOfBirth))
        {
            markModified();
        }*/
     ...
     * @param daLogNum
     */
    static public JuvenileOffenderTracking find(String daLogNum)
    {
        IHome home = new Home();
        JuvenileOffenderTracking jot = (JuvenileOffenderTracking) home.find(daLogNum, JuvenileOffenderTracking.class);
        return jot;
    }
    ...
    private void initSchoolName()
    {
        if (schoolName == null)
        {
            ...
            sb.append(districtCodeId).append("-").append(schoolCodeId);
            schoolName = (JuvenileSchoolDistrictCode) new mojo.km.persistence.Reference( sb.toString(),
                    JuvenileSchoolDistrictCode.class).getObject();
        }
    }
