...
public class FindJuvenileWarrantsWithBadSchoolCodesAdHoc {
	...
	public static void main(String[] args) {
		...
		FindJuvenileWarrantsWithBadSchoolCodesAdHoc adHoc = new FindJuvenileWarrantsWithBadSchoolCodesAdHoc();
		BufferedWriter badSchoolCodes = null;
		BufferedWriter badWarrantSchoolNoJJs = null;
        try {
        	Date currDate = new Date();
            StringBuffer sb = new StringBuffer("C:\\JUV_BAD_SCHOOL_CODES");
            sb.append(".");
            ...
            sb = new StringBuffer("C:\\JUV_BAD_SCHOOL_CODES_NO_JJS");
            sb.append(".");
            sb.append(DateUtil.dateToString(currDate, "yyyyMMddHHmmss"));
            sb.append(".txt");
	...
	public FindJuvenileWarrantsWithBadSchoolCodesAdHoc() {
		super();
