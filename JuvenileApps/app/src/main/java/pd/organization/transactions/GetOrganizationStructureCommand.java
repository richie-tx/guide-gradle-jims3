 ...
 * @author Jim Fisher
 */
public class GetOrganizationStructureCommand implements ICommand
{
    ...
    public void execute(IEvent event) throws Exception
    {
		...
		OrganizationStructureResponseEvent organizationStructureResponseEvent = new OrganizationStructureResponseEvent() ; 
		organizationStructureResponseEvent.setOrganizationTO( organizationTO ) ;
   		IDispatch dispatch = EventManager.getSharedInstance(EventManager.REPLY);
   		dispatch.postEvent(organizationStructureResponseEvent) ; 
    }
