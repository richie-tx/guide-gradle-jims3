...
public class SupervisionPlanPrintTemplateRequestCommand implements ICommand{
   ...
   {
			SupervisionPlanPrintTemplateRequestEvent waReqEvent = (SupervisionPlanPrintTemplateRequestEvent)event;			
