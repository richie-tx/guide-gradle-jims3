...
public class SupervisionOrderPrintTemplateRequestCommand implements ICommand 
{
   
   /**
	* @roseuid 42FBA49F00EA
	*/
   public SupervisionOrderPrintTemplateRequestCommand() 
   {
   ...
   {
			SupervisionOrderPrintTemplateRequestEvent waReqEvent = (SupervisionOrderPrintTemplateRequestEvent)event;
