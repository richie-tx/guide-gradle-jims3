 ...
 */
public class UpdateCodetableRegistrationCommand implements ICommand
{

	/**
	 * @roseuid
	 */
	public UpdateCodetableRegistrationCommand()
	{
	}
	...
	public void execute(IEvent event) throws SecurityException, IllegalArgumentException, InstantiationException,
			...
			CodetableException
	{
		UpdateCodetableRegistrationEvent gEvent = (UpdateCodetableRegistrationEvent) event;
