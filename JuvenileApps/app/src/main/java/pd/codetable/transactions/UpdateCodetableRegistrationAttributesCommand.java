 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class UpdateCodetableRegistrationAttributesCommand implements ICommand {

	  /**
	   * @roseuid
	   */
	  public UpdateCodetableRegistrationAttributesCommand()  {
	  }
	 ...
	 * @roseuid 
*/
	  public void execute(IEvent event) throws SecurityException, IllegalArgumentException, InstantiationException,
			ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException,
			CodetableException {
	  	UpdateCodetableRegistrationAttributesEvent gEvent = (UpdateCodetableRegistrationAttributesEvent) event;
		...
		try {
			...
			aCreator.saveAttirbutes(gEvent);
