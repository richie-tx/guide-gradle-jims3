 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class GetServiceTypeCdByGroupCommand implements ICommand
{

	/**
	 * 
	 */
	public GetServiceTypeCdByGroupCommand()
	{
	...
	{
		GetServiceTypeCdByGroupEvent getCodesEvent = (GetServiceTypeCdByGroupEvent) event;

		Iterator i = JuvenileEventTypeCode.findServiceTypeCodesByGroup(getCodesEvent); 
