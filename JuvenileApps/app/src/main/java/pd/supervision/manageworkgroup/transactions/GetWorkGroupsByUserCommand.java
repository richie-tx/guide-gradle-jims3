...
public class GetWorkGroupsByUserCommand implements ICommand 
{
   
   /**
    * @roseuid 45DB612902C9
    */
   public GetWorkGroupsByUserCommand() 
   {
   ...
   {
        GetWorkGroupsByUserEvent evt = (GetWorkGroupsByUserEvent)event;
