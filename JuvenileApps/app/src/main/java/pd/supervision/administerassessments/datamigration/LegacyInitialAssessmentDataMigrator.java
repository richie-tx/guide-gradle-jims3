...
public class LegacyInitialAssessmentDataMigrator {
	public static void main(String[] args) {
         if (!(args != null && args.length == 1)){
		    System.out.println("!!!!! INVALID PARMS !!!!!");
		} else {
		    LegacyInitialAssessmentDataMigrator ladm = new LegacyInitialAssessmentDataMigrator(args[0]);
		    ladm.execute(new LegacyAssessmentDataMigratorEvent());
		}
    }
	...
	public LegacyInitialAssessmentDataMigrator(String configFileName) {
	    super();
	...
	private void buildWisconsinInitialAssessmentAnswers(Assessment
			assessment, String needsRisksString) {

		AssessmentQuestionAnswer aqa = this.getBaseAnswer(assessment);
		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
				AssessmentDataMigrationConstants.WISCINITRISK_Q1, 
				AssessmentDataMigrationConstants.RISK_ADDRESS_CHANGE,
				needsRisksString);
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
				AssessmentDataMigrationConstants.WISCINITRISK_Q2, 
				AssessmentDataMigrationConstants.RISK_TIME_EMPLOYED,
				needsRisksString);
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
				AssessmentDataMigrationConstants.WISCINITRISK_Q3, 
				AssessmentDataMigrationConstants.RISK_ALCOHOL,
				needsRisksString);
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
				AssessmentDataMigrationConstants.WISCINITRISK_Q4, 
				AssessmentDataMigrationConstants.RISK_DRUG,
				needsRisksString);
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
				AssessmentDataMigrationConstants.WISCINITRISK_Q5, 
				AssessmentDataMigrationConstants.RISK_ATTITUDE,
				needsRisksString);
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
				AssessmentDataMigrationConstants.WISCINITRISK_Q6, 
				AssessmentDataMigrationConstants.RISK_FIRST_ADJ_AGE,
				needsRisksString);
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
				AssessmentDataMigrationConstants.WISCINITRISK_Q7, 
				AssessmentDataMigrationConstants.RISK_PRIOR_PAROLE_SUPER,
				needsRisksString);
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
				AssessmentDataMigrationConstants.WISCINITRISK_Q8, 
				AssessmentDataMigrationConstants.RISK_PRIOR_PAROLE_REVOC,
				needsRisksString);
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
				AssessmentDataMigrationConstants.WISCINITRISK_Q9, 
		...
		if (m204Response.equals(ZERO_STRING)){//Burglary/Theft/Auto theft/Robbery
			this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
					AssessmentDataMigrationConstants.WISCINITRISK_Q10A, ZERO_STRING);			
			this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
					AssessmentDataMigrationConstants.WISCINITRISK_Q10B, ZERO_STRING);
		} else if (m204Response.equals(ONE_STR)){//Burglary/Theft/Auto theft/Robbery
			this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
					AssessmentDataMigrationConstants.WISCINITRISK_Q10A, TWO);			
			this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
					AssessmentDataMigrationConstants.WISCINITRISK_Q10B, ZERO_STRING);
			...
			this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
					AssessmentDataMigrationConstants.WISCINITRISK_Q10A, ZERO_STRING);			
			this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
					AssessmentDataMigrationConstants.WISCINITRISK_Q10B, THREE);
		...
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G1,
				AssessmentDataMigrationConstants.WISCINITRISK_Q11, 
				AssessmentDataMigrationConstants.RISK_ADULT_JUV_ASSAULT,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q1, 
				AssessmentDataMigrationConstants.NEED_ACADEMIC,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q2, 
				AssessmentDataMigrationConstants.NEED_EMPLOYMENT,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q3, 
				AssessmentDataMigrationConstants.NEED_FINANCIAL,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q4, 
				AssessmentDataMigrationConstants.NEED_MARITAL,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q5, 
				AssessmentDataMigrationConstants.NEED_COMPANIONS,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q6, 
				AssessmentDataMigrationConstants.NEED_STABILITY,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q7, 
				AssessmentDataMigrationConstants.NEED_ALCOHOL,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q8, 
				AssessmentDataMigrationConstants.NEED_DRUG,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q9, 
				AssessmentDataMigrationConstants.NEED_MENTAL,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q10, 
				AssessmentDataMigrationConstants.NEED_HEALTH,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q11, 
				AssessmentDataMigrationConstants.NEED_SEX_BEHAVE,
				needsRisksString);		
		this.writeWisconsinAnswer(aqa, AssessmentDataMigrationConstants.WISCONSIN_INITIAL_G2,
				AssessmentDataMigrationConstants.WISCINITNEEDS_Q12, 
				AssessmentDataMigrationConstants.NEED_PO_IMPRESSION,
				needsRisksString);		
	}
	public void execute(LegacyAssessmentDataMigratorEvent reqEvent) {
        try {
 	       File needsRiskExtractFile = new File("C:\\JDSACSA\\JDSACSA0.ASSESSME.NEED.RISK.TXT");
	       errorFile = AssessmentDataMigrationHelper.createFile("C:\\JDSACSA\\INITIAL.ASSESSMENT.ERRORS", errorFile);
	       assessmentFlatFile = AssessmentDataMigrationHelper.createFile("C:\\JDSACSA\\INITIAL.ASSESSMENT", assessmentFlatFile);
	       assessmentFlatFile.write(AssessmentDataMigrationDataOutputHelper.getDatabaseColumns(new Assessment()));
	       wisconsinFlatFile = AssessmentDataMigrationHelper.createFile("C:\\JDSACSA\\INITIAL.WISCONSIN", wisconsinFlatFile);
	       wisconsinFlatFile.write(AssessmentDataMigrationDataOutputHelper.getDatabaseColumns(new Wisconsin()));
	       lsirFlatFile = AssessmentDataMigrationHelper.createFile("C:\\JDSACSA\\INITIAL.LSIR", lsirFlatFile);
	       lsirFlatFile.write(AssessmentDataMigrationDataOutputHelper.getDatabaseColumns(new LSIR()));
	       qasFlatFile = AssessmentDataMigrationHelper.createFile("C:\\JDSACSA\\INITIAL.ASSESSMENTQAS", qasFlatFile);
	       qasFlatFile.write(AssessmentDataMigrationDataOutputHelper.getDatabaseColumns(new AssessmentQuestionAnswer()));
	       legacyUpdateFlatFile = AssessmentDataMigrationHelper.createFile("C:\\JDSACSA\\INITIAL.CSLEGACYUPDATLOG", legacyUpdateFlatFile);
	       legacyUpdateFlatFile.write(AssessmentDataMigrationDataOutputHelper.getDatabaseColumns(new LegacyUpdateLog()));
	       migrationResults = AssessmentDataMigrationHelper.createFile("C:\\JDSACSA\\INITIAL.ASSESSMENT.MIGRATION.RESULTS", migrationResults);
	       ...
	       migrationResults.write("STARTING INITIAL ASSESSMENT MIGRATION @ "+ new Date() + '\n');
	       ...
	       migrationResults.write('\n' + "FINISHED INITIAL ASSESSMENT MIGRATION @ "+ new Date());
	...
	private void processAssessment(String needsRisksString) {
		...
		LegacyAssessmentNeedRisk lan = null;
		errorFound = false;
		try {
			lan = LegacyAssessmentNeedRisk.getData(needsRisksString, needsRisksSchemaMap);
		...
		Date aDate = null;
		String aStringValue = AssessmentDataMigrationHelper.getDataValue(needsRisksString, AssessmentDataMigrationConstants.ASSESSMENT_DATE, needsRisksSchemaMap);
...
//		if (lan.getCstsSnu() != null 
//				&& !lan.getCstsSnu().equals(PDConstants.BLANK)
//				&& !lan.getCstsSnu().equals(ASTERISKS)){
//		} else {
//			this.writeError(needsRisksString, NO_CSTS_SNU);
//			//return;
//		}
		if (prevSpn == null || !lan.getSpn().equals(prevSpn)){
			//SupervisionPeriod supervisionPeriod = SupervisionPeriod.findActiveSupervisionPeriod(lan.getSpn(), CSC_AGENCY);
			supervisionBeginDate = AssessmentDataMigrationHelper.getSupervisionPeriodBeginDate(readConnection, lan.getSpn());
		...
		assessment.setMigratedAssessmentDate(aDate);
     	...
     	if (aDate.compareTo(supervisionBeginDate) < ZERO){
     		...
     		//Create initial assessment using supervision period begin date as assessment.date
     		//TODO: need to populate new
     		aDate = supervisionBeginDate;
     	}
     	if (errorFound){
     		return;
		...
		if (lan.isLsir()){
			...
			if (lan.getDueDate() != null){
				lsir.setDueDate(lan.getDueDate());
			} else {
			...
			if (lan.getDueDate() != null){
				wisconsin.setAssessmentDueDate(lan.getDueDate());
			} else {
		       Calendar calendar = Calendar.getInstance();
		       calendar.setTime(assessment.getAssessmentDate());
		       calendar.roll(Calendar.YEAR, true);
			...
			wisconsin.setNeedsLevel(lan.getNeedsLevel());
			...
			wisconsin.setRiskLevel(lan.getRiskLevel());
			...
			this.buildWisconsinInitialAssessmentAnswers(assessment, needsRisksString);
		}
		if (lan.getCstsSnu() != null 
				&& !lan.getCstsSnu().equals(PDConstants.BLANK)
				&& !lan.getCstsSnu().equals(ASTERISKS)){
			nextLegacyUpdateOID++;
			LegacyUpdateLog uLog = AssessmentDataMigrationHelper.createLegacyUpdateLog(assessment, lan, nextLegacyUpdateOID);
			try {
		...
		if (incrementalCounter > 199){
			try {
				...
				msg.append(lan.getRecordCount());
				msg.append(" SPN=");
				msg.append(lan.getSpn());
				msg.append('\n');
				migrationResults.write(msg.toString());
	...
	private void processMigration(FileReader needsRisksExtractFileReader) {
		...
		wisconsinAnswerMap = AssessmentDataMigrationHelper.getAnswerMap(CSCAssessmentConstants.ASSESSMENTTYPE_WISCONSIN, true);
