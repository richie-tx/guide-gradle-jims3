...
public class GetConditionsToDisassociateFromDepartmentPoliciesCommand implements ICommand 
{
   
   /**
    * @roseuid 42F7C446004E
    */
   public GetConditionsToDisassociateFromDepartmentPoliciesCommand() 
   {
   ...
   public void execute(IEvent event) 
	{
		GetConditionsToDisassociateFromDepartmentPoliciesEvent reqEvent = (GetConditionsToDisassociateFromDepartmentPoliciesEvent)event;

		AgencyPolicy policy = AgencyPolicy.find( reqEvent.getPolicyId() );
		if(policy == null){
			return;
		}
