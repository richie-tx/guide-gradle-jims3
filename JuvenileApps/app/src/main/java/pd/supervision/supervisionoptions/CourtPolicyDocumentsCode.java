...
public class CourtPolicyDocumentsCode extends mojo.km.persistence.PersistentObject {
	CourtPolicy parent;
	...
	*/
	private void initChild() {
		if (child == null) {
			try {
				child = (Code) new mojo.km.persistence.Reference(childId, Code.class).getObject();
			} catch (Throwable t) {
			}
		}
	}
