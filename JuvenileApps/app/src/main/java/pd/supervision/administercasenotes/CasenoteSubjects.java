 ...
 *
 */
public class CasenoteSubjects extends PersistentObject
{

	private Casenote parent;
	private String childId;
	private String parentId;
	private SupervisionCode child;
	/**
...
//		}
	       if (child == null) {
	            child = (SupervisionCode) new mojo.km.persistence.Reference(childId,
	...
	*/
	...
	public void setChild(Code lchild)
	{
		...
		this.child = (SupervisionCode) new mojo.km.persistence.Reference(lchild).getObject();
	}
	/**
	...
	*/
	...
	public static Iterator findAll(IEvent event){
		return new Home().findAll(event, CasenoteSubjects.class);
	}
}
