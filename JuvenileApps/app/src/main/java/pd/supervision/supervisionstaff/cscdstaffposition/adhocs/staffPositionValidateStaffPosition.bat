...
%JAVA%\jre\bin\java -cp %classpath% -Xmx512M -Dmojo.config=SRVPJ1P.xml pd.supervision.supervisionstaff.cscdstaffposition.adhocs.ValidateStaffWithCRM26AdHoc SRVPJ1P.xml