...
public class GetSchoolAdjudicationNotificationCommand implements ICommand 
{
   
   /**
    * @roseuid 45702FB40066
    */
   public GetSchoolAdjudicationNotificationCommand() 
   {
    ...
    */
	public void execute(IEvent event) {
		...
		GetSchoolAdjudicationNotificationEvent requestEvent = (GetSchoolAdjudicationNotificationEvent) event;
		
		Iterator attenIter = ServiceEventAttendance.findAll(requestEvent);
