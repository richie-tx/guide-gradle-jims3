...
public class GetActiveCasesByCaseCommand implements ICommand
{

    /**
     * @roseuid 464360260252
     */
    public GetActiveCasesByCaseCommand()
    {
    ...
    {
        GetActiveCasesByCaseEvent event = (GetActiveCasesByCaseEvent) anEvent;
