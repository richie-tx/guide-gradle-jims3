 ...
 */
public class ResolveNonComplianceCommand extends CommandUtil implements ICommand 
{
   
   /**
    * @roseuid 473B887E0371
    */
   public ResolveNonComplianceCommand() 
   {
   ...
   {
   	   ResolveNonComplianceEvent sEvent = (ResolveNonComplianceEvent) event;
   	   DAOHandler handler = getHandler(SupervisionOrderConditionConstants.RESOLVE_NONCOMPLIANCE_DAO_LOCATOR);
