 ...
 */
public class JuvenileTattooPhoto extends PersistentObject {
	/**
	 * 
	 */
	 ...
	 */
	static public JuvenileTattooPhoto find(String aPictureName) {
		JuvenileTattooPhoto photo = null;
		IHome home = new Home();
		photo = (JuvenileTattooPhoto) home.find(aPictureName, JuvenileTattooPhoto.class);
		return photo;
	}
	...
	static public List findAll(String juvId) {
		IHome home = new Home();
		Iterator iter = home.findAll("juvenileId", juvId, JuvenileTattooPhoto.class);

		List photos = CollectionUtil.iteratorToList(iter);

		Collections.sort(photos, new Comparator() {
			public int compare(Object o1, Object o2) {
				JuvenileTattooPhoto p1 = (JuvenileTattooPhoto) o1;
				JuvenileTattooPhoto p2 = (JuvenileTattooPhoto) o2;
