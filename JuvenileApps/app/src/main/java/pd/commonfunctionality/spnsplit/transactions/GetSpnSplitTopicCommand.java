 ...
 */
public class GetSpnSplitTopicCommand extends CommandUtil implements ICommand 
{
   
   /**
    * @roseuid 4561E29D00A0
    */
   public GetSpnSplitTopicCommand() 
   {
   ...
   {
	   GetSpnSplitTopicEvent sEvent = (GetSpnSplitTopicEvent) event;
	   ...
	   handler.get(sEvent.getDefendantId());
   }
