...
public class ResponseContextFactory {
	...
	public Object lookup(String context) throws ReflectionException{
		...
		// get the context from database or property file
		//ResponseContextLocator locator = ResponseContextLocator.getInstance();
		//responseName = locator.getContextName(context);

		try {
			Class c = Class.forName(context);
			response = (Object) c.newInstance();			
