 ...
 * 
 */
public class GetDepartmentPoliciesWhereClause {
...
//			"yyyy-MM-dd");
	...
	public String getClause(IEvent anEvent) {
		GetDepartmentPoliciesEvent evt = (GetDepartmentPoliciesEvent) anEvent;
		StringBuffer buf = new StringBuffer();

		// Name
		// Note: The NAME clause is always used so that other clauses do not
		// have to
		// check for a previous clause to know if an 'and' is required. This
		// also gets
		// around an issue in the JDBCMapping class that requires this method to
		// return
