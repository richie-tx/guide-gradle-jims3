...
public class SubmitPostReleaseCreateAction extends JIMSBaseAction
{
	public SubmitPostReleaseCreateAction() {
	...
	public ActionForward finish(ActionMapping aMapping, ActionForm aForm, HttpServletRequest aRequest, HttpServletResponse aResponse) 
	   {
		...
		SaveCharterPostReleaseEvent reqEvent = (SaveCharterPostReleaseEvent)EventFactory.getInstance( JuvenileControllerServiceNames.SAVECHARTERPOSTRELEASE ) ;
		reqEvent.setJuvenileNum(eduForm.getJuvenileNum());
		reqEvent.setEmployedCodeId(eduForm.getPostReleaseEmployedCodeId());
		reqEvent.setStatusDate(eduForm.getPostReleaseStatusDate());
		reqEvent.setComments(eduForm.getOtherText());
		reqEvent.setContinuingEducationCodes(eduForm.getSelectedList());
