...
public class SubmitRiskFormulaRecommendationUpdateAction extends JIMSBaseAction
{
	protected void addButtonMapping(Map keyMap)
	{
		keyMap.put("button.finish", "updateRecommendation");
     ...
     */
    public ActionForward updateRecommendation(ActionMapping aMapping, ActionForm aForm, HttpServletRequest aRequest,
            HttpServletResponse aResponse) throws GeneralFeedbackMessageException
    {
    	...
    	saveEvent.setRecommendationId(rfRecommendationForm.getRecommendationId());
    	...
    	saveEvent.setAssessmentTypeName(rfDetailsForm.getFormulaName());
    	...
    	rfRecommendationForm.setConfirmMessage("Recommendation successfully Updated.");
