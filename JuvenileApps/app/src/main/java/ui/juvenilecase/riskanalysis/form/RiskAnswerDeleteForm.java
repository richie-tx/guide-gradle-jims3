 ...
 *
 */
public class RiskAnswerDeleteForm extends ActionForm
{
	
	public RiskAnswerDeleteForm()
	{		
	}
	...
	private List removeAnswersList = new ArrayList();
	//Question
	...
	public List getRemoveAnswersList() {
		return removeAnswersList;
	}

	public void setRemoveAnswersList(List removeAnswersList) {
		this.removeAnswersList = removeAnswersList;
	}
