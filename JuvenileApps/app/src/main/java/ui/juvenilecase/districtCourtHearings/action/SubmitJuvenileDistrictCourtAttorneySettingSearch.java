 ...
 *
 */
public class SubmitJuvenileDistrictCourtAttorneySettingSearch extends JIMSBaseAction
{
	...
	String barNum = courtHearingForm.getBarNumber();
	String juvenileNum = courtHearingForm.getJuvenileNumber();
	String attorneyName = courtHearingForm.getAttorneyName();
												...
												|| courtHearingForm.getAttorneyName()!=null && courtHearingForm.getAttorneyName().isEmpty() )
	{
	    ...
	    GetJJSCLAncillaryCourtByBarNumAndHearingDateEvent ancillaryCrtEvt = (GetJJSCLAncillaryCourtByBarNumAndHearingDateEvent) EventFactory.getInstance(JuvenileCourtHearingControllerServiceNames.GETJJSCLANCILLARYCOURTBYBARNUMANDHEARINGDATE);
	    ancillaryCrtEvt.setBarNumber(courtHearingForm.getBarNumber());
	    ancillaryCrtEvt.setCourtDate(courtHearingForm.getCourtDate());
	    ...
	    //did not add conditions for 146714 as it seems like not pulling from ancillary court
	    ...
	    //*****************************************COURT RECORDS *********************************************//	
	    // Case 1: court calendar record. JJSCLCOURT //bar No and court Date.
	 /*   if (courtHearingForm.getCourtDate() != null && !courtHearingForm.getCourtDate().isEmpty() && courtHearingForm.getBarNumber() != null && !courtHearingForm.getBarNumber().isEmpty()
		    && (courtHearingForm.getJuvenileNumber()==null || courtHearingForm.getJuvenileNumber()!=null && courtHearingForm.getJuvenileNumber().isEmpty()))
	    {
		GetJJSCLCourtByBarNumAndHearingDateEvent jjsCLCrtEvent = (GetJJSCLCourtByBarNumAndHearingDateEvent) EventFactory.getInstance(JuvenileCourtHearingControllerServiceNames.GETJJSCLCOURTBYBARNUMANDHEARINGDATE);
		jjsCLCrtEvent.setCourtDate(courtHearingForm.getCourtDate());
		jjsCLCrtEvent.setBarNumber(courtHearingForm.getBarNumber());
		...
		//add the conditions for 146714 except the date filtering
	    ...
	    //case 2: JJSCOURT :Only Bar Number 
	    if (courtHearingForm.getBarNumber() != null && !courtHearingForm.getBarNumber().isEmpty() && juvenileNum!=null && juvenileNum.isEmpty() &&  courtHearingForm.getCourtDate()!=null && courtHearingForm.getCourtDate().isEmpty())
	    {
		GetJJSCLCourtByBarNumEvent jjsCLCrtEvent = (GetJJSCLCourtByBarNumEvent) EventFactory.getInstance(JuvenileCourtHearingControllerServiceNames.GETJJSCLCOURTBYBARNUM);
		jjsCLCrtEvent.setBarNumber(courtHearingForm.getBarNumber());
		dispatch.postEvent(jjsCLCrtEvent);
		CompositeResponse resp = (CompositeResponse) dispatch.getReply();
		List<DocketEventResponseEvent> crtDktRespEvts = MessageUtil.compositeToList(resp, DocketEventResponseEvent.class);
		//add the conditions for 146714
		//sort order by oid and chainnumber
				Date fromDate=DateUtil.stringToDate(DateUtil.dateToString( DateUtil.getCurrentDate(), DateUtil.DATE_FMT_2),DateUtil.DATE_FMT_2);
				Collections.sort((List<DocketEventResponseEvent>) crtDktRespEvts, Collections.reverseOrder(new Comparator<DocketEventResponseEvent>() {
					@Override
	    ...
	    //case 3: JJSCOURT : only Juvenile Number
	    ...
	    //Case 4: Bar no and Juvenile Number.
	    if (courtHearingForm.getBarNumber() != null && !courtHearingForm.getBarNumber().isEmpty() &&
		     courtHearingForm.getJuvenileNumber() != null && !courtHearingForm.getJuvenileNumber().isEmpty() && courtHearingForm.getCourtDate()!=null && courtHearingForm.getCourtDate().isEmpty())
	    {
		GetJJSCLCourtByBarNumAndJuvNumEvent jjsCrtJuvEvt = (GetJJSCLCourtByBarNumAndJuvNumEvent) EventFactory.getInstance(JuvenileCourtHearingControllerServiceNames.GETJJSCLCOURTBYBARNUMANDJUVNUM);
		jjsCrtJuvEvt.setJuvenileNumber(courtHearingForm.getJuvenileNumber());
		jjsCrtJuvEvt.setBarNumber(courtHearingForm.getBarNumber());
	    ...
	    //case 5: Juvenile and Hearing Date // does find by attribute
	    if (courtHearingForm.getCourtDate() != null && !courtHearingForm.getCourtDate().isEmpty() 
		    && courtHearingForm.getJuvenileNumber() != null && !courtHearingForm.getJuvenileNumber().isEmpty() && courtHearingForm.getBarNumber() != null && courtHearingForm.getBarNumber().isEmpty())
	    {
		GetJJSCLCourtByJuvNumEvent jjsCrtJuvEvt = (GetJJSCLCourtByJuvNumEvent) EventFactory.getInstance(JuvenileCourtHearingControllerServiceNames.GETJJSCLCOURTBYJUVNUM);
		jjsCrtJuvEvt.setJuvenileNumber(courtHearingForm.getJuvenileNumber());
		dispatch.postEvent(jjsCrtJuvEvt);
		CompositeResponse juvCompResp = (CompositeResponse) dispatch.getReply();
		List<DocketEventResponseEvent> crtDktRespEvents = MessageUtil.compositeToList(juvCompResp, DocketEventResponseEvent.class);
		...
		if (crtDktRespEvents != null && !crtDktRespEvents.isEmpty())
		{
			...
			if (docRespEvent != null)
			{
			    if(docRespEvent.getChainNumber().equalsIgnoreCase(prevChain))
				continue;
			    else if (courtHearingForm.getCourtDate().equals(docRespEvent.getCourtDate()))  //filter by hearing date.
			    {
				docRespEvent.setCourtTime(JuvenileFacilityHelper.stripColonInDate(docRespEvent.getCourtTime()));
				dockets.add(docRespEvent);
			    }
	    ...
	    //case 6: All the search parameters.
	    /*if (courtHearingForm.getCourtDate() != null && !courtHearingForm.getCourtDate().isEmpty() 
		    && courtHearingForm.getJuvenileNumber() != null && !courtHearingForm.getJuvenileNumber().isEmpty() 
		    && (courtHearingForm.getCourtDate() != null && !courtHearingForm.getJuvenileNumber().isEmpty()))*/
	    
	   
	    if (courtHearingForm.getCourtDate() != null || !courtHearingForm.getCourtDate().isEmpty() 
		    || courtHearingForm.getJuvenileNumber() != null || !courtHearingForm.getJuvenileNumber().isEmpty()
		    ||courtHearingForm.getBarNumber() != null || !courtHearingForm.getBarNumber().isEmpty()) 
		    
	    {
		GetJJSCLCourtByAtySettingSrchAttrEvent jjsCrtJuvEvt = (GetJJSCLCourtByAtySettingSrchAttrEvent) EventFactory.getInstance(JuvenileCourtHearingControllerServiceNames.GETJJSCLCOURTBYATYSETTINGSRCHATTR);
		jjsCrtJuvEvt.setJuvenileNumber(courtHearingForm.getJuvenileNumber());
		jjsCrtJuvEvt.setBarNumber(courtHearingForm.getBarNumber());
		if(courtHearingForm.getCourtDate()!=null&&!courtHearingForm.getCourtDate().isEmpty())
		{
		...
		//jjsCrtJuvEvt.setCourtDate(courtHearingForm.getCourtDate());
		String assignedAtty =courtHearingForm.getAssignedAttorney();
		jjsCrtJuvEvt.setAssignedAtty(assignedAtty);
		dispatch.postEvent(jjsCrtJuvEvt);
		CompositeResponse juvCompResp = (CompositeResponse) dispatch.getReply();
		List<DocketEventResponseEvent> crtDktRespEvents = MessageUtil.compositeToList(juvCompResp, DocketEventResponseEvent.class);
	    ...
	    //do all parameter add in detention too.
	    //*****************************************DETENTION RECORDS *********************************************//
	    //GET JJSCLDETENTION RECORDS
	    // Case 1: court calendar record. JJSCLCOURT //bar No and court Date
	    /*if (courtHearingForm.getCourtDate() != null && !courtHearingForm.getCourtDate().isEmpty() && courtHearingForm.getCourtDate() != null && !courtHearingForm.getCourtDate().isEmpty()
		    && (courtHearingForm.getJuvenileNumber()==null || courtHearingForm.getJuvenileNumber()!=null && courtHearingForm.getJuvenileNumber().isEmpty()))
	    {
		    GetJJSCLDetentionByBarNumAndHearingDateEvent jjsdetnCrtEvent = (GetJJSCLDetentionByBarNumAndHearingDateEvent) EventFactory.getInstance(JuvenileDetentionHearingControllerServiceNames.GETJJSCLDETENTIONBYBARNUMANDHEARINGDATE);
		    jjsdetnCrtEvent.setBarNumber(courtHearingForm.getBarNumber());
		    jjsdetnCrtEvent.setCourtDate(courtHearingForm.getCourtDate());
	    ...
	    //case 2: only bar num
	    if (courtHearingForm.getBarNumber() != null && !courtHearingForm.getBarNumber().isEmpty() && juvenileNum != null && juvenileNum.isEmpty() && courtHearingForm.getCourtDate().isEmpty())
	    {
		GetJJSCLDetentionByBarNumEvent jjsdetnCrtEvent = (GetJJSCLDetentionByBarNumEvent) EventFactory.getInstance(JuvenileDetentionHearingControllerServiceNames.GETJJSCLDETENTIONBYBARNUM);
		jjsdetnCrtEvent.setBarNumber(courtHearingForm.getBarNumber());
		dispatch.postEvent(jjsdetnCrtEvent);
		CompositeResponse clDetnResp = (CompositeResponse) dispatch.getReply();
		List<DocketEventResponseEvent> clDetnDktRespEvts = MessageUtil.compositeToList(clDetnResp, DocketEventResponseEvent.class);
	   ...
	   //Case 3: // only juv num
		...
		if (clDetnDktRespEvts != null && !clDetnDktRespEvts.isEmpty())
		{
			...
			////task 146725
				...
				continue;
			    //set Court Date and time
			    else if(fromDate.compareTo(DateUtil.stringToDate(docRespEvent.getCourtDate(), DateUtil.DATE_FMT_1))<=0&&(docRespEvent.getDisposition()==null||docRespEvent.getDisposition().isEmpty()))
			    {
        			    docRespEvent.setCourtTime(JuvenileFacilityHelper.stripColonInDate(docRespEvent.getCourtTime()));
        			    if (docRespEvent.getJuvenileNumber() != null)
        			    {
	    ...
	    //Case 4: Bar no and Juvenile Num.
	    if (courtHearingForm.getBarNumber() != null && !courtHearingForm.getBarNumber().isEmpty() 
		    && courtHearingForm.getJuvenileNumber() != null && !courtHearingForm.getJuvenileNumber().isEmpty()&& courtHearingForm.getCourtDate()!=null && courtHearingForm.getCourtDate().isEmpty())
	    {
		// Get detention records based on bar no or juvenile no.
		GetJJSCLDetentionByBarNumAndJuvNumEvent jjsJuvDetnEvt = (GetJJSCLDetentionByBarNumAndJuvNumEvent) EventFactory.getInstance(JuvenileDetentionHearingControllerServiceNames.GETJJSCLDETENTIONBYBARNUMANDJUVNUM);
		jjsJuvDetnEvt.setJuvenileNumber(courtHearingForm.getJuvenileNumber());
		jjsJuvDetnEvt.setBarNumber(courtHearingForm.getBarNumber());
	    ...
	    //case 5: Juvenile and Hearing Date 
	    if (courtHearingForm.getCourtDate() != null && !courtHearingForm.getCourtDate().isEmpty() 
		    && courtHearingForm.getJuvenileNumber() != null && !courtHearingForm.getJuvenileNumber().isEmpty() &&  courtHearingForm.getBarNumber()!=null && courtHearingForm.getBarNumber().isEmpty())
	    {
		// Get detention records based on bar no or juvenile no.
		GetJJSCLDetentionByJuvNumEvent jjsJuvDetnEvt = (GetJJSCLDetentionByJuvNumEvent) EventFactory.getInstance(JuvenileDetentionHearingControllerServiceNames.GETJJSCLDETENTIONBYJUVNUM);
		jjsJuvDetnEvt.setJuvenileNumber(courtHearingForm.getJuvenileNumber());
		dispatch.postEvent(jjsJuvDetnEvt);
		CompositeResponse juvRespnse = (CompositeResponse) dispatch.getReply();
		List<DocketEventResponseEvent> dktResponses = MessageUtil.compositeToList(juvRespnse, DocketEventResponseEvent.class);
		...
		if (dktResponses != null && !dktResponses.isEmpty())
		{
			...
			////task 146725
			    ...
			    {
        			    if (courtHearingForm.getCourtDate().equals(docRespEvent.getCourtDate())&&(docRespEvent.getDisposition()==null||docRespEvent.getDisposition().isEmpty()))
	    ...
	    {
		// Get detention records based on bar no or juvenile no.
		GetJJSCLDetentionByAtySettingSrchAttrEvent jjsJuvDetnEvt = (GetJJSCLDetentionByAtySettingSrchAttrEvent) EventFactory.getInstance(JuvenileDetentionHearingControllerServiceNames.GETJJSCLDETENTIONBYATYSETTINGSRCHATTR);
		jjsJuvDetnEvt.setJuvenileNumber(courtHearingForm.getJuvenileNumber());
		jjsJuvDetnEvt.setBarNumber(courtHearingForm.getBarNumber());
		if(courtHearingForm.getCourtDate()!=null&&!courtHearingForm.getCourtDate().isEmpty())
		{
		...
		String assignedAtty =courtHearingForm.getAssignedAttorney();
		jjsJuvDetnEvt.setAssignedAtty(assignedAtty);
		dispatch.postEvent(jjsJuvDetnEvt);
		CompositeResponse juvRespnse = (CompositeResponse) dispatch.getReply();
		List<DocketEventResponseEvent> dktResponses = MessageUtil.compositeToList(juvRespnse, DocketEventResponseEvent.class);
		////task 146725
	...
	CourtHearingForm form = (CourtHearingForm) aForm;
	IDispatch dispatch = EventManager.getSharedInstance(EventManager.REQUEST);
	AttorneysettingsSearchResultsReportBean reportBean = new AttorneysettingsSearchResultsReportBean();
	...
	pdfManager.createPDFReport(aRequest, aResponse, PDFReport.ATTORNEYSETTINGS_SEARCH_RESULTS_REPORT);
	return null;
