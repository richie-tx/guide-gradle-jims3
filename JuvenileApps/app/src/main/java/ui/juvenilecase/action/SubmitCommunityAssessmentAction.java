...
public class SubmitCommunityAssessmentAction extends LookupDispatchAction
{
     ...
     */
    public SubmitCommunityAssessmentAction()
    {
...
//		SaveCommunityAssessmentEvent saveEvt = (SaveCommunityAssessmentEvent) EventFactory
//                .getInstance(JuvenileRiskAnalysisControllerServiceNames.SAVECOMMUNITYASSESSMENT);
//        
        //saveEvt.setAssessmentDate(refForm.getCommunityAssessmentDate());
        ...
        event.setAssessmentType(RiskAnalysisConstants.RISK_TYPE_COMMUNITY);
        ...
        if (resp != null && resp.isMessage() == true) {
        	...
        	errors.add(ActionErrors.GLOBAL_MESSAGE, new ActionMessage("error.assessmenttypecannotbedonewithinhour", 
       			RiskAnalysisConstants.RISK_TYPE_COMMUNITY, riskForm.getCasefileID()));
	        ...
	        saveEvt.setAssessmentType(RiskAnalysisConstants.RISK_TYPE_COMMUNITY);
...
//		}
	 ...
	 */
	public ActionForward updateCommunityRiskAnalysisOverrideStatus(ActionMapping aMapping, ActionForm aForm, 
			HttpServletRequest aRequest, HttpServletResponse aResponse)
	{
		RiskAnalysisForm riskForm = (RiskAnalysisForm)aForm;
		
		SaveCommunityAssessmentEvent saveEvt = (SaveCommunityAssessmentEvent)
		EventFactory.getInstance(JuvenileRiskAnalysisControllerServiceNames.SAVECOMMUNITYASSESSMENT);
