 ...
 *	@deprecated
 */
public class RiskAssessmentInterviewForm extends ActionForm
{
	private String action;
	
	//private Date interviewAssessmentDate;
    ...
    private String assessmentType = RiskAnalysisConstants.RISK_TYPE_INTERVIEW;
...
/*    *//**
     * @param string
     *//*
    public void setInterviewAssessmentDate(Date dt)
    {
        interviewAssessmentDate = dt;
    }
*/
    /**
     * @param string
     ...
     * @param string
     */
    public void setOnsetAge(String string)
    {
        onsetAge = string;
    }
