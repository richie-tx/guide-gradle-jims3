 ...
 * @author jims2
 * 
 * Takes in juvenile number, referral number (optional), or assessmt_id are used to display JCMAYSIASSESSMNT records
 */

public class DeleteMaysiAssessQueryAction extends Action {

	private Logger log = Logger.getLogger("DeleteMaysiAssessQueryAction");
