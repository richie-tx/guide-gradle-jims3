...
public class UpdateDetentionCourtRecordQueryAction extends Action
{

    private Logger log = Logger.getLogger("UpdateDetentionCourtRecordQueryAction");
	...
	else
	{
		...
		List<JJSCLDetention> seqNumbers = JuvenileCaseHelper.getSequenceNumbers(juvenileNum);
		regform.setSequenceNumberList(seqNumbers);
