...
public class DisplayJuvenileFacilitySplAttnAction extends LookupDispatchAction{
	...
	public ActionForward link(ActionMapping aMapping,ActionForm aForm,HttpServletRequest aRequest,HttpServletResponse aResponse)
	{
		...
		Collection<JuvenileFacilitySplAttnReasonResponseEvent> splAttnRespEventList = JuvenileFacilityHelper.getAllJuvFacSplAttnReasonComments(form.getJuvenileNum());
		form.setSplAttnReasonComments(splAttnRespEventList);
