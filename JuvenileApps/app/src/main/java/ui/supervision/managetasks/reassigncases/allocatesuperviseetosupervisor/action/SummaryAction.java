...
public class SummaryAction extends JIMSBaseAction {
	...
	protected void addButtonMapping(Map keyMap) {
		...
		keyMap.put("button.allocatesuperviseetosupervisor.confirmation.confirm",
				"confirmSuperviseeAllocationToSupervisor");
	}
	...
	public ActionForward confirmSuperviseeAllocationToSupervisor(ActionMapping aMapping, ActionForm aForm,
		...
		if (!caseAssignmentForm.isTaskProcessed()){
			...
			ReassignSuperviseeService.getInstance().allocateSuperviseeToSupervisor(caseAssignmentForm);
