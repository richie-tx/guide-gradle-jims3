...
package ui.supervision.administercompliance.administercasesummary.form;
 ...
 *  
 */
public class CaseSummaryForm extends ActionForm 
{
...
// end common form variables	
	...
	private List caseSummaryDisplayList;
	private String violationReportId;
// these 9 variables are common variables used in element creatation only 	
...
// TASK varialbles
    ...
    public void clear()
    {
    	...
    	this.caseSummaryDisplayList = new ArrayList();
...
/**
	...
	/**
	 * @return the otherSummaryOfCourtActions
	 */
	public String getOtherSummaryOfCourtActions() {
		return otherSummaryOfCourtActions;
	}
	/**
	 * @param otherSummaryOfCourtActions the otherSummaryOfCourtActions to set
	 */
	...
	/**
	 * @return the selectedCourtActionsIds
	 */
...
//	}
	...
	/**
	 * @return Returns the caseSummaryDisplayList.
	 */
	public List getCaseSummaryDisplayList() {
		return caseSummaryDisplayList;
	}
	/**
	 * @param caseSummaryDisplayList The caseSummaryDisplayList to set.
	 */
	public void setCaseSummaryDisplayList(List caseSummaryDisplayList) {
		this.caseSummaryDisplayList = caseSummaryDisplayList;
	}
	/**
