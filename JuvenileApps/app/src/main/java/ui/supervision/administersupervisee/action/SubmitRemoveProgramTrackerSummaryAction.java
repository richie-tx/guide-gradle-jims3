...
public class SubmitRemoveProgramTrackerSummaryAction extends JIMSBaseAction
{
    ...
    */
   public SubmitRemoveProgramTrackerSummaryAction() 
   {
	...
	public ActionForward finish(ActionMapping aMapping,
        ...
        if (er != null){
        	...
        	SuperviseeHeaderForm myHeaderForm = (SuperviseeHeaderForm) getSessionForm(
            	...
            	aRequest.setAttribute("confirmMessage", "Program Tracker Information successfully removed.");
