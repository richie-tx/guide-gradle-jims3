 ...
 * 
 */
public class ProcessReturnOfServiceWarrantNumberComparator implements Comparator
{
    public int compare(Object o1, Object o2)
    {
        String key1 = ((ProcessReturnOfServiceResponseEvent) o1).getWarrantNum();
        String key2 = ((ProcessReturnOfServiceResponseEvent) o2).getWarrantNum();
        if(key1!=null)
        	key1=key1.trim();
        else{
        	key1="0";
