 ...
 *
 */
public class GetLocationByCSServiceProviderEvent extends RequestEvent 
{
	private String cslocationId;	
	...
	/**
	 * @return the cslocationId
	 */
	public String getCslocationId() {
		return cslocationId;
	}
	/**
	 * @param cslocationId the cslocationId to set
	 */
	public void setCslocationId(String cslocationId) {
