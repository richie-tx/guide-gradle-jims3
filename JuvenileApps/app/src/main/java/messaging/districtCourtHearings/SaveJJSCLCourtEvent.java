...
public class SaveJJSCLCourtEvent extends RequestEvent
{
    /**
	 * 
	 */
	...
	/**
	 * @param hearingDispositionDesc the hearingDispositionDesc to set
	 */
	...
	/**
	 * @param hearingResultDesc the hearingResultDesc to set
	 */
	...
	/**
	 * @param hearingTypeDesc the hearingTypeDesc to set
	 */
	...
	/**
	 * @param petitionAllegationDesc the petitionAllegationDesc to set
	 */
	...
	/**
	 * @param courtSeqNumber the courtSeqNumber to set
	 */
	...
	/**
	 * @param courtChainNumber the courtChainNumber to set
	 */
