...
public class UpdateJJSHeaderFromDetentionCourtEvent extends RequestEvent
{
    ...
    private boolean releasedecisionStatus=false;
    private boolean distreleasedecisionStatus=false;
...
*/
    ...
    public boolean isReleasedecisionStatus()
    {
        return releasedecisionStatus;
    }

    public void setReleasedecisionStatus(boolean releasedecisionStatus)
    {
        this.releasedecisionStatus = releasedecisionStatus;
    }
    public boolean isDistreleasedecisionStatus()
    {
        return distreleasedecisionStatus;
    }

    public void setDistreleasedecisionStatus(boolean distreleasedecisionStatus)
    {
