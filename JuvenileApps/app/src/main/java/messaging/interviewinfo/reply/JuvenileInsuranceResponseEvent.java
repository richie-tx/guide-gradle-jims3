 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class JuvenileInsuranceResponseEvent extends RequestEvent implements Comparable
{
	...
	public int compareTo(Object obj) throws ClassCastException {
		...
		if (this.entryDate == null)
			return 1;
		JuvenileInsuranceResponseEvent evt = (JuvenileInsuranceResponseEvent) obj;
