 ...
 *
 */
public class BenefitsReceivedByResponseEvent extends ResponseEvent implements Comparable
{
	...
	public int compareTo(Object o) {
		BenefitsReceivedByResponseEvent input = (BenefitsReceivedByResponseEvent) o;
