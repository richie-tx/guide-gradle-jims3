...
public class JuvenileFacilityAdmissionCommentsResponseEvent extends ResponseEvent implements IAddressable,Comparable<JuvenileFacilityAdmissionCommentsResponseEvent>{
	...
	@Override
	public int compareTo(JuvenileFacilityAdmissionCommentsResponseEvent o) {
		if(o == null)
			return 1; // this makes any null objects go to the bottom change this to -1 if you want the top of the list
		if(this.createDate==null)
			return -1; // this makes any null objects go to the bottom change this to 1 if you want the top of the list
		JuvenileFacilityAdmissionCommentsResponseEvent evt = (JuvenileFacilityAdmissionCommentsResponseEvent)o;
