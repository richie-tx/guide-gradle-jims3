...
public class CasefileDocumentsResponseEvent extends ResponseEvent implements Comparable{
	...
	/**
	 * @param documentTypeCd the documentTypeCd to set
	 */
