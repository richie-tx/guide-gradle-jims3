 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class CommonAppDocResponseEvent extends ResponseEvent implements Comparable{
	public static final String COMMUNITY_EXIT_PLAN = "CEP";
	public static final String COMMONAPP_REPORT = "CRP";
	public static final String RESIDENTIAL_EXIT_PLAN = "REP";
	...
	public int compareTo(Object o) {
        ...
        if (this.createDate == null)
            return -1; // this makes any null objects go to the bottom change this to 1 if you want
        // the top of the list
        CommonAppDocResponseEvent evt = (CommonAppDocResponseEvent) o;
