...
public class GetJuvenileCasefilePetitionsEvent extends RequestEvent 
{
    ...
    */
   public GetJuvenileCasefilePetitionsEvent() {}
    ...
    * 
    * @param juvenileNum the new value of the juvenileNum property
    */
