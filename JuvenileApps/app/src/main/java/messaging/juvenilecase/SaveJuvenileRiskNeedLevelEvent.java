...
public class SaveJuvenileRiskNeedLevelEvent extends RequestEvent 
{
   ...
   private List<String> referralNumbers;
    ...
    */
   public SaveJuvenileRiskNeedLevelEvent() 
   {
   ...
   public String getCaseFileId() 
   {
	...
	public List<String> getReferralNumbers()
	{
	    return referralNumbers;
	}

	public void setReferralNumbers(List<String> referralNumbers)
	{
