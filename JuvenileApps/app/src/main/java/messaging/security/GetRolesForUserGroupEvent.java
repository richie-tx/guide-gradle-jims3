//Source file: C:\\views\\archproduction\\app\\src\\messaging\\security\\GetRolesForUserGroupEvent.java

package messaging.security;

import mojo.km.messaging.RequestEvent;

public class GetRolesForUserGroupEvent extends RequestEvent
{
	public String userGroupId;

	/**
	 * @roseuid 429720DD011C
	 */
	public GetRolesForUserGroupEvent()
	{
