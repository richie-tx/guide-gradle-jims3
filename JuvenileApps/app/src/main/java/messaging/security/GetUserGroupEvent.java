//Source file: C:\\views\\archproduction\\app\\src\\messaging\\security\\GetUserGroupEvent.java

package messaging.security;

import mojo.km.messaging.RequestEvent;

public class GetUserGroupEvent extends RequestEvent
{
	public String userGroupId;

	/**
	 * @roseuid 429720C000FD
	 */
	public GetUserGroupEvent()
	{
