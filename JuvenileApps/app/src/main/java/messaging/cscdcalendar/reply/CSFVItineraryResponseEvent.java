// Source file:
// C:\\PROGRA~1\\IBM\\SQLLIB\\bin\\messaging\\cscdcalendar\\ResponseEvents\\CSFVItenaryResponseEvent.java
 ...
 */
public class CSFVItineraryResponseEvent extends ResponseEvent {
	...
	/**
	 * @roseuid 47A2366F029C
	 */
	public CSFVItineraryResponseEvent() {
	...
	/**
	 * @return Returns the fvItineraryId.
	 */
	public String getFvItineraryId() {
		return fvItineraryId;
	}

	/**
	 * @param fvItineraryId
	 *            The fvItineraryId to set.
	 */
	public void setFvItineraryId(String fvItineraryId) {
		this.fvItineraryId = fvItineraryId;
	}
