 ...
 *
 */
public class DepartmentPolicyResponseEvent extends ResponseEvent implements Comparable
{
	...
	public int compareTo(Object arg0)
			{
				String newString = "";
				DepartmentPolicyResponseEvent cre = (DepartmentPolicyResponseEvent) arg0;
				if (this.name == null)
				{
					this.name = newString;
				}
	 ...
	 * @param string
	 */
	public void setAgencyPolicyId(String string)
	{
	 ...
	 * @param string
	 */
	public void setAgencyPolicyName(String string)
	{
