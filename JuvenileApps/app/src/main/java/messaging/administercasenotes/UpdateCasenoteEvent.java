...
public class UpdateCasenoteEvent extends RequestEvent implements ICasenote
{
	...
	/**
    * @roseuid 44F461770233
    */
   public UpdateCasenoteEvent() 
   {
   }
...
//	}
	...
	/**
	 * @param aSubjectCollection  The subjectId to set.
	 */
...
//	}
	...
	/* (non-Javadoc)
	 * @see messaging.administercasenotes.domintf.ICasenote#getAutoSaved()
	 */
	...
	/* (non-Javadoc)
	 * @see messaging.administercasenotes.domintf.ICasenote#setAutoSaved(boolean)
	 */
	public void setAutoSaved(boolean b) {
	}

    /* (non-Javadoc)
     * @see messaging.administercasenotes.domintf.ICasenote#getCollateralInfo()
     */
    ...
    /* (non-Javadoc)
     * @see messaging.administercasenotes.domintf.ICasenote#setCollateralInfo(java.lang.String)
     */
