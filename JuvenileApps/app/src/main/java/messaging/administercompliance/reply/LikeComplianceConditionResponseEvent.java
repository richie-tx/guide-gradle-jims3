 ...
 * @author mchowdhury
 */
public class LikeComplianceConditionResponseEvent extends AComplianceConditionResponseEvent
{
	private List complianceConditionResponseEvents;
	private List courtPolicies; 
    private List departmentPolicies;
    private String AMPMId;
	
    /**
	 * @return Returns the complianceConditionResponseEvents.
	 */
	public List getComplianceConditionResponseEvents() {
		return complianceConditionResponseEvents;
	}
	/**
	 * @param complianceConditionResponseEvents The complianceConditionResponseEvents to set.
	 */
	public void setComplianceConditionResponseEvents(List complianceConditionResponseEvents) {
		this.complianceConditionResponseEvents = complianceConditionResponseEvents;
	}
	/**
