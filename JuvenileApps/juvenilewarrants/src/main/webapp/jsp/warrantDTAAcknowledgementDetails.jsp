...
<title><bean:message key="title.heading"/> - warrantDTAAcknowledgementDetails.jsp</title>
...
<html:form action="/submitWarrantDTAAcknowledgement" target="content">
   <input type="hidden" name="helpFile" value="juvwarnt/juvenile_warrants_final.htm#|23">
	       <!--<input type="hidden" name="warrantTypeUI" value="<bean:write name="juvenileWarrantForm" property="warrantTypeUI"/>">-->
<!-- BEGIN HEADING TABLE -->
	<table width="100%">
      <tr>
        <td align="center" class="header"><bean:message key="title.juvWarrantDTA"/>&nbsp;Acknowledgement&nbsp;Details</td>
      </tr>
	 </table>
<!-- END HEADING TABLE -->
...
<table width="98%" border="0">
   <tr>
     <td>
	  <ul>
        <li>Verify that warrant displayed is correct warrant and select Finish to acknowledge the warrant.</li>
        <li>Select Cancel to exit page without acknowledging the warrant.</li>
 	  </ul>	</td>
  </tr>
</table>  
...
<table border="0" cellpadding=1 cellspacing=0 align="center">
	 <tr valign="top">
		...
		<td>
		<html:form action="/displayGenericSearch.do?warrantTypeUI=reqAckDTA"> 			  
