...
<html:base />
<title>JIMS2 - warrantReturnOfServiceSignatureStatusConfirm.jsp</title>
<!-- JAVASCRIPT FILES-->
...
<input type="hidden" name="helpFile" value="juvwarnt/juvenile_warrants_final.htm#|43">

<!-- BEGIN HEADING TABLE -->
<table align="center">
  <tr>
    <td class="header"><bean:message key="title.juvWarrantFileReturnOfServiceSignature"/> Confirmation</td>
  </tr>
</table>
<!-- END HEADING TABLE -->
<br>
...
<table width="98%">
   <tr>
     <td align="center" class="confirm">Service Return Signature Status updated to Filed.</td>
  </tr>
</table>
<!-- END MESSAGE TABLE -->
