...
<!-- C Shimek       08/08/2005  Revised to display new look and feel --> 
<!-- D Gibler       08/24/2005  Changed "back to warrant" button to execute ViewWarrantDetailsAction.  Needs to do this because this page displays
                                in the View flow and also in the Create Warrant flow.  -->
...
<%-- CShimek		04/11/2007  #41031 removed Back To Warrant button and target=content in form tag --%>
<%-- LDeen			06/04/2007  #42564 changed path to app.js --%>
<%-- CShimek		12/21/2006  #44943 revised button display to use js instead of logic tags, problem with logic tag value not being set, used to work fine --%>
...
<html:base />
<title><bean:message key="title.heading" /> - warrantAssociateConfirm.jsp</title>
...
<!-- BEGIN FORM -->		
<html:form action="/submitJuvWarrantCreate">
	<input type="hidden" name="helpFile" value="juvwarnt/juvenile_warrants_final.htm#|169">

<!-- BEGIN HEADING TABLE -->
<table width=100%>
  <tr>
    <td align="center" class="header" ><bean:message key="title.juvWarrantAssociate"/>&nbsp;Confirmation</td>
  </tr>
</table>
<!-- END HEADING TABLE -->
...
<table width=98% border=0 cellspacing=1 cellpadding=2 align=center>
   ...
   <tr>
     <td align="center" class="confirm">
		  ...
		  The following Responsible Adult has been created.
		</logic:equal>  
		<logic:equal name="juvenileAssociateForm" property="action" value="update">
		  The following Responsible Adult has been updated.
		</logic:equal>  
	 </td>
   </tr>	 	
 </table>
...
<%-- BEGIN ASSOCIATE NAME INFO TABLE --%>
...
<%-- 	  		<html:submit property="submitAction" onclick="return disableSubmit(this, this.form)">
	  			 <bean:message key="button.backToWarrant"></bean:message>
   			</html:submit> --%>
	 	...
	 	<script type="text/javascript">
            	...
            	if (windowName != "content"){
            		document.write("<input type='button' name='closeWindow' value='Close Window' onclick='window.close()'>");
			  		...
			  		document.write('<html:submit property="submitAction" onclick="return disableSubmit(this, this.form)">');
   					document.write('<bean:message key="button.mainPage"></bean:message>');
					document.write('</html:submit>');            	
            	}
            </script>	
