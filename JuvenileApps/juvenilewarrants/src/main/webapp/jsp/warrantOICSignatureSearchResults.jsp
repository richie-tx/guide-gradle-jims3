<!DOCTYPE HTML>
<!--MODIFICATIONS -->
<%-- Used for Order of Immediated Custody(OIC) Search Results --%>
<%-- 02/14/2005	 Leslie Deen	Create JSP --%>
<%-- 10/06/2005  CShimek		ER#23756 revise titles --%>
<%-- 02/01/2006  CShimek        Added hidden field for HelpFile access --%>
...
<html:base />
<title><bean:message key="title.heading"/> - warrantOICSignatureSearchResults.jsp</title>
<!--END HEADER TAG-->

<!--BEGIN BODY TAG-->
<body>
<!-- BEGIN FORM -->			
<html:form action="/displayWarrantOICSignatureSearchResults" target="content">
   <input type="hidden" name="helpFile" value="juvwarnt/juvenile_warrants_final.htm#|192">
<!-- BEGIN HEADING TABLE -->
<table width=98% align="center">	
	<tr>
		<td align="center" class="header">Update&nbsp;<bean:message key="title.juvWarrantOICSignature"/> Search Results
         </td>		 
    <tr><td>&nbsp;</td></tr>
    <tr>
        <td><ul>	       
...
<!-- display detail header -->  
	<tr class="detailHead" id="firstRow">
    	...
    	<jims:sortResults beanName="juvenileWarrantForm" results="warrants" primaryPropSort="warrantNum" primarySortType="INTEGER" sortId="1" levelDeep="1"/>
   		...
   		<td class="subhead"><bean:message key="prompt.petitionNumber"/>
   		<jims:sortResults beanName="juvenileWarrantForm" results="warrants" primaryPropSort="petitionNum" primarySortType="STRING" sortId="2" levelDeep="1"/>
	   	</td>
...
<pg:item>
  				...
  				<tr class= 
					...
					%> align="left">
					<td><a href="/<msp:webapp/>displayWarrantOICSignatureSearchResults.do?warrantTypeUI=singleItem=true&reqSigOIC&warrantNum=<bean:write name="juvenileWarrantIndex" property="warrantNum"/>">
						<bean:write name="juvenileWarrantIndex" property="warrantNum"/></a></td>
					<td><bean:write name="juvenileWarrantIndex" property="petitionNum"/></td>
...
<table border="0" width="100%">
  <tr align="center">
    <!--CANCEL BUTTON FORM-->
			<td>
			  <html:form action="/displayGenericSearch.do?warrantTypeUI=reqSigOIC">
