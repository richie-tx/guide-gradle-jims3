...
<head>
	<meta name="title" value="<%=PDFReport.DTAWARRANTRETURN_REPORT_NAME.getReportName()%>"/>
	<meta name="author" value="JIMS2, Harris County"/>
	<meta name="subject" value="<%=PDFReport.DTAWARRANTRETURN_REPORT_NAME.getReportName()%>"/>
...
<table width="100%" border-style="none">
		<tr align="center">
			<td align="center" width="40%">The State Of Texas</td><td align="center" width="20%">&#167;</td><td align="left" width="40%" class="indent-35px">Directive To Apprehend</td>
		</tr>
		<tr align="center">
...
<table width="100%" border-style="none" class="margin-top-24px">
		<tr>
			<td  align="left">
				<%=StringEscapeUtils.escapeXml("I, " + reportInfo.getExecutorName() + ", the undersigned, a peace officer under the laws of the " + 
						"State of Texas, certifies that the foregoing Directive to Apprehend came to hand on the day it was issued and that it was executed on " + 
						StringUtil.isNotNull(DateUtil.dateToString(reportInfo.getCurrentServiceDate(), "MMM dd, yyyy")) + " by taking custody of " + 
						reportInfo.getFirstName() + " " +  reportInfo.getMiddleName() + " " + reportInfo.getLastName() + " " + reportInfo.getSuffix() + 
						" and placing them in jail in Harris County, Texas.") %>
			</td>
		</tr>
</table>
