...
<%-- RCapestani			09/14/2007  #44731 comment out Juv Phone Number --%>
<%-- LDeen				02/15/2008  #49555 change <br> to be inside <tr> tag --%>
<%-- R Young            08/6/2015   #27796 MJCW:  Adapt MJCW and Warrants to IE10 and 11 (Juv Profile - Education UI) --%>
...
<html:base />
<title><bean:message key="title.heading"/> - warrantActivateConfirm.jsp</title>
<!-- APP JAVASCRIPT FILE -->
...
<html:form action="/displayGenericSearch" target="content">
	<logic:equal name="juvenileWarrantForm" property="warrantTypeUI" value="actARR">
		<input type="hidden" name="helpFile" value="juvwarnt/juvenile_warrants_final.htm#|75">
	</logic:equal>
...
<table width="95%" align="center" border="0">
   <tr>
     <td align="center" class="confirm">Warrant has been activated.</td>
  </tr>
</table>  
...
<!-- BEGIN JUVENILE WARRANT INFORMATION BLOCK -->  
     ...
     <tr>			
        ...
        <td class=formDe nowrap width="1%"><bean:write name="juvenileWarrantForm" property="juvenileNum"/></td>                
     </tr>
     <tr>
...
<!-- VARIABLES NEEDED FOR ASSOCIATE DISPLAY -->
 <% int RecordCounter = 0; 
    ...
    <tr>
	    ...
	    <td class=formDeLabel colspan="2" align="left"><bean:message key="prompt.relationshipToJuvenile"/></td>
    </tr>
...
<tr><td><br></td></tr>
<!-- BEGIN WARRANT ACTIVATION INFORMATION BLOCK -->  
	<tr>
	 	<td class=detailHead colspan=4 nowrap><bean:message key="prompt.activationInfo" /></td>
	</tr>
 	<tr>
   ...
   <tr>
	  ...
	  <td class=formDe>
	      <bean:write name="juvenileWarrantForm" property="warrantSignedStatus"/></td>
   </tr>
   <tr>		
