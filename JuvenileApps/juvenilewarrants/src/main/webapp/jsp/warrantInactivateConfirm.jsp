<!DOCTYPE HTML>
<!--MODIFICATIONS -->
<%-- HRodriguez	01/26/2005	Create JSP --%>
...
<%-- CShimek	01/30/2007  added disableSubmit to mainPage button--%>
...
<html:base />
<title><bean:message key="title.heading"/> - warrantInactivateConfirm.jsp</title>
<!-- JAVASCRIPT FILES-->
...
<logic:equal name="juvenileWarrantForm" property="action" value="summary">
	<input type="hidden" name="helpFile" value="juvwarnt/juvenile_warrants_final.htm#|25">	
</logic:equal>	
<logic:notEqual name="juvenileWarrantForm" property="action" value="summary">
	<input type="hidden" name="helpFile" value="juvwarnt/juvenile_warrants_final.htm#|160">	
</logic:notEqual>   
<!-- BEGIN HEADING TABLE -->
<table width="98%">
    <tr>    
   		<td align="center" class="header">
   			<bean:message key="prompt.inactivate" />&nbsp;<bean:message key="title.juvWarrant"/>
   			<logic:equal name="juvenileWarrantForm" property="action" value="summary">
...
<table width="98%">
   	<tr>
   		<logic:equal name="juvenileWarrantForm" property="action" value="summary">
			<td>
				<ul>
					<li>Verify that information is correct and select Finish button to inactivate Warrant.</li>				
					<li>If any changes are needed, select Back button.</li>
				</ul>
			</td>   				
   		</logic:equal>	
   		<logic:notEqual name="juvenileWarrantForm" property="action" value="summary">
   			<td align="center" class=confirm>Juvenile Warrant successfully inactivated.</td>
   		</logic:notEqual>	   	
  	</tr>	
</table>
...
<!-- BEGIN WARRANT INFORMATION SECTION -->
	...
	<logic:equal name="juvenileWarrantForm" property="referralNum" value="0">
		<tr>
			...
			<td class=formDe>
				<logic:equal name="juvenileWarrantForm" property="transactionNum" value=""></logic:equal>               
			...
			<td class=formDe>
				<logic:equal name="juvenileWarrantForm" property="daLogNum" value=""></logic:equal>               				  
...
<!-- BEGIN JUVENILE INFORMATION SECTION -->
	...
	<tr>
		...
		<td class=formDe colspan=3><bean:write name="juvenileWarrantForm" property="maskedSSN" />
	</tr>
	<tr>
...
<%--       <a href="/<msp:webapp/>displayAssociateDetails.do?associateNumber=<bean:write name="associateIndex" property="associateNum"/>"> --%>
			<a href="javascript:openWindow('/<msp:webapp/>displayAssociateDetails.do?associateNumber=<bean:write name="associateIndex" property="associateNum"/>');">	               							      
        		...
        		<bean:write name="associateIndex" property="associateName.middleName" /></a>
      </td>
...
<!-- END OTHER INFORMATION SECTION -->
	...
	<tr><td colspan="4">&nbsp;</td></tr>		
<!-- BEGIN WARRANT INACTIVATE INFORMATION SECTION -->
	<tr>
		<td class="detailHead" colspan="4"><bean:message key="prompt.warrantInactivateInfo" /></td>
	</tr>
   	<tr>
		<td class=formDeLabel width=1% nowrap><bean:message key="prompt.inactivateReason"/></td>
       	<td class=formDe colspan="3"><bean:write name="juvenileWarrantForm" property="recallReason" /></td>	
    </tr>   					
<!-- END WARRANT INACTIVATE INFORMATION SECTION -->			
</table>
