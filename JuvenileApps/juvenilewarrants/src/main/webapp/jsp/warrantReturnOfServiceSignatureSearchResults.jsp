<!DOCTYPE HTML>
<!-- Used to search for juvenile service search results. -->
<!--MODIFICATIONS -->
...
<html:base />
<title><bean:message key="title.heading"/> - warrantReturnOfServiceSignatureSearchResults.jsp</title>
...
<!--BEGIN BODY TAG-->
<body>
<html:form action="/displayWarrantReturnOfServiceSignatureSearchResults" target="content">
<input type="hidden" name="helpFile" value="juvwarnt/juvenile_warrants_final.htm#|45">
   
<!-- BEGIN HEADING TABLE -->
 <table align="center">
   <tr>
     <td class="header">
          <bean:message key="title.juvWarrantFileReturnOfServiceSignature"/> Search Results
     </td>
   </tr>
</table>
<!-- END HEADING TABLE -->
...
<pg:item>
    ...
    <tr class= 
	   <% RecordCounter++;
	    ...
	    %> >
   		<td> 
   		     <a href="/<msp:webapp/>displayWarrantReturnOfServiceSignatureSearchResults.do?warrantTypeUI=retSigStatus&warrantNum=<bean:write name="warrantIndex" property="warrantNum"/>">
...
<table width="98%" border="0" align="center">
   <tr>
      ...
      <html:form action="/displayGenericSearch.do?warrantTypeUI=retSigStatus"> 
         <html:submit>
