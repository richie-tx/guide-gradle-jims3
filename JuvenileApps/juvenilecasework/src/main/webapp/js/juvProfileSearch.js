$(document).ready(function () {
	...
	if($("#referralAction").val()!="juvenileSearchResults")
		$("#searchType").val("JNUM");
	evalSearch(myForm);
		...
		if(typeof searchType !="undefined"){
			var searchType = $("#searchType").val();
			   if(searchType=="JNAM"){
				...
				//if(validateJuvenileProfileSearchForm(myForm))
				//	spinner();
				//else
					//return validateJuvenileProfileSearchForm(myForm);
