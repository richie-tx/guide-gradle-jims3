...
function checkInputs()
{
	...
	var fld5 = Trim(document.getElementById("ncicCd").value);
	...
	var str = fld1 + fld2 + fld3 + fld4+fld5;
	if (str == "")	 {
	...
	fld1 = document.getElementById("ncicCd");
	if (fld1.value > "") {
		if (numericRegExp.test(fld1.value,numericRegExp) == false) {
			if (msg == ""){
				fld1.focus();
			}
			msg += "NCIC Code must be numeric value.\n";
		}
	}
	if (msg == "") {
...
<html:form action="/handleJuvenileDistrictCourtOffenseSearch"  target="content" focus="alphaCodeId">
<!-- BEGIN HEADING TABLE -->
...
<%-- BEGIN SEARCH INPUT TABLE --%>					
						<table border="0" cellspacing='1' cellpadding="2" width="100%">
							...
							<tr>
								...
								<td class="formDe"><html:text name='courtHearingForm' property='alphaCodeId' size="6" maxlength="6" styleId="acId"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"  width="1%" nowrap="nowrap"><bean:message key="prompt.short"/> <bean:message key="prompt.description"/></td>
								<td class="formDe"><html:text name='courtHearingForm' property='shortDesc' size="30" maxlength="30" styleId="descId"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"><bean:message key="prompt.DPS"/> <bean:message key="prompt.code"/></td>
								<td class="formDe"><html:text name='courtHearingForm' property='dpsCodeId' size="8" maxlength="8" styleId="dpsId"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"><bean:message key="prompt.severityLevel"/> </td>
								<td class="formDe"><html:text name='courtHearingForm' property="categoryId" size="2" maxlength="2" styleId="catId"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"><bean:message key="prompt.ncicCode"/> </td>
								<td class="formDe"><html:text name='courtHearingForm' property="ncicCode" size="8" maxlength="8" styleId="ncicCd"/></td>
							</tr>
							<tr>
...
<%-- END SEARCH INPUT TABLE --%>
						...
						<logic:notEmpty name="courtHearingForm" property="offenseResultList">
<%-- BEGIN SEARCH RESULTS TABLE --%>						
							<table border="0" cellspacing='1' cellpadding="2" width="100%">
								<tr>
									<td align="center" style="padding:2px" colspan="2"><br>
										<bean:size id="collSize" name="courtHearingForm" property="offenseResultList"/>
...
<%-- BEGIN SEARCH RESULTS LIST TABLE --%>									
										<table border="0" width="100%" cellspacing="1" cellpadding="2">				
											<tr bgcolor="#cccccc">
												<td width="1%"></td>
												<td class="subhead"><bean:message key="prompt.alpha" /> <bean:message key="prompt.code" /><jims2:sortResults beanName="courtHearingForm" results="offenseResultList" primaryPropSort="alphaCode" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="1" /></td>
												<td class="subhead"><bean:message key="prompt.short" /> <bean:message key="prompt.description" /><jims2:sortResults beanName="courtHearingForm" results="offenseResultList" primaryPropSort="shortDescription" primarySortType="STRING" defaultSortOrder="ASC" sortId="2" /></td>
												<td class="subhead"><bean:message key="prompt.DPS" /> <bean:message key="prompt.code" /><jims2:sortResults beanName="courtHearingForm" results="offenseResultList" primaryPropSort="dpsCode" primarySortType="STRING" defaultSortOrder="ASC" sortId="3" /></td>
												<td class="subhead"><bean:message key="prompt.severityLevel" /><jims2:sortResults beanName="courtHearingForm" results="offenseResultList" primaryPropSort="category" primarySortType="STRING" defaultSortOrder="ASC" sortId="4" /></td>
											</tr>
					                        ...
					                        <bean:define id="paginationResultsPerPage" type="java.lang.String"><bean:message key="pagination.recordsPerPage"/></bean:define>
					                         ...
					                         <%-- End Pagination header stuff --%>
			  								<logic:iterate id="offIndex" name="courtHearingForm" property="offenseResultList" indexId="index">
                              					...
                              					<pg:item>
													...
													<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>" height="100%">
														<td align="center">																																		
															<html:radio name="courtHearingForm" property="selectedValue" value='<%=offId%>' onclick="enableSelectButton();" />
														</td>
...
<table border="0" width="100%">
	<tr> 
		<td align="center">
			<html:submit onclick="spinner()" property="submitAction"><bean:message key="button.back"/></html:submit> 				
			<html:submit onclick="spinner()" property="submitAction" disabled="true" styleId="selectBtn"><bean:message key="button.select" /></html:submit>
