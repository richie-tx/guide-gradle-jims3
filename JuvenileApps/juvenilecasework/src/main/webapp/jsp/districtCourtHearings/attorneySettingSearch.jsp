...
<script type='text/javascript' src="/<msp:webapp/>js/districtCourtHearings/attorneySettingSearch.js"></script>
...
$(document).ready(function(){
	...
	$("#printBtn").click(function(){
		spinner();
		$.ajax({
	        url: '/JuvenileCasework/submitJuvenileDistrictCourtAttorneySetting.do?submitAction=Print',
	        type: 'post',
...
<title><bean:message key="title.heading"/>/attorneySettingSearch.jsp</title>
</head> 
<%--END HEAD TAG--%>
<%--BEGIN BODY TAG--%>
<body>
<html:form action="/submitJuvenileDistrictCourtAttorneySetting" target="content">
<!-- HELP FILE -->
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|264">

<table width='100%'>
	<tr>
		<td align="center"><h2>Process Juvenile Court Hearings<br/><br/>Search Attorney Setting</h2></td>
	</tr>
</table>
<br/>
...
<table width="98%" border="0">
  <tr>
    <td>
      <ul>
        <li>Action field Bar Number or Attorney Name or Juvenile Number is required.</li>
        <li>Click Submit button to inquire Attorney Setting.</li>
      </ul>
    </td>
  </tr>
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" align="center" class="borderTableBlue" colspan="5">      
   <tr class='crtDetailHead'>
	...
	<tr>
		...
		<td class='formDeLabel'  colspan="1"  width="5%" nowrap="nowrap"><span>+</span><bean:message key="prompt.attorneyName"/></td>
		<td class='formDe' colspan="7" width="5%" nowrap="nowrap" colspan="3">
			<input type="text" name="attorneyName" id="attorneyName" size="50" maxlength="50" value="<bean:write name="courtHearingForm" property="attorneyName"/>" disabled/> <html:button property="submitAction" styleId="searchAttorney"><bean:message key="button.searchAttorney" /></html:button>
	...
	<tr>
		...
		<td valign='top' align="right" class="formDeLabel" nowrap="nowrap" width="10%"><bean:message key="prompt.limitattorneyResults"/></td>																
		<td class='formDe' colspan='8' nowrap>
			<html:radio styleId="assignedAttorney1" name="courtHearingForm" property="assignedAttorney" value="1"/><bean:message key="prompt.firstAssigned" />
			<html:radio styleId="assignedAttorney2" name="courtHearingForm" property="assignedAttorney" value="2"/><bean:message key="prompt.secondAssigned" /> 
			<html:hidden styleId="assignedAttorneyId" name="courtHearingForm" property="assignedAttorney"/>	
		</td>
	 				...
	 				<tr class="crtDetailHead">   
	    				<td>   
	          			...
	          			<td>
	  						...
	  						<jims:sortResults beanName="courtHearingForm" results="dktSearchResults" primaryPropSort="juvenileName" primarySortType="STRING" defaultSortOrder="ASC" sortId="8" />
		          		</td>
		          		<td>
	  						<bean:message key="prompt.attorneyName1"/>
	  						<jims:sortResults beanName="courtHearingForm" results="dktSearchResults" primaryPropSort="attorneyName" primarySortType="STRING" defaultSortOrder="ASC" sortId="9" />
		          		</td>
						<td>
	  						<bean:message key="prompt.connection1"/>
		          		...
		          		<!-- add the new coloumn 1st or second -->
		          		<td>
	  						<bean:message key="prompt.attorneyName2"/>
	  						<jims:sortResults beanName="courtHearingForm" results="dktSearchResults" primaryPropSort="attorney2Name" primarySortType="STRING" defaultSortOrder="ASC" sortId="7" />
		          		</td>
	  				...
	  				<logic:iterate id="dockets" name="courtHearingForm" property="dktSearchResults" indexId='indexer'> 
	          			<pg:item>
			    				<tr class="<%out.print( (indexer.intValue() % 2 == 1) ? "alternateRow" : "normalRow" );%>" colspan="10">
			    					...
			    					<td class='formDe' colspan="1"><bean:write name="dockets" property="attorney2Name"/></td>
			    				</tr>
	  					</pg:item>
	  		  		</logic:iterate> 
		  	 	</table>
