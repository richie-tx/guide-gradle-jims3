...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- attorneyNameSearch.jsp</title>
...
function checkInputs()
{
	...
	var shortDescRegExp = /[>?@~!<0-9]/;
	
	fld1 = document.getElementById("attorneyName");
	if (fld1.value > "") {
		if (shortDescRegExp.test(fld1.value,shortDescRegExp) == true) {
			if (msg == ""){
				fld1.focus();
			}
...
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);" onload="selectSingleAttorney()">
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|0">
<html:form action="/handleJuvenileDistrictCourtAttorneySearch"  target="content" focus="attorneyName">
<!-- BEGIN HEADING TABLE -->
...
<table width="100%">
	<tr>
    	<td>
            <ul>
                <li>Enter search criteria and then select "Find Attorney Search" button to perform search.</li>
				<li>To select a record click "Select" button.</li>
            </ul>
		</td>
	</tr> 
	<tr>
		<td class="required">&nbsp;Attorney Name is required for search.</td>
	</tr>
</table>
...
<%-- BEGIN SEARCH INPUT TABLE --%>					
						<table border="0" cellspacing='1' cellpadding="2" width="100%">
							<tr class='crtDetailHead'>
								<td colspan="2" class='crtDetailHead'><bean:message key="prompt.searchFor"/> <bean:message key="prompt.attorneyName"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"  width="1%" nowrap="nowrap"><bean:message key="prompt.2.diamond"/><bean:message key="prompt.attorneyName"/></td>
								<td class="formDe"><html:text name='courtHearingForm' property='attorneyName' size="30" maxlength="50" styleId="attorneyName"/></td>
							</tr>
							
							<tr>
								<td class="formDeLabel"></td>
								<td class="formDe">
									 <html:submit property="submitAction" onclick="return checkInputs();"><bean:message key="button.findAttorney"/></html:submit>		
...
<%-- END SEARCH INPUT TABLE --%>
						...
						<logic:notEmpty name="courtHearingForm" property="attorneyDataList">
<%-- BEGIN SEARCH RESULTS TABLE --%>						
							<table border="0" cellspacing='1' cellpadding="2" width="100%">
								<tr>
									<td align="center" style="padding:2px" colspan="2"><br>
										<bean:size id="collSize" name="courtHearingForm" property="attorneyDataList"/>
...
<%-- BEGIN SEARCH RESULTS LIST TABLE --%>									
										<table border="0" width="100%" cellspacing="1" cellpadding="2">				
											<tr bgcolor="#cccccc">
												<td width="1%"></td>
												<td class="subhead"><bean:message key="prompt.barNumber" /><jims2:sortResults beanName="courtHearingForm" results="attorneyDataList" primaryPropSort="barNum" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="1" /></td>
												<td class="subhead"><bean:message key="prompt.attorneyName" /><jims2:sortResults beanName="courtHearingForm" results="attorneyDataList" primaryPropSort="attyName" primarySortType="STRING" defaultSortOrder="ASC" sortId="2" /></td>
											</tr>
					                        ...
					                        <bean:define id="paginationResultsPerPage" type="java.lang.String"><bean:message key="pagination.recordsPerPage"/></bean:define>
					                         ...
					                         <%-- End Pagination header stuff --%>
			  								<logic:iterate id="offIndex" name="courtHearingForm" property="attorneyDataList" indexId="index">
                              					...
                              					<pg:item>
													...
													<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>" height="100%">
														...
														<td><bean:write name='offIndex' property='barNum'/></td>
														<td><bean:write name='offIndex' property='attyName'/></td>
													</tr>
												</pg:item>
