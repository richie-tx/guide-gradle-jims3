...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;-<bean:message key="title.juvenileProfile"/>&nbsp;- programReferralEventDetails.jsp</title>
...
<table width='100%'>
  <tr>
    <td align="center" class="header" ><bean:message key="title.juvenileCasework"/>&nbsp;- <bean:message key="title.juvenileProfile"/>&nbsp;- <bean:message key="prompt.program"/>&nbsp;<bean:message key="prompt.eventDetails"/></td>
  </tr>
</table>
<table width="100%">
	<tr><td>&nbsp;</td></tr>
	       ...
	       <td>
	     		 <table width='100%' border="0" cellpadding="4" cellspacing="1">
		   				...
		   				<tr>
		   					...
		   					<td class="formDe"><bean:write name="programReferralForm" property="currentServiceEvent.eventDate" formatKey="time.format.HHmm"/></td>
		   				</tr>
		   				<tr>
