...
<html:base />
<title><bean:message key="title.heading" /> - juvenileFacilityProfileSearch.jsp</title>
...
<script type="text/javascript" src="/<msp:webapp/>js/juvFacilityProfileSearch.js"></script>
...
<table width='100%'>
  <tr>
    <td align="center" class="header">Process Juvenile Facility Admission - Search Juvenile Records</td>
  </tr>
</table>
<%-- END HEADING TABLE --%>
...
<table align="center" width="98%" border="0" cellpadding="2" cellspacing="1"  class='borderTableBlue'>
   <tr>
     <td class='facDetailHead' width='1%' nowrap='nowrap' ><bean:message key="prompt.searchBy"/></td>
     <td class="facDetailHead">
...
<span id="juvenileName" class='visible'>
	<table align="center" width="98%" border="0" cellpadding="2" cellspacing="1" class='borderTableBlue'>
	  <tr>
	    <td class="facDetailHead" nowrap='nowrap' width="1%"><bean:message key="prompt.2.diamond"/><bean:message key="prompt.juvenileLastName" /></td>
	    <td class="facDetailHead" colspan="3"><html:text property="lastName" size="60" maxlength="75" styleId="lastName"/></td>
	  </tr>
	  
	  <tr>
	    <td class="facDetailHead" nowrap='nowrap' width="1%"><bean:message key="prompt.juvenileFirstName"/></td>
	    <td class="facDetailHead"><html:text property="firstName" size="50" maxlength="50" styleId="firstName"/></td>
	    
	    <td class="facDetailHead" nowrap='nowrap' width="1%"><bean:message key="prompt.race"/></td>
	    <td class="facDetailHead">
	  ...
	  <tr>
	    <td class="facDetailHead" nowrap='nowrap' width="1%"><bean:message key="prompt.juvenileMiddleName"/></td>
	    <td class="facDetailHead"><html:text property="middleName" size="50" maxlength="50" styleId="middleName"/></td>
	    
	    <td class="facDetailHead" nowrap='nowrap' width="1%"><bean:message key="prompt.sex"/></td>
	    <td class="facDetailHead">
...
<table align="center" width="98%" border="0" cellpadding="2" cellspacing="1"  class='borderTableBlue'>
  <tr>
     <td class="facDetailHead" nowrap='nowrap' width="1%"><bean:message key="prompt.2.diamond"/><bean:message key="prompt.dateOfBirth"/></td>
     <td class="facDetailHead"><html:text property="juvenileDOB" size="10" styleId="dateOfBirth"/></td> 	  
  </tr>
</table>
</span>
<%-- END INQUIRY TABLE --%>
...
<table align="center" width="98%" border="0" cellpadding="2" cellspacing="1"  class='borderTableBlue'>
 <tr>
	<td class="facDetailHead" nowrap width="1%"><bean:message key="prompt.2.diamond"/><bean:message key="prompt.ssn"/></td>
	<td class="facDetailHead">
	...
	<tr>
		<td align="center">
		  <html:submit property="submitAction"  styleId="submitBtn"> <bean:message key="button.submit" /></html:submit>&nbsp;
  		  <input type="button" onclick="goNav('/<msp:webapp/>displayJuvenileProfileSearch.do?isFacility=true')" value="<bean:message key='button.refresh'/>"/>
  		  &nbsp;
...
<span id="searchResults" class='visible'>
	<logic:equal name="juvenileProfileSearchForm" property="facilityAction" value="facilitySearchResults">	
		<html:hidden  property="facilityAction" value="facilitySearchResults" styleId="facilityAction"/> <!-- used for show/hide search results -->
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<%-- BEGIN TRAITS TABLE --%>
		    	<tiles:insert page="juvenileFacilityProfileSearchResults.jsp"> 
