...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- facilityTraitStatusUpdate.jsp</title>
...
<table width='98%' border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
	<tr>
		<td valign="top" class="facDetailHead" ><bean:message key="prompt.update" />&nbsp;<bean:message key="prompt.trait" /></td>
	</tr>
	<tr>
...
<table border="0" width="100%">
	<tr>
		<td align="center">
			...
			<logic:empty  name="juvenileTraitsForm" property="updateTraitsList" >
				<input type="button" name="finishBtn" value=<bean:message key="button.finish"/> disabled />
			</logic:empty>
