...
<title><bean:message key="title.heading"/>/facilityReferralTransferRecord.jsp</title>
...
<table width='100%'>
	<tr>
		<td align="center" class="header">Process Juvenile Facility Admission - Booking Transfer Record</td>
	</tr>
</table>
<%-- END HEADING TABLE --%>
...
<table width="98%" border="0">
	<tr>
		<td align="left">
			<ul>
				<li>Select the TransferTo Referral and Click the Next button.</li>
			</ul>
		</td>
	</tr>
</table>
...
<table width="99%" cellpadding="0" cellspacing="1" class='borderTableBlue'  align="center">		
	...
	<tr>
		<td valign="top">
			<table width="99%" cellpadding="0" cellspacing="1" class='borderTableBlue'  align="center" valign="top">	
				<tr class='facDetailHead'>
					<td  class='paddedFourPix' align='left' nowrap='nowrap'>Transfer From</td>									
				</tr>
				...
				<tr>									
					<td align="left">
						<table width="100%" cellpadding="2" cellspacing="1" border='0'>
							...
							<tr>
								<td width="15%" nowrap>
									<input type="radio" name="transferFromReferral" value='<bean:write name="admitReleaseForm" property="detResp.referralNumber"/>' disabled="true" id="transferFromReferral"/><bean:write  name="admitReleaseForm" property="detResp.referralNumber"/> 
								</td>
								<td width="20%" nowrap>
									<b><bean:write name="admitReleaseForm" property="petition"/></b>
								</td>
								<td width="50%" nowrap>
		...
		<td>
			<table width="99%" cellpadding="0" cellspacing="1" class='borderTableBlue'  align="center">	
				<tr class='facDetailHead'>
					<td  class='paddedFourPix' align='left' nowrap='nowrap'>Transfer To</td>									
				</tr>
				<logic:empty name="admitReleaseForm" property="referrals">
				<tr>
					<td>(No Referrals)</td>
					...
					<td align="left">
						<table width="100%" cellpadding="2" cellspacing="1" border='0'>
							<tr class='formDeLabel'>
								...
								<td align="left" nowrap>Assignment Date</td>											
							</tr>
							...
							<logic:iterate name="admitReleaseForm" property="referrals" id="juvRefsIter" indexId="refIndexer">   
								...
								<html:hidden name="admitReleaseForm" property="action" styleId='action'/>
								<tr>
									<td width="10%" align="left"  nowrap>
										<logic:equal name="juvRefsIter" property="hasCasefiles" value="true">
											<b><bean:write  name="juvRefsIter" property="referralNumber"/></b> 
										</logic:equal>
									...
									<logic:notEmpty  name="juvRefsIter" property="casefiles">
										<logic:iterate name="juvRefsIter" property="casefiles" id="casefilesIter" indexId="casefilesIndexer">
											<tr style="<% out.print( (casefilesIndexer.intValue() % 2 == 1) ? "background-color: #ffffff" : "background-color:#F5F6F8" );%>" height="100%">
												<td></td>
												<logic:present name="juvRefsIter" property="hasCasefiles">  
													<td width="5%" align="left" nowrap><input type="radio" name="transferToReferral"  value='<bean:write  name="juvRefsIter" property="referralNumber"/>-<bean:write  name="casefilesIter" property="supervisionNum"/>-<bean:write  name="juvRefsIter" property="mostSevereOffense.severitySubtype"/>' id="caseFileId"/><b><bean:write name="casefilesIter" property="supervisionNum"/></b></td>
												</logic:present>
												...
												<td></td>
												<td></td>
												<td width="10%" align="left" nowrap><bean:write name="casefilesIter" property="assignmentDate" formatKey="date.format.mmddyyyy"/></td>
											</tr>
										</logic:iterate>	
									</logic:notEmpty>
								</tr>
