...
<html:form action="/submitProgramReferral" target="content">
...
<table width='100%'>
	<tr>
    <td align="center" class="header" ><bean:message key="title.juvenileCasework" />&nbsp;-&nbsp;<bean:message key="title.create" />&nbsp;<bean:message key="prompt.programReferral" />&nbsp;<bean:message key="prompt.summary" /></td>
	</tr>
</table>
