										...
										<tr>
 											<td valign='top'>
												...
												<tr>
													...
													<td class='formDe'>
														<bean:write name="juvenileReferralForm"  property="juvenileNum"/>
													...
													<td class='formDe' colspan='3'>
														<bean:write name="juvenileReferralForm"  property="formattedName"/>
													...
													<td class='formDe' colspan='4'>
														<%-- <bean:write name="juvenileReferralForm" property="hispanic"/> --%>
														<logic:equal name="juvenileReferralForm" property="hispanic" value="true">Yes</logic:equal>
													</td>
												</tr>
											
												<tr>
													<td class='formDeLabel' width="1%" nowrap="nowrap"><bean:message key="prompt.currentAge"/></td>
													<td class='formDe'><bean:write name="juvenileReferralForm" property="age"/> 
													<td class='formDeLabel' width="1%"><bean:message key="prompt.race" /></td>
													<td class='formDe'><bean:write name="juvenileReferralForm" property="race"/></td>
													<td class='formDeLabel' width="1%" ><bean:message key="prompt.sex" /></td>
													<td class='formDe'><bean:write name="juvenileReferralForm" property="sex"/></td>
													<td class='formDeLabel'> <bean:message key="prompt.dob"/></td>
													<td class='formDe'><bean:write name="juvenileReferralForm" property="dateOfBirth" formatKey="date.format.mmddyyyy"/></td>														
		...
		<td align="center">	
			<logic:equal name="juvenileReferralForm" property="activateSupervision" value="Y">
		  	...
		  	<input type="button" id="createVopDetailsBtn" name="submitAction" value="<bean:message key="button.vopDetailsCreate"/>" 
												onclick="changeFormActionURL(this.form.name, 
												'/<msp:webapp/>displayJuvenileProfileReferralList.do?submitAction=Referrals&juvenileNum=<bean:write name='juvenileReferralForm' property='juvenileNum'/>', true);">
			</jims2:isAllowed>
		  	</logic:equal>
	...
	<tr>
		<td align="center">	
				...
				<input type="button" id="btnReturnReferralBriefing" name="submitAction" value="<bean:message key="button.returnToReferralBriefing"/>" 
												onclick="changeFormActionURL(this.form.name, 
												'/<msp:webapp/>displayJuvenileBriefingDetails.do?submitAction=referralLink&juvenileNum=<bean:write name='juvenileReferralForm' property='juvenileNum'/>', true);">
				<input type="button" id="btnReturnFacilityBriefing" name="submitAction" value="<bean:message key='button.returnToFacilityBriefing'/>" 
												onclick="changeFormActionURL(this.form.name, 
												'/<msp:webapp/>displayJuvenileProfileSearchResults.do?isFacility=true&searchType=JNUM&juvenileNum=<bean:write name='juvenileReferralForm' property='juvenileNum'/>', true);">
