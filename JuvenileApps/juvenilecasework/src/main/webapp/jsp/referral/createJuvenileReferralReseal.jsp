...
<html:base />
<title><bean:message key="title.heading" /> - createJuvenileReferralReseal.jsp</title>
...
$(document).ready(function(){	
	$("#btnReferralbreifing").click(function(){
		spinner();
	})	
	$("#btnFacilitybreifing").click(function(){
		spinner();
	})
})
</script>
...
<%--BEGIN FORM TAG--%>
<html:form action="/submitCreateReferral" target="content" >
...
<table width='100%'>
  <tr>
    <td align="center" class="header"> Process Referrals - Create Reseal Referral Record</td>
  </tr>
</table>
<%-- END HEADING TABLE --%>
...
<%-- BEGIN INSTRUCTION TABLE --%>
	<table width="98%" border="0">
		...
		<tr>
			<td>
				<ul>
					<li>To add RESEAL offense and create referral number, click the Add Referral button. </li>	
				    <li>To create an additional RESEAL offense and referral number, click Create Next Referral after completing the referral and assignment record. </li>				     
				</ul>
			</td>
		</tr>
...
<%-- BEGIN DETAIL TABLE --%>
						...
						<tr>
							<td colspan="2">
								...
								<tr>
									...
									<td class='formDe'><html:text property="newRefDate" size="10" maxlength="10" disabled="true"/></td>
									<td class='formDeLabel' nowrap='nowrap' width="5%"><bean:message key="prompt.2.diamond" /><bean:message key="prompt.referralSource"/></td>									
									<td class='formDe'>
										<html:select property="newRefSource" styleId="newRefSource" disabled="true">
									...
									<td class='formDe'>
										<html:select property="newRefIntakeDecision" styleId="newRefIntakeDecision" disabled="true">
									   	 	<html:option value="">
									...
									<td class='formDe'><html:text styleId="newRefIntakeDate" property="newRefIntakeDate" size="10" maxlength="10" disabled="true"/></td>
								</tr>
								</table>
							</td>
						</tr>
							...
							<td colspan="2">
								...
								<tr>
									...
									<td class='formDe' colspan= '4'>
										<html:select property="offenseCode" styleId="offenseCD">
											<html:optionsCollection property="offenseCodes" value="alphaCode" label="alphaCode" />
										</html:select>
									</td>
								...
								<tr>
									...
									<td class='formDe'><html:text name="juvenileReferralForm" property="offenseDate" size="8" maxlength="10" disabled="true"/></td>
									<td class='formDe' colspan= '4' valign='top'></td><td class='formDe' valign='top'></td>
								</tr>
								<tr>								
									<td class='formDeLabel' valign='top'  nowrap="nowrap" ><bean:message key="prompt.keymap"/> </td>
									<td class='formDe'><html:text styleId="keyMapLocation" property="referralOffenseBean.keyMapLocation" size="6" maxlength="6" disabled="true"/></td>									
									<td class='formDeLabel' colspan= '4' width="5%" ><bean:message key="prompt.investigation"/># </td> <td class='formDe'><html:text styleId="investigationNum" property="referralOffenseBean.investigationNum" size="10" maxlength="10" disabled="true"/></td>
								</tr>
								</table>
							</td>
						</tr>
					...
					<logic:notEmpty name="juvenileReferralForm" property="originalChargeReferrals">		              
					 <table width="100%" bgcolor="#cccccc" cellspacing="1">
							...
							<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
								...
								<td align="center" ><input type="radio" name="selectedValue" value="<bean:write name="referralList" property="referralNumber"/>" id="originalChargeRadio"></td>
					...
					<table width="100%" cellpadding="2" cellspacing="0" border='0'>
						...
						<tr>
							<td colspan="2">
								...
								<tr>
									...
									<td class='formDe'><html:text styleId="assignmentDateStr" property="assignmentDateStr" size="8" maxlength="10" disabled="true"/></td>
								</tr>
						...
						<tr>
								<td colspan="6" class="formDe">
									...
									<html:submit property="submitAction" onclick="spinner()"  styleId="createResealBtn"> <bean:message key="button.addReferral" /></html:submit>&nbsp;  				   			
						  		</div>
								</td>
							</tr>
	...
	<html:hidden styleId="message" name="juvenileReferralForm" property="updateMessage"/>
	<html:hidden styleId="refNumber" name="juvenileReferralForm" property="newRefNum"/>	
	...
	<tr>
		<td align="center">	
			<logic:equal name="juvenileReferralForm" property="activateSupervision" value="Y">
				<input type="button" name="submitAction" value="<bean:message key='button.activateIntakeSup'/>" 
		  	...
		  	<html:submit property="submitAction" onclick="spinner()"  styleId="createNextResealBtn"> <bean:message key="button.createNextReseal" /></html:submit>&nbsp;  	
		</td>
	</tr>
	<tr>
		<td align="center">	
				...
				<input type="button" id="btnReferralbreifing" name="submitAction" value="<bean:message key="button.returnToReferralBriefing"/>" 
												onclick="changeFormActionURL(this.form.name, 
				...
				<input type="button" id="btnFacilitybreifing" name="submitAction" value="<bean:message key='button.returnToFacilityBriefing'/>" 
												onclick="changeFormActionURL(this.form.name, 
