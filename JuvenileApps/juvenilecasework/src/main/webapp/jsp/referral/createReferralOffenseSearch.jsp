...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- createReferralOffenseSearch.jsp</title>
...
function checkInputs()
{
	...
	if (fld1.value > "") {
		if (alphaNumericRegExp.test(fld1.value,alphaNumericRegExp) == false) {
			...
			msg += "Category must be alphabetic character and/or numeric value.\n";
		}
	}
	if (msg == "") {
...
<html:form action="/handleProcessReferralsOffenseSearch"  target="content" focus="alphaCodeId">
<!-- BEGIN HEADING TABLE -->
  <div class="page-header">
            <h2>Process Referrals</h2>
...
<table width="100%">
	...
	<tr>		  
		<td align="center" class="errorAlert"><bean:write name='juvenileReferralForm' property='message' /></td>		  
	</tr>   	  
</table>
<!-- END ERROR TABLE  -->
...
<%-- BEGIN SEARCH INPUT TABLE --%>					
						<table border="0" cellspacing='1' cellpadding="2" width="100%">
							<tr class='referralDetailHead'>
								<td colspan="2" class='referralDetailHead'><bean:message key="prompt.searchFor"/> <bean:message key="prompt.offenses"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"><bean:message key="prompt.alpha"/> <bean:message key="prompt.code"/></td>
								<td class="formDe"><html:text name='juvenileReferralForm' property='alphaCodeId' size="6" maxlength="6" styleId="acId"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"  width="1%" nowrap="nowrap"><bean:message key="prompt.short"/> <bean:message key="prompt.description"/></td>
								<td class="formDe"><html:text name='juvenileReferralForm' property='shortDesc' size="30" maxlength="30" styleId="descId"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"><bean:message key="prompt.DPS"/> <bean:message key="prompt.code"/></td>
								<td class="formDe"><html:text name='juvenileReferralForm' property='dpsCodeId' size="8" maxlength="8" styleId="dpsId"/></td>
							</tr>
							<tr>
								<td class="formDeLabel">Category </td>
								<td class="formDe"><html:text name='juvenileReferralForm' property="categoryId" size="2" maxlength="2" styleId="catId"/></td>
							</tr>
							<tr>
...
<%-- END SEARCH INPUT TABLE --%>
						...
						<logic:notEmpty name="juvenileReferralForm" property="offenseResultList">
<%-- BEGIN SEARCH RESULTS TABLE --%>						
							<table border="0" cellspacing='1' cellpadding="2" width="100%">
								<tr>
									<td align="center" style="padding:2px" colspan="2"><br>
										<bean:size id="collSize" name="juvenileReferralForm" property="offenseResultList"/>
...
<%-- BEGIN SEARCH RESULTS LIST TABLE --%>									
										<table border="0" width="100%" cellspacing="1" cellpadding="2">				
											<tr bgcolor="#cccccc">
												<td width="1%"></td>
												<td class="subhead"><bean:message key="prompt.alpha" /> <bean:message key="prompt.code" /><jims2:sortResults beanName="juvenileReferralForm" results="offenseResultList" primaryPropSort="alphaCode" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="1" /></td>
												<td class="subhead"><bean:message key="prompt.short" /> <bean:message key="prompt.description" /><jims2:sortResults beanName="juvenileReferralForm" results="offenseResultList" primaryPropSort="shortDescription" primarySortType="STRING" defaultSortOrder="ASC" sortId="2" /></td>
												<td class="subhead"><bean:message key="prompt.DPS" /> <bean:message key="prompt.code" /><jims2:sortResults beanName="juvenileReferralForm" results="offenseResultList" primaryPropSort="dpsCode" primarySortType="STRING" defaultSortOrder="ASC" sortId="3" /></td>
												<td class="subhead">Category<jims2:sortResults beanName="juvenileReferralForm" results="offenseResultList" primaryPropSort="category" primarySortType="STRING" defaultSortOrder="ASC" sortId="4" /></td>
											</tr>
					                        ...
					                        <bean:define id="paginationResultsPerPage" type="java.lang.String"><bean:message key="pagination.recordsPerPage"/></bean:define>
					                         ...
					                         <%-- End Pagination header stuff --%>
			  								<logic:iterate id="offIndex" name="juvenileReferralForm" property="offenseResultList" indexId="index">
                              					...
                              					<pg:item>
													...
													<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>" height="100%">
														<td align="center">																																		
															<html:radio name="juvenileReferralForm" property="selectedValue" value='<%=offId%>' onclick="enableSelectButton();" />
														</td>
