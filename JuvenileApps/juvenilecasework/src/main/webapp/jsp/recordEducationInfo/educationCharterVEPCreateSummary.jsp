...
<%-- 10/27/2015 R Capestani #30818 MJCW: PROD Juv Profile > Education Tab > Add Traits / Select Casefile 2 Tiny Squares Showing (IE11 conversion) --%>
...
<html:base />
<title><bean:message key="title.heading"/> - educationCharterVEPCreateSummary.jsp</title>
...
<html:form action="submitVEPCreate" target="content">
...
<table width="100%">
  ...
  <logic:equal name="educationCharterDetailsForm" property="action" value="confirm">
	...
	<tr><td align="center" class="confirm">Vocational Education Information successfully added.</td></tr>
  </logic:equal>	
</table>
<!-- END HEADING TABLE -->
<!-- BEGIN ERROR TABLE -->
	...
	<tr>
		<td>
			<ul>
				...
				<li>Select Back button to return to Create Progam page.</li>
			</ul>
		</td>
	</tr>
  </table>
													   ...
													   <tr>
														  <td>
															<table border="0" cellpadding="2" cellspacing="1" width="100%" >
																<tr>
																	<td class="formDeLabel" width="1%" nowrap><bean:message key="prompt.program"/></td>
																	<td class="formDe"><bean:write name="educationCharterDetailsForm" property="vepProgramCode"/></td>
																</tr>
																<tr>
																	<td class="formDeLabel" width="1%" nowrap><bean:message key="prompt.startDate"/></td>
