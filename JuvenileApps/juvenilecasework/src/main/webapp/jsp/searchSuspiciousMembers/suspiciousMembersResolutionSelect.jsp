...
<html:base />
<title><bean:message key="title.heading" /> - suspiciousMembersResolutionSelect.jsp</title>

<%-- JAVASCRIPT FILES FOR THIS PAGE --%>
<script type='text/javascript' src="/<msp:webapp/>js/casework_util.js"></script>
<script type='text/javascript' src="/<msp:webapp/>js/app.js"></script>
<script type='text/javascript'>
function newSeperateWindow( tURL, windowName, width, height ) {
...
function validateSelect(btn)
{
	...
	alert("Member selection is required to " + btn + ".");
	return false;	
...
<body onKeyDown="return checkEnterKeyAndSubmit(event,true);" onload="checkResults()">
	...
	<table width="100%">
		<tr>
			<td class="header" align="center">
				<bean:message key="prompt.suspiciousMembers" /> - Resolution Selection
			</td>
		</tr>
	</table>
<%-- END HEADING TABLE --%>
			...
			<logic:iterate id="fmInfo" name="suspiciousMemberForm" property="familyMemberInfoList" >
				<tr>
					<td class='headerLabel' valign="bottom" width="1%" nowrap="nowrap">
						<input type="radio" name="selectedValue" value=<bean:write name="fmInfo" property="memberNum" /> id="fminfoId" > 
						<bean:message key="prompt.member" /> #
					</td>
					<td class='headerData'><a href="javascript:newSeperateWindow('/<msp:webapp/>displaySuspiciousMemberDetails.do?submitAction=Link&memberID=<bean:write name="fmInfo" property="memberNum" />', 'winName_<bean:write name="fmInfo" property="memberNum" />',600,525);"><bean:write name='fmInfo' property='memberNum' /></a></td>
					...
					<td class='headerData'><bean:write name="fmInfo" property="formattedSSN" /></td>
				</tr>	
				<tr>
					<td class='headerLabel'><bean:message key="prompt.gender" /></td>
					<td class='headerData'><bean:write name="fmInfo" property="sex" /></td>
					...
					<td class='headerData' colspan="3"><bean:write name="fmInfo" property="nationalityDesc" /></td>
				</tr>
			</logic:iterate>			
		</table>
...
<%-- BEGIN MATCHING MEMBERS TABLE --%>
	<table align="center" width="98%" border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
		<tr bgcolor='#f0f0f0'>
			<td class="detailHead" colspan="2">Matching Suspicious Members</td>
		</tr>
		<tr>
			<td align="center"> 
				<table width="100%" cellpadding="2" cellspacing="1"> 
					<logic:empty  name="suspiciousMemberForm" property="matchingMembersList" >
						<tr>
							<td>No Matching Suspicious Members found.</td>
							<td><input type="hidden" name="noMatches" value="" id="noMatId" />
						</tr>
					</logic:empty> 
					<logic:notEmpty  name="suspiciousMemberForm" property="matchingMembersList" >
						<tr class="formDeLabel">
							...
							<td class="subHead"><bean:message key="prompt.gender" /></td>
							<td class="subHead"><bean:message key="prompt.nationality" /></td>
							<td class="subHead"><bean:message key="prompt.ethnicity" /></td>
						...
						<%-- Begin Pagination item wrap --%>
	          			<pg:item>
							<tr class="<%out.print((index2.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
								<td width="1%"><input type="radio" name="selectedValue" value="<bean:write name='matchList' property='memberNum'/>" ></td>
								<td><a href="javascript:newSeperateWindow('/<msp:webapp/>displaySuspiciousMemberDetails.do?submitAction=Link&memberID=<bean:write name="matchList" property="memberNum" />', 'winName_<bean:write name="matchList" property="memberNum" />',600,525);"><bean:write name='matchList' property='memberNum' /></a></td>
						...
						<%-- BEGIN ASSOCIATED JUVENILES LIST TABLE FOR MATCHING SUSPICIOUS MEMBERS --%>
						<tr>
							<td colspan="8" >
								<table align="center" width="98%" border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
									<tr bgcolor='#f0f0f0'>
									...
									<tr>
										<td align="center"> 
											<table width="100%" cellpadding="2" cellspacing="1">
												<logic:empty  name="matchList" property="associatedJuveniles" >
													<tr>
														<td align="left">No Associated Juveniles found.</td>
													</tr>
												</logic:empty> 
												<logic:notEmpty  name="matchList" property="associatedJuveniles" >
													<tr class="formDeLabel">
														<td align="left" class="subHead"><bean:message key="prompt.juvenile#" /></td>
														<td align="left" class="subHead"><bean:message key="prompt.juvenileName" /></td>
														<td align="left" class="subHead"><bean:message key="prompt.race" /></td>
													...
													<logic:iterate id="juvSMList" name="matchList" property="associatedJuveniles" indexId="index1">
														<tr class="<%out.print((index1.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
															<td align="left"><a href="/<msp:webapp/>displayFamilyConstellationList.do?juvnum=<bean:write name="juvSMList" property="juvId" />">
																<bean:write name="juvSMList" property="juvId" />
																</a>
															</td>
															<td align="left"><bean:write name="juvSMList" property="juvName" /></td>
															<td align="left"><bean:write name="juvSMList" property="raceDesc" /></td>
															<td align="left"><bean:write name="juvSMList" property="dateOfBirth" formatKey="date.format.mmddyyyy" /></td>
															<td align="left"><bean:write name="juvSMList" property="ethnicityDesc" /></td>
															<td align="left"><bean:write name="juvSMList" property="sexDesc" /></td>
														</tr>
													</logic:iterate>
												</logic:notEmpty>	
											</table>
	...
	<%-- END ASSOCIATED JUVENILES LIST TABLE FOR MATCHING SUSPICIOUS MEMBERS  --%>			
...
<%-- BEGIN BUTTON TABLE --%>		
	<table align="center" border="0" width="100%">
		<tr>
			<td align="center">
				<html:submit property="submitAction" styleId="mergeButton" onclick="disableSubmit(this, this.form)">
					<bean:message key="button.merge" />
				</html:submit>
				<html:submit property="submitAction" styleId="correctButton" onclick="return validateSelect('Correct') && disableSubmit(this, this.form);">
					<bean:message key="button.correct" />
				</html:submit>
				<html:submit property="submitAction" styleId="removeFlagButton" onclick="return validateSelect('Remove Flag') && disableSubmit(this, this.form);">
					<bean:message key="button.removeFlag" />
				</html:submit>
				<html:submit property="submitAction" styleId="replaceButton" onclick="disableSubmit(this, this.form)">
