...
<html:base />
<title><bean:message key="title.heading" /> - suspiciousMembersConnectionConfirm.jsp</title>
...
<%-- BEGIN ERROR TABLE --%>
	<table width="98%" border="0" align="center">
		<tr>
			<td align="center">Suspicious Members Create Successfully</td>
		</tr>
	</table>
<%-- END ERROR TABLE --%>
		...
		<table width='98%' align="center" border='0' cellpadding='2' cellspacing='1' bgcolor='#cccccc'>		
			...
			<logic:iterate id="fmInfo" name="suspiciousMemberForm" property="familyMemberInfoList" >
				<tr>
					...
					<td class='headerData'><bean:write name='fmInfo' property='memberId' /></td>
						...
						<%-- Begin Pagination item wrap --%>
	          			<pg:item>
							<tr class="<%out.print((index2.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
								<td width="1%"></td>
								<td><bean:write name='matchList' property='memberId' /></td>
