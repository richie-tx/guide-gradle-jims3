...
<html:base />
<title><bean:message key="title.heading" /> - suspiciousMembersConnectSummary.jsp</title>
	...
	<table width="100%">
		<tr>
			<td class="header" align="center">
				<bean:message key="prompt.suspiciousMembers" /> - Connection Summary
			</td>
		</tr>
	</table>
<%-- END HEADING TABLE --%>
						...
						<%-- Begin Pagination item wrap --%>
	          			<pg:item>
							<tr class="<%out.print((index2.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
								<td width="1%"></td>
								<td><a href="javascript:newCustomWindow('/<msp:webapp/>displaySuspiciousMemberDetails.do?submitAction=Link&memberID=<bean:write name="matchList" property="memberId" />', 'winName',600,525);"><bean:write name='matchList' property='memberId' /></a></td>
								<td><bean:write name="matchList" property="fullNamelfm" /></td>
								<td nowrap="nowrap"><bean:write name="matchList" property="completeSSN" /></td>
								<td><bean:write name="matchList" property="sexDesc" /></td>
								<td><bean:write name="matchList" property="nationalityId" /></td>
...
<%-- BEGIN BUTTON TABLE --%>		
	<table align="center" border="0" width="100%">
		...
		<logic:notEmpty  name="suspiciousMemberForm" property="matchingMembersList" >
			<td align="center">
				<html:submit property="submitAction" styleId="nxtButton" onclick="disableSubmit(this, this.form)">
