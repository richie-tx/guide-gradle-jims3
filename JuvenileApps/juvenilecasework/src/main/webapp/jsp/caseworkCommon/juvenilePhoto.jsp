		...
		<td align='center'>
			<table width='100%' border="0" cellpadding="0" cellspacing="0">
				...
				<logic:notEqual name="juvenilePhotoForm" property="selectedValue" value="">
  				<tr>
						<td><img alt="Mug Shot Not Available" title="Juvenile Photo" src="/<msp:webapp/>getJuvenilePhoto.do?submitAction=Photo Detail" width="350" border='1' /></td>
					</tr>
					<tr>
						<td align='center'>&nbsp;</td>
					</tr>
				...
				<logic:equal name="juvenilePhotoForm" property="selectedValue" value="">
  				<logic:greaterThan name='juvenilePhotoForm' property='totalPhotosAvailable' value='1'>
    				<logic:iterate name="juvenilePhotoForm" property="allPhotos" id="photoIndex">
    					<tr>
    						<td width='1%'>&nbsp;<a href="/<msp:webapp/>getJuvenilePhoto.do?submitAction=Link&selectedValue=<bean:write name="photoIndex" property="photoName"/>"><img alt="Mug Shot Not Available" title="Juvenile Photo" src="/<msp:webapp/>getJuvenilePhoto.do?submitAction=Photo Thumbnail&selectedValue=<bean:write name='photoIndex' property='photoName'/>" width="128" border='1' /></a></td>
...
<logic:greaterThan name='juvenilePhotoForm' property='totalPhotosAvailable' value='1'>
  <logic:notEqual name="juvenilePhotoForm" property="selectedValue" value="">
  	...
  	<input id='backToButton' type='button' value="Back to All Photos" onclick="history.go(-1)" />
  </logic:notEqual>
</logic:greaterThan>	
