...
<logic:equal name="juvenilePhysicalCharacteristicsForm" property="action" value="summary">
    <input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|170">
</logic:equal>
<logic:equal name="juvenilePhysicalCharacteristicsForm" property="action" value="confirm">
    <input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|169">
</logic:equal>
...
<table width="98%">
	<tr>
		<td align="center" class="header">
    		<logic:equal name="juvenilePhysicalCharacteristicsForm" property="action" value="summary">
    			<bean:message key="title.juvenileCasework"/> - <bean:message key="title.juvenileProfile"/> - Create <bean:message key="title.physicalCharacter"/>&nbsp;Summary 
    		</logic:equal>
    		<logic:equal name="juvenilePhysicalCharacteristicsForm" property="action" value="confirm">			
    			<bean:message key="title.juvenileCasework"/> - <bean:message key="title.juvenileProfile"/> - Create <bean:message key="title.physicalCharacter"/>&nbsp;Confirmation   				
				<tr>
					<td class="confirm">Physical Characteristics successfully created.</td>
				</tr>
			</logic:equal>  	
    	</td>	  	   
  	</tr>  	
										...
										<tr>
											<td valign='top' align='center'>		
												...
												<table width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
													...
													<tr>
														<td class='formDeLabel' valign='top'><bean:message key="prompt.build" /></td>
														<td class='formDe' valign='top'><bean:write name="juvenilePhysicalCharacteristicsForm" property="build" /></td>
													</tr>
													<tr>
														<td class='formDeLabel'><bean:message key="prompt.height" /></td>
														<td class='formDe'><bean:write name="juvenilePhysicalCharacteristicsForm" property="heightFeet" />ft
															<bean:write name="juvenilePhysicalCharacteristicsForm" property="heightInch" />in
														</td>
													</tr>
													<tr>
														<td class='formDeLabel'><bean:message key="prompt.weight" /></td>
														<td class='formDe'><bean:write name="juvenilePhysicalCharacteristicsForm" property="weight" /></td>
													</tr>
													<tr>
													<td class='formDeLabel'  nowrap='nowrap'><bean:message key="prompt.hairColorCurrent"/></td>
														<td class='formDe'><bean:write name="juvenilePhysicalCharacteristicsForm" property="hairColor" /></td>
													</tr>
													<tr>
														<td class='formDeLabel' width='1%' nowrap='nowrap'><bean:message key="prompt.eyeColorContacts"/></td>
														<td class='formDe'><bean:write name="juvenilePhysicalCharacteristicsForm" property="eyeColor" /></td>
													</tr>
												</table>						
											...
											<table align='center'>
										  	<tr>
									    		<logic:equal name="juvenilePhysicalCharacteristicsForm" property="action" value="summary">
											    	...
											    	<td>
															<html:button property="button.back" styleId="physCharSummBack">
																<bean:message key="button.back"></bean:message>
															</html:button>
															<html:submit property="submitAction" styleId="physCharSummFinish">
