...
<title><bean:message key="title.heading" /> - juvenileProfileSSNUpdate.jsp</title>
...
<table width='100%'>
	<tr>
		<td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.juvenileProfile"/> - <bean:message key="prompt.SSN" /> <bean:message key="title.update" /></td>
	</tr>
</table>
<%-- END HEADING TABLE --%>
...
<%-- BEGIN MASTER INFO TABLE --%>
												<div class='spacer'></div>
	  											<table cellpadding='2' cellspacing='1' border='0' width="98%" class="borderTableBlue">
													...
													<tr>
														<td class='formDeLabel' valign="top" nowrap='nowrap' width="5%"><bean:message key="prompt.2.diamond" /><bean:message key="prompt.SSN" /></td>
