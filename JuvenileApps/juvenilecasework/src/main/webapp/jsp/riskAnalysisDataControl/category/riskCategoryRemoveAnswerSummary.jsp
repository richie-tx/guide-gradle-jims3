...
<html:base />
<title><bean:message key="title.heading" /> - riskCategoryRemoveAnswerSummary.jsp</title>
...
<%--BEGIN FORM TAG--%>
<html:form action="/submitRiskCategoryRemoveAnswer" target="content"> 
<input type="hidden" name="helpFile" value="">
<%-- BEGIN HEADING TABLE --%>
	<table width="100%">
		<tr>
			<td align="center" class="header" >
				<bean:message key="title.riskTotalCategories"/> - <bean:message key="prompt.remove"/> <bean:message key="prompt.answer"/>
				<logic:equal name="riskAnswerDeleteForm" property="pageType" value="summary">
					<bean:message key="prompt.summary"/>
				</logic:equal>
				<logic:equal name="riskAnswerDeleteForm" property="pageType" value="confirm">
		...
		<logic:equal name="riskAnswerDeleteForm" property="pageType" value="confirm">
			<tr>
		  		<td class=confirm>Category Answer(s) successfully removed.</td>
	  		</tr>
	 	</logic:equal>
	</table>
<%-- END HEADING TABLE --%>
	...
	<table width="98%" border="0">
		<tr>
			<td>
				<logic:equal name="riskAnswerDeleteForm" property="pageType" value="summary">
					<ul>
						<li>Remove an answer attached to an existing Question modifies the Category.</li>
  				...
  				<table width="100%" cellpadding="2" cellspacing="0">
            		<tr>
						<td class="detailHead">
							...
							Current <bean:message key="prompt.answer"/>s for <bean:write name="handleRiskQuestionDetailsSelectionForm" property="question.questionName" />
						</td>
 					</tr>
				</table>
...
<%-- END CURRENT ANSWERS BLOCK TABLE --%>
	<div class="spacer4px" ></div>
<%-- BEGIN REMOVED BLOCK TABLE --%>
	<table width="98%" border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
		<tr>
			<td class="detailHead">
				<logic:equal name="riskAnswerDeleteForm" property="pageType" value="summary">
					<bean:message key="prompt.answer"/> to be removed for <bean:write name="handleRiskQuestionDetailsSelectionForm" property="question.questionName" />
				</logic:equal>
				<logic:equal name="riskAnswerDeleteForm" property="pageType" value="confirm">
					<bean:message key="prompt.answer"/> removed for <bean:write name="handleRiskQuestionDetailsSelectionForm" property="question.questionName" />
				</logic:equal>	 
			</td>
		</tr>
		<tr>
...
<%-- BEGIN REMOVED ANSWERS LIST TABLE --%>
				<table width="100%" cellpadding="2" cellspacing="1" border="0" class="borderTableGrey">
					<logic:iterate id="raid" name="riskAnswerDeleteForm" property="removeAnswersList" >
			       		<tr>
							<td width="15%" class="formDeLabel"><bean:message key="prompt.entryDate"/></td>
							<td colspan="3" class="formDe">
								<bean:write name="raid" property="answerEntryDate" formatKey="datetime.format.mmddyyyyHHmm" />
								<html:hidden name="raid" property="answerEntryDate"/>
							 </td>
						</tr>					
				 		<tr>
							<td class="formDeLabel"><bean:message key="prompt.answerText"/></td>
							<td class="formDe" colspan="3"><bean:write name="raid" property="response" /></td>
						</tr>
			 	  		<tr>					
							<td width="15%" class="formDeLabel"><bean:message key="prompt.weight"/></td>
							<td width="35%" class="formDe"><bean:write name="raid" property="weight" /></td>
							<td width="20%" class="formDeLabel"><bean:message key="prompt.subordinateQuestion" />?</td>
							<td width="30%" class="formDe"><bean:write name="raid" property="subordinateQuestionName" /></td>     
						</tr>	
				 		<tr>
							<td class="formDeLabel"><bean:message key="prompt.sortOrder"/></td>
							<td class="formDe"><bean:write name="raid" property="sortOrder" /></td>
							<td class="formDeLabel"><bean:message key="prompt.action"/></td>
							<td class="formDe"><bean:write name="raid" property="action" /></td> 
						</tr> 
						<tr><td></td></tr>
		 			</logic:iterate> 	
				</table>
<%-- END REMOVED ANSWERS LIST TABLE --%>

			</td>
		</tr>
	</table>	
<%-- END REMOVED BLOCK TABLE --%>
	<div class="spacer4px"></</div>	
<%-- BEGIN BUTTONS TABLE --%>	    
	<table width="100%">
		<tr>
