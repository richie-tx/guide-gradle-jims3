...
<html:base />
<title><bean:message key="title.heading" /> - riskCategoryUpdateAnswerSummary.jsp</title>
...
<%--BEGIN FORM TAG--%>
<html:form action="/submitRiskCategoryUpdateAnswer" target="content"> 
	...
	<table width="100%">
		<tr>
			<td align="center" class="header" >
				...
				<logic:equal name="riskAnswerUpdateForm" property="pageType" value="summary">
					<bean:message key="prompt.summary"/>
				</logic:equal>
				<logic:equal name="riskAnswerUpdateForm" property="pageType" value="confirm">
		...
		<logic:equal name="riskAnswerUpdateForm" property="pageType" value="confirm">
			<tr>
		  		<td class=confirm>Category Answer successfully updated.</td>
	  		</tr>
	 	</logic:equal>
	</table>
<%-- END HEADING TABLE --%>
...
<%-- BEGIN UPDATE ANSWERS BLOCK TABLE --%>
	<table width="98%" border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
		<tr>
			<td class="detailHead">
				<logic:equal name="riskAnswerUpdateForm" property="pageType" value="summary">
					<bean:message key="prompt.answer"/> to be updated for <bean:write name="handleRiskQuestionDetailsSelectionForm" property="question.questionName" /> 
				</logic:equal>
				<logic:equal name="riskAnswerUpdateForm" property="pageType" value="confirm">
					<bean:message key="prompt.answer"/> updated for <bean:write name="handleRiskQuestionDetailsSelectionForm" property="question.questionName" /> 
				</logic:equal>	 
			</td>
		</tr>
		<tr>
			<td>	
<%-- BEGIN UPDATE ANSWERS TABLE --%>
				<table width="100%" cellpadding="2" cellspacing="1" border="0" class="borderTableGrey">
		        	<tr class="detailHead">
			 		...
			 		<tr>
						...
						<td class="formDe" colspan="3"><bean:write name="riskAnswerUpdateForm" property="currentAnswer.answerText" /></td>
					</tr>
		 	  		<tr>					
						<td width="15%" class="formDeLabel"><bean:message key="prompt.weight"/></td>
						<td width="35%" class="formDe"><bean:write name="riskAnswerUpdateForm" property="currentAnswer.weight" /></td>
						<td width="20%" class="formDeLabel"><bean:message key="prompt.subordinateQuestion" />?</td>
						<td width="30%" class="formDe"><bean:write name="riskAnswerUpdateForm" property="currentAnswer.subordinateQuestionName" /></td>     
					</tr>	
			 		<tr>
						<td class="formDeLabel"><bean:message key="prompt.sortOrder"/></td>
						<td class="formDe"><bean:write name="riskAnswerUpdateForm" property="currentAnswer.sortOrder" /></td>
						<td class="formDeLabel"><bean:message key="prompt.action"/></td>
						<td class="formDe"><bean:write name="riskAnswerUpdateForm" property="currentAnswer.action" /></td> 
					</tr>  
				</table>
