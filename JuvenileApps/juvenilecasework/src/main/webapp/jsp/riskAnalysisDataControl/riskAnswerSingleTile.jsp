...
<title><bean:message key="title.heading" /> - riskAnswerSingleTile.jsp</title>
...
<!-- BEGIN ANSWERS TABLE --> 
  <table width='98%' border="0" cellpadding="2" cellspacing="0" class=borderTableBlue> 
   <tr> 
      <td valign=top class=detailHead colspan=4><bean:write name="answerBoxTitle"/></td> 
   </tr> 
   <tr> 
      <td colspan=4 class=bodyText> 
	    ...
	    <tiles:insert page="riskAnswerInnerSingleTile.jsp" flush="true">
