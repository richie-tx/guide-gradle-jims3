...
<html:base />
<title><bean:message key="title.heading" /> - riskQuestionCreateSummary.jsp</title>
...
<%--BEGIN FORM TAG--%>
<html:form action="/submitRiskQuestionCreate"> 

<input type="hidden" name="helpFile" value="">
  <!-- BEGIN HEADING TABLE -->
  <table width="100%">
    <tr>
      <td align="center" class="header" ><bean:message key="title.riskQuestions"/> - <bean:message key="title.create"/>&nbsp;<bean:message key="prompt.question"/> Summary</td>
    </tr>
  </table>
  <!-- END HEADING TABLE -->
    ...
    <tr>
      <td>
        <ul>
          ...
          <li>Select Finish button to save Risk Question & Answer(s). </li>
        </ul>
      </td>
    </tr>
