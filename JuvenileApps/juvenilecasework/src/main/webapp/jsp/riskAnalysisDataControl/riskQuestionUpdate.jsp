...
<%-- 04/23/2012		CShimek		#73272 revised onload scripting and removed unneeded timeout.js --%>
...
<html:base />
<title><bean:message key="title.heading" /> - riskQuestionUpdate.jsp</title>
...
<%--BEGIN FORM TAG--%> 
<html:form action="/displayRiskQuestionUpdate" target="content" focus="question.questionName">
	<input type="hidden" name="helpFile" value="">
<%-- BEGIN HEADING TABLE --%>
	<table width="100%">
		<tr>
			<td align="center" class="header" ><bean:message key="title.riskQuestions"/> - <bean:message key="title.update"/>&nbsp;<bean:message key="prompt.question"/> </td>
		</tr>
	</table>
<%--- END HEADING TABLE --%>
<%-- BEGIN ERROR TABLE --%>
