...
<html:base />
<title><bean:message key="title.heading"/> - riskAnswerUpdateConfirmation.jsp</title>
...
<html:form action="/submitRiskAnswerUpdate" target="content">
...
<!-- BEGIN HEADING TABLE -->
  <table width="100%">
    <tr>
      <td align="center" class="header" ><bean:message key="title.riskQuestions"/> - <bean:message key="prompt.update"/>&nbsp;<bean:message key="prompt.answer"/> Confirmation</td>
    </tr>
    <tr id='confirmMessage'>
	  <td class=confirm>Answer(s) successfully updated.</td>
	</tr>
  </table>
  <!-- END HEADING TABLE -->
  ...
  <bean:define id="answerUpdateTitle" toScope="page">
  	Answer Updated
  </bean:define>
  ...
  <tiles:insert page="riskAnswerSingleTile.jsp" flush="true">
  	<tiles:put name="formName" type="String" value="${form}" />
  	<tiles:put name="answerBoxTitle" type="String" value="${answerUpdateTitle}" />
  </tiles:insert>
  <%-- END UPDATE ANSWERS TABLE --%>
