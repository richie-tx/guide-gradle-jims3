...
<html:base />
<title><bean:message key="title.heading" /> - riskFormulaActivateSummary.jsp</title>
...
<html:form action="/submitRiskFormulaActivate" target="content">
	...
	<table width="100%">
		<tr>
			<td align="center" class="header" >
				<bean:message key="title.riskFormulas"/> - <bean:message key="prompt.formula"/>&nbsp;<bean:message key="prompt.activate"/>
...
<%-- END INSTRUCTION TABLE --%>
	<logic:equal name="riskFormulaDetailsForm" property="pageType" value="summary">
		<logic:notEqual name="riskFormulaDetailsForm" property="activationDateStr" value="">
			<bean:define id="boxTitle" value="Formula to be Deactivated" toScope="page"/>
		</logic:notEqual>
		<logic:equal name="riskFormulaDetailsForm" property="activationDateStr" value="">
			<bean:define id="boxTitle" value="Formula to be Activated" toScope="page"/>
		</logic:equal>
	</logic:equal>
	<logic:equal name="riskFormulaDetailsForm" property="pageType" value="confirm">
		<logic:notEqual name="riskFormulaDetailsForm" property="activationDateStr" value="">
			<bean:define id="boxTitle" value="Formula Deactivated" toScope="page"/>
		</logic:notEqual>
		<logic:equal name="riskFormulaDetailsForm" property="activationDateStr" value="">
			<bean:define id="boxTitle" value="Formula Activated" toScope="page"/>
		</logic:equal>
	</logic:equal>	
	...
	<tr>
		<td align="center">
			<logic:equal name="riskFormulaDetailsForm" property="pageType" value="summary">
				...
				<html:submit property="submitAction" onclick="disableSubmit(this,this.form)"><bean:message key="button.confirmActivation" /></html:submit>
				<html:submit property="submitAction" onclick="disableSubmit(this,this.form)"><bean:message key="button.cancel"/></html:submit>
			</logic:equal>
			<logic:equal name="riskFormulaDetailsForm" property="pageType" value="confirm">
				<html:submit property="submitAction" onclick="disableSubmit(this,this.form)"><bean:message key="button.formulaSearchResults"/></html:submit>
			</logic:equal>	
		</td>
	</tr>
</table>
