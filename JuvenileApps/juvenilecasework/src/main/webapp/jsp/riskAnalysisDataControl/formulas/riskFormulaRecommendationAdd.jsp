...
<html:base />
<title><bean:message key="title.heading" /> - riskFormulaRecommendationAdd.jsp</title>
...
<html:form action="/displayRiskFormulaRecommendationAddSummary" target="content" focus="recommendationName">
<span align="center">
<%-- BEGIN HEADING TABLE --%>
	<table width="100%">
		<tr>
