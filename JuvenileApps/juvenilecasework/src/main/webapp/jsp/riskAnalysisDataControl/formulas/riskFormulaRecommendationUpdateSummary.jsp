...
<html:base />
<title><bean:message key="title.heading" /> - riskFormulaRecommendationUpdateSummary.jsp</title>
...
<html:form action="/submitRiskFormulaRecommendationUpdate" target="content">
<span align="center">
<%-- BEGIN HEADING TABLE --%>
	<table width="100%">
		<tr>
	...
	<table width="98%" border="0">
		<tr>
			<td>
				<logic:equal name="riskFormulaRecommendationForm" property="pageType" value="summary">
					<ul>
						<li>Select Finish button to save recommendation updates.</li>
