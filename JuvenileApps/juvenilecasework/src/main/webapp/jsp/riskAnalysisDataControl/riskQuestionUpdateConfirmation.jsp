...
<html:base />
<title><bean:message key="title.heading" /> - riskQuestionUpdateConfirmation.jsp</title>
...
<input type="hidden" name="helpFile" value="">
  ...
  <table width="100%">
    <tr>
      <td align="center" class="header" ><bean:message key="title.riskQuestions"/> - <bean:message key="title.update"/>&nbsp;<bean:message key="prompt.question"/> Confirmation</td>
    </tr>
    <tr id='confirmMessage'>
	  <td class=confirm>Question successfully updated.</td>
	</tr>
  </table>
  <!-- END HEADING TABLE -->
