...
<html:base />
<title><bean:message key="title.heading"/> - riskQuestionAddAnswerSummary.jsp</title>
...
<!-- BEGIN HEADING TABLE -->
  <table width="100%">
    <tr>
      <td align="center" class="header" ><bean:message key="title.riskQuestions"/> - <bean:message key="prompt.add"/>&nbsp;<bean:message key="prompt.answer"/> Summary</td>
    </tr>
  </table>
  <!-- END HEADING TABLE -->
  ...
  <bean:define id="answerAddTitle" toScope="page">
  	Answer to be Added
  </bean:define>
  ...
  <tiles:insert page="riskAnswersTile.jsp" flush="true">
    <tiles:put name="formName" type="String" value="${form}" />
  	...
  	<tiles:put name="showAnswerRadioButtons" type="String" value="false" />
  	<tiles:put name="showAnswerNameAsReferenceLinks" type="String" value="false" />
  	<tiles:put name="answerBoxTitle" type="String" value="${answerAddTitle}" />
  </tiles:insert>
