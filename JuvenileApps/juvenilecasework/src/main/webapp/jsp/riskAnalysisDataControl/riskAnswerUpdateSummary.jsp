...
<html:base />
<title><bean:message key="title.heading"/> - riskAnswerUpdateSummary.jsp</title>
...
<!-- BEGIN HEADING TABLE -->
  <table width="100%">
    <tr>
      <td align="center" class="header" ><bean:message key="title.riskQuestions"/> - <bean:message key="prompt.update"/>&nbsp;<bean:message key="prompt.answer"/> Summary</td>
    </tr>
  </table>
  <!-- END HEADING TABLE -->
