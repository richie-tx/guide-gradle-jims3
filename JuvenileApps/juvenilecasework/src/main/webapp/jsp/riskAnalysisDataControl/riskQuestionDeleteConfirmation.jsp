...
<html:base />
<title><bean:message key="title.heading"/> - riskQuestionDeleteConfirmation.jsp</title>
...
<table width="100%">
  <tr>
    <td align="center" class="header" ><bean:message key="title.riskQuestions"/> - <bean:message key="prompt.delete"/>
                                       <bean:message key="prompt.question"/>&nbsp;<bean:message key="title.confirmation"/></td>
  </tr>
  <tr id='confirmMessage'>
	  <td class=confirm>Question successfully deleted.</td>
  </tr>
</table>
<!-- END HEADING TABLE -->
<!-- BEGIN ERROR TABLE -->
...
<div class="spacer"></div>
  <table border="0" width="100%">
    <tr>
      <td align="center"><html:submit property="submitAction"><bean:message key="button.questionSearch"/></html:submit></td>
    </tr>
  </table>
