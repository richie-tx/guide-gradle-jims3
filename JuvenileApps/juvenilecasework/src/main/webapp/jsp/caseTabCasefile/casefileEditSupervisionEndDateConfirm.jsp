...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|49">
...
<table width='100%'>
	<tr>
		<td align="center" class="header">
			...
			<bean:message key="title.update"/> Expected End Date <bean:message key="title.confirmation"/>
		</td>
	</tr>   
	<tr>
		<td align="center" class="confirm">Expected End Date has been updated.</td>
	</tr> 
</table>
<%-- END HEADING TABLE --%>
<%--header start--%>
...
<%-- BEGIN BUTTON TABLE --%>
									<table border="0" width="100%">
										<tr>
											<td align="center">
												<input type="button" value="<bean:message key='button.returnToCasefile'/>" onClick="goNav('/<msp:webapp/>displayJuvenileCasefileDetails.do?casefileId=<bean:write name="juvenileCasefileForm" property="supervisionNum"/>')">
											</td>
										</tr>
									</table>
<%-- END BUTTON TABLE --%>
