...
<html:base />
<title><bean:message key="title.heading" /> - facilityCurrentPopulationReport.jsp</title>
...
$(document).ready(function(){	
	$("#printBtn").click(function(){
		spinner();
		$.ajax({
	        url: '/JuvenileCasework/displayFacilityCurrentPopulationReport.do?submitAction=Print',
	        type: 'post',
	        data: $('form#facilityCurrentPopulationReport').serialize(),
	...
	$("#guardianDetPrintBtn").click(function(){
		spinner();		
		$.ajax({
	        url: '/JuvenileCasework/displayFacilityCurrentPopulationReport.do?submitAction=Guardian Detail Print',
	        type: 'post',
	        data: $('form#facilityCurrentPopulationReport').serialize(),
	        success: function(data, textStatus , xhr) {
	         	if (200 == xhr.status){
...
function findInfo()
{
	var forwardURL = "/<msp:webapp/>displayFacilityCurrentPopulationReport.do?submitAction=Submit";	
...
<%--BEGIN FORM TAG--%>
<html:form styleId="facilityCurrentPopulationReport" action="/displayFacilityCurrentPopulationReport" target="content" focus="facilityId" >
...
<table width='100%'>
  <tr>
    <td align="center" class="header">
    	...
    	<bean:message key="prompt.facility"/> <bean:message key="prompt.current"/> Population Report
    </td>
  </tr>
  	<%-- <tr>
	...
	<table align="center" width="98%" border="0" cellpadding="2" cellspacing="1" class='borderTableBlue'>
		<tr>
			...
			<td class="detailHead"><bean:message key="prompt.dob" />
				<jims2:sortResults beanName="juvenilePopulationForm" results="currentPopulations" primaryPropSort="juvenileDateOfBirth" primarySortType="DATE" secondPropSort="firstName" secondarySortType="STRING" finalPropSort="juvenileDateOfBirth" finalSortType="STRING" defaultSortOrder="ASC" sortId="11" />
			</td>
			...
			<td class="detailHead"><bean:message key="prompt.day" />s <bean:message key="prompt.in" />
				<jims:sortResults beanName="juvenilePopulationForm" results="currentPopulations" primaryPropSort="diffInDays" primarySortType="INT" defaultSortOrder="ASC" sortId="7" />
				</td>
				<td class="detailHead"><bean:message key="prompt.riskneeds"/>
				<jims:sortResults beanName="juvenilePopulationForm" results="currentPopulations" primaryPropSort="riskneedLvl" primarySortType="STRING" defaultSortOrder="ASC" sortId="4" />
				</td> 
		</tr>
		...
		<%-- Begin Pagination item wrap --%>
			...
			<tr>
				<td align="left">
						<a onclick="spinner()" href="/<msp:webapp/>displayJuvenileProfileSearchResults.do?juvenileNum=<bean:write name="tots" property="juvenileNum"/>&searchType=JNUM">
				...
				<td align="left"><bean:write name="tots" property="juvenileDateOfBirth"/></td>
				...
				<%-- <td align="left"><bean:write name="tots" property="diffInDays"/></td>  --%>
				<logic:notEqual name="tots" property="riskneedLvl" value="">
				<td align="left"><span title='<bean:write name="tots" property="riskLvlDesc"/>'><bean:write name="tots" property="riskLvl"/></span>/<span title='<bean:write name="tots" property="needsLvlDesc"/>'><bean:write name="tots" property="needsLvl"/></span></td>					
				</logic:notEqual>
			</tr>
			</pg:item>
...
<table align="center" border="0" width="100%">
	<tr>
		<td align="center">
			...
			<html:submit styleId="guardianDetPrintBtn" property="submitAction"><bean:message key="button.guardianPrint" /></html:submit>
		</td>
	</tr>
</table>
<%-- END BUTTON TABLE --%>
