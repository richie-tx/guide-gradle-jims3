...
<html:base />
<title><bean:message key="title.heading" /> - commonAppScreeningProfileSummary.jsp</title>
                  					...
                  					<table width='100%' border="0" cellpadding="0" cellspacing="0" class="borderTableRed">
                      					...
                      					<td valign=top align=center>
                        					...
                        					<table width='98%' border="0" cellpadding="0" cellspacing="0" >
                        						<tr>
                        							<td valign=top>
                        								<logic:equal name="commonAppForm" property="reportType"value="CASP">
														<!--tabs start-->
														<tiles:insert page="../caseworkCommon/commonAppExitReportTabs.jsp" flush="true">
															<tiles:put name="tabid" value="screeningProfile"/>
															<tiles:put name="casefileid" value='<%= request.getParameter(PDJuvenileCaseConstants.CASEFILEID_PARAM) %>' />
														</tiles:insert>	
														<!--tabs end-->
														</logic:equal>
                                	...
                                	<td align="center">
                                  	<logic:notEqual name="commonAppForm" property="action" value="<%=naming.UIConstants.CONFIRM_UPDATE%>">
                                				<html:submit property="submitAction"><bean:message key="button.back"/></html:submit>
                                		 		<input type="button" onclick="changeFormActionURL('/<msp:webapp/>displayCommonAppExitReportDetails.do?submitAction=Link&reportType=CAFD',false);return disableSubmit(this, this.form);" value="Save and Continue">
