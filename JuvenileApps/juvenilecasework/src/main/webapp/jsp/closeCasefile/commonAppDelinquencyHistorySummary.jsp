...
<html:base />
<title><bean:message key="title.heading" /> - commonAppDelinquencyHistorySummary.jsp</title>
                              	...
                              	<tr>
                                	<td align="center">
                                  	<logic:notEqual name="commonAppForm" property="action" value="<%=naming.UIConstants.CONFIRM_UPDATE%>">
                                				...
                                				<input type="button" onclick="changeFormActionURL('/<msp:webapp/>displayCommonAppExitReportDetails.do?submitAction=Link&reportType=CASN',false);return disableSubmit(this, this.form);" value="Save and Continue">
