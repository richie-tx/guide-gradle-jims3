...
<%-- 10/26/2012 C Shimek 	Remove erroneous "<" displaying on page, found while testing defect 73991. --%>
<%-- 07/02/2013 R Young		#74852 RapidSpellWeb file changesV3.2.0 for JUV. --%>
...
<html:base />
<title><bean:message key="title.heading" /> - commonAppExitReportUpdate.jsp</title>
...
/* callback function for the 'spell check' button
   this function will spell check all textarea
	 fields on this form, using a single button.
*/
function runSpellCheck()
{
  alert( 'Spell Check complete for all fields (demo only)' );
/* **** currently commented out until all the fields show up on the form
   **********************************************************************
  var rswlCntrls = ["spellLaunch1","spellLaunch2", "spellLaunch3"];
        								...
        								<tr>
      										<td valign='top'>
      											<tiles:insert page="../caseworkCommon/commonAppFormTabs.jsp" flush="true">
													<tiles:put name="tabid" value="commonAppReport"/>
													<tiles:put name="casefileid" value='<%= request.getParameter(PDJuvenileCaseConstants.CASEFILEID_PARAM) %>' />
  												</tiles:insert>	
            								</td>
                    					</tr>
...
<%-- BEGIN BUTTON TABLE --%>
															<table border="0" width="100%">
																<%-- <logic:equal name="juvenileCasefileForm" property="juvUnder21" value="true">
																	<tr>
																		<td align="center">
																			<input type='button' onclick="runSpellCheck();" value="Spell Check All Text Fields" />
																		</td>
																	</tr>
																</logic:equal>--%>	
																<tr>
