                        						...
                        						<tr>
                        							<td valign=top>
														...
														<tiles:insert page="../caseworkCommon/commonAppExitReportTabs.jsp" flush="true">
															<tiles:put name="tabid" value="facilityDetails"/>
															<tiles:put name="casefileid" value='<%= request.getParameter(PDJuvenileCaseConstants.CASEFILEID_PARAM) %>' />
														</tiles:insert>	
														<!--tabs end-->
                        							</td>
                              	...
                              	<tr>
                                	<td align="center">
                                  	<logic:notEqual name="commonAppForm" property="action" value="<%=naming.UIConstants.CONFIRM_UPDATE%>">
                                				...
                                				<input type="button" onclick="changeFormActionURL('/<msp:webapp/>displayCommonAppExitReportDetails.do?submitAction=Link&reportType=CASA',false);return disableSubmit(this, this.form);" value="Save and Continue">
