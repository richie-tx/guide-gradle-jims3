...
<html:base />
<title><bean:message key="title.heading" /> - commonAppSubstanceAbuseHistorySummary.jsp</title>
                        						...
                        						<tr>
                        							<td valign=top>
														...
														<tiles:insert page="../caseworkCommon/commonAppExitReportTabs.jsp" flush="true">
															<tiles:put name="tabid" value="substanceAbuseHistory"/>
															<tiles:put name="casefileid" value='<%= request.getParameter(PDJuvenileCaseConstants.CASEFILEID_PARAM) %>' />
														</tiles:insert>	
														<!--tabs end-->
                        							</td>
                                	...
                                	<td align="center">
                                  	<logic:notEqual name="commonAppForm" property="action" value="<%=naming.UIConstants.CONFIRM_UPDATE%>">
                                				<html:submit property="submitAction"><bean:message key="button.back"/></html:submit>
                                		 		<input type="button" onclick="changeFormActionURL('/<msp:webapp/>displayCommonAppExitReportDetails.do?submitAction=Link&reportType=CAFH',false);return disableSubmit(this, this.form);" value="Save and Continue">
