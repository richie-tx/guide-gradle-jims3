...
<%-- Used to display transferred offenses listing off Transferred Offenses tab in Juvenile Profile --%>
<%--MODIFICATIONS --%>
...
<title><bean:message key="title.heading"/> - juvTabReferral - transferredOffensesList.jsp</title>
...
<table width='100%'> 
	<tr> 
		<td align="center" class="header" >Juvenile Casework - Juvenile Profile - Transferred Offenses List</td> 
	</tr> 
	<tr>
...
<%-- End Pagination item wrap --%>
							    					...
							    					<logic:empty name="transferredOffenseForm" property="existingTransferredOffensesList">
							    						<tr>
							    							<td colspan='7' align="left">No Transfered Offenses found for this casefile.</td>
							    						</tr>
							    					</logic:empty>
								         		</table> 
