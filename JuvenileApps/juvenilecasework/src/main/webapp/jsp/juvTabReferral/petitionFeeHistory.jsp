...
<%-- 07/11/2012 CShimek		removed onload() causing js error --%>
...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|434">

<!-- BEGIN HEADING TABLE -->
<table width='100%'>
   <tr>
    <td align="center" class="header" >Juvenile Casework - Juvenile Profile - Fee Payment History</td>
  </tr>
</table>
<!-- END HEADING TABLE -->
