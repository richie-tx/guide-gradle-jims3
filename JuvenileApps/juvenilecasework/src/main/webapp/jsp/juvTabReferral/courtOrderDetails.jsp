<!DOCTYPE HTML>
<%--MODIFICATIONS --%>
<%-- 08/10/2007	Uma Gopinath Create JSP --%>
...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|430">

<!-- BEGIN HEADING TABLE -->
<table width='100%'>
  <tr>
    <td align="center" class="header">Juvenile Casework - Juvenile Profile - Court Orders</td>
  </tr>
</table>
<!-- END HEADING TABLE -->
	               							...
	               							<table cellpadding="2" cellspacing="1" width='100%'>
                								...
                								<logic:notEmpty name="petitionDetailsForm" property="courtOrders"> 
									                  ...
									                  <td valign="top"><bean:message key="prompt.offense"/></td>		                
																	...
																	<logic:iterate indexId="index" id="resultsIndex" name="petitionDetailsForm" property="courtOrders">					                    
