<!DOCTYPE HTML>
<!-- User selects the "Search for Offense Code" on VOP Create page -->
<%--MODIFICATIONS --%>
<%--06/30/2023 NMathew CREATE JSP --%>
...
<table width="100%">
	<tr>
		<td align="center" class="header">
			Juvenile Casework - Juvenile Profile - Violation of Probation - Search Offense
		</td>
	</tr>
</table>
<!-- END HEADING TABLE -->
...
<table width="100%">
	...
	<tr>		  
		<td align="center" class="errorAlert"><bean:write name='vopOffenseForm' property='errMessage' /></td>		  
	</tr>   	  
</table>
<!-- END ERROR TABLE  -->
<html:form action="/handleJuvenileVOPOffenseSearch"  target="content" focus="alphaCodeId">
...
<%-- BEGIN SEARCH INPUT TABLE --%>					
						<table border="0" cellspacing='1' cellpadding="2" width="100%">
							...
							<tr>
								...
								<td class="formDe"><html:text name='vopOffenseForm' property='alphaCodeId' size="6" maxlength="6" styleId="acId"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"  width="1%" nowrap="nowrap"><bean:message key="prompt.short"/> <bean:message key="prompt.description"/></td>
								<td class="formDe"><html:text name='vopOffenseForm' property='shortDesc' size="30" maxlength="30" styleId="descId"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"><bean:message key="prompt.DPS"/> <bean:message key="prompt.code"/></td>
								<td class="formDe"><html:text name='vopOffenseForm' property='dpsCodeId' size="8" maxlength="8" styleId="dpsId"/></td>
							</tr>
							<tr>
								<td class="formDeLabel"><bean:message key="prompt.severityLevel"/> </td>
								<td class="formDe"><html:text name='vopOffenseForm' property="categoryId" size="2" maxlength="2" styleId="catId"/></td>
							</tr>
							<tr>
...
<%-- END SEARCH INPUT TABLE --%>
						...
						<logic:notEmpty name="vopOffenseForm" property="offenseResultList">
<%-- BEGIN SEARCH RESULTS TABLE --%>						
							<table border="0" cellspacing='1' cellpadding="2" width="100%">
								<tr>
									<td align="center" style="padding:2px" colspan="2"><br>
										<bean:size id="collSize" name="vopOffenseForm" property="offenseResultList"/>
...
<%-- BEGIN SEARCH RESULTS LIST TABLE --%>									
										<table border="0" width="100%" cellspacing="1" cellpadding="2">				
											<tr bgcolor="#cccccc">
												<td width="1%"></td>
												<td class="subhead"><bean:message key="prompt.alpha" /> <bean:message key="prompt.code" /><jims2:sortResults beanName="vopOffenseForm" results="offenseResultList" primaryPropSort="alphaCode" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="1" /></td>
												<td class="subhead"><bean:message key="prompt.short" /> <bean:message key="prompt.description" /><jims2:sortResults beanName="vopOffenseForm" results="offenseResultList" primaryPropSort="shortDescription" primarySortType="STRING" defaultSortOrder="ASC" sortId="2" /></td>
												<td class="subhead"><bean:message key="prompt.DPS" /> <bean:message key="prompt.code" /><jims2:sortResults beanName="vopOffenseForm" results="offenseResultList" primaryPropSort="dpsCode" primarySortType="INTEGER" defaultSortOrder="ASC" sortId="3" /></td>
												<td class="subhead"><bean:message key="prompt.severityLevel" /><jims2:sortResults beanName="vopOffenseForm" results="offenseResultList" primaryPropSort="category" primarySortType="STRING" defaultSortOrder="ASC" sortId="3" /></td>
											</tr>
					                        ...
					                        <bean:define id="paginationResultsPerPage" type="java.lang.String"><bean:message key="pagination.recordsPerPage"/></bean:define>
					                         ...
					                         <%-- End Pagination header stuff --%>
			  								<logic:iterate id="offIndex" name="vopOffenseForm" property="offenseResultList" indexId="index">
                              					...
                              					<pg:item>
													...
													<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>" height="100%">
														<td align="center">																																		
															<html:radio name="vopOffenseForm" property="selectedValue" value='<%=offId%>' onclick="enableSelectButton();" />
														</td>
