...
<title><bean:message key="title.heading"/> - juvenileDrugTestingConfirmation.jsp</title>
...
<table width="98%">
  	<tr>
    	<td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.juvenileProfile"/> - Create Drug/Substance Testing - Confirmation</td>	  	    	 
  	</tr>  	
</table>
<%-- END HEADING TABLE --%>
<br>
