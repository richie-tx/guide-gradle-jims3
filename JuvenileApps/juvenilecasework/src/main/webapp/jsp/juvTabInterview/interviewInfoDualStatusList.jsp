...
<title><bean:message key="title.heading"/> - interviewInfoDualStatusList.jsp</title>
...
<table width="98%">
  <tr>
    <td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.juvenileProfile"/> - Dual Status List</td> 
  </tr>  	
</table>
<%-- END HEADING TABLE --%>
...
<table width="98%" border="0">
  <tr>
    <td>
      <ul>
        <li>Click on hyperlinked Entry Date to see dual status detail.</li>
      </ul>
    </td>
  </tr>
</table>
                  ...
                  <pg:pager index="center" maxPageItems="<%=Integer.parseInt(paginationResultsPerPage)%>"
                    ...
                    <%-- End Pagination header stuff --%>											
          						<table width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">				
            						...
            						<logic:empty name="juvenileAbuseForm" property="dualstatuses">
            							<tr class="detailHead">
            								<td colspan="6">No Dual Status History found</td>
            							</tr>
             						</logic:empty>
     
			      						  <logic:notEmpty name="juvenileAbuseForm" property="dualstatuses">
            							<tr class="detailHead">
            								<td align="left"><bean:message key="prompt.entryDate" /></td>
            								<td align="left" nowrap><bean:message key="prompt.referralRegion" /></td>
            								<td align="left"><bean:message key="prompt.custodyStatus" /></td>
            								<td align="left"><bean:message key="prompt.CPSlevelofCare" /></td>
            								<td align="left"><bean:message key="prompt.parentalRights" /></td>								
            							</tr>
     
			           						<%-- display detail info --%>  
             							<logic:iterate id="abuseIndex" name="juvenileAbuseForm" property="dualstatuses" indexId="dualStatusId">
          	  							 <%-- Begin Pagination item wrap --%>
                      		  <pg:item>
              								<tr class="<%out.print( (dualStatusId.intValue() % 2 == 1) ? "alternateRow" : "normalRow" );%>">
              										
                								<td align="left"><a href="/<msp:webapp/>displayJuvenileDualStatusDetails.do?dualstatusId=<bean:write name="abuseIndex" property="dualstatusId"/>&action=view"> 
                								...
                								<td align="left">
                  								...
                  								<bean:write name="abuseIndex" property="referralRegion" /> <%-- <bean:write name="abuseIndex" property="middleName" /> --%>
																	</td>
                								<td align="left"><bean:write name="abuseIndex" property="custodyStatus" /></td>
                								<td align="left"><bean:write name="abuseIndex" property="cpslevelofCare" /></td>
                								<td align="left"><bean:write name="abuseIndex" property="parentalrightsTermination" /></td>
                								<%-- <td align="left"><bean:write name="abuseIndex" property="dualstatusId" /></td> --%>
                							 </tr>
...
<%-- 								<html:button property="button.back" onclick="history.back();"><bean:message key="button.back" /></html:button> --%>
                                    <input type="button" value="Back" name="return" id="btnDulaStatusLstBack" />
									<logic:notEmpty name="juvenileProfileHeader" property="status">
										<jims2:isAllowed requiredFeatures='<%=Features.JCW_PRF_MAS_DUALSTATUS_U%>'>
											...
											<logic:notEqual name="juvenileProfileHeader" property="status" value="CLOSED">
												<html:submit property="submitAction"><bean:message key="button.addMoreDualStatusInfo"/></html:submit>
											</logic:notEqual>
