...
familyMemberFinancialDetails.jsp</title>
</head>
<%--END HEADER TAG--%>
<%--BEGIN BODY TAG--%>
...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|262">
	...
	<table width="98%">
			<tr>
				<td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.juvenileProfile"/> - <bean:message key="prompt.family"/>  <bean:message key="prompt.member"/> 
						 <bean:message key="prompt.financial"/> <bean:message key="prompt.details"/> 
				</td>
			</tr>
	</table>
		...
		align="center">
			<tr>
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td valign="top"><%--tabs start--%> <tiles:insert page="../caseworkCommon/juvenileProfileTabs.jsp" flush="true">
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="borderTableGreen">
						<tr>
							...
							<div class="spacer"></div>
										<table width="98%" border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td valign="top"><%--tabs start--%> <tiles:insert page="../caseworkCommon/memberInfoTabs.jsp" flush="true">
                                    ...
                                    <tiles:put name="employmentInfoList" beanName="juvenileMemberForm" beanProperty="employmentInfoList"/>	
                                     <tiles:put name="rowIdHeader" value="pChar0"/>
														...
														<tr>
															...
															<table width="100%" cellpadding="2" cellspacing="1">
																...
																<%--tr id="pChar0" class="hidden">
								                                    <td valign="top">
									                                    <tiles:insert page="../caseworkCommon/familyFinancialInfo.jsp" flush="true">
					                                  ...
					                                  <tiles:insert page="../caseworkCommon/familyFinancialInfo.jsp" flush="false">
						                                 <tiles:put name="familyFinancialInfo" beanName="juvenileMemberForm" beanProperty="currentGuardian" />	
					                                  </tiles:insert>
				                                   </td>
				                                </tr>
                                        ...
                                        <tr>
                                         ...
                                         <td colspan="3" class="formDe"><nested:write
                                          	property="notes" />
                                         </td>
                                        </tr>
																	</table>
