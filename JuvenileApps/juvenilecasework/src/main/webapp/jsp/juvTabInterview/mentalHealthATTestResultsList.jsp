...
<title><bean:message key="title.heading"/> - mentalHealthATTestResultsList.jsp</title>
<!-- Javascript for emulated navigation -->
...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|329">
...
<table width='100%'>
  ...
  <tr>
 	  <td align="center" class="header">Achievement <bean:message key="prompt.test"/> <bean:message key="prompt.results"/> <bean:message key="prompt.list"/></td>
  </tr>  
</table>
<!-- END HEADING TABLE -->
										  	...
										  	<td align="center">
												<div class='spacer'></div>
										  		<table width='98%' border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
														<tr>
															<td colspan="4" class="detailHead">Achievement Test Results</td>
														</tr>
														<tr>
															<td>
																<table width='100%' border="0" cellpadding="2" cellspacing="1">
																	<logic:empty name="testingSessionForm" property="achievementResultsList"> 
																    <tr class="detailHead">
																			<td colspan="4">No Previous Achievement Test Results Available.</td>
																    </tr>
																	</logic:empty>
																	
																	<logic:notEmpty name="testingSessionForm" property="achievementResultsList"> 
																			<tr>
																				<td>
																					<table width='100%' border="0" cellpadding="2" cellspacing="1">
																		                <tr class="formDeLabel">  
																		                  ...
																		                  <td valign="top"><bean:message key="prompt.test"/> <bean:message key="prompt.name"/></td>
																							...
																							<% int RecordCounter = 0; %>	
																								<logic:iterate id="resultsIndex" name="testingSessionForm" property="achievementResultsList" >
																									<!-- Begin Pagination item wrap -->																										
													                      <pg:item>
																									<tr class="<% out.print( ((++RecordCounter) % 2 == 1) ? "normalRow" : "alternateRow" );%>">
  																                  <td valign="top"><a href="/<msp:webapp/>displayMentalHealthAchievementSummary.do?submitAction=View&selectedValue=<bean:write name="resultsIndex" property="testId"/>">
