...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|357">


<%-- BEGIN HEADING TABLE --%>
<table width='100%'>
  <tr>
    <td align="center" class="header" ><bean:message key="title.juvenileCasework"/> - <bean:message key="title.juvenileProfile"/> - Insurance
										...
										<tr>
											...
											<div class='spacer'></div>
												...
												<tiles:insert page="/jsp/caseworkCommon/juvenileInsuranceDisplayTile.jsp" flush="true">
													...
													<tiles:put name="insurances" beanName="juvenileBenefitsInsuranceForm" beanProperty="newJuvInsurances"/>
												</tiles:insert>
												<br>
											</td>
										</tr>
		        ...
		        <%-- END TABLE --%>
						...
						<table border=0 align='center'>	
							<tr>
								...
								<td>
									<html:submit property="submitAction" styleId="benefitInsureDetFinish" ><bean:message key="button.finish"/></html:submit>
								</td>
</html:form>
