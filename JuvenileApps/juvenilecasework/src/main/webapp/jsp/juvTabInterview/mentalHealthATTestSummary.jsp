<!DOCTYPE HTML>
<!-- User selects the Next button after entering create details-->
<!--MODIFICATIONS -->
...
<title><bean:message key="title.heading"/> - mentalHealthATTestSummary.jsp</title>
...
<html:form action="/submitMentalHealthAT" target="content">
<logic:equal name="testingSessionForm" property="actionType" value="summary">
    <input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|331">
</logic:equal>
<logic:equal name="testingSessionForm" property="actionType" value="confirm">    
    <input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|332">
</logic:equal>
<logic:equal name="testingSessionForm" property="actionType" value="view">
    <input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|454">
</logic:equal>    
...
<table width='100%'>
  ...
  <logic:equal name="testingSessionForm" property="actionType" value="summary">	
    <tr>		
	     <td align="center" class="header"> Create Achievement Test Results Summary </td>
	  </tr>
  </logic:equal>
  <logic:equal name="testingSessionForm" property="actionType" value="confirm">	
  	 <tr>		
	     <td align="center" class="header"> Create Achievement Test Results Confirmation </td>
	  </tr>
   ...
   <logic:equal name="testingSessionForm" property="actionType" value="view">	
	  <tr>
	    <td align="center" class="header" >Achievement Test Results Details
				</td>
	  </tr>
  </logic:equal>
...
<table width="98%" border="0">
  ...
  <tr>
    <td>
     <ul>
    		 <li>Review information, then select <b>Finish</b> button to save Achievement Test Results.</li>
  																		...
  																		<table border="0" cellpadding="4" cellspacing="1" width='100%'>
																			...
																			<tr>
  																			...
  																			<tr>
  																				...
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.testDate"/></td>
  																				<td class="formDeLabel"><bean:message key="prompt.test"/> <bean:message key="prompt.name"/></td>
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.testName"/></td>
  																			</tr>
  																			<tr>
  																				<td class="formDeLabel"><bean:message key="prompt.wordReadingScore"/></td>
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.readingScore"/></td>
  																				<td class="formDeLabel"><bean:message key="prompt.wordReadingLevel"/></td>
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.readingGradeLevel"/></td>
  																				
  																			</tr>
  																			<tr>
  																			    <td class="formDeLabel"><bean:message key="prompt.readingCompositeScore"/></td>
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.readingCompositeScore"/></td>
  																				<td class="formDeLabel"></td>
  																				<td class="formDe"></td>  																				
  																			</tr>
  																			<tr>
  																			    <td class="formDeLabel"><bean:message key="prompt.spellingScore"/></td>
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.spellingScore"/></td>
  																				<td class="formDeLabel"><bean:message key="prompt.spellingGradeLevel"/></td>
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.spellingGradeLevel"/></td>  																				
  																			</tr>
  																			<tr>
  																			    <td class="formDeLabel" width='1%' nowrap="nowrap"><bean:message key="prompt.mathComputation"/></td>
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.arithmeticScore"/></td>
  																				<td class="formDeLabel" width='1%' nowrap="nowrap"><bean:message key="prompt.mathComputationGradeLevel"/></td>
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.arithmeticGradeLevel"/></td>  																				
  																			</tr>
  																			<tr>
  																				<td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="prompt.sentenceComprehensionScore"/></td>
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.sentenceCompletionScore"/></td>
  																				<td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="prompt.sentenceComprehensionLevel"/></td>
  																				<td class="formDe"><bean:write name="testingSessionForm" property="atRec.sentenceCompletionLevel"/></td>  																				
  																			</tr>
  																			
  																			<tr>
  																				<td colspan="4" class="formDeLabel"><bean:message key="prompt.testingRecommendations"/></td>
  																			</tr>
  																			<tr>
  																				<td colspan="4" class="formDe"><bean:write name="testingSessionForm" property="atRec.recommendations"/></td>
  																			</tr>
  																		</table>
  																	</td>
  																</tr>
