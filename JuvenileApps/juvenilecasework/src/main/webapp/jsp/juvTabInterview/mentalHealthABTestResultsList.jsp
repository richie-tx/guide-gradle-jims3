<!DOCTYPE HTML>
<!--MODIFICATIONS -->
<!-- 09/01/2010	Debbie Nikolis Create JSP -->
...
<title><bean:message key="title.heading"/> - mentalHealthABtestResultsList.jsp</title>
<!-- Javascript for emulated navigation -->
...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/searchjuvenilecasework/Search_Juvenile_Profile.htm#|12">
...
<table width='100%'>
  ...
  <tr>
  	  <td align="center" class="header"><bean:message key="prompt.adaptiveBehavior"/> 
												  ...
												  <tr>
												  	<td align="center">
											  			...
											  			<table width='98%' border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
										  					<tr>
																	<td class="detailHead">Adaptive Behavior Results</td>
																</tr>																
																<tr>
																	<td>
																		<table width='100%' border="0" cellpadding="2" cellspacing="1">
																			<logic:empty name="testingSessionForm" property="abResultsList"> 
																		    <tr class="detailHead">
																					<td colspan="4">No Previous Adaptive Behavior Test Results Available.</td>
																		    </tr>
																			</logic:empty>

																			<logic:notEmpty name="testingSessionForm" property="abResultsList"> 
																				<tr>
																					<td>
																						<table width='100%' border="0" cellpadding="2" cellspacing="1">
																		      ...
																		      <td valign="top"><bean:message key="prompt.compositeScore"/></td>																			                  
															                </tr>
															                 ...
															                 <!-- Begin Pagination Header Tag-->
																								...
																								<pg:pager index="center" maxPageItems="<%=Integer.parseInt(paginationResultsPerPage)%>"
    																								...
    																								<!-- End Pagination header stuff -->
    																									<logic:iterate indexId='index' id="resultsIndex" name="testingSessionForm" property="abResultsList" >
    																										<!-- Begin Pagination item wrap -->																										
																	                      <pg:item>
      																										<tr class="<%out.print( (index.intValue() % 2 == 1) ? "alternateRow" : "normalRow" );%>">
    																			                  <td valign="top"><a href="/<msp:webapp/>displayMentalHealthABSummary.do?submitAction=View&selectedValue=<bean:write name="resultsIndex" property="testId"/>">
      												                                <bean:write name="resultsIndex" property="testDate" formatKey="date.format.mmddyyyy" /></a>
    																			                  ...
    																			                  <td valign="top"><bean:write name="resultsIndex" property="instructorName" /></td>																								                    
    																                     		  ...
    																                     		  <td valign="top"><bean:write name="resultsIndex" property="compositeScore" /></td>																									                 
    																			                </tr>
    																									  </pg:item>
