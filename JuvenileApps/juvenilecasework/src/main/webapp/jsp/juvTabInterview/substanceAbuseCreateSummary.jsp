...
<title><bean:message key="title.heading"/> - substanceAbuseCreateSummary.jsp</title>
...
<table width="98%">
  	<tr>
    	<td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.juvenileProfile"/> - Create Substance Abuse - Summary</td>	  	    	 
  	</tr>  	
</table>
<%-- END HEADING TABLE --%>
<br>
