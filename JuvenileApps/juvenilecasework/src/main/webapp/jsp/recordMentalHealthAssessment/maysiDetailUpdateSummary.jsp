...
<table width="100%">
	<tr>
		<td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.juvenileProfile"/> - Mental Health History Details Confirmation</td>
	</tr>
</table>
<%-- END HEADING TABLE --%>
<br>
						            							...
						            							<logic:equal name="mentalHealthForm" property="hasSubAssessment" value="true">
							              							...
							              							<tr>
							              								<td valign="top" class="formDe" colspan="4">
							              									<bean:write name="mentalHealthForm" property="updatedMaysiComments"/>
							              								</td>
							              							</tr>
					      										</logic:equal>
						            						</table>
