...
<%--CShimek 07/26/2013  #75802 Added scheduled date display to reason MAYSI not administered when reason is Office Interview Pending --%>
...
<html:base />
<title><bean:message key="title.heading" /> - maysiDetail.jsp</title>
...
<table width="100%">
	<tr>
		<td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.juvenileProfile"/> - Mental Health History Details</td>
	</tr>
</table>
<%-- END HEADING TABLE --%>
<br>
							           						...
							           						<table width='100%' cellpadding="4" cellspacing="1">
						            							...
						            							<tr>
						            								...
						            								<jims2:switch name="mentalHealthForm" property="administer">
						            										<jims2:case value="true"><td class="formDe"><bean:write name="mentalHealthForm" property="assessmentOption"/></td></jims2:case>
						            										<jims2:default><td class="formDe"></td></jims2:default>
						            								</jims2:switch>
						            							</tr>
						            							<tr>
						            							...
						            							<logic:equal name="mentalHealthForm" property="hasSubAssessment" value="true">
							              							...
							              							<tr>
							              								<td valign="top" class="formDe" colspan="4"><bean:write name="mentalHealthForm" property="subsAssessmentComments"/></td>
							              							</tr>
					      										</logic:equal>
						            						</table>
						            					</td>
            							...
            							<tr>
            								<td>
            									<table border="0" cellpadding="1" cellspacing="1" align="center">
            										<tr>
            											<td align="center">
            												<logic:equal name="mentalHealthForm" property="assessmentOption" value="SUBSEQUENT DONE">
            													<html:submit property="submitAction"><bean:message key="button.updateComment"/></html:submit>
                              								</logic:equal>
                              								<html:submit property="submitAction"><bean:message key="button.back"/></html:submit>
															<logic:equal name="mentalHealthForm" property="assessmentOption" value="SUBSEQUENT NEEDED">                  
																<jims2:isAllowed requiredFeatures='<%=Features.JCW_PRF_MH_MAYSIS_U%>'>
																	<html:submit property="submitAction"><bean:message key="button.subsAssessment"></bean:message></html:submit>
																</jims2:isAllowed>
															</logic:equal>
															<html:form action="/displaySubsequentMAYSI" target="content">
												  					<td>
												  						<html:submit property="submitAction"><bean:message key="button.PrintMaysiForm" /></html:submit>
												  					</td> 
												  			</html:form>
														</td>
													</tr>
