...
<title>Juvenile Casework -/specialProcessing/viewJuvenileSealQueryResult.jsp</title>
...
{	console.log(field.value.length);
	...
	{	
  		alert("Your comment has been truncated to " + maxlen +" characters, the maximum allowed.");
...
<html:form action="/PerformJuvenileSealing" onsubmit="return this;">
...
<p>&nbsp;</p>
	...
	<elogic:if name="juveniles" property="recType" op="equal" value="S.JUVENILE">
			<elogic:then>
				<tr>
					<td align="center"><h4><i>Juvenile Master Record is Sealed. This record does not qualify for Juvenile Master Seal.</i></h4></td>
				</tr>
			</elogic:then>	
	</elogic:if>
	<elogic:if name="juveniles" property="recType" op="notequal" value="S.JUVENILE">
		...
		<tr>
			<td bgcolor="gray"><font color="white" face="bold" size="-1">REASON FOR SEAL:</font></td>
				...
				<html:textarea name="ProdSupportForm" property="sealComments" rows="2"
	  ...
	  <tr>
		  ...
		  <td><font size="-1"><html:text name="ProdSupportForm" property="sealedDate" styleId='sealedDate' size="10" /></font></td>
...
<table align="center" border="0" width="10%">	
	<elogic:if name="ProdSupportForm" property="rectype" op="notequal" value="S.JUVENILE">
		<elogic:then>
			<tr>
				<td colspan="2" align="center">
				<!--<html:submit property="submitAction" styleId="submitBtn">CONFIRM JUVENILE SEAL</html:submit> -->
				<input type="button" id="submitBtn" value="Confirm Juvenile Seal"/>
			</td>
	</tr>
		</elogic:then>	
	</elogic:if>	
	...
	<tr>
		<td>
			...
			<td><input type="button" onclick="return closeWindow(this.form)" id="BtnCancel" value="<bean:message key='button.cancel'/>"/>
		</td>
	</tr>
	</table>
	<br />

<html:hidden styleId="activeRef" name="ProdSupportForm" property="hasActiveReferral"/>
<html:hidden styleId="activeCas" name="ProdSupportForm" property="hasActiveCasefile"/>
<html:hidden styleId="activeFac" name="ProdSupportForm" property="hasActiveFacility"/>
</html:form>
