...
<title>Juvenile Casework -/specialProcessing/viewJuvenilePurgeQuery.jsp</title>
...
<body>
	<h2 align="center">Purge Juvenile Master Record</h2>
	<hr>
	<div id="container">
		<p align="center">Please enter a Juvenile Number to find out what data exists.</p>
		<div id="inputFields">
			<html:form method="post" styleId="viewJuvenilePurge" action="/ViewJuvenilePurgeQuery" onsubmit="return this;">
