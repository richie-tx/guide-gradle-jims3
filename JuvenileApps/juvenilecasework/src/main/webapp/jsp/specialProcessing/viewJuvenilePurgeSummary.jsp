...
<title>Juvenile Casework -/specialProcessing/viewJuvenilePurgeSummary.jsp</title>
...
<html:form action="/ViewJuvenilePurgeQuery" onsubmit="return this;">
...
<tr>
		<td align="center"><h4><font color="green"><i>Juvenile Master Record is Purged successfully.</i></font></h4></td>
</tr>
</table>
...
<table border="0" width="700">			
	...
	<tr colspan="2">
		<td align="center">
		<html:form action="/ViewJuvenilePurgeQuery?clr=Y">
			<input type="submit" name="Return" value="Return To Juvenile Master Purge"/>
		</html:form>	
		</td>
	</tr>
</table>
