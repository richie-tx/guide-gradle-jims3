...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- gangAssessDetails.jsp</title>
...
<logic:equal name="riskAnalysisForm" property="recommendationOverridden" value="false">
   <input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|149">
</logic:equal>
<%-- BEGIN HEADING TABLE --%>
<table width="100%">
	<tr>
		<td align="center" class="header">
    		<bean:message key="title.juvenileCasework"/> - Risk Assessment Previous 
    		<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="GANG">Gang</logic:equal> 
    		<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="GANG COPY">Gang Copy</logic:equal>  
    		<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="MH SCREEN">MH Screen</logic:equal> Information
   		    <jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_OVERRIDE_RECOMMENDATION%>'> 
		    	...
		    	<logic:equal name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUMMARY%>">
		    		 ...
		    		 <input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|224">
		    	</logic:equal>
		    	<logic:equal name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUCCESS%>">
		    		<bean:message key="prompt.confirmation"/>
		    		<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|225">
		    	</logic:equal>
	    	</jims2:isAllowed>	
		</td>
	</tr>
...
<logic:equal name="riskAnalysisForm" property="recommendationOverridden" value="true">
	<logic:equal name="riskAnalysisForm" property="action" value="<%=UIConstants.SUCCESS%>">
			...
			<ul>
				<logic:equal name="juvenileCasefileForm" property="juvUnder21" value="true">
					<logic:equal name="riskAnalysisForm" property="allowUpdates" value="true">	
						<li>Select Finish button to view Recommendation.</li>
					</logic:equal>	
				</logic:equal>
...
Allow updates..<bean:write name="riskAnalysisForm" property="allowUpdates" />
												...
												<table align="center" width="98%" border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
                          							<tr>
                          								<td class="detailHead" colspan="2">
                          									 <logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="GANG">Gang</logic:equal>
    															<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="GANG COPY">Gang Copy</logic:equal> 
                          									 <logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="MH SCREEN">MH Screen </logic:equal> <bean:message key="prompt.info"/>: <nested:write  name="riskAnalysisForm" property="assessmentId"/>
                          								</td>
                          							</tr>
                          							<tr>
						                          		<td align="center">
						                          			<table width="100%" cellpadding="4" cellspacing="1">				
						                          				<tr>
						                          					<td class="formDeLabel" width="70%" nowrap="nowrap">Date Taken</td>
						                          				...
						                          				<tr>
						                          					<td class="formDeLabel" width="70%" nowrap="nowrap">Part</td>
													...
													<logic:equal name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.EDIT%>"> <%-- return disableSubmit(this, this.form); --%>
	                        							<tr>
		                           							<td align="center">
				                         						...
				                         						<html:submit property="submitAction" onclick="document.forms[0].action.value = 'back';"><bean:message key="button.back" /></html:submit>
																<logic:equal name="juvenileCasefileForm" property="juvUnder21" value="true">
																	<logic:equal name="riskAnalysisForm" property="allowUpdates" value="true">					
																		<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_OVERRIDE_RECOMMENDATION%>'>  
																		...
																		<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_RISK_CLM_U%>'>  
																			<logic:equal name="riskAnalysisForm" property="overNinetyDays" value="<%=UIConstants.YES_FULL_TEXT%>">
																				<input type="button" value="Update" onclick="location.href='/<msp:webapp/>displayGangUpdate.do?mode=update'">
																			</logic:equal>
																		</jims2:isAllowed>
																	</logic:equal>
																</logic:equal>
																<input type='button' value="Print" onclick="javascript:newCustomWindow('/<msp:webapp/>displayRiskAssessmentDetails.do?assessmentId=<bean:write name="riskAnalysisForm" property="assessmentId"/>&assessmentType=GANG&action=print',450,450);"/>
																<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_OVERRIDE_RECOMMENDATION%>'>  
