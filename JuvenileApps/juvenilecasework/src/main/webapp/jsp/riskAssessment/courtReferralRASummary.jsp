...
<%-- 04/12/2012		CShimek 	#72377 add errorAlert code --%>
...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- courtReferralRASummary.jsp</title>
...
<logic:equal name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitCourtReferralUpdate" scope="request"/>
	<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|211">  
</logic:equal>

<logic:notEqual name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitCourtReferral" scope="request"/>
	<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|210"> 
</logic:notEqual>
...
<table width='100%'>
	<tr>
    	<td align="center" class="header"><bean:message key="title.juvenileCasework"/> - Risk Assessment TJJD Risk Information
    	<logic:equal name="riskAnalysisForm" property="mode" value="update">
			Update 
		</logic:equal> Summary</td>
  	</tr>
</table>
<%-- END HEADING TABLE --%>
				        												...
				        												<td colspan='2'>
														          			<table align="center" width='100%' border="0" cellpadding="4" cellspacing="1" class="borderTableGrey">
																		 		<tr>
							                 										...
							                 										<td class='formDe' colspan='2'><bean:write name="riskAnalysisForm" property="casefileID" /></td>
							  	              									</tr>
					      	          										</table>
					          	      									</td>
				        											</tr>
