...
<title><bean:message key="title.heading" />&nbsp;
	<bean:message key="title.juvenileCasework" />&nbsp;- residentialAssessDetails.jsp</title>
...
<html:form action="/displayRiskAssessmentDetails" target="content">
    ...
    <logic:equal name="riskAnalysisForm" property="recommendationOverridden" value="false">
		<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|151">
	</logic:equal>	
	...
	<table width='100%'>
		<tr>
			<td align="center" class="header">
				<bean:message key="title.juvenileCasework" /> - Risk Assessment Previous Residential Information
	   		    <jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_OVERRIDE_RECOMMENDATION%>'> 
			    	...
			    	<logic:equal name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUMMARY%>">
			    		 ...
			    		 <input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|226">
			    	</logic:equal>
			    	<logic:equal name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUCCESS%>">
			    		<bean:message key="prompt.confirmation"/>
			    		<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|227">
			    	</logic:equal>
		    	</jims2:isAllowed>	
			</td>
		</tr>
								...
								<tr>
									<td>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0" class="borderTableGreen">
											<tr>
												<td valign="top" align="center">
												<%-- BEGIN Residential Information TABLE --%>
												<div class="spacer"></div>
												<table align="center" width="98%" border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
													<tr>
														<td class="detailHead" colspan="2">
														<bean:message key="prompt.residential" />&nbsp;<bean:message key="prompt.info" />: <nested:write  name="riskAnalysisForm" property="assessmentId"/></td>
													</tr>
													<tr>
														<td align="center">
														<table width="100%" cellpadding="4" cellspacing="1">
															<tr>
																...
																<td class="formDe">
																<nested:write name="riskAnalysisForm" property="riskAssessmentDate" formatKey="date.format.mmddyyyy" /></td>
															</tr>
															<tr>
...
<%-- END Residential Information TABLE --%>
											<div class="spacer"></div>									
															 		...
															 		<logic:equal name="riskAnalysisForm" property="allowUpdates" value="true">					
																		...
																		<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_RISK_CLM_U%>'>  
																			<logic:equal name="riskAnalysisForm" property="overNinetyDays" value="<%=UIConstants.YES_FULL_TEXT%>">
																				<input type="button" value="Update" onclick="location.href='/<msp:webapp/>displayResidentialUpdate.do?mode=update'">
																			</logic:equal>
																		</jims2:isAllowed>
																	</logic:equal>
																</logic:equal> 
