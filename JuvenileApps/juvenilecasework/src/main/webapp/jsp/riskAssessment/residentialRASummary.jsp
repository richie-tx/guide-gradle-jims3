...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- residentialRASummary.jsp</title>
...
<logic:equal name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitResidentialUpdate" scope="request"/>  
</logic:equal>

<logic:notEqual name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitResidential" scope="request"/> 
</logic:notEqual>

<html:form action="${actionURL}" target="content">

<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|28">

<%-- BEGIN HEADING TABLE --%>
<table width="100%">
	<tr>
    	<td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.riskAssessmentResidentialInformation"/>
    	<logic:equal name="riskAnalysisForm" property="mode" value="update">
		Update 
		</logic:equal>	
    	Summary</td>
...
<table width="98%" border="0">
 	<tr>
    	<td>
      		<ul>
        		<li>Select Finish button to view Residential Recommendation.</li>
						                        ...
						                        <table align="center" width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
                        							<tr>
                      									<td class="detailHead" colspan="2">
                      										<bean:message key="prompt.residential"/>&nbsp;<bean:message key="prompt.info"/> 
                      									</td>
                      								</tr>
                      								<tr>
								                    	<td align='center'>
