...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- progressRASummary.jsp</title>
...
<logic:equal name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitProgressUpdate" scope="request"/>  
</logic:equal>

<logic:notEqual name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitProgress" scope="request"/> 
</logic:notEqual>
...
<table width="98%" border="0">
  <tr>
    <td>
  	  <ul>
        <li>Select Finish button to view Progress Recommendation.</li>
                        ...
                        <table align="center" width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
                        	<tr>
                        		<td class=detailHead colspan="2">
	                        		<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="RESIDENTIAL PROGRESS">
							    		Residential Progress Information
							    	</logic:equal>
									<logic:notEqual name="riskAnalysisForm" property="riskAssessmentType" value="RESIDENTIAL PROGRESS">
	                        			<bean:message key="prompt.progress"/>&nbsp;<bean:message key="prompt.info"/>
	                        		</logic:notEqual>
                        		</td>
                        	</tr>
                          <tr>
