...
<%-- 07/28/2009     LDeen	   fixed problem with bean:questions --%>
...
<title>juvenilecasework/riskAssessment/communityAssessDetails.jsp</title>
...
<logic:equal name="riskAnalysisForm" property="recommendationOverridden" value="false">
   <input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|147">
</logic:equal>
...
<table width='100%'>
	<tr>
    	<td align="center" class="header">
    		...
    		<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="COMMUNITY">
    				<bean:message key="title.juvenileCasework"/> Community
    			</logic:equal>	
    			<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="COMMUNITY PCI">
    				<bean:message key="title.juvenileCasework"/> Community PCI
    			</logic:equal> Supervision Information
    		<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_OVERRIDE_RECOMMENDATION%>'> 
		    	...
		    	<logic:equal name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUMMARY%>">
		    		 ...
		    		 <input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|228">
		    	</logic:equal>
		    	<logic:equal name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUCCESS%>">
		    		<bean:message key="prompt.confirmation"/>
		    		<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|229">
		    	</logic:equal>
	    	</jims2:isAllowed>	
    	</td>
  	</tr>
...
<%-- BEGIN Border table green TABLE --%>
...
<%-- BEGIN Border table blue TABLE --%>
						                        <table align="center" width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
						                        	<tr>
						                        		...
						                        		<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="COMMUNITY">
    															<bean:message key="prompt.communityOldSupervision"/> 
    														</logic:equal>	
    													<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="COMMUNITY PCI">
    															<bean:message key="prompt.communitySupervision"/> 
    													</logic:equal>
						                        		&nbsp;<bean:message key="prompt.info"/>: <nested:write  name="riskAnalysisForm" property="assessmentId"/> </td>
						                        	</tr>
						                        	<tr>
						                        		<td align="center">
																	...
																	<logic:equal name="riskAnalysisForm" property="allowUpdates" value="true">					
																		...
																		<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_RISK_CLM_U%>'>  
																			<logic:equal name="riskAnalysisForm" property="overNinetyDays" value="<%=UIConstants.YES_FULL_TEXT%>">
																				<input type="button" value="Update" onclick="location.href='/<msp:webapp/>displayCommunityUpdate.do?mode=update'">
																			</logic:equal>
																		</jims2:isAllowed>
																	</logic:equal>
																</logic:equal>
...
<%-- END CASEFILE CASEFILE INFO TABS INNER TABLE --%>
			      		<div class='spacer'></div>
			    	</td>
			  	</tr>
			</table>
