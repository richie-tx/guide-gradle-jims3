...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- residentialRA.jsp</title>
...
<html:form action="/displayResidentialSummary">

<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|26">
		                      					...
		                      					<table border="0" width="100%">
		                        					<tr>
							                        	<td align="center">
							                            	...
							                            	<html:submit property="submitAction" onclick="return validateFields(this.form)">
