<!DOCTYPE HTML>
<%--MODIFICATIONS --%>
<%-- 09/20/2005		DWilliamson	Create Interview RA Recommendation jsp--%>
...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- interviewRARecommendation.jsp</title>
...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|160">
...
<table width='100%'>
  <tr>
   ...
   <logic:notEmpty name="riskAnalysisForm" property="assessmentId" >
	  <tr>
	    <td align="center" class="confirm" >PREA Follow-up Risk Assessment saved.</td>
	  </tr>
    			  ...
    			  <%-- BEGIN CASEFILE INFO TABS INNER TABLE --%>
	  			  ...
	  			  <table width='98%' border="0" cellpadding="0" cellspacing="0">
                        ...
                        <table align="center" width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">	
                           <tr>
                        		<td class="detailHead"><bean:message key="prompt.preaFollowUp"/>&nbsp;<bean:message key="prompt.recommendation"/></td>
                        	</tr>
