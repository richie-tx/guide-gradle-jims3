...
<html:form action="/displayTestingPeer?action=parental" target="content">
...
<table width='100%'>
  <tr>
    <td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.riskAssessmentParentalIssuesInformation"/></td>
  </tr>
</table>
<%-- END HEADING TABLE --%>
...
<table width="98%" border="0">
  <tr>
    <td>
  	  <ul>
        <li>Check all relevant boxes then select Next button for Parental Issues Questionaire.</li>
