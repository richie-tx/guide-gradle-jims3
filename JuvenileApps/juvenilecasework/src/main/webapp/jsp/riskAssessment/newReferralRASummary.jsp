...
<%-- 04/12/2012		CShimek 	defect #72377, add errorAlert code --%>
...
<title>juvenilecasework/riskAssessment/newReferralRASummary.jsp</title>
...
<table width='100%'>
 	<tr>
    	<td align="center" class="header">
    		  ...
    		  <logic:notEqual name="riskAnalysisForm" property="mode" value="update">
    		     <input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|146">
    		  </logic:notEqual>  
    		  <logic:equal name="riskAnalysisForm" property="mode" value="update">
    		  	 Update 
    		     <input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|218">
		      </logic:equal>Summary 
    	</td>
  </tr>
</table>
	...
	<tr>
		<td>
			<ul>
        		...
        		<li>Select Finish button to view Detention Recommendation.</li>
