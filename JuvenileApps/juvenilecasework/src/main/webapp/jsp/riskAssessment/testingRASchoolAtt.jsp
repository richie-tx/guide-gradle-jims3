...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- testingRASchoolAtt.jsp</title>
...
<html:form action="/displayTestingPeer?action=attitude" target="content">

<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|39">

<%-- BEGIN HEADING TABLE --%>
<table width='100%'>
  <tr>
    <td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.riskAssessmentSchoolAttendanceInformation"/></td>
  </tr>
</table>
<%-- END HEADING TABLE --%>
...
<table width="98%" border="0">
  <tr>
    <td>
  	  <ul>
        <li>Check all relevant boxes then select Next button for Attitude/Appearance Questionaire.</li>
                        	...
                        	<tr>
                        		<td valign="top">
                      	          ...
                      	          <nested:iterate id="questionAnswers" name="riskTestingForm" property="questionAnswers" indexId="outer">
                        	        	<%if(outer.intValue() == 8) { %>
                          						<tr>
                            						<td class="formDeLabel" colspan="6"> <bean:write name="questionAnswers" property="questionText"/> </td>						
...
<div valign="top"><script type="text/javascript">renderBackToTop()</script></div>
