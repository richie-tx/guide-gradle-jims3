...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- gangAssessDetailsReport.jsp</title>
...
<table width="100%" border-style="none">
		<tr align="center">
			<td align="center" width="100%"><h2>
			 ...
			 <logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="MH SCREEN">MH Screen </logic:equal> RISK ASSESSMENT REPORT</h2></td>
		</tr>
		<tr></tr>
</table>
</div>
