...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- progressRARecommendation.jsp</title>
...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|19">
...
<table width='100%'>
  ...
  <logic:notEmpty name="riskAnalysisForm" property="assessmentId" >
	  <tr>
	    <td align="center" class="confirm" ><logic:equal name="riskAnalysisForm" property="riskAssessmentType"  value="RESIDENTIAL PROGRESS">Residential</logic:equal> Progress 
	     Risk Assessment saved.</td>
	  </tr>
    			  ...
    			  <%-- BEGIN CASEFILE INFO TABS INNER TABLE --%>
	  			  ...
	  			  <table width='98%' border="0" cellpadding="0" cellspacing="0">
                        ...
                        <table align="center" width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">	
                           <tr>
                        		<td class="detailHead"><logic:equal name="riskAnalysisForm" property="riskAssessmentType"  value="RESIDENTIAL PROGRESS">Residential</logic:equal> <bean:message key="prompt.progress"/>
                        	...
                        	<tr bgcolor='#f0f0f0'>
                        		<td align="center">
                        			<table width="100%" cellpadding="4" cellspacing="1">				
                        				<tr>
                        					<td class="formDeLabel"><bean:message key="prompt.recommendation"/></td>
                        					<td class="formDe"><bean:write name="riskProgressForm" property="recommendation" /></td>
                        				</tr>
                        			</table>
                        		</td>
                        	</tr>
                        ...
                        <%-- END Interview Information Recommendation TABLE --%>
