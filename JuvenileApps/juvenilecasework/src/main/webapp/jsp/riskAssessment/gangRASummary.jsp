...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- gangRASummary.jsp</title>
...
function popupReminder(){
	alert("Please return to Gang Referral Assessment to enter conclusion information.");
	return;
}
...
<logic:equal name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitGangUpdate" scope="request"/>  
</logic:equal>

<logic:notEqual name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitGang" scope="request"/> 
</logic:notEqual>

<html:form action="${actionURL}" target="content">

<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|21">
...
<table width='100%'>
    ...
    <logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="MH SCREEN">
   	...
   	<logic:notEqual name="riskAnalysisForm" property="riskAssessmentType" value="MH SCREEN">
    	<bean:message key="title.riskAssessmentGangInformation"/>
  </logic:notEqual>&nbsp;Summary</td>
	</tr>
</table>
<%-- END HEADING TABLE --%>
...
<%-- BEGIN Program Referral History TABLE --%>
												<table align="center" width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
													<tr>
						                        		...
						                        		<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="MH SCREEN">
												    		MH Screen Information
												    	</logic:equal>
														<logic:notEqual name="riskAnalysisForm" property="riskAssessmentType" value="MH SCREEN">
						                        			<bean:message key="prompt.gang"/>&nbsp;<bean:message key="prompt.info"/>
						                        		</logic:notEqual>
                        								</td>
													</tr>
													<tr>
													...
													<tr>
														<td align="center">
															<html:submit property="submitAction"><bean:message key="button.back" /></html:submit>
															 ...
															 <logic:notEqual name="riskAnalysisForm" property="riskAssessmentType" value="MH SCREEN">
															 <html:submit property="submitAction" onclick="popupReminder();return disableSubmit(this, this.form); ">															 	
																	<bean:message key="button.finish" />
																</html:submit>
															 </logic:notEqual>
															&nbsp;
