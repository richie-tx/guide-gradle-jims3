<!DOCTYPE HTML>
<%--MODIFICATIONS --%>
<%-- 09/20/2005		DWilliamson	Create Interview AssessDetails jsp--%>
...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- interviewAssessDetails.jsp</title>
...
<logic:notEqual name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUMMARY%>">
  <logic:notEqual name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUCCESS%>">
  <logic:equal name="riskAnalysisForm" property="recommendationOverridden" value="false">
    <input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|150">
  </logic:equal>  
  </logic:notEqual>  
</logic:notEqual>
...
<table width='100%'>
	<tr>
    	<td align="center" class="header">
    		<bean:message key="title.juvenileCasework"/> - Risk Assessment Previous <logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="INTERVIEW">Interview</logic:equal> 
                          									 <logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="PREA FOLLOW-UP">PREA Follow-up </logic:equal> Information
   		    <jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_OVERRIDE_RECOMMENDATION%>'> 
		    	...
		    	<logic:equal name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUMMARY%>">
		    		...
		    		<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|222"> 
		    	</logic:equal>
		    	<logic:equal name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUCCESS%>">
		    		<bean:message key="prompt.confirmation"/>
		    	   <input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|223">	
		    	</logic:equal>
	    	</jims2:isAllowed>	
    	</td>
  	</tr>
                      							...
                      							<table align="center" width='98%' border="0" cellpadding="2" cellspacing="1"  class="borderTableBlue">
                      								<tr>
                      									<td class="detailHead" colspan="2">
                      										<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="INTERVIEW">Interview</logic:equal> 
                          									 <logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="PREA FOLLOW-UP">PREA Follow-up </logic:equal>: <nested:write  name="riskAnalysisForm" property="assessmentId"/>
                      									</td>
                      								</tr>
                      								<tr>
                      									<td align="center">
																...
																<logic:equal name="riskAnalysisForm" property="allowUpdates" value="true">					
																	...
																	<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_RISK_CLM_U%>'>  
																		<logic:equal name="riskAnalysisForm" property="overNinetyDays" value="<%=UIConstants.YES_FULL_TEXT%>">
																			<input type="button" value="Update" onclick="location.href='/<msp:webapp/>displayInterviewUpdate.do?mode=update'">
																		</logic:equal>
																	</jims2:isAllowed>
																</logic:equal>
															</logic:equal>
															<input type='button' value="Print" onclick="javascript:newCustomWindow('/<msp:webapp/>displayRiskAssessmentDetails.do?assessmentId=<bean:write name="riskAnalysisForm" property="assessmentId"/>&assessmentType=PREA FOLLOW-UP&action=print',450,450);"/>
															<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_OVERRIDE_RECOMMENDATION%>'>  
