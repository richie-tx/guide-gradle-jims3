...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- testingRABehavioralIssues.jsp</title>
...
<html:form action="/displayTestingPeer?action=substance" target="content">

<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|31">

<%-- BEGIN HEADING TABLE --%>
<table width='100%'>
  <tr>
    <td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.riskAssessmentBehavioralIssuesInformation"/></td>
  </tr>
</table>
<%-- END HEADING TABLE --%>
...
<table width="98%" border="0">
  <tr>
    <td>
  	  <ul>
        <li>Check all relevant boxes then select Next button for Development Questionaire.</li>
