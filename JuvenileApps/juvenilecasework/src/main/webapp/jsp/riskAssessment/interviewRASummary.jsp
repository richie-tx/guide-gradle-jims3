...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- interviewRASummary.jsp</title>
...
<logic:equal name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitInterviewUpdate" scope="request"/>  
</logic:equal>

<logic:notEqual name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitInterview" scope="request"/> 
</logic:notEqual>

<html:form action="${actionURL}" target="content">


<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|161">

<%-- BEGIN HEADING TABLE --%>
<table width='100%'>
	<tr>
    	<td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.riskAssessmentPREAFollowUpInformation"/>
    	<logic:equal name="riskAnalysisForm" property="mode" value="update">
    	Update
    	</logic:equal>
    	Summary</td>
							                    	...
							                    	<td align='center'>
                       									<table width='100%' cellpadding="4" cellspacing="1">
               												...
               												<tiles:insert page="../caseworkCommon/riskAnalysisQuestionAnswersSummary.jsp" flush="false">
																	<tiles:put name="tilesAFormName" value="riskInterviewForm"/>
															</tiles:insert>
