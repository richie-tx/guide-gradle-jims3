...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- communityRASummary.jsp</title>
...
<logic:equal name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitCommunityUpdate" scope="request"/>  
</logic:equal>

<logic:notEqual name="riskAnalysisForm" property="mode" value="update">
	<c:set var="actionURL" value="/submitCommunity" scope="request"/> 
</logic:notEqual>

<html:form action="${actionURL}" target="content">

<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|154">
...
<table width="98%" border="0">
	<tr>
    	<td>
	  		<ul>
        		<li>Select Finish button to view Supervision Recommendation.</li>
		  									...
		  									<td valign="top" align="center">
						                        ...
						                        <table align="center" width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
						                        	<tr>
    													...
    													</logic:equal>&nbsp;<bean:message key="prompt.info"/></td>
						                        	</tr>
                        									...
                        									<table width='100%' cellpadding="4" cellspacing="1">
                        										<tr>
                  												...
                  												<tiles:insert page="../caseworkCommon/riskAnalysisQuestionAnswersSummary.jsp" flush="false">
																	<tiles:put name="tilesAFormName" value="riskCommunityForm"/>
																</tiles:insert>
