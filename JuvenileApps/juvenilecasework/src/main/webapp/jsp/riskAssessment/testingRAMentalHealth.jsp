...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- testingRAMentalHealth.jsp</title>
...
<html:form action="/displayTestingSummary" target="content">

<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|348">

<%-- BEGIN HEADING TABLE --%>
<table width='100%'>
  <tr>
    <td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="prompt.risk"/>
      <bean:message key="prompt.assessment"/>
      <bean:message key="prompt.mentalHealth"/>
      <bean:message key="prompt.issue"/>s
...
<table width="98%" border="0">
  <tr>
    <td>
  	  <ul>
        <li>Check all relevant boxes then select Next button for Risk Assessment Testing Summary.</li>
