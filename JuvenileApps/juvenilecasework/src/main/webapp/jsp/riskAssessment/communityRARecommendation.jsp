...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- communityRARecommendation.jsp</title>
...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|155">
...
<table width='100%'>
  <tr>
    <td align="center" class="header"><bean:message key="title.juvenileCasework"/> -
     <logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="COMMUNITY">
    				<bean:message key="title.riskAssessmentCommunitySupervision"/>
    			</logic:equal>	
    			<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="COMMUNITY PCI">
    				<bean:message key="title.riskAssessmentCommunityPCISupervision"/>
    			</logic:equal>&nbsp;Recommendation
     </td>
  ...
  <logic:notEmpty name="riskAnalysisForm" property="assessmentId" >
	  <tr>
	    ...
	    <logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="COMMUNITY">
    				<bean:message key="title.riskAssessmentCommunitySave"/>
    			</logic:equal>	
    			<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="COMMUNITY PCI">
    				<bean:message key="title.riskAssessmentCommunityPCISave"/>
    			</logic:equal>
	    </td>
	  </tr>
...
<%-- BEGIN Community Recommendation TABLE --%>
  			    ...
  			    <%-- BEGIN CASEFILE INFO TABS INNER TABLE --%>
	  			  ...
	  			  <table width='98%' border="0" cellpadding="0" cellspacing="0">
                        ...
                        <table align="center" width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">	
                           <tr>
                        		<td class="detailHead"><logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="COMMUNITY">
    															<bean:message key="prompt.communityOldSupervision"/> 
    														</logic:equal>	
    													<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="COMMUNITY PCI">
    															<bean:message key="prompt.communitySupervision"/> 
    													</logic:equal>&nbsp;<bean:message key="prompt.recommendation"/></td>
                        	</tr>
                        ...
                        <%-- END Community Recommendation TABLE --%>
