<!DOCTYPE HTML>
<%--MODIFICATIONS --%>
<%-- 09/20/2005		DWilliamson	Referral AssessDetails jsp--%>
<%-- 07/20/2009     CShimek    #61004 added timeout.js  --%>
<%-- 03/15/2011     CShimek    replaced local js with assessDetails.js  --%>
<%-- 05/01/2011     CShimek    #69765 Add code to display Summary/Confirmation in heading --%>
...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- progressAssessDetails.jsp</title>
	...
	<tr>
		<td align="center" class="header">
    		<bean:message key="title.juvenileCasework"/> - Risk Assessment Previous 
    		 <logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="RESIDENTIAL PROGRESS">Residential</logic:equal> Progress Information
												...
												<table align="center" width="98%" border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
                          							<tr>
                          								<td class="detailHead" colspan="2">
															<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="RESIDENTIAL PROGRESS">Residential</logic:equal>&nbsp;
                          									 <bean:message key="prompt.progress"/> <bean:message key="prompt.info"/>: <nested:write  name="riskAnalysisForm" property="assessmentId"/>
                          								</td>
                          							</tr>
                          							<tr>
						                          		<td align="center">
																	...
																	<logic:equal name="riskAnalysisForm" property="allowUpdates" value="true">					
																		...
																		<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_RISK_CLM_U%>'>  
																			<logic:equal name="riskAnalysisForm" property="overNinetyDays" value="<%=UIConstants.YES_FULL_TEXT%>">
																				<input type="button" value="Update" onclick="location.href='/<msp:webapp/>displayProgressUpdate.do?mode=update'">
																			</logic:equal>
																		</jims2:isAllowed>
																	</logic:equal>
																</logic:equal>												
