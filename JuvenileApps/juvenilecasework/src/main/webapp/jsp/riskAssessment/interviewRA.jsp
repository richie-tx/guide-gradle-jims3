...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- interviewRA.jsp</title>
...
<html:form action="/displayInterviewSummary">

<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|159">
...
<table width="98%" border="0">
	<tr>
    	<td>
			<ul>
        		<li>Complete <strong>all</strong> PREA Follow-up questions and then select Next button to view summary.</li>
