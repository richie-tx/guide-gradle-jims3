<!DOCTYPE HTML>
<%--MODIFICATIONS --%>
<%-- 05/01/2013	 CShimek	Create Risk Analysis jsp--%>
...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- gangRA.jsp</title>
...
<html:form action="/displayGangSummary">
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|0">
...
<%-- BEGIN  TABLE --%>
												...
												<table align="center" width='98%' border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
													<tr>
														<logic:notEqual name="riskAnalysisForm" property="riskAssessmentType" value="MH SCREEN">
														<td class='detailHead'><bean:message key="prompt.gang"/>&nbsp;<bean:message key="prompt.riskAssessment"/></td>
														</logic:notEqual>
														<logic:equal name="riskAnalysisForm" property="riskAssessmentType" value="MH SCREEN">
														<td class='detailHead'><bean:message key="prompt.mhScreen"/>&nbsp;<bean:message key="prompt.riskAssessment"/></td>
														</logic:equal>
													</tr>
													<tr>
														<td align='center'>	
								                          	<table width='100%' cellpadding="4" cellspacing="1">
								                          		<tr>
	                         										<td class='detailHead' colspan="4">
	                         											<bean:message key="prompt.generalInfo"/>
	                         										</td> 
	                         									</tr>	
                             								</table>
								                          	<table width='100%' cellpadding="4" cellspacing="1">                                
