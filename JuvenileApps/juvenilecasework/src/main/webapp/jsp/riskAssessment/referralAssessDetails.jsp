...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- referralAssessDetails.jsp</title>
...
<logic:notEqual name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUMMARY%>">
   <logic:notEqual name="riskAnalysisForm" property="secondaryAction" value="<%=UIConstants.SUCCESS%>">
      <logic:equal name="riskAnalysisForm" property="recommendationOverridden" value="false">
        <input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|221">
      </logic:equal>
   </logic:notEqual>   
</logic:notEqual>      
                      							...
                      							<table align="center" width='98%' border="0" cellpadding="2" cellspacing="1"  class="borderTableBlue">
                      								<tr>
                      									<td class="detailHead" colspan="2">
                      										Pre-Court Staffing: <nested:write  name="riskAnalysisForm" property="assessmentId"/>
                      									</td>
                      								</tr>
                      								<tr>
                      									<td align="center">
...
<%-- BEGIN RECOMMENDATION & OVERRIDE SECTION TABLE --%>
											<logic:notEqual name="riskAnalysisForm" property="riskAssessmentType" value="<%=naming.RiskAnalysisConstants.RISK_TYPE_NON_CUSTODY_REFERRAL%>"> 
																	...
																	<logic:equal name="riskAnalysisForm" property="allowUpdates" value="true">						
																		<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_OVERRIDE_RECOMMENDATION%>'>  
																		 ...
																		 <jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_RISK_CLM_U%>'>  
																			<input type="button" value="Update" onclick="location.href='/<msp:webapp/>displayReferralUpdate.do?isNewReferral=false&mode=update'">
																		</jims2:isAllowed>
																	</logic:equal>	
																</logic:equal>
																<jims2:isAllowed requiredFeatures='<%=Features.JCW_CF_OVERRIDE_RECOMMENDATION%>'>  
