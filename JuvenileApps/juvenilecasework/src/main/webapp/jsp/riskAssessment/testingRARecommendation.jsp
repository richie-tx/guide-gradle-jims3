...
<title><bean:message key="title.heading"/>&nbsp;<bean:message key="title.juvenileCasework"/>&nbsp;- testingRARecommendation.jsp</title>
...
<input type="hidden" name="helpFile" value="ManageJuvenileCasework/managejuvenilecasework/Manage_Juvenile_Casework.htm#|38">

<%-- BEGIN HEADING TABLE --%>
<table width='100%'>
  <tr>
    <td align="center" class="header"><bean:message key="title.juvenileCasework"/> - <bean:message key="title.riskAssessmentRecommendationInformation"/></td>
  </tr>
  <logic:notEmpty name="riskAnalysisForm" property="assessmentId" >
	  <tr>
	    <td align="center" class="confirm" >Testing Risk Assessment saved.</td>
	  </tr>
    			  ...
    			  <%-- BEGIN CASEFILE INFO TABS INNER TABLE --%>
	  			  ...
	  			  <table width='98%' border="0" cellpadding="0" cellspacing="0">
                        ...
                        <table align="center" width='98%' border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">	
                           <tr>
                        		<td class="detailHead"><bean:message key="prompt.testing"/>&nbsp;<bean:message key="prompt.info"/>&nbsp;<bean:message key="prompt.recommendation"/></td>
                        	</tr>
