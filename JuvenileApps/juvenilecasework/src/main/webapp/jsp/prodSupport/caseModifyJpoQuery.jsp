...
<title>Juvenile Casework -/prodSupport/caseModifyJpoQuery.jsp</title>
<%-- STYLE SHEET LINK --%>
...
<p align="center">Please enter a casefile ID to find out what dependent data exists.</p>
	...
	<div align="center">
	<html:form styleId="modifyJpoForm" method="post" action="/ModifyJpoQuery" onsubmit="return this;">
