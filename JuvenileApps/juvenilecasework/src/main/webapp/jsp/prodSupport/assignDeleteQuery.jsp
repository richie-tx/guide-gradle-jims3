...
<title>Juvenile Casework -/prodSupport/assignDeleteQuery.jsp</title>
...
<p align="center">Please enter a casefile ID to find out what dependent data exists.</p>
	...
	<div align="center">
	<html:form styleId="assignDeleteForm" method="post" action="/AssignDeleteQuery" onsubmit="return this;">
