...
<title>Juvenile Casework -/prodsupport/viewJuvenileUnsealSummary.jsp</title>
...
<html:form action="/ViewJuvenileUnpurgeQuery" onsubmit="return this;">

<h2 align="center">Juvenile Master/Referral Un-Seal Results</h2>
<br>
<hr>
<table width="900" align="center">
<tr>
	<logic:equal name="ProdSupportForm" property="action" value="unSealJuv">
		<td align="center"><h4><font color="green"><i>Juvenile Master Seal Indicator Removed successfully from Juvenile and ALL associated Court, Detention, Referral and Petition Records.</i></font></h4></td>
	</logic:equal>
<%-- 	<logic:equal name="ProdSupportForm" property="action" value="unSealRef">
		<td align="center"><h4><font color="green"><i>Juvenile Referral Seal Indicator Removed successfully from Juv.<bean:write  name="ProdSupportForm" property="juvenileId" /></i></font></h4></td>
	</logic:equal> --%>
</tr>
</table>
<%-- <logic:notEmpty	name="ProdSupportForm" property="juveniles">
	...
	<elogic:if name="juveniles" property="recType" op="notequal" value="S.JUVENILE">
		...
		<br /><br />
		<tr>
			<td bgcolor="gray"><font color="white" face="bold" size="-1">PURGE SERIES</font></td>
			<td><font size="-1"><bean:write  name="ProdSupportForm" property="purgeSerNum" />&nbsp;</font></td>
		</tr>
		<tr>
			<td bgcolor="gray"><font color="white" face="bold" size="-1">PURGE BOX</font></td>
			<td><font size="-1"><bean:write  name="ProdSupportForm" property="purgeBoxNum" />&nbsp;</font></td>
		</tr>
		 <tr>
			<td bgcolor="gray"><font color="white" face="bold" size="-1">PURGE COMMENTS</font></td>
				<td><font size="-1"><bean:write  name="ProdSupportForm" property="purgeComments" />&nbsp;</font></td>
  		</tr>	  
		</elogic:then>
		</elogic:if>
	</table>
...
<table border="0" width="700">			
	...
	<tr colspan="2">
		<%-- <td align="center">
		<html:form action="/ViewJuvenileUnpurgeQuery?clr=Y">
			<input type="submit" name="Return" value="Back to the Query"/>
		</html:form>	
		</td> --%>
