...
<title>Juvenile Casework -/prodSupport/UpdateDistrictCourtCalendarRecordSummary</title>
...
<table align="center" border="0" width="500">
		...
		<logic:notEmpty name="ProdSupportForm" property="originalJuvDistCourtRecords">
		<bean:define id="courtRecords" name="ProdSupportForm" property="originalJuvDistCourtRecords" type="java.util.ArrayList" />
		<%= courtRecords.size()  %>
		<% if ( courtRecords.size() > 1) { %>
		<tr>
			<td colspan="2" align="center">
