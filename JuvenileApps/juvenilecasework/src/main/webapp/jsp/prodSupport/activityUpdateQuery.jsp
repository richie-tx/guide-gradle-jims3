...
<title>Juvenile Casework -/prodSupport/activityUpdateQuery.jsp</title>
<%-- STYLE SHEET LINK --%>
...
<p align="center">Please enter an ActivityID to display its information.</p>
	...
	<div align="center">
	<html:form styleId="activityUpdateForm" method="post" action="/ActivityUpdateQuery" onsubmit="return this;">
