...
<!-- Referenced from CourtProcessing: AttorneyNameSearch -->
<%--MODIFICATIONS --%>
...
<title><bean:message key="title.heading" />&nbsp;<bean:message
		key="title.juvenileCasework" />&nbsp;- LastAttorneyNameSearch.jsp</title>
...
<body topmargin="0" leftmargin="0"
	...
	<html:form action="/PerformUpdateLastAttorney"
		 onsubmit="return this;" focus="attorneyName">
		<!-- BEGIN HEADING TABLE -->
		<div class="page-header">
			<h2>Production Support - Search Juvenile - Last Attorney Update</h2>
								...
								<table border="0" cellspacing='1' cellpadding="2" width="100%">
									...
									<tr>
										...
										<td class="formDe"><html:submit property="submitAction"
												onclick="return checkInputs();" styleId="findBtn">
