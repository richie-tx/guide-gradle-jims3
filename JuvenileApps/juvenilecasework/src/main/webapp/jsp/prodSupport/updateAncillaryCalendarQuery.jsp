...
<title>Juvenile Casework -/prodSupport/UpdateAncillaryCourtCalendarRecordQuery</title>
<link rel="stylesheet" type="text/css" href="/<msp:webapp/>css/casework.css" />
<!--JQUERY FRAMEWORK-->
<%@include file="../jQuery.fw"%>
<script type='text/javascript' src="/<msp:webapp/>js/prodSupport/updateAncillaryCourtCalendar.js"></script>
...
<body>
<h2 align="center">Production Support - Search Ancillary Court Calendar Data </h2>
<hr>

<p align="center">Please enter a Petition Number and a Court Date to view current Ancillary Court Calendar Data.</p>

	<div align="center">
	<html:form styleId="ancillaryCalendar" method="post" action="/UpdateAncillaryCalendarQuery">
	<table width="100%">
			<tr>
	...
	<table border="0" width="700">
		<tr>
			...
			<td align="right"><font face="" style="FONT-FAMILY: Arial"
				color="#0000aa"><strong> Petition Number:</strong></font></td>
			<td>
