...
<title>Juvenile Casework -/prodSupport/caseMergeSummary.jsp</title>
</head>
...
<h2 align="center">Merge Casefile Summary</h2>
<hr>

<p align="center"><font color="green"><b>Casefile number 
<bean:write name="ProdSupportForm" property="fromCasefile" /> was successfully merged with 
<bean:write name="ProdSupportForm" property="toCasefile" />.</b></font></p>
</html:form>


<p align="center"><b>The following is a list of records affected by this change. This is for auditing purposes.<br> 
If this merge was made in error, please provide this list to the JIMS Data Team to restore the data.</b></p>
<hr>
	...
	<tr>
		...
		<td bgcolor="gray"> <font color="white" face="bold" size="-1">Migrated?</font></td>
	</tr>
	...
	<tr>
		...
		<logic:equal name="assignments" property="wasMigrated" value="true">
		<td><font size="-1">Yes</font></td>
		</logic:equal>
		<logic:equal name="assignments" property="wasMigrated" value="false">
		<td><font size="-1">No, duplicate referral.</font></td>
		</logic:equal>
	</tr>
	</logic:iterate>
	...
	<logic:notEmpty name="ProdSupportForm" property="facilityDetentionList">
		...
		<p>&nbsp;</p>
		<h3 align="center">Associated Facility Admit/Release</h3>

		<table border="1" width="500" align="center">

			<tr>
				<td bgcolor="gray"><font color="white" face="bold" size="-1">JJS_DETENTION_ID</font>
				</td>
			</tr>
			<logic:iterate id="facilityDetentionList" name="ProdSupportForm" property="facilityDetentionList">
				<tr>
					<td><font size="-1"><bean:write name="facilityDetentionList" property="detentionId" />&nbsp;</font>
					</td>
				</tr>
			</logic:iterate>
		</table>
	...
	<table border="1" width="500" align="center">
		...
		<logic:notEmpty name="ProdSupportForm" property="headerInfo">
			<tr>
				<td bgcolor="gray"><font color="white" face="bold" size="-1">JJS_HEADER_ID</font>
				</td>
			</tr>
			<tr>
				<td><font size="-1"><bean:write name="ProdSupportForm" property="headerInfo.headerId" />&nbsp;</font>
				</td>
			</tr>
		</logic:notEmpty>
