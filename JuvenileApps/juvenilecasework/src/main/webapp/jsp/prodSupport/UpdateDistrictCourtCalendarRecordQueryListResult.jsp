...
<script type='text/javascript'
	src="/<msp:webapp/>js/prodSupport/UpdateDistrictCourtCalendar.js"></script>

</head>

<body>

	<html:form action="/UpdateDistrictCourtCalendarRecordQuery" onsubmit="return this;">
		<BR>		
		<div>
					...
					<table class="resultTbl" border="1" width="800" align="center">
						...
						<tr class="detailHead">
							...
							<td bgcolor="gray"><font color="white" face="bold" size="-1">Petition
									Allegation</font> <jims:sortResults beanName="ProdSupportForm"
									results="juvDistCourtRecords" primaryPropSort="allegation"
						...
						<logic:iterate id="juvDistCourtRecords" name="ProdSupportForm"
							...
							<pg:item>
								<tr>
									...
									<td><font size="-1"><bean:write
												name="juvDistCourtRecords" property="allegation" />&nbsp;</font></td>
	...
	<html:form action="/UpdateDistrictCourtCalendarRecordQuery?clr=Y"
