...
<title>Juvenile Casework -/prodSupport/updateCaleventQuery.jsp</title>
<%-- STYLE SHEET LINK --%>
...
<p align="center">Please enter a service event ID to find out what dependent data exists.</p>
	...
	<div align="center">
	<html:form styleId="updateCaleventForm" method="post" action="/UpdateCaleventQuery" onsubmit="return this;">
