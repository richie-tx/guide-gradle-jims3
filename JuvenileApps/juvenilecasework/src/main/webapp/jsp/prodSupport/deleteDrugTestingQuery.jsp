...
<script>
	$(document).ready(function(){
		$("#submitBtn").click(function(e){
			...
			if ( validateInput() ) {
				spinner();
				$("#deleteDrugTestingForm").submit();
			} else {
				alert("Juvenile Id or Drug Testing Id is required.");
			}
		})
...
<p align="center">Please enter a Juvenile ID or Drug Testing ID to view drug testing Data.</p>
	<div align="center">
	<html:form styleId="deleteDrugTestingForm" method="post" action="/DeleteDrugTestingQuery" onsubmit="return this;">
