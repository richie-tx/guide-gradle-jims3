...
<title>Juvenile Casework -/prodSupport/updateClosingQuery.jsp</title>
<%-- STYLE SHEET LINK --%>
...
<p align="center">Please enter a casefile ID to view current casefile data.</p>
	...
	<div align="center">
	<html:form styleId="UpdateClosingForm" method="post" action="/UpdateClosingQuery" onsubmit="return this;">
