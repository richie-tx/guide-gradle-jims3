...
<head>
<meta http-equiv="x-ua-compatible" content="IE=edge,chrome=1"/>
<title>Juvenile Casework -/prodSupport/DeleteEventsByInstructorQueryResult.jsp</title>
<%-- STYLE SHEET LINK --%>
<link rel="stylesheet" type="text/css" href="/<msp:webapp/>css/casework.css" />
<style>
	#container {
	...
	<div class="container">
		...
		<div>
			<p align="center"><b><i>Select the radio button next to the record <br>
				you want to update and click Next button.</i></b></p>	
		...
		<div class="command">
			<html:form method="post" styleId="PerformDeleteEventsByInstructor"
										action="/PerformDeleteEventsByInstructor">
