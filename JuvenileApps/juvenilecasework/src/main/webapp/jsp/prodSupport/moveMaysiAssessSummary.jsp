...
<title>Juvenile Casework -/prodSupport/moveMaysiAssessSummary.jsp</title>
</head>

<body>
	
<h2 align="center">Move MAYSI Assessment Summary</h2>
<hr>
...
<logic:iterate id="maysis" name="ProdSupportForm" property="maysis">
	...
	<logic:notEmpty name="ProdSupportForm" property="toJuvenileId">
		...
		<td>
		<font color="red"><i>Updated, previous value: </i><bean:write name="maysis" property="juvenileNum" /></font>
		</td>
		</logic:notEmpty>
