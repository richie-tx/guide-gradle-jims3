...
<head>
<meta http-equiv="x-ua-compatible" content="IE=edge,chrome=1"/>
<title>Juvenile Casework -/prodSupport/deletePetitionRecordQuery.jsp</title>
...
<body>
	<div id="container">
		<h2>Production Support - Search Petition Record for Delete</h2>
		<hr>
		...
		<div id="inputFields">
			<html:form method="post" styleId="viewDetailsForm"
									  action="/DeletePetitionRecordQuery" onsubmit="return this;">
				<div>
