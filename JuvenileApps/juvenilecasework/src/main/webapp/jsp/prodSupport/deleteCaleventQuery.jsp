...
<title>Juvenile Casework -/prodSupport/deleteCaleventQuery.jsp</title>
<%-- STYLE SHEET LINK --%>
...
<p align="center">Please enter a service event ID to find out what dependent data exists.</p>

	<div align="center">
	<html:form styleId="deleteCaleventForm" method="post" action="/DeleteCaleventQuery" onsubmit="return this;">
