...
<title>Juvenile Casework
	-/prodSupport/viewDetentionCourtDeleteQueryListResult</title>
...
<body>
	...
	<html:form action="/DeleteDetentionCourtRecordQuery" onsubmit="return this;">
		<BR>		
		<div>
	...
	<html:form action="/DeleteDetentionCourtRecordQuery?clr=Y"
