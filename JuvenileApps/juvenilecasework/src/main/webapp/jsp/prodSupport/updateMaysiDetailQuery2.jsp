...
<title>Juvenile Casework -/prodSupport/updateMaysiDetailQuery2.jsp</title>
...
{
	document.forms[0].maysidetailId.value = value;
	return true;
}
</script>
...
<h2 align="center">Production Support - Detail Query</h2>
<hr>

<p align="center">Select a detail from the list and click SUBMIT to view current data.</p>

<div align="center">
<html:form method="post" action="/UpdateMaysiDetailQuery?edit=Y" onsubmit="return this;">
...
<logic:notEmpty name="ProdSupportForm" property="maysidetails">
	...
	<tr>
		<td>
	 		<input type="radio" name="radioProp" value="<bean:write name="maysidetails" property="maysiDetailId"/>"
	 		onclick="fillId(<bean:write name="maysidetails" property="maysiDetailId"/>)">
	 		<bean:write name="maysidetails" property="maysiDetailId"/>
		</td>			
		...
		<td><font size="-1"><b><bean:write name="maysidetails" property="referralNumber" /></b>&nbsp;</font></td>
  ...
  <table border="0" width="700">
	<tr>
		...
		<td><html:text property="maysidetailId" size="10" maxlength="15" readonly="true"/>
	</tr>
	<tr>
		<td>&nbsp;</td>
...
<logic:empty name="ProdSupportForm" property="maysidetails">
	...
	<table border="0">
		<tr>
		<td align="center">
		<html:form method="post" action="/UpdateMaysiDetailQuery?clr=Y" onsubmit="return this;">
