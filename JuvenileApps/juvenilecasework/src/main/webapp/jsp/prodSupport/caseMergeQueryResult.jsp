...
<title>Juvenile Casework -/prodSupport/caseMergeQueryResult.jsp</title>
...
function confirmDelete(){
	if(confirm('Are you sure you want to merge the casefile and all its records?')){
		spinner();
		return true;	
	} else {
		return false;
...
<html:form action="/MergeDetailQuery" onsubmit="return this;">
...
<input type="hidden" name="tableId" value="" />
	...
	<h2 align="center">Results for CASEFILE_ID = 
			<bean:write name="ProdSupportForm" property="fromCasefile" /></h2>
	<br>
	<h4 align="center"><i>The following rows will be <font color="red">MERGED</font> from casefile 
	<bean:write name="ProdSupportForm" property="fromCasefile" /> into casefile 
	<bean:write name="ProdSupportForm" property="toCasefile" />.</i></h4>
...
<table width="100%" cellspacing="1">	
	...
	<tr>
	<td align="center">
	<font size="+1"><b>Associated Facility Admit/Release</b></font><br>
	  	...
	  	<logic:notEqual name="ProdSupportForm" property="facilityDetentionCount" value="0">	 
	    	 ...
	    	 Result(s) Returned</i>&nbsp;&nbsp;<br><br>
	    	<input type="submit" name="details" value="Details" onClick="setTableId('facility')"/>	  
	  	</logic:notEqual>
...
<tr>
<td>
<html:form action="/MergeCasefileQuery?clr=Y">
<p align="center">
...
<html:form action="/PerformCaseMerge">
<p align="center">
	<input type="submit" name="Merge Records" value="Merge Records" onClick="return confirmDelete();">
</p>
</html:form>
