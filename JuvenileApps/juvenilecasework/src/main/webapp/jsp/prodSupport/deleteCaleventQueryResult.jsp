...
<title>Juvenile Casework -/prodSupport/deleteCaleventQueryResult.jsp</title>
<%-- STYLE SHEET LINK --%>
...
function confirmDelete(){
	if(confirm('Are you sure you want to delete the event and all its records?')) {
		spinner();
		return true;	
	} else {
		return false;
...
<html:form action="/PerformDeleteCalevent" onsubmit="return this;">

<input type="hidden" name="tableId" value="" />
	
	<h2 align="center">Delete Calendar Event Query Results</h2>
	<br>
	<h4 align="center"><i>The following rows will also be <font color="red">DELETED</font> along with service event  
...
<logic:notEmpty	name="ProdSupportForm" property="servevents">
	<tr>
		<td>
		<p align="center">
			<input type="submit" value="Delete Record" onClick="return confirmDelete();">
		</p>
		</td>
	</tr>
</logic:notEmpty>
...
<table border="0" width="700">
	<tr>
	<td>
	<html:form action="/DeleteCaleventQuery?clr=Y">
		<p align="center">
