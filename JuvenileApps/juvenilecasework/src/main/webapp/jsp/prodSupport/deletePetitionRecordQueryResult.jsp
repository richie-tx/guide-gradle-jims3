...
<title>Juvenile Casework -/prodSupport/deletePetitionRecordQueryResult</title>

<link rel="stylesheet" type="text/css" href="/<msp:webapp/>css/casework.css" />	
<!--JQUERY FRAMEWORK-->
<%@include file="../jQuery.fw"%>
<script type='text/javascript' src="/<msp:webapp/>js/casework.js"></script>
<script type='text/javascript' src="/<msp:webapp/>js/prodSupport/deletePetitionDetails.js"></script>

</head>

<body>

<html:form action="/deletePetitionDetailsRecordQuery" onsubmit="return this;">
...
you want to delete and click the Submit button.</i></b></p>	     
	...
	<td>
	<p align="center">
	<html:submit property="submitAction" styleId="selectPetBtn">Submit</html:submit>
	</p>
	</td>
	</logic:notEmpty>
...
<html:form action="/DeletePetitionRecordQuery?clr=Y" onsubmit="return this;">
<table align="center"">
	<tr>
		<td>
