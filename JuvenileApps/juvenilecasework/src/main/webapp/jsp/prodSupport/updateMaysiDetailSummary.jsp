...
<title>Juvenile Casework -/prodSupport/updateMaysiDetailSummary.jsp</title>
</head>

<body>
	
<h2 align="center">Update MAYSI Detail Summary</h2>
<hr>
...
<logic:notEmpty name="ProdSupportForm" property="maysidetails">
	...
	<logic:notEmpty name="ProdSupportForm" property="newReferralNum">
		...
		<td><font color="red"><i>Updated, previous value: </i><bean:write  name="maysidetails" property="referralNumber" /></font></td>
	 </logic:notEmpty>
	  
	  <logic:empty name="ProdSupportForm" property="newReferralNum">
		<td bgcolor="gray"><font color="white" face="bold" size="-1">REFERRALNUMBER</font></td>
	...
	<table align="center" border="0" width="500">
		<tr>
			...
			<td colspan="1" align="left"><html:form
					action="/UpdateMaysiDetailQuery?clr=Y" onsubmit="return this;">
