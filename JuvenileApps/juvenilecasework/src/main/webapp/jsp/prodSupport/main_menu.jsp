...
<head>
	...
	function openMainPopupMenu(){	
		 ...
		 var url = webApp + "DisplayProductionSupportMainPopup.do";
		 var newWin = window.open(url, "pictureWindow", "height=1300,width=1050,toolbar=no,scrollbars=yes,resizable=yes,status=yes,dependent=no");
		 newWin.focus();
		return false;
	}
				...
				<div class="row">  
					<div class="panel-heading text-center">
						<html:form method="post" action="/DisplayProductionSupportMainPopup.do">
							<html:submit styleId="popupButton" value="Open Production Support Screen" onclick="return openMainPopupMenu()"/>
						</html:form>
					</div>
				</div>
			</div> 
