...
<title>Juvenile Casework -/prodSupport/caseDeleteClosingQuery.jsp</title>
<%-- STYLE SHEET LINK --%>
...
<p align="center">Please enter a casefile ID to find out what dependent data exists.</p>
	...
	<div align="center">
	<html:form styleId="CaseDeleteClosingForm" method="post" action="/CaseDeleteClosingQuery" onsubmit="return this;">
