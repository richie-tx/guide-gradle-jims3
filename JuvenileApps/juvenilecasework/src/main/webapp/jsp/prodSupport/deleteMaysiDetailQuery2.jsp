...
<title>Juvenile Casework -/prodSupport/deleteMaysiDetailQuery2.jsp</title>
...
<h2 align="center">Production Support - MAYSI Detail Query</h2>
<hr>

<p align="center">Select a record from the list and click SUBMIT to view current data.<br/> 
	No records will be deleted until confirmed on the next page.</p>

	<div align="center">
	<html:form method="post" action="/DeleteMaysiDetailQuery?edit=Y" onsubmit="return this;">
...
<logic:empty name="ProdSupportForm" property="maysidetails">
	...
	<table border="0">
		<tr>
		<td align="center">
		<html:form method="post" action="/DeleteMaysiDetailQuery?clr=Y" onsubmit="return this;">
