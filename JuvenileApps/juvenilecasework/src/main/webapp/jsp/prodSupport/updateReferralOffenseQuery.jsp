...
<title>Juvenile Casework -/prodSupport/updateReferralOffenseQuery</title>
<!--JQUERY FRAMEWORK-->
...
<body>
<h2 align="center">Production Support - Search Referral Offense Record </h2>
<hr>

<p align="center">Please enter a Juvenile ID and Referral Number to view current referral offense data.</p>

	<div align="center">
	<html:form method="post" action="/UpdateReferralOffenseRecordQuery" onsubmit="return this;">
