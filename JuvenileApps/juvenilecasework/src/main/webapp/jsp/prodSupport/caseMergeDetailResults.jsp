...
<title>Juvenile Casework -/prodSupport/caseMergeDetailResults.jsp</title>
...
<html:form action="/MergeCasefileQuery" onsubmit="return this;">
...
<span id="assignhist" class="hidden">
	...
	<tr>
		...
		<td bgcolor="gray"><font color="white" face="bold" size="-1">FUNDSOURCE</font></td>
	...
	<tr>
		...
		<td><font size="-1"><bean:write  name="juvprogrefs" property="sentDate" />&nbsp;</font></td>
	...
	<tr>
		...
		<td><font size="-1"><bean:write  name="progrfasgnhists" property="createDate" formatKey="date.format.mmddyyyy" formatKey="date.format.mmddyyyy" />&nbsp;</font></td>
		<td><font size="-1"><bean:write  name="progrfasgnhists" property="updateUser" />&nbsp;</font></td>
		<td><font size="-1"><bean:write  name="progrfasgnhists" property="updateDate" />&nbsp;</font></td>
	...
	<p>&nbsp;</p>
	<h3 align="left">Associated Facility Admit/Release</h3>
	...
	<tr>
		<td><font size="-1"><bean:write  name="facilityDetention" property="detentionId" />&nbsp;</font></td>
		...
		<td><font size="-1"><bean:write  name="facilityDetention" property="referralNumber" />&nbsp;</font></td>
	</tr>
	</logic:iterate>
	...
	<logic:notEmpty	name="ProdSupportForm" property="headerInfo">
			
	<p>&nbsp;</p>
	<h3 align="left">Associated Facility Admit/Release</h3>
	</logic:notEmpty>
	</logic:empty> <!--This Extra empty tag check is to avoid the header disply twice when data is coming from both the tables  -->
	...
	<tr>
		<td><font size="-1"><bean:write  name="ProdSupportForm" property="headerInfo.headerId" />&nbsp;</font></td>
		<td><font size="-1"><bean:write  name="ProdSupportForm" property="headerInfo.bookingSupervision" />&nbsp;</font></td>
		<td><font size="-1"><bean:write  name="ProdSupportForm" property="headerInfo.referralNo" />&nbsp;</font></td>
	</tr>
