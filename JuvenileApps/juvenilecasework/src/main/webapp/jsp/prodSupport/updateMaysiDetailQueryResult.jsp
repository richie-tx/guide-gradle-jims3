...
<title>Juvenile Casework -/prodSupport/updateMaysiDetailQueryResult.jsp</title>
...
<div>
	<html:form action="/PerformUpdateMaysiDetail" onsubmit="return this;">

		<h3 align="center">
			MAYSI Detail Results
		</h3>
...
<logic:notEmpty name="ProdSupportForm" property="maysidetails">
	...
	<tr>
		...
		<td>New Value:&nbsp;<html:text property="newReferralNum" size="10" maxlength="15" /></td>
...
<table align="center"">
	...
	<tr>
		<logic:notEmpty name="ProdSupportForm" property="maysidetails">
		<td><input type="submit" name="Update Record" value="Update Record" onClick="return confirmUpdate();" />
						</td>
		</logic:notEmpty>
	</tr>
</table>
	...
	<table align="center">
		...
		<tr>
			<td>
			<p align="center">
			<html:form action="/UpdateMaysiDetailQuery?clr=Y" onsubmit="return this;">
