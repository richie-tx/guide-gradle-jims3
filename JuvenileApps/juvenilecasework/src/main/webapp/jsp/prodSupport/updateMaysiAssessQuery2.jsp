...
<title>Juvenile Casework -/prodSupport/updateMaysiAssessQuery2.jsp</title>
...
<p align="center">Select an assignment from the list and click SUBMIT to view current data.</p>

	<div align="center">
	<html:form method="post" action="/UpdateMaysiAssessQuery?edit=Y" onsubmit="return this;">
...
<table border="0" width="700">
	...
	<table border="0">
		<tr>
		<td align="center">
		<html:form method="post" action="/UpdateMaysiAssessQuery?clr=Y" onsubmit="return this;">
