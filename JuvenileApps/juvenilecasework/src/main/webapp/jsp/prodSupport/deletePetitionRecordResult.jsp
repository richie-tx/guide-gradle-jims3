...
<title>Juvenile Casework
	-/prodSupport/deletePetitionRecordResult.jsp</title>
...
<body>
	...
	<p align="center"><b><i>For Petition Record Deletion click Delete Petition</i></b></p>
	...
	<div id="command">
		<div>
			<html:form method="post" styleId="viewDetailsForm"
				action="/deletePetitionDetailsRecordQuery">
				<input id="submitBtn" type="button" value="Delete Petition" />

				<html:hidden styleId="newCharge" name="ProdSupportForm"
					property="assignmentId" />
				<html:hidden styleId="petitionOid" name="ProdSupportForm"
					property="OID" />
				<html:hidden styleId="updateSeq" name="ProdSupportForm"
					property="hiddenForward" />
				<html:hidden styleId="referralDt" name="ProdSupportForm"
					property="referralDate" />
				<html:hidden styleId='petitionDt' name='ProdSupportForm'
					property='newPetitionDate' />
				<html:hidden styleId='petitionAmend' name='ProdSupportForm'
					property='petitionAmended' />
				<html:hidden styleId='petitionNum' name='ProdSupportForm'
					property='petitionNum' />
				<html:hidden styleId='petitionType' name='ProdSupportForm'
					property='petitionType' />
				<html:hidden styleId='referralId' name='ProdSupportForm'
					property='newReferralNum' />
				<html:hidden styleId='petitionStat' name='ProdSupportForm'
					property='petitionStatus' />
				<html:hidden styleId='petitionSeq' name='ProdSupportForm'
