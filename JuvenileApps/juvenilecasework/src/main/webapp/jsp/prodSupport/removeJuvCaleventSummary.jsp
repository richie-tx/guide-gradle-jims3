...
<title>Juvenile Casework -/prodSupport/removeJuvCaleventSummary.jsp</title>
</head>

<body>
	
<html:form method="post" action="/RemoveJuvCaleventQuery" onsubmit="return this;">

<h2 align="center">Remove Juvenile from Calendar Event Summary</h2>
<hr>

<p align="center"><font color="green"><b>Juvenile # <bean:write name="ProdSupportForm" property="juvenileId" /> has been removed from Service Event ID
	<bean:write name="ProdSupportForm" property="serveventId" /></b></font></p>
</html:form>
...
<table align="center" border="0" width="500">
	...
	<html:form method="post" action="/RemoveJuvCaleventQuery.do?clr=Y" onsubmit="return this;">
	<html:submit onclick="return this;" value="Remove another Youth from Event"/>
	</html:form>
	</td>
	</tr>
</table>
