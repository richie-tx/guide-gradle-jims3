...
<title>Juvenile Casework -/prodSupport/DeleteDistrictCourtCalendarRecordQuery</title>
...
<body>
<h2 align="center">Production Support - Search District Court Calendar Data for Delete</h2>
<hr>

<p align="center">Please enter a Juvenile Number to view current District Court Calendar Data.</p>

	<div align="center">
	<html:form method="post" action="/DeleteDistrictCourtCalendarRecordQuery" onsubmit="return this;">
	<table width="100%">
			<tr>
