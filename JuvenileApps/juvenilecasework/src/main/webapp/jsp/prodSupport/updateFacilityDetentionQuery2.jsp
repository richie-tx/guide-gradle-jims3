...
<title>Juvenile Casework -/prodSupport/updateFacilityDetentionQuery2.jsp</title>
...
<h2 align="center">Production Support - Facilities Detention Details Query</h2>
<hr>

<p align="center">Select a detail from the list and click SUBMIT to view current data.</p>

<div align="center">
<html:form method="post" action="/UpdateFacilityDetentionQuery?edit=Y" onsubmit="return this;">
...
<logic:empty name="ProdSupportForm" property="facilityDetentionList">
	...
	<table border="0">
		<tr>
		<td align="center">
		<html:form method="post" action="/UpdateFacilityDetentionQuery?clr=Y" onsubmit="return this;">
