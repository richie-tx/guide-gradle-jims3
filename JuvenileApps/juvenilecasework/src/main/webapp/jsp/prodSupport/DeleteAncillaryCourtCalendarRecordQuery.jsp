...
<title>Juvenile Casework -/prodSupport/DeleteAncillaryCourtCalendarRecordQuery</title>
...
<body>
<h2 align="center">Production Support - Search Ancillary Court Calendar Data (Delete) </h2>
<hr>

<p align="center">Please enter a Petition Number to view current Ancillary Court Calendar Data.</p>

	<div align="center">
	<html:form method="post" action="/DeleteAncillaryCourtCalendarRecordQuery" onsubmit="return this;">
	<table width="100%">
			<tr>
				<td align="center" id="error-alert" class="errorAlert"><font color="red"><html:errors></html:errors></font>				
				</td>
			</tr>
			<tr>
		<td>&nbsp;</td>
	...
	<table border="0" width="700">
		<tr>
			...
			<td align="right"><font face="" style="FONT-FAMILY: Arial"
				color="#0000aa"><strong> Petition Number:</strong></font><font color="red">*</font></td>
			<td>
				<html:text property="petitionNum" styleId='petitionNum' size="11" maxlength="11" />
			</td>
		</tr>
		<tr>
			<td align="right"><font face="" style="FONT-FAMILY: Arial"
