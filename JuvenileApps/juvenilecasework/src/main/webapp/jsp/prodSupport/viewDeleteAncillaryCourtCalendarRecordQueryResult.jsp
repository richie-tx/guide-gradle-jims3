...
<title>Juvenile Casework
	-/prodSupport/UpdateDistrictCourtCalendarRecordQueryListResult</title>
...
<body>
	...
	<html:form action="/DeleteAncillaryCourtCalendarRecordQuery" onsubmit="return this;">
		<BR>		
		<div>

			<h2 align="center">
				Results for Deleting Petition Number
			...
			<table class="resultTbl" border="1" width="750" align="center">
				...
				<tr>
					<td bgcolor="gray"><font color="white" face="bold" size="-1">Respondent
							Name</font></td>
					<td><font size="-1"><bean:write name="ProdSupportForm"
								property="respondentName" />&nbsp;</font> <elogic:if
			...
			<p align="center">
				...
				<pg:pager index="center"
					...
					<table class="resultTbl" border="1" width="800" align="center">
						...
						<logic:iterate id="ancillaryCalendarRecords" name="ProdSupportForm"
							property="ancillaryCalendarRecords">
							<pg:item>
								<tr>
									<td width="1%"><input type="radio" name="docketEventId"
										value="<bean:write name='ancillaryCalendarRecords' property='docketEventId'/>" />
										<input type="hidden" id="docketId">
									</td>
									<td><font size="-1"><bean:write
												name="ancillaryCalendarRecords" property="court" />&nbsp;</font></td>
									<td><font size="-1"><bean:write
												name="ancillaryCalendarRecords" property="courtDate"
												formatKey="date.format.mmddyyyy" />&nbsp;</font>
									</td>
									<td><font size="-1"><bean:write
												name="ancillaryCalendarRecords" property="chainNumber" />&nbsp;</font>
									</td>
									<td><font size="-1"><bean:write
												name="ancillaryCalendarRecords" property="seqNum" />&nbsp;</font></td>
								</tr>
							</pg:item>
						</logic:iterate>
	...
	<html:form action="/DeleteAncillaryCourtCalendarRecordQuery?clr=Y"
