...
<title>Juvenile Casework
	-/prodSupport/UpdateDetentionCourtCalendarRecordSummary</title>
	...
	<html:form action="/PerformUpdateDetentionCourtRecord"
		...
		<div>
			...
			<table border="1" width="750" align="center">
				...
				<tr>
					<td bgcolor="gray"><font color="white" face="bold" size="-1">Juvenile Record
							Type</font></td>
			...
			<p align="center"><b><i><font style="font-weight: bold;"
							color="green" size="3" face="Arial">Juvenile record has been updated.</font></i></b></p>
					...
					<table border="1" width="800" align="center">
						...
						<tr>
							...
							<html:hidden styleId='oldJuvenileNum' name='juvDetCourtRecords'
								property='juvenileNumber' indexed="true" />
						</tr>
						<tr>
							<td bgcolor="gray"><font color="white" face="bold" size="-1">Juvenile
									Detention ID</font>
							...
							<td>
									...
									<font size="-1"><bean:write
										name="juvDetCourtRecords" property="detentionId" />&nbsp;</font>
							</td>
							
							<html:hidden styleId='olddetentionId' name='juvDetCourtRecords'
								property='detentionId' indexed="true" />
						</tr>
						<tr>
							...
							<td><font size="-1"><bean:write
										name="juvDetCourtRecords" property="court" />&nbsp;</font>
							</td>
						</tr>
						<tr>
							<td bgcolor="gray">
						...
						<tr>
							...
							<td><font size="-1"><bean:write
										name="juvDetCourtRecords" property="barNum" />&nbsp;</font>
							</td>							
						</tr>
						<tr>
						...
						<tr>
							...
							<td><font size="-1"><bean:write
										name="juvDetCourtRecords" property="attorneyName" />&nbsp;</font>
							</td>							
						</tr>
						<tr>
							...
							<td><font size="-1"><bean:write
										...
										formatKey="date.format.mmddyyyy" />&nbsp;</font>
							</td>
						...
						<tr>
							<td bgcolor="gray"><font color="white" face="bold" size="-1">Hearing
									Decision Result</font>
							</td>
							<td><font size="-1"><bean:write
										name="juvDetCourtRecords" property="courtResult" />&nbsp;</font>
							</td>							
						</tr>
						<tr>
							<td bgcolor="gray"><font color="white" face="bold" size="-1">Hearing
							...
							<td><font size="-1"><bean:write
										name="juvDetCourtRecords" property="hearingType" />&nbsp;</font>
							</td>							
						</tr>						
						<tr>
							...
							<html:hidden styleId='oldReferralNum' name='juvDetCourtRecords'
								property='referralNum' indexed="true" />
						...
						<tr>
							...
							<html:hidden styleId='oldJuvNum' name='juvDetCourtRecords'
								property='seqNum' indexed="true" />
						...
						<tr>
							...
							<td><font size="-1"><bean:write
										...
										name="juvDetCourtRecords" property="lcTime" />&nbsp;</font></td>
						...
						<tr>
							...
							<td><font size="-1"><bean:write
										name="juvDetCourtRecords" property="lcUser" />&nbsp;</font>
							</td>
...
<table align="center" border="0" width="500">
		...
		<tr>
			<td colspan="2" align="center">
				<html:form method="post" action="/UpdateDetentionCourtRecordQuery" onsubmit="return this;">
					<input type="submit" value="Back to Query Results" />
				</html:form>
			</td>
		</tr>
		</logic:greaterThan>
