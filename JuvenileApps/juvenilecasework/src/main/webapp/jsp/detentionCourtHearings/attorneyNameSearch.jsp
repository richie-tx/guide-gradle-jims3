...
<html:form action="/handleJuvenileSearchDetentionHearings"  target="content" focus="attorneyName">
<!-- BEGIN HEADING TABLE -->
...
<%-- BEGIN SEARCH INPUT TABLE --%>					
						<table border="0" cellspacing='1' cellpadding="2" width="100%">
							...
							<tr>
								...
								<td class="formDe"><html:text name='detentionHearingForm' property='attorneyName' size="30" maxlength="50" styleId="attorneyName"/></td>
							</tr>
...
<%-- END SEARCH INPUT TABLE --%>
						...
						<logic:notEmpty name="detentionHearingForm" property="attorneyDataList">
<%-- BEGIN SEARCH RESULTS TABLE --%>						
							<table border="0" cellspacing='1' cellpadding="2" width="100%">
								<tr>
									<td align="center" style="padding:2px" colspan="2"><br>
										<bean:size id="collSize" name="detentionHearingForm" property="attorneyDataList"/>
...
<%-- BEGIN SEARCH RESULTS LIST TABLE --%>									
										<table border="0" width="100%" cellspacing="1" cellpadding="2">				
											<tr bgcolor="#cccccc">
												<td width="1%"></td>
												<td class="subhead"><bean:message key="prompt.barNumber" /><jims2:sortResults beanName="detentionHearingForm" results="attorneyDataList" primaryPropSort="barNum" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="1" /></td>
												<td class="subhead"><bean:message key="prompt.attorneyName" /><jims2:sortResults beanName="detentionHearingForm" results="attorneyDataList" primaryPropSort="attyName" primarySortType="STRING" defaultSortOrder="ASC" sortId="2" /></td>
											</tr>
					                        ...
					                        <bean:define id="paginationResultsPerPage" type="java.lang.String"><bean:message key="pagination.recordsPerPage"/></bean:define>
					                         ...
					                         <%-- End Pagination header stuff --%>
			  								<logic:iterate id="offIndex" name="detentionHearingForm" property="attorneyDataList" indexId="index">
                              					...
                              					<pg:item>
													...
													<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>" height="100%">
														<td align="center">																																		
															<html:radio name="detentionHearingForm" property="selectedValue" value='<%=offId%>' onclick="enableSelectButton();" />
														</td>
