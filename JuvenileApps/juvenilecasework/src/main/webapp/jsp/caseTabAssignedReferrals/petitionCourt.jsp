...
<table width='100%'>
  <tr>
    <td align="center" class="header" ><bean:message key="title.juvenileCasework"/>&nbsp;-&nbsp;<bean:message key="prompt.court"/>
      		  	...
      		  	<tr>
      		    	<td valign=top>
                        ...
                        <table border="0" cellpadding=1 cellspacing=1 align=center>
                          <tr>
                            <td align="center">
                              <html:form action="/displayJuvenileCasefileAssignedReferralsList.do?submitAction=Referrals">
