...
<table width='100%'>
  <tr>
    <td align="center" class="header">Juvenile Casework - Assigned Referral Property Loss Details</td>
  </tr>
</table>
<!-- END HEADING TABLE -->
				...
				<tr>
  				<td>
  					<table cellpadding=2 cellspacing=1 width='100%'>
  						<tr bgcolor='#cccccc'>
  							<td class=subHead><bean:message key="prompt.itemDescription"/></td>
  							<td class=subHead>Amount</td>
  					  </tr>

							<logic:iterate id="resultsIndex" name="petitionDetailsForm" property="propertyLosses" indexId="index">
