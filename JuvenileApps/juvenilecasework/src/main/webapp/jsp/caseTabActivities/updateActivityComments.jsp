            						...
            						<tr>
            							<td valign=top align=center>
            								<table width='100%' border="0" cellpadding="4" cellspacing="1" >
            									...
            									<tr><td colspan=4>
														<html:textarea styleId= "updateComments" rows="4" style="width:100%" name="activitiesForm" property="updateComments" onmouseout="textCounter(this,8000)" onkeyup="textCounter(this,8000)"></html:textarea>
													</td></tr>
            								</table>
