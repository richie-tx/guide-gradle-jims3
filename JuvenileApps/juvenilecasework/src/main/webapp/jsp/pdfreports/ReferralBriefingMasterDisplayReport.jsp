...
<pdf onload="pdf:130">
<head>
	<meta name="title" value="<%=PDFReport.REFERRAL_BRIEFING_MASTER_DISPLAY_REPORT.getReportName()%>"/>
	<meta name="author" value="JIMS2, Harris County"/>
	<meta name="subject" value="<%=PDFReport.REFERRAL_BRIEFING_MASTER_DISPLAY_REPORT.getReportName()%>"/>
...
<table width="100%" border-style="none">
		<tr>
			<td align="center" colspan="2" font-size="20"><b>HCJPD Juvenile Details Report -- Confidential</b></td>
		</tr>
</table>
</div>
<br></br>
