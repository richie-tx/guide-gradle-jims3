...
<div class="body" page-break-before="avoid">
	<p class="arial-font-10" align="left" padding-top="0" padding-bottom="0">
		...
		${reportInfo.guardianAddress.streetAddress}<br/>
   		...
   		<p>
  		${reportInfo.juvenile.fullNameFirst}, esta carta es para reconocer que usted ha completado su período de supervisión de
		libertad condicional o adjudicación diferida asignada bajo la supervisión del Departamento de Libertad Condicional de 
		Menores del condado de Harris. El expediente de su caso con Libertad Condicional de Menores del condado de Harris está cerrado.
	  	</p>
	  	<p>
  		En general, los registros del tribunal de menores son confidenciales; sin embargo, esta norma no se aplica a todos ni 
  		a todas las situaciones Tenga en cuenta que, si un menor ha estado involucrado con la policía, se genera un registro 
  		...
  		explican la confidencialidad de los registros del tribunal de menores y a quiénes se aplica. El Subcapítulo C-1, 
  		Capítulo 58 del Código de Familia de Texas también proporciona los procedimientos para el Sellado de los registros 
  		de menores.
	  	</p>
	  	<p>
		...
		<p>
  		<b>•		Para sellar expedientes por delitos graves y menores:</b> Proyecto de Justicia Juvenil del Instituto Earl Carl. 
  					Visite el sitio web y llene el formulario de información en <a>www.tsulaw.edu/centers/ECI/juvenile_justice_program</a>  o llame al (713) 313-1130.
		</p>
		<p>
		<b>•		Para sellar expedientes por delitos graves y menores:</b> Facultad de Derecho de University of Houston: clínica de sellado y expurgo de expedientes.
					Visite <a href="https://www.law.uh.edu/clinic/rse.asp">records Sealing and Expunction Clinic - University of Houston Law Center (uh.edu)</a> o llame al 713-743-2094 para obtener más información.
		</p>
		<p>
