				...
				<table width="100%">
				 <tr>
				 	<td class="arial-8" align="left"  width="100%" style="margin-left: 10%; color: #a0a3a1">
						Statutes current as of September 1, 2021
					</td>
...
<div class="body" page-break-before="avoid">
  	...
  	<p class="times-font-10" align="justify" padding-top="0" padding-bottom="0">
  		Anyone referred to juvenile court for conduct that happened while age 10-16 (before 17) has a juvenile record, even if not taken into custody by police. 
  		Referrals are for delinquent conduct (Class A or B misdemeanor or felony offenses) or conduct indicating a need for supervision (CINS) 
  		(e.g. Class C misdemeanors, running away, "sexting"). Juvenile records exist with probation, law enforcement, prosecutors, courts, and in the 
  		Juvenile Justice Information System (JJIS) computer database maintained by the Texas Department of Public Safety.
	</p>
  	<p class="arial-font-10" color="DodgerBlue" align="left" padding-top="0" padding-bottom="0" font-weight="bold">
  		Who can access juvenile records?
  	</p> 
	<p class="times-font-10" align="justify" padding-top="0" padding-bottom="0">
	  	Juvenile records are confidential. The law says who can access them. This includes entities that need access for community safety or to provide services to juveniles. 
	  	DPS may share the records in JJIS only with: criminal and juvenile justice agencies; TJJD and the Ombudsman for TJJD; courts having jurisdiction over juveniles; 
	  	the Department of Family and Protective Services for certain background checks; the military (only with the juvenile's permission); 
	  	and noncriminal justice agencies if allowed by federal law or executive order. Law enforcement, probation, prosecutors, 
	  	and courts are also limited in how they may share records. Once records are sealed, no one may access them.
	</p>
	<p class="arial-font-10" color="DodgerBlue" align="left" padding-top="0" padding-bottom="0" font-weight="bold">
  		How do I get my records sealed?
	</p>
	<p class="times-font-10" align="justify" padding-top="0" padding-bottom="0">
		If the only reason you were referred to juvenile court was for CINS and there are court records, 
		your records will be sealed when you turn 18 if you do not have an adult felony conviction or pending adult charges. 
		If you were referred to juvenile court for delinquent conduct (felony or misdemeanor) but were never adjudicated (i.e. "found guilty") or 
		you were adjudicated for a misdemeanor but not a felony, your records will be sealed when you turn 19 if you do not have an adult conviction for a felony or 
		jailable misdemeanor and do not have pending adult or juvenile charges. You do not have to apply to the court for this type of sealing.  
	</p>
	<p class="times-font-10" align="justify" padding-top="0" padding-bottom="0">
		If you were adjudicated for a felony or you do not meet the criteria for sealing above, you may file an application asking the court to seal your records. 
		You do not need an attorney to do this, but you may choose to hire one. You are allowed to file this application if you are 17 and have been discharged from 
		probation or the case against you is closed. If you are under 17, you may file if it has been at least a year since you were discharged from probation or 
		the case was closed. The court can only seal your records if you do not have any adult felony convictions or any pending adult charges, 
		are not currently required to register as a sex offender, and are not currently committed to TJJD. The court may choose to seal your records without a hearing or 
		may hold a hearing to decide whether or not to seal the records. The court cannot deny your application for sealing without first having a hearing. 
		You should contact the probation department that provided services for information on the sealing process there. 
	</p>
  	<p class="arial-font-10" color="DodgerBlue" align="left" padding-top="0" padding-bottom="0" font-weight="bold">
	  	Are there any records that can’t be sealed?
	</p>
	<p class="times-font-10" align="justify" padding-top="0" padding-bottom="0">
		Your records cannot be sealed if you were certified to stand trial as an adult or were given a determinate sentence (probation or TJJD commitment). 
		If required to register as a sex offender, your records cannot be sealed until your requirement to register has expired. If committed to TJJD without a
		determinate sentence, your records cannot be sealed until you have been discharged from TJJD. Records in a JP or municipal court (Class C misdemeanors) 
		cannot be sealed because they are not juvenile records. Records in the gang database cannot be sealed, though they can be removed in certain circumstances. 
		Only criminal justice agencies can access them and only for criminal justice purposes.
	</p>
	<!--  
	<p class="times-font-10" align="justify" padding-top="0" padding-bottom="0">
...
<div class="body">
	...
	<p class="times-font-10" align="justify" padding-top="0" padding-bottom="0">
	  	When records are sealed, it means that all records showing you were referred to juvenile court are stored in a way that they cannot be seen anymore. 
	  	Any adjudications are removed and it is treated like you were never even taken into custody or referred to juvenile court. 
	  	The law says that you are not required to state in any proceeding or in any application for employment, licensing, admission, housing, 
	  	or other public or private benefit that the records ever existed or that you were ever arrested, prosecuted, or adjudicated.
	</p>
	<p class="times-font-10" align="justify" padding-top="0" padding-bottom="0">
	  	Additionally, the law states that once records are sealed, the information in the records, the fact that they once existed, 
	  	or your denial of the existence of the records may not be used against you in any manner. This includes a perjury prosecution or other criminal proceeding, 
	  	a civil proceeding, including an administrative proceeding involving a governmental entity, an application process for licensing or certification, 
	  	or an admission, employment, or housing decision. So even if someone finds out you once had juvenile records, that cannot be used against you.
	</p>
	<p class="arial-font-10" color="DodgerBlue" align="left" padding-top="0" padding-bottom="0" font-weight="bold">
		Can sealed records be reopened? 
	</p>
	<p class="times-font-10" align="justify" padding-top="0" padding-bottom="0">
	  	A court can open sealed records if you ask them to. The court can also reopen the records if a prosecutor asks them to for limited purposes, 
	  	including a future prosecution for a capital offense or a future prosecution for an offense for which punishment can be enhanced based on your juvenile record. 
	  	Re-opening a sealed record does not mean that the record is "unsealed." The protections that come with sealing a record remain in place, 
	  	but the documents can be used for the specified reasons.
	</p>
	<p class="arial-font-10" color="DodgerBlue" align="left" padding-top="0" padding-bottom="0" font-weight="bold">
		What about records in a justice or municipal court? 
	</p>
	<p class="times-font-10" align="justify" padding-top="0" padding-bottom="0">
	  	For those of juvenile age, Class C misdemeanors in justice or municipal court are confidential and may not be disclosed to the public. If you have only one conviction prior to your 17<sup>th</sup> birthday, you may be able to have certain offenses "expunged" or removed from your record.
	</p>
	<p class="arial-font-10" color="DodgerBlue" align="left" padding-top="0" padding-bottom="0" font-weight="bold">
		Where can I get additional information? 
	</p>
	<p class="times-font-10_italic" align="center" padding-top="0" padding-bottom="0">
		Texas Family Code Chapter 58 and Code of Criminal Procedure Article 45. You can access Texas laws online at: www.statutes.legis.state.tx.us
	</p>
...
<div class="body">
	...
	<table width="100%" border-style="none">
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(1) records relating to a criminal combination or criminal street gang maintained by the Department of Public Safety or a local law enforcement agency under Chapter 61, Code of Criminal Procedure;</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(2) sex offender registration records maintained by the Department of Public Safety or a local law enforcement agency under Chapter 62, Code of Criminal Procedure; and</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(3) records collected or maintained by the Texas Juvenile Justice Department for statistical and research purposes, including data submitted under Section 221.007, Human Resources Code, and personally identifiable information.</p></td>
		</tr>
		<tr align="center">
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(a) This section does not apply to the records of a child referred to a juvenile court or juvenile probation department solely for conduct indicating a need for supervision.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			...
			to have all records related to the person's juvenile matters, including records relating to any matters involving conduct indicating a need for supervision, sealed without applying to the juvenile court if the person:</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(2)	has not been adjudicated as having engaged in delinquent conduct or, if adjudicated for delinquent conduct, was not adjudicated for delinquent conduct violating a penal law of the grade of felony;</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(5) has not as an adult been convicted of a felony or a misdemeanor punishable by confinement in jail; and	</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(6) does not have any pending charges as an adult for a felony or a misdemeanor punishable by confinement in jail.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(a) The Department of Public Safety shall certify to a juvenile probation department that has submitted	records to the juvenile justice information system that the records relating to a person referred to the juvenile probation department appear to be eligible for sealing under Section 58.253.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(b) The Department of Public Safety may issue the certification described by Subsection (a) by electronic means, including by electronic mail.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(c) Except as provided by Subsection (d), not later than the 60th day after the date the juvenile probation department receives a certification under Subsection (a), the juvenile probation department shall:</p></td>
		</tr>
	</table>
</div>
<!--  Page 4 -->
<div class="body">
	<table width="100%" border-style="none">
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(2) provide the court with a list of all referrals received by the department relating to that person and the outcome of each referral.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(a) A person who was referred to a juvenile court for conduct indicating a need for supervision 
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(1)	has records relating to the conduct filed with the court clerk;</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(2) is at least 18 years of age;</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(3) has not been referred to the juvenile probation department for delinquent conduct;</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(5) does not have any pending charges as an adult for a felony or a misdemeanor punishable by confinement in jail.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(1) give the juvenile court notice that a person's records are eligible for sealing under Subsection (a); and</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(2) provide the juvenile court with a list of all referrals relating to that person received by the department and the outcome of each referral.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(c) Not later than the 60th day after the date the juvenile court receives notice from the juvenile probation department under Subsection (b), the juvenile court shall issue an order sealing all records relating to the person named in the notice.</p></td>
		</tr>
				<tr align="center">
			<td colspan="4"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">Sec. 58.2551. SEALING RECORDS WITHOUT APPLICATION: FINDING OF NOT TRUE.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">A juvenile court, on the court’s own motion and without a hearing, 
			shall immediately order the sealing of all records related to the alleged conduct if the court enters a finding that the allegations are not true.
		</p></td>
		</tr>		
	</table>
</div>
...
<div class="body">
	<table width="100%" border-style="none">
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(a) Notwithstanding Sections 58.253 and 58.255, a person may file an 
			application for the sealing of records related to the person in the juvenile court served by the juvenile probation department to which the person was referred. 
			The court may not charge a fee for filing the application, regardless of the form of the application.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(a-1) An application filed under this section may be sent to the juvenile court by any reasonable method authorized under Rule 21, Texas Rules of Civil Procedure, including secure electronic means.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(b) An application filed under this section must include either the following information or the reason that one or more of the following is not included in the application:</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(2) the conduct for which the person was referred to the juvenile probation department, including the date on which the conduct was alleged or found to have been committed;</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(3) the cause number assigned to each petition relating to the person filed in juvenile court, if any, and the court in which the petition was filed; and</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(4) a list of all entities the person believes have possession of records related to the person, including the applicable entities listed under Section 58.258(b).</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(c) Except as provided by Subsection (d), the juvenile court may order the sealing of records related to all matters for which the person was referred to the juvenile probation department if the person:</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(1)	is at least 17 years of age, or is younger than 17 years of age and at least one year has elapsed after the date of final discharge in each matter for which the person was referred to the juvenile probation department;</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(2) does not have any delinquent conduct matters pending with any juvenile probation department or juvenile court;</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
...
<div class="body">
	<table width="100%" border-style="none">
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(2) hold a hearing under Section 58.257 at the court's discretion to determine whether to order the sealing of the person's records.</p></td>
		</tr>
		<tr align="center">
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(4) all entities named in the application that the person believes possess eligible records related to the person; and</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(5) a list of the entities believed to be in possession of the records that have been ordered sealed, including the entities listed under Subsection (b).</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(b) Not later than the 60th day after the date of the entry of the order, the court shall provide a copy of the order to:</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
...
<div class="body">
	<table width="100%" border-style="none">
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(2)	send copies of the order to all entities listed in the order by any reasonable method, including certified mail or secure electronic means.</p></td>
		</tr>
		<tr align="center">
		...
		<tr align="center">
			...
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td align="left" width="70%"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(A) limit access to the records relating to the person in the juvenile justice information system to only the Texas Juvenile Justice Department for the purpose of conducting research and statistical studies;</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td align="left" width="70%"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(B) destroy any other records relating to the person in the department's possession, including DNA records as provided by Section 411.151, Government Code; and</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
...
<div class="body">
	<table width="100%" border-style="none">
		...
		<tr align="center">
			<td colspan="4"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0"></p></td>
		</tr>
		<tr align="center">
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(a) A juvenile court may allow, by order, the inspection of records sealed under this subchapter or under Section 58.003, as that law existed before September 1, 2017, only by:</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
			<td colspan="2"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(3) a court, the Texas Department of Criminal Justice, or the Texas Juvenile Justice Department for the purposes of Article 62.007(e), Code of Criminal Procedure.</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">(b) After a petitioner inspects records under this section, the court may order the release of any or all of the records to the petitioner on the motion of the petitioner.</p></td>
		</tr>
		<tr align="center">
			<td colspan="4"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0"></p></td>
		</tr>
		...
		<tr align="center">
			...
			existed, or the person's denial of the existence of the records or of the person's involvement in a juvenile matter may not be used against the person in any manner, including in:
			</p></td>
		</tr>
		<tr align="center">
			<td align="left" width="10%"></td>
...
<div class="body">
	<table width="100%" border-style="none">
		...
		<tr align="center">
			<td align="left" width="10%"></td>
			<td colspan="3"><p class="arial-font-10" align="justify" padding-top="0" padding-bottom="0">The court shall order the destruction of the records relating to the conduct for which a child is taken into custody or referred to juvenile court without being taken into custody, including records contained in the juvenile justice information system, if:</p></td>
		</tr>	
		<tr align="center">
			<td align="left" width="10%"></td>
			<td align="left" width="10%"></td>
