...
<pdf onload="pdf:130">
<head>
	<logic:equal name="reportInfo" property="certCode" value="54.02">
		<meta name="title" value="<%=PDFReport.SUBPOENA_CERT_17_JUVENILE.getReportName()%>"/>
		<meta name="subject" value="<%=PDFReport.SUBPOENA_CERT_17_JUVENILE.getReportName()%>"/>
	</logic:equal>
	<logic:equal name="reportInfo" property="certCode" value="54.02(J)">
		<meta name="title" value="<%=PDFReport.SUBPOENA_CERT_OVER17_JUVENILE.getReportName()%>"/>
		<meta name="subject" value="<%=PDFReport.SUBPOENA_CERT_OVER17_JUVENILE.getReportName()%>"/>
	</logic:equal>
...
<div class="header">
	<table width="100%" border-style="none" align="center">
		<tr>
			<td width="5%" valign="Top" align="left" class="helvetica-font-9">
				<p>CHILD</p>
			</td>
			...
			<tr>
	 		...
	 		<tr>
	 			<td class="helvetica-font-9" align="left">
			 		...
			 		<p style="line-height:150%">A TRUE COPY OF THIS WRIT, TOGETHER WITH A TRUE COPY OF THE PETITION, AND MOTION TO WAIVE JURISDICTION, YOU WILL DELIVER TO SAID PARENT, GUARDIAN OR OTHER PERSON HAVING CUSTODY OF THE SAID RESPONDENT.</p>
