...
<pdf onload="pdf:130">
<head>
	<meta name="title" value="<%=PDFReport.INTERVIEW_APPOINTMENT_LETTER_EN.getReportName()%>"/>
	<meta name="author" value="JIMS2, Harris County"/>
	<meta name="subject" value="<%=PDFReport.INTERVIEW_APPOINTMENT_LETTER_EN.getReportName()%>"/>
	...
	<table width="100%" border-style="none" padding="0">
		<tr>
			<td>
				...
				I have scheduled an appointment for you/your child,
				<%=eventAppointmentLetterTO.getJuvenileFirstName() %> <%=eventAppointmentLetterTO.getJuvenileMiddleName() %> <%=eventAppointmentLetterTO.getJuvenileLastName() %>, to come to
				<%=eventAppointmentLetterTO.getServiceLocationName() %> on <%=eventAppointmentLetterTO.getEventDate() %> at <%=eventAppointmentLetterTO.getEventTime() %>.
				...
				<p class="arial-font-10 text-margin-bottom-25">
				If you have any questions please call <%=eventAppointmentLetterTO.getOfficerPhone() %>.
				</p>
			</td>
		</tr>
