...
<pdf onload="pdf:130">
<head>
	<meta name="title" value="<%=PDFReport.SUBPOENA_STD_JUVENILE.getReportName()%>"/>
	<meta name="author" value="JIMS2, Harris County"/>
	<meta name="subject" value="<%=PDFReport.SUBPOENA_STD_JUVENILE.getReportName()%>"/>
...
<div class="header">
	<table width="100%" border-style="none" align="center">
		<tr>
			...
			<td class="helvetica-font-9" align="right" padding-top="2" padding-bottom="0" width="90%">
				<p>
...
<div class="body" page-break-before="avoid">
	<table width='100%' border="0">
	 		...
	 		<tr>
				<td colspan="1" valign="Top" align="left" class="helvetica-font-9">
			...
			<tr>
	 		...
	 		<tr>
	 			<td align="left" class="helvetica-font-9">
	 				<span>
	 					<br/><nobr>THE STATE OF TEXAS:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;TO ${reportInfo.juvenileName}, RESPONDENT</nobr>
	 				</span>
	 			</td>
	 		</tr>
	 		<tr><td><p></p></td></tr>
	 		...
	 		<tr>
	 			<td class="helvetica-font-9" align="left">
	 				<p>
		 				YOU ARE HEREBY COMMANDED TO SUMMON ${reportInfo.juvenileName}<br/>
		 				<!--83328 bug fixed-->
		 				<span padding-left="2.8in" text-indent="-0.1in"><nobr>${reportInfo.juvenileAddress.streetAddress},&nbsp;${reportInfo.juvenileAddress.cityStateZip},&nbsp;${reportInfo.juvenileContact.contactPhoneNumber.formattedPhoneNumber}</nobr></span>
				 		<p style="line-height:250%">
				 		IF TO BE FOUND IN YOUR COUNTY, TO BE AND APPEAR IN THE ${reportInfo.courtIdWithSuffix} DISTRICT COURT OF HARRIS COUNTY, TEXAS, TO BE HELD ON THE ${reportInfo.courtLocation}, HOUSTON, TEXAS, ON THE ${reportInfo.courtDate} A.D., AT ${reportInfo.courtTime} / INSTANTER THEN AND THERE TO ANSWER THE PETITION OF COUNTY OF ${reportInfo.plaintiffName}, PLAINTIFF, IT BEING CAUSE NO. ${reportInfo.petitionNum} <logic:notEmpty name="reportInfo" property="reopenPetStatus">${reportInfo.reopenPetStatus}</logic:notEmpty> FILED HEREIN ON THE <logic:notEmpty name="reportInfo" property="amendmentDate">${reportInfo.amendmentDate}</logic:notEmpty><logic:empty name="reportInfo" property="amendmentDate">${reportInfo.filingDate}</logic:empty> A.D., IN WHICH ${reportInfo.juvenileName} IS RESPONDENT,&nbsp;WHEREIN THE SAID PETITIONER ALLEGES TO THE FOLLOWING FACTS, TO WIT:ALL AS FULLY SET OUT IN THE ACCOMPANYING TRUE COPY OF THE PETITION OF THE SAID PLAINTIFF TO THE OFFICER SERVING THIS CITATION:
				 	 	</p>
				 	</p>
			 		
			 		<p text-indent="0.1in" style="line-height:200%">A TRUE COPY OF THIS WRIT, TOGETHER WITH A TRUE COPY OF THE PETITION, YOU WILL DELIVER TO THE SAID RESPONDENT.</p>
