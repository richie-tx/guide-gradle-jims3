...
<table width="90%" border-style="none">
	<tr>
		<td colspan="7" align="center"><p class="times-font-9"><b>Case Status Results</b></p></td>
	</tr>
</table>
...
<table width="100%" border-style="none">
	<tr>
		<td align="left"><p class="times-font-8">Case Status: <c:out value="${reportInfo.statusSearchType}"/></p></td>
	</tr>
	<tr>
	...
	<thead>
		<tr align="center">
			...
			<td></td>			
			 ...
			 <td><p class="times-font-8-bold"><nobr>Probation Officer</nobr></p></td>
