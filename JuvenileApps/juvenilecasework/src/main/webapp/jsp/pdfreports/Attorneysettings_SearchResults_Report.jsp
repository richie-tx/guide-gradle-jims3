...
<jsp:useBean id="reportInfo" class="ui.juvenilecase.AttorneysettingsSearchResultsReportBean" scope="session"/>

<pdf onload="pdf:130">

<head>
	<meta name="title" value="<%=PDFReport.ATTORNEYSETTINGS_SEARCH_RESULTS_REPORT.getReportName()%>"/>
	<meta name="author" value="JIMS2, Harris County"/>
	<meta name="subject" value="<%=PDFReport.ATTORNEYSETTINGS_SEARCH_RESULTS_REPORT.getReportName()%>"/>
		...
		<macro id="myheader">
			<div class="header" align="center">
				<table width="90%" border-style="none">
					<tr>
						<td align="left"><p class="times-font-10"><b>Search Attorney Setting</b></p></td>
...
<table width="100%" border-style="none">
	<thead>
		<tr align="center">
			...
			<td width="10%"><p class="times-font-9"><b>ATTORNEY NAME</b></p></td> 			
		</tr>
		<tr>
			<td width="1%">--------</td>
			<td width="1%">---------</td>		
		...
		<c:set var="searchResults"  value="${reportInfo.attorneySearchResults}" scope="session"/>
			<c:forEach var="resultItems" items="${searchResults}" varStatus="status">			
				<tr>
					...
					<td><p class="times-font-8"><c:out value="${resultItems.attorneyName}"/></p></td>					
				</tr>
			</c:forEach>
	</tbody>
