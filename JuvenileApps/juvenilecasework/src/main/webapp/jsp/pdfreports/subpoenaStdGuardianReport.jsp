...
<head>
	<logic:equal name="courtHearingForm" name="queryString" value="F">
		<meta name="title" value="<%=PDFReport.SUBPOENA_STD_GUARD_FATHER.getReportName()%>"/>
		<meta name="subject" value="<%=PDFReport.SUBPOENA_STD_GUARD_FATHER.getReportName()%>"/>
	</logic:equal>
	<logic:equal name="courtHearingForm" name="queryString" value="M">
		<meta name="title" value="<%=PDFReport.SUBPOENA_STD_GUARD_MOTHER.getReportName()%>"/>
		<meta name="subject" value="<%=PDFReport.SUBPOENA_STD_GUARD_MOTHER.getReportName()%>"/>
	</logic:equal>
	<logic:equal name="courtHearingForm" name="queryString" value="O">
		<meta name="title" value="<%=PDFReport.SUBPOENA_STD_GUARD_OTHER.getReportName()%>"/>
		<meta name="subject" value="<%=PDFReport.SUBPOENA_STD_GUARD_OTHER.getReportName()%>"/>
	</logic:equal>
