...
/* simulate browser to NOT be IE to make back buttons work */
gbNav6=true;
gbNav61=true;
gbNav4=true;
gbIE4=false;
...
function ShowWebHelp(strHelpPath, strWnd, uCommand, nMapId)
{
	...
	if (a_pszHelpFile)
	{
		...
		{
			var sParam = "left="+screen.width+",top="+screen.height+",width=100,height=100";
//alert("a1a2a3 " + a_pszHelpFile);
//			var sParam = "left=0,top=0,width=1,height=1";			
//			window.open(a_pszHelpFile, "__webCshStub", sParam);
			window.open(a_pszHelpFile, "", sParam);
		}
		else
		{
			var sParam = "left="+screen.width+",top="+screen.height+",width=100,height=100";
