...
<html:form action="/handleValidateMFA" target="_top" styleId="MFAerrorForm">
...
<table width="98%" border="0">
  <tr>
    ...
    <% String error = (String)request.getSession().getAttribute("pageerror");
			   String pageerrors = "" ;
				if( error != null )
				{
					pageerrors = error ;
			...
			%>
	 <td align="center" class="errorAlert"><%=pageerrors%></td>
  </tr>
...
<%-- <table width="100%">
<logic:notEmpty name="MFAerrorForm" property="errorMessage">
 <tr>		  
    <td align="center" class="errorAlert"><bean:write name="MFAerrorForm" property="errorMessage"/></td>		  
  </tr> 
</logic:notEmpty>
 <logic:empty name="MFAerrorForm" property="errorMessage">
  <tr>		  
