...
<title><bean:message key="title.heading"/> - loginJIMS2AccountCreateSummary.jsp</title>
...
<html:form action="/submitCreateJIMS2AccountAction">
<logic:equal name="loginForm" property="action" value="summary">
	<logic:equal name="loginForm" property="userType" value="genericUser">
		<input type="hidden" name="helpFile" value="jims2security/jims2_security.htm#|283">
	</logic:equal>	
	<logic:equal name="loginForm" property="userType" value="genericSP">
		<input type="hidden" name="helpFile" value="jims2security/jims2_security.htm#|287">
	</logic:equal>	
	<logic:equal name="loginForm" property="userType" value="nonGenericUser">		
		<input type="hidden" name="helpFile" value="jims2security/jims2_security.htm#|290">
	</logic:equal>	
</logic:equal>
<logic:equal name="loginForm" property="action" value="confirm">
	<logic:equal name="loginForm" property="userType" value="genericUser">
		<input type="hidden" name="helpFile" value="jims2security/jims2_security.htm#|284">
	</logic:equal>	
	<logic:equal name="loginForm" property="userType" value="genericSP">
		<input type="hidden" name="helpFile" value="jims2security/jims2_security.htm#|288">
	</logic:equal>	
	<logic:equal name="loginForm" property="userType" value="nonGenericUser">		
		<input type="hidden" name="helpFile" value="jims2security/jims2_security.htm#|291">
	</logic:equal>	
</logic:equal>
...
<table width="98%" border="0">
	<TBODY>
		<tr>
		<logic:equal name="loginForm" property="action" value="confirm">
			<td align="center" class="header"><bean:message key="title.createJIMS2UserProfileAccount"/> <bean:message key="title.confirmation"/></td>
		</logic:equal>
		<logic:equal name="loginForm" property="action" value="summary">
			<td align="center" class="header"><bean:message key="title.createJIMS2UserProfileAccount"/> <bean:message key="title.summary"/></td>
		</logic:equal>
		</tr>
	</TBODY>
</table>
...
<table width="98%" border="0"> 
	<tr> 
        ...
        <logic:equal name="loginForm" property="action" value="confirm">
			<td class=confirm> The following JIMS2 Account has been successfully created</td>
       	</logic:equal>
	</tr> 
</table> 
...
<table width="98%" border="0" cellpadding="2" cellspacing="1" align=center class="borderTableBlue"> 
	<logic:equal name="loginForm" property="userType" value="genericUser">
		...
		<tr> 
			<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.badgeNumber"/></td> 
			<td class="formDe"><bean:write name="loginForm" property="badgeNumber"/></td>
		</tr> 
		<tr> 
			<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.other"/> <bean:message key="prompt.id"/> <bean:message key="prompt.number"/></td> 
			<td class="formDe"><bean:write name="loginForm" property="otherIdNumber"/></td>
		</tr> 
		<tr> 
			<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.lawEnforcementAgency"/></td> 
			<td class="formDe"><bean:write name="loginForm" property="agencyName"/></td>
		</tr> 
	</logic:equal>
	<logic:equal name="loginForm" property="userType" value="genericSP">
		<tr> 
			<td class="detailHead" colspan="2" valign="top" ><bean:message key="prompt.service"/> <bean:message key="prompt.provider"/> <bean:message key="prompt.info"/></td> 
		</tr> 
		<tr> 
			<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.service"/> <bean:message key="prompt.provider"/> <bean:message key="prompt.name"/></td> 
	...
	<logic:notEqual name="loginForm" property="userType" value="genericSP">
		<tr> 
			<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.department"/></td> 
			<td class="formDe"><bean:write name="loginForm" property="departmentName"/></td>
		</tr> 
	</logic:notEqual>
	<tr> 
		<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.userName"/></td> 
		<td class="formDe"><bean:write name="loginForm" property="userName"/></td>
	</tr> 
	<tr> 
		<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.workPhone"/></td> 
		<td class="formDe"><bean:write name="loginForm" property="userWorkPhoneNumber"/></td>
	</tr> 
	<tr> 
	...
	<logic:notEqual name="loginForm" property="userType" value="nonGenericUser">
		<tr> 
			<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.JIMS2Password"/></td> 
			<td class="formDe"><bean:write name="loginForm" property="displayPassword"/></td>
		</tr> 
		<tr> 
			<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.forgottenPasswdPhrase"/></td> 
			<td class="formDe"><bean:write name="loginForm" property="forgottenPasswdPhrase"/></td>
		</tr> 
		<tr> 
			<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.answer"/></td> 
