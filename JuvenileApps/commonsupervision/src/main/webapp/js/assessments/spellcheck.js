...
function popUpCheckSpellingspellCheckerButtonId(interfaceObjectName){  
	var spellBoot = "<html><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8'></head><body onLoad='document.forms[0].submit();'><font face='arial, helvetica' size=2>Spell checking document...</font><form action='jsp/common/spellCheckPopUp.jsp' method='post' ACCEPT-CHARSET='UTF-8'>";  
