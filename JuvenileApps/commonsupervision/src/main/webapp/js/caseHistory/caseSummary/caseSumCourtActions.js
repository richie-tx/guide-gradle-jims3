...
function validateNextInput(theForm){
	...
	if (theForm.whoSignedId.selectedIndex == 0){
		if (msg == ""){
			theForm.whoSignedId.focus();
		}
		msg += "Who Signed is required.\n";
	}
	...
	var result = validateComments(theForm.summaryOfCourtActions.value, "Summary of Court Actions",3500);
	if (result != ""){
		if (msg == ""){
			theForm.summaryOfCourtActions.focus();
		}
		msg += result;
	}
