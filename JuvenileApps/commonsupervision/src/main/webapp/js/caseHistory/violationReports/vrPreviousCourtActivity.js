...
//		result = validateComments(theForm.create1Comments.value, "Violation Report Comments");
//		if (result != ""){
//			if (msg == ""){
//				theForm.create1Comments.focus();
//			}
...
//			theForm.selectedMotionActivityId.selectedIndex == 0 &&
...
//	if (theButton.value == "Next"){
//		result = validateComments(theForm.create2Comments.value, "Motions Comments");
//		if (result != ""){
//			if (msg == ""){
//				theForm.create2Comments.focus();
//			}
...
//			theForm.selectedOtherActivityId.selectedIndex == 0 &&
...
//	if (theButton.value == "Next"){
//		result = validateComments(theForm.create3Comments.value, "Others Comments");
//		if (result != ""){
//			if (msg == ""){
//				theForm.create3Comments.focus();
//			}
