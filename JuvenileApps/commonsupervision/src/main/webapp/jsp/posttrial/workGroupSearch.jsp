...
<html:base />
<title><bean:message key="title.heading" /> - posttrial/workGroupSearch.jsp</title>
...
{	
	if (theForm.workgroupName.value == "" &&
	    theForm.workgroupTypeId.selectedIndex == 0)
	{		
...
<html:form action="/displayTaskWorkGroupSearchResults" target="content" focus="workgroupName">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Tasks/CSCD_Tasks.htm#|4">
<div align="center">
							...
							<tr>
								...
								<!-- BEGIN HEADING TABLE -->
									<table width=100%>
										<tr>							
											...
											<bean:message key="title.CSCD" />&nbsp;-&nbsp;<bean:message key="prompt.create" />&nbsp;<bean:message key="prompt.task" />&nbsp;-&nbsp;<bean:message key="prompt.searchFor" />&nbsp;<bean:message key="prompt.workgroup" />
										</td>						
						  				</tr>
									</table>
								<!-- END HEADING TABLE -->
									...
									<table width="98%" border="0">
										<tr>
											<td><ul>
												...
												<li>Click Submit button to retrieve workgroups.</li>
											</ul></td>
										</tr>
										<tr>
								...
								<!-- BEGIN BUTTON TABLE -->
									<table border="0" width="100%">
										<tr>
											<td align="center">
										        <html:submit property="submitAction"><bean:message key="button.back"/></html:submit>  <%-- validateWorkGroupSearchForm(this.form) && --%>
												<html:submit property="submitAction" onclick="return (validateSearch(this.form) && disableSubmit(this, this.form));">
