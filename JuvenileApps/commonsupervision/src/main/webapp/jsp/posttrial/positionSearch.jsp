...
<html:base />
<title><bean:message key="title.heading" /> - posttrial/positionSearch.jsp</title>
<!--THESE TWO LINES FOR STRUTS & JAVASCRIPTS VALIDATIONS-->
<html:javascript formName="taskPositionSearchForm" /> 
<script type="text/javascript" src="/<msp:webapp/>js/timeout.js"></script> 
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
<script valign="top" src="/<msp:webapp/>js/organization.js"></script>
<script>
function valPage(theFormElem){
	...
	var theLastName = trimAll(elemLastName.value);
	var theFirstName = trimAll(elemFirstName.value);
	if(theLastName.value =='' && (theFirstName !='' || trimAll(elemMiddleName.value)!='')){
		...
		if(retVal == true){
			return validateTaskPositionSearchForm(theFormElem);
		} else {
			return false;
		}
	}
...
<logic:iterate indexId="organizationIterIndex" id="organizationIter" name="cscdTaskForm" property="organizations">
...
<body topmargin="0" leftmargin="0" onload="reloadOrganization(document.forms[0], 'divisionId','programUnitId','programSectionId','<bean:write name="cscdTaskForm" property="programUnitId"/>', '<bean:write name="cscdTaskForm" property="programSectionId"/>')" onKeyDown="return checkEnterKeyAndSubmit(event,true)">
<html:form action="/displayTaskPositionSearchResults" target="content" focus="userId">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Tasks/CSCD_Tasks.htm#|6">
<div align="center">
									...
									<td>																
										<table width="100%" cellpadding="2" cellspacing="1">
											<tr>
												...
												<td class="formDe">
													<html:text name="cscdTaskForm" property="userId" size="8" maxlength="8"/>
												</td>
											</tr>
											<tr>
												<td class="formDeLabel" nowrap><bean:message key="prompt.plusSign"/><bean:message key="prompt.lastName" /></td>
												<td class="formDe">
													<html:text name="cscdTaskForm" property="name.lastName" size="30" maxlength="30"/>
												</td>
											</tr>
											<tr>
												<td class="formDeLabel" nowrap><bean:message key="prompt.firstName" /></td>
												<td class="formDe">
													<html:text name="cscdTaskForm" property="name.firstName" size="25" maxlength="25"/>
												</td>
											</tr>
											<tr>
												<td class="formDeLabel" nowrap width="1%"><bean:message key="prompt.middleName" /></td>
												<td class="formDe">
													<html:text name="cscdTaskForm" property="name.middleName" size="25" maxlength="25"/>
												</td>
											</tr>
											<tr>
												<td class="formDeLabel" nowrap width="1%"><bean:message key="prompt.cjad" /></td>
												<td class="formDe">
													<html:text name="cscdTaskForm" property="cjad" size="15" maxlength="9"/>
												</td>
											</tr>																			
											<!-- SEARCH BY position info-->
											<tr>
											  <td class="formDeLabel" nowrap><bean:message key="prompt.positionName" /> </td>
											  <td class="formDe"><html:text name="cscdTaskForm" property="positionName" size="30" maxlength="50"/></td>
											</tr>
											<tr>
											...
											<tr>
												...
												<td class="formDe">
													<html:text name="cscdTaskForm" property="workgroupName" size="25" maxlength="25"/>
												</td>
											</tr>
										</table>
									</td>
