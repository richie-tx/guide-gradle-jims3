...
<!--MODIFICATIONS -->
<!-- 11/17/2008 C Shimek   Modified version of administerCaseloadCSCD/assessments/scsDetails.jsp for SPn Splits -->
...
<html:base />
<title><bean:message key="title.heading" /> - manageRecords/scsDetails.jsp</title>
					...
					<tr>
						<td>
							<table width="100%" cellpadding="4" cellspacing="1">
								...
								<logic:iterate id="eachAssessmentVersion" name="scsAssessmentForm" property="versionDetailsList" indexId="index">  
