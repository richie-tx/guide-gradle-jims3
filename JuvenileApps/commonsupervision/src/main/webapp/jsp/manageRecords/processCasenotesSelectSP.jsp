<html>
	<head>
		<title>Common Supervision - processCasenotesSelectSP.htm</title>
...
<script>										
											function toggleSupPd(theCheckBox,selectId){
									...
									<td valign=top align=center>
										...
										<table width="98%" border="0">
											<tr>
												<td>
													<ul>
														<li>Select Casenotes to move from Erroneous SPN to Valid SPN and select which of the supervision period to associate the casenote to.</li>
													</ul>
												</td>
											</tr>
											<tr>
												<td class=required>+ Conditionally required.</td>
											</tr>
										</table>
										...
										<table width="98%" cellpadding="2" cellspacing="1">
											...
											<tr class=formDeLabel>
												<td colspan=5>
													<table cellpadding="0" cellspacing="0">
														<tr>
															<td><input type=checkbox name="cn" onclick="toggleSupPd(this,'cn1');"></td>
															<td class=formDeLabel>+Supervision Period</td>
															<td>
																<select id=cn1 disabled>
																	<option>Please Select</option>
																	<optGroup label="Erroneous SPN">
																	<option>10/11/2002-10/11/2003</option>
																	<option>10/11/2005-10/11/2006</option>
																	</optGroup>
																	<optGroup label="Valid SPN">
																	<option>09/11/2002-05/11/2003</option>
																	<option>12/11/2005-12/11/2006</option>
																	</optGroup>
																</select>
															</td>
														</tr>
											...
											<tr class=formDeLabel>
												<td colspan=5>
													<table cellpadding="0" cellspacing="0">
														<tr>
															<td><input type=checkbox name="cn" onclick="toggleSupPd(this,'cn2');"></td>
															<td class=formDeLabel>+Supervision Period</td>
															<td>
																<select id=cn2 disabled>
																	<option>Please Select</option>
																	<optGroup label="Erroneous SPN">
																	<option>10/11/2002-10/11/2003</option>
																	<option>10/11/2005-10/11/2006</option>
											...
											<tr class=formDeLabel>
												<td colspan=5>
													<table cellpadding="0" cellspacing="0">
														<tr>
															<td><input type=checkbox name="cn" onclick="toggleSupPd(this,'cn3');"></td>
															<td class=formDeLabel>+Supervision Period</td>
															<td>
																<select id=cn3 disabled>
																	<option>Please Select</option>
																	<optGroup label="Erroneous SPN">
																	<option>10/11/2002-10/11/2003</option>
																	<option>10/11/2005-10/11/2006</option>
										...
										<table border="0" width="100%">
											<tr>
												<td align="center">
													<input type=button value=Next onClick="goNav('processCasenotesSummary.htm?period=notAllChains')">
													<input type="reset" value="Cancel" name="cancel"  onClick="goNav('caseMenu.htm')">
												</td>
											</tr>
										</table>
										<!-- END BUTTON TABLE -->
			...
			<tr>
				<td>
					<ol>
						...
						<li>Erroneous and valid SPN sup periods in the dropdown is an illustration of scenario 3x</li>
					</ol>
				</td>
			</tr>
		</table>
