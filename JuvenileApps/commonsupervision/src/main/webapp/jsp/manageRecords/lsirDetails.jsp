...
<!--MODIFICATIONS -->
<!-- 11/17/2008 C Shimek   Modified version of administerCaseloadCSCD/assessments/lsirDetails.jsp for SPn Splits -->
...
<html:base />
<title><bean:message key="title.heading" /> - manageRecords/lsirDetails.jsp</title>
					...
					<tr>
						<td>
							<table width="100%" cellpadding="4" cellspacing="1">
								...
								<logic:iterate id="eachAssessmentVersion" name="lsirAssessmentForm" property="versionDetailsList" indexId="index">  
