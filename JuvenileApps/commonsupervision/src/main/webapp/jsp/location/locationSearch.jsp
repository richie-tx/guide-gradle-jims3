<!DOCTYPE HTML>
<!-- 09/15/2006	 Debbie Williamson - Create JSP -->
...
<html:form action="/displayLocationSearchResults" target="content" focus="locationCd">

<input type="hidden" name="helpFile" value="commonsupervision/Location/Administer_Location.htm#|394">
			...
			<table width='100%' border="0" cellpadding="0" cellspacing="0" class="borderTableBlue">
				<tr>
					<td valign=top align=center>						
  					...
  					<table width='100%'>
    			  	<tr>
    			    	<td align="center" class="header"><bean:message key="title.search" /> <bean:message key="prompt.locations" /></td>
					  	</tr>
						</table>
						<!-- END HEADING TABLE -->
						...
						<table width="98%" border="0">
  						...
  						<tr>
                <td class=required colspan=4> <bean:message key="prompt.2.diamond"/> <bean:message key="prompt.requiredFieldsInstruction" /> At least 1 Required</td>
              </tr>
              <tr>
                <td colspan=4 class=required>+ Street Name required if searching by Street Number.</td>
	          	...
	          	<tr class="detailHead">
	              <td><bean:message key="title.search" /> <bean:message key="prompt.locations" /></td>
	            </tr>
	          	<tr>
	              <td>
  	              		...
  	              		<td class="formDeLabel" nowrap><bean:message key="prompt.locationID" /></td>
 				            ...
 				            <tr>
				              ...
				              <td class="formDe" colspan=3>						              	
    										<html:select property="serviceProviderName" name="locationForm">
      									   <html:option value=""><bean:message key="select.generic" /></html:option>  			            	  	
      									   <html:optionsCollection property="serviceProviderList"  value="serviceProviderName" label="serviceProviderName"  name="locationForm"/>
    										</html:select>  
  				            </td>	
  				          </tr>
  				          <tr>						              
    		              <td class="formDeLabel" nowrap><bean:message key="prompt.service" /> <bean:message key="prompt.type" /></td>
    		              <td class="formDe">
  											<html:select property="serviceTypeId" name="locationForm">
   											  <html:option value=""><bean:message key="select.generic" /></html:option>  			            	  	
   											  <html:optionsCollection property="serviceTypeList"  value="serviceTypeCode" label="description"  name="locationForm"/>
  											</html:select>  
    	                  </td>
    	                  </tr> 
						  <tr>				
  				          ...
  				          <tr>
				              <td class="formDeLabel" nowrap><bean:message key="prompt.location" /> <bean:message key="prompt.name" /></td>
				              <td class="formDe"><html:text name="locationForm" property="locationName" maxlength="35" size="35"/></td>
  				          </tr>
  				          <tr>
  				          ...
  				          <tr>
              					...
              					<td colspan=2 style="padding: 0; margin: 0">
              						<table style="padding: 0; margin: 0">
  				          				<tr>
              							<td class="formDeLabel" nowrap width="140">Location Unit</td>
	       								<td class="formDe">						              	
	    										<html:select property="locationUnitId" name="locationForm">
	      									   <html:option value=""><bean:message key="select.generic" /></html:option>  			            	  	
	      									   <html:optionsCollection property="locationUnitsAll"  value="juvLocationUnitId" label="locationUnitSelectLabel"  name="locationForm"/>
	    										</html:select>  
	       								</td>
	       								<!-- 
	       								<td class="formDeLabel" nowrap width="140">Location Unit Status</td>
					  	              		 <td class="formDe">
									              	<html:select property="locationUnitStatusId" name="locationForm">
					      										<html:option value=""><bean:message key="select.generic" /></html:option>  			            	  												   
					   											  <html:optionsCollection property="locationStatusList"  value="code" label="description"  name="locationForm"/>
					      						      </html:select>
				      						</td>
  	              			...
  	              			<td colspan=2 style="padding: 0; margin: 0">
  				          		<table style="padding: 0; margin: 0">
  				          			<tr>
	  	              					<td class="formDeLabel" nowrap width="140">Location Unit Status</td>
	       								<td class="formDe">
	       									<html:radio styleId="locationUnitStatusYes" name="locationForm" property="locationUnitStatus" value="ACTIVE"/>ACTIVE
	       								</td>
	       								<td class="formDe">
	       									<html:radio styleId="locationUnitStatusNo" name="locationForm" property="locationUnitStatus" value="INACTIVE" checked=true />INACTIVE 
	       								</td>
	       								<td class="formDe">
	       									<html:hidden styleId="locationUnitStatusId" name="locationForm" property="locationUnitStatus"/>	
	       								</td>	       														    
       								</tr>
       							</table>  
  				          	</td>
				            ...
				            <tr>
				              <td colspan=4 class=formDe>
					              <table width="100%" border=0 cellpadding="2" cellspacing="1">				              				          
					                ...
					                <tr>
					                  <td class=formDe><html:text property="locationAddress.streetNumber" maxlength="15" size="6"/></td>
					                  <td class=formDe colspan=3>
		              	        <html:text property="locationAddress.streetName" maxlength="50" size="35"/>
					                ...
					                <tr>
					                  <td class=formDe><html:text property="locationAddress.city" maxlength="25" size="25"/></td>
					                  <td class=formDe>
      						...
      						<table border="0" width="100%">
   							  	<tr>
   							    	<td align="center">
     										...
     										<input type="button" onclick="goNav('/<msp:webapp/>displayLocationSearch.do')" value="<bean:message key='button.refresh'/>"/>
     									</td>
   							  	</tr>
     							</table>
     							<!-- END BUTTON TABLE -->
