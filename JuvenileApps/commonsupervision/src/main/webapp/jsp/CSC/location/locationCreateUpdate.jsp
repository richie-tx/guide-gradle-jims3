...
<html:javascript formName="locationCreateCSCForm"/>
...
<html:form action="/displayLocationCreateUpdateSummaryForCSC" target="content" focus="locationCd">

<logic:equal name="locationForm" property="action" value="create">
   <input type="hidden" name="helpFile" value="commonsupervision/CSCD_Location/CSCD_Location.htm#|1">
</logic:equal>
<logic:equal name="locationForm" property="action" value="update">
   <input type="hidden" name="helpFile" value="commonsupervision/CSCD_Location/CSCD_Location.htm#|9">
</logic:equal>
  			...
  			<tr>
  				<td valign="top" align="center">
  					...
  					<table width="98%" border="0">
  						...
  						<tr>
  							<td class="required" colspan="4"><bean:message key="prompt.3.diamond"/> <bean:message key="prompt.requiredFieldsInstruction" /></td>
  						</tr>
  					</table>
  					<%-- BEGIN ERRORS TABLE --%>
  					<table width="100%">
  						...
  						<tr>
  							<td>
  								<table width="100%" border="0" cellpadding="2" cellspacing="1">
  									<tr>
  										<td class="formDeLabel" nowrap width="1%"><bean:message key="prompt.3.diamond"/><bean:message key="prompt.locationID" /></td>
										<td class="formDe"><html:text name="locationForm" property="locationCd" size="10" maxlength="10"/></td>
  										<td class="formDeLabel" nowrap width="1%"><bean:message key="prompt.3.diamond"/><bean:message key="prompt.location"/></td>
  										<td class="formDe"><html:text name="locationForm" property="locationName" size="35" maxlength="35"/></td>
  										
  									</tr>
  									<tr>
  									<td class="formDeLabel" nowrap><bean:message key="prompt.3.diamond"/><bean:message key="prompt.inHouse"/></td>
  										<td class="formDe"> 
  									...
  									<tr>
  										...
  										<td class="formDe">
  										  <html:text name="locationForm" property="locationFax.areaCode" size="3" maxlength="3" onkeyup="return autoTab(this, 3);" />-
  										   <html:text name="locationForm" property="locationFax.prefix" size="3" maxlength="3" onkeyup="return autoTab(this, 3);" />-
  										   <html:text name="locationForm" property="locationFax.last4Digit" size="4" maxlength="4" onkeyup="return autoTab(this, 4);" />
  										</td>
  									</tr>
  									<tr>       
  										<td class="formDeLabel" nowrap width="1%"><bean:message key="prompt.3.diamond" /><bean:message key="prompt.region"/></td>
  										<td class="formDe">
  												...
  												<tr class="detailHead">
  												    <td align="right" class="detailHead"> 
  														<input type="button" value="<bean:message key='button.validate' />" 
    																onClick="return validateAddrAction('locationForm','/<msp:webapp/>validateLocationAddress.do','', 'locationAddress','/jsp/CSC/location/locationCreateUpdate.jsp', true);">
  									...
  									<tr>
  										<td colspan="4" class="formDe">
  											<table width="100%" border="0" cellpadding="2" cellspacing="1">
  												<tr>
  													<td class="formDeLabel"><bean:message key="prompt.3.diamond"/><bean:message key="prompt.streetNumber"/></td>
  													<td class="formDeLabel" colspan="2"><bean:message key="prompt.3.diamond"/><bean:message key="prompt.streetName"/></td>
  												</tr>
  												<tr>
  													<td class="formDe"><html:text name="locationForm" property="locationAddress.streetNumber" size="15" maxlength="15"/></td>
  												...
  												<tr>
  													<td class="formDe">
  														<html:select name="locationForm" property="locationAddress.streetTypeId" size="1">
  												...
  												<tr>
  													...
  													<td class="formDe">
  														<html:select name="locationForm" property="locationAddress.stateId" >
  														   <html:option value=""><bean:message key="select.generic" /></html:option>  			            	  	
  														  <jims2:codetable codeTableName="<%=PDCodeTableConstants.STATE_ABBR%>" sort="true"></jims2:codetable>
  														</html:select>  
  													</td>
  													<td class="formDe">
  					...
  					<table border="0" width="100%">
  						<tr>
  							<td align="center"><html:submit property="submitAction">
  								...
  								<html:submit property="submitAction" onclick="return validateLocationCreateCSCForm(this.form) && validateCreateUpdateFields() && validateRadios((this.form), 'isInHouse', 'In House is required.  Please select either Yes or No.');">
