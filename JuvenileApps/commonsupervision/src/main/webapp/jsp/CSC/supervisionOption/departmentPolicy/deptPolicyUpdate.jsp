...
<!-- 06/03/2008	 LDeen				ER#51066 removed Tiny MCE-was not supposed to be here -->
<!-- 07/29/2010  D Williamson 		ER#55920 Add Text Counter. -->
...
function setFocus()
{
	var txtFld = document.getElementsByName("name");
...
<title><bean:message key="title.heading" /> - deptPolicyUpdate.jsp</title>
</head>
...
<body topmargin=0 leftmargin="0" onload="reloadGroup(document.forms[0], '<bean:write name="departmentPolicyForm" property="group2Id"/>', '<bean:write name="departmentPolicyForm" property="group3Id"/>'), setFocus()" onKeyDown="return checkEnterKeyAndSubmit(event,true)">
<html:form action="/displayDepartmentPolicyName" target="content" onsubmit="return (myTinyMCEFix() && validateSelectedCourts(this))">
<div align="center">
							...
							<tr>
								<td align="center" class="header">
									<logic:equal name="departmentPolicyForm" property="action" value="copy">
										...
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|100">
									</logic:equal>
									
									<logic:equal name="departmentPolicyForm" property="action" value="create">
										<bean:message key="prompt.create" />
										<bean:message key="<%=deptPolicyTitle%>"/>
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|90">
									</logic:equal>
									...
									<logic:equal name="departmentPolicyForm" property="action" value="update">
										<logic:notEqual name="departmentPolicyForm" property="inUse" value="true">
											...
											<bean:message key="<%=deptPolicyTitle%>"/>
											<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|94">
										</logic:notEqual>
										<logic:equal name="departmentPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|95">
											<bean:message key="prompt.update" />
								...
								<td>
									...
									<logic:equal name="departmentPolicyForm" property="action" value="<%=UIConstants.UPDATE%>"> 
											<tr>
												...
												<td class="formDe"><html:text name="departmentPolicyForm" property="name" size="50" maxlength="50"/></td>
											</tr>
									</logic:equal>
										<tr>
											<td class="formDeLabel" width=1% nowrap><bean:message key="prompt.4.diamond"/><bean:message key="<%=departmentGroup1Caption%>"/></td>
											<td class="formDe">
												<input type="hidden" name="selectedGroup1" value="<bean:write name="departmentPolicyForm" property="group1Id"/>" >
												<logic:equal name="departmentPolicyForm" property="action" value="create">
												...
												<logic:notEqual name="departmentPolicyForm" property="action" value="create">
													<html:select property="group1Id" size="1" onchange="updateGroup2(this.form);checkGroupChange(this, 1, departmentPolicyForm);">
														<html:option value=""><bean:message key="select.generic" /></html:option>
														<html:optionsCollection property="groups" value="groupId" label="name" /> 
													</html:select>
												</logic:notEqual>
										...
										<tr>
											...
											<td class="formDe">
													<input type="hidden" name="selectedGroup2" value="<bean:write name="departmentPolicyForm" property="group2Id"/>" >
													<logic:equal name="departmentPolicyForm" property="action" value="create">
													...
													<logic:notEqual name="departmentPolicyForm" property="action" value="create">
														<logic:empty name="departmentPolicyForm" property="group2">
															<html:select property="group2Id" disabled="true" onchange="updateGroup3(this.form);checkGroupChange(this, 2, departmentPolicyForm);">
																<html:option value=""><bean:message key="select.generic" /></html:option>
															</html:select>
														</logic:empty>
														
														<logic:notEmpty name="departmentPolicyForm" property="group2">
															<html:select property="group2Id" size="1" onchange="updateGroup3(this.form);checkGroupChange(this, 2, departmentPolicyForm);">
																<html:option value=""><bean:message key="select.generic" /></html:option>
										...
										<tr>
											...
											<td class="formDe">
											<input type="hidden" name="selectedGroup3" value="<bean:write name="departmentPolicyForm" property="group3Id"/>" >
												<logic:equal name="departmentPolicyForm" property="action" value="create">
												...
												<logic:notEqual name="departmentPolicyForm" property="action" value="create">
													<logic:empty name="departmentPolicyForm" property="group3">
														<logic:empty name="departmentPolicyForm" property="group2">
															<html:select property="group3Id" disabled="true" onchange="checkGroupChange(this, 3, departmentPolicyForm);">
																<html:option value=""><bean:message key="select.generic" /></html:option>
															</html:select>
														</logic:empty>
														<logic:notEmpty name="departmentPolicyForm" property="group2">
															<html:select property="group3Id" onchange="checkGroupChange(this, 3, departmentPolicyForm);">
																<html:option value=""><bean:message key="select.generic" /></html:option>
															</html:select>
														</logic:notEmpty>
													</logic:empty>
													...
													<logic:notEmpty name="departmentPolicyForm" property="group3">
														<html:select property="group3Id" size="1" onchange="checkGroupChange(this, 3, departmentPolicyForm);">
															<html:option value=""><bean:message key="select.generic" /></html:option>
										...
										<tr>				
											...
											<logic:notEqual name="departmentPolicyForm" property="inUse" value="true">
											    <td class="formDeLabel" width=1% nowrap valign=top><bean:message key="prompt.4.diamond"/><bean:message key="<%=departmentPolicyLiteralCaption%>" /><br>(Max Characters: 1000)</td>	
												<td class="formDe"><html:textarea name="departmentPolicyForm" property="departmentPolicy" style="width:100%" rows="5" onmouseout="textLimit( this, 1000 )" onkeyup="textLimit( this, 1000 )"/>
												<script>
																	...
																	customValMaxLength('departmentPolicy','Policy  cannot be more than 1000 characters',1000);
																</script>
												</td>				
											</logic:notEqual>
											<logic:equal name="departmentPolicyForm" property="inUse" value="true">
												<td class="formDeLabel" width=1% nowrap valign=top><bean:message key="prompt.4.diamond"/><bean:message key="<%=departmentPolicyLiteralCaption%>" /></td>	
											<html:hidden name="departmentPolicyForm" property="departmentPolicy"/>
										...
										<tiles:insert page="../../../common/spellCheckButtonTile.jsp" flush="true">
												<tiles:put name="agencyCode" beanName="departmentPolicyForm" beanProperty="agencyId"/>
										</tiles:insert>
										<tr>
											<td class="formDeLabel" width=1% nowrap><bean:message key="prompt.4.diamond"/><bean:message key="prompt.effectiveDate" /></td>
											<td class="formDe">
											    ...
											    <logic:equal name="departmentPolicyForm" property="inUse" value="true">	
											        <html:hidden name="departmentPolicyForm" property="effectiveDate"/>
													<bean:write name="departmentPolicyForm" property="effectiveDate" />
												</logic:equal>
										    </td>				
					                    </tr>
										...
										<tr>
											<td class="formDeLabel" valign=top width=1% nowrap><bean:message key="prompt.notes" /><br>(Max Characters: 1000)</td>
											<td class="formDe"><html:textarea name="departmentPolicyForm" property="notes" style="width:100%" rows="3" onmouseout="textLimit( this, 1000 )" onkeyup="textLimit( this, 1000 )"/></td>
										</tr>
										<tr>
						...
						<table border="0" width="100%">
							<tr>
								...
								<logic:notEqual name="departmentPolicyForm" property="action" value="<%=UIConstants.CREATE%>"> 
										...
										<html:submit property="submitAction" onclick="return (myTinyMCEFix() && validateDept(this.form) && validateSelectedCourts(this.form) && compareDate(this.form) && unhideGroups(this.form) && disableSubmit(this, this.form));"><bean:message key="button.next"/></html:submit>
