				...
				<tr>
					...
					<%--/logic:notEmpty--%> 
							...
							<table width="98%" border="0" cellpadding="2" cellspacing="1" class=borderTableBlue>
								<tr class="detailHead">
									<td width=1%></td>
									<td class=subHead><bean:message key="<%=courtPolicyTitle%>"/>&nbsp;<bean:message key="prompt.name" />
										<jims2:sortResults beanName="courtPolicyForm" results="courtPolicySearchResults" primaryPropSort="name" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="1" levelDeep="4"/>
									</td>
									<td class=subHead><bean:message key="<%=courtGroup1Caption%>"/>
										<jims2:sortResults beanName="courtPolicyForm" results="courtPolicySearchResults" primaryPropSort="group1Name" primarySortType="STRING" sortId="2" levelDeep="4"/>
									</td>
									<td class=subHead><bean:message key="<%=courtGroup2Caption%>"/>
										<jims2:sortResults beanName="courtPolicyForm" results="courtPolicySearchResults" primaryPropSort="group2Name" primarySortType="STRING" sortId="3" levelDeep="4"/>
									</td>
									<td class=subHead><bean:message key="<%=courtGroup3Caption%>"/>
										<jims2:sortResults beanName="courtPolicyForm" results="courtPolicySearchResults" primaryPropSort="group3Name" primarySortType="STRING" sortId="4" levelDeep="4"/>
									</td>
								</tr>
