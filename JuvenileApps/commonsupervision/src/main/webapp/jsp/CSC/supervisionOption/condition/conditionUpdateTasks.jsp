...
<!-- 07/29/2010  D Williamson	 - ER#55920 Added text counter -->
				...
				<tr>
					<td valign="top" align="center">
							...
							<tr>
								<td align="center" class="header">
									<logic:equal name="supervisionConditionForm" property="action" value="copy">
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|32">
										<bean:message key="prompt.copy" />
										<bean:message key="title.supervisionCondition" />&nbsp;-&nbsp;<bean:message key="title.emailNotificationAndTasks" />										
									</logic:equal>
									
									<logic:equal name="supervisionConditionForm" property="action" value="create">
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|8">
									...
									<logic:equal name="supervisionConditionForm" property="action" value="update">
										<logic:notEqual name="supervisionConditionForm" property="inUse" value="true">
											<logic:notEqual name="supervisionConditionForm" property="specialCondition" value="true">
												<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|17">
										...
										<logic:equal name="supervisionConditionForm" property="inUse" value="true">
											<logic:notEqual name="supervisionConditionForm" property="specialCondition" value="true">
												<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|18">
												<bean:message key="prompt.update" />
										...
										<logic:equal name="supervisionConditionForm" property="specialCondition" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|19">
											<bean:message key="prompt.update" />
												...
												<tr id="sc13" class="hidden">
													...
													<td class="formDe">
														...
														<logic:notEqual name="supervisionConditionForm" property="periodValue" value="0">
															<bean:write name="supervisionConditionForm" property="periodValue"/> 
															<bean:write name="supervisionConditionForm" property="period"/>
															</logic:notEqual>
														</logic:notEmpty>
													</td>
												</tr>
						...
						<table width="98%" border="0" cellspacing="1" cellpadding="4">
							...
							<tr>
								<td class="formDeLabel" width="1%" valign="top" nowrap><bean:message key="prompt.taskSubject" /><br>(Max Characters: 50)</td>
								<td class="formDe">
									<html:textarea name="supervisionConditionForm" property="tasks.subject2" rows="3" style="width:100%" onmouseout="textLimit( this, 50 )" onkeyup="textLimit( this, 50 )"></html:textarea>
								</td>
							</tr>
							<tr>
