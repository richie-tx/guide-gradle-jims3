...
<!-- 06/29/2006  C Shimek      - defect#30799 select condition radio button if only single condition found -->
<!-- 01/19/2007	 Hien Rodriguez - ER#38002 Add coding to integrate the Help Screen. -->
<!-- 10/07/2009  C Shimek      - defect#62318 revised "results" for to use string value created in search action -->
						...
						<td valign="top" align="center">
							...
							<logic:notEmpty name="supervisionConditionForm" property="conditionSearchResults">
								<div align="center">
									...
									<bean:write	name="supervisionConditionForm" property="searchResultText" />
								</div>
								<table width="98%" border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
									<tr class="detailHead">
										<td width="1%"></td>
										<td><bean:message key="prompt.conditionName" />
										...
										<td><bean:message key="<%=conditionGroup1Caption%>"/>
										...
										<td><bean:message key="<%=conditionGroup3Caption%>"/>
											<jims2:sortResults beanName="supervisionConditionForm" results="conditionSearchResults" primaryPropSort="group3Name" primarySortType="STRING" sortId="4" levelDeep="4"/>
										</td>
									</tr>
									...
									<logic:iterate id="conditionSearchResultsIter" name="supervisionConditionForm" property="conditionSearchResults" indexId="index">
