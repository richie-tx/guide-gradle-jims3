...
<!-- 09/10/2008  Richard Young defect#53440 add function to enable dropdowns when submit is pressed -->
...
<title><bean:message key="title.heading" /> - CSC/supervisionOption/deptPolicySearch.jsp</title>
</head>
...
<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|86">
<div align="center">
			...
			<table width=100% border="0" cellpadding="0" cellspacing="0" class="borderTableBlue">
				...
				<tr>
					<td valign=top align=center>
						...
						<table width=100%>
								<tr>
									<td align="center" class="header"><bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="prompt.search" /></td>
								</tr>
								<tr>
