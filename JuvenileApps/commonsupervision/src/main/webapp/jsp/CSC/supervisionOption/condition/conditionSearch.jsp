...
<!-- 08/20/2008  Clarence Shimek defect#53082 added onload script to maintain group selections on not founds -->
...
<html:base />
<title><bean:message key="title.heading" /> - supervisionOption/condition/conditionSearch.jsp</title>
...
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true)" onload="updateGroup2(document.forms[0])" >
<html:form action="/displaySupervisionConditionSearchResults" target="content" focus="conditionName">
<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|1">
<div align="center">
				...
				<tr>
					<td valign="top" align="center">
						...
						<table width="100%">
							<tr>
								<td align="center" class="header">
									<bean:message key="title.supervisionCondition" />&nbsp;<bean:message key="title.search" />
								</td>
							</tr>	
							<tr>
						...
						<table width="98%" border="0" cellspacing="0" cellpadding="2" class="borderTableBlue">
							<tr>
								<td class="detailHead"><bean:message key="title.search" />&nbsp;<bean:message key="title.supervisionCondition" /></td>
							</tr>
							<tr>
								<td>
									<table width="100%" border="0" cellspacing="1" cellpadding="2">
										<tr>
											...
											<td class="formDe"><html:text name="supervisionConditionForm" property="conditionName"/></td>
										</tr>
										<tr>
											<td class="formDeLabel"><bean:message key="prompt.literal" /></td>
											<td class="formDe"><html:text name="supervisionConditionForm" property="conditionLiteral" size="60"/></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="formDe">
												<html:select property="conditionStatusId" size="1">
													<html:option value=""><bean:message key="prompt.selectALL" /></html:option>
										...
										<tr>
											...
											<td class="formDe">
												<html:radio name="supervisionConditionForm" property="specialCondition" value="false"/><bean:message key="prompt.normal" />
												<html:radio name="supervisionConditionForm" property="specialCondition" value="true" /><bean:message key="prompt.special" />
											</td>
										</tr>
										<tr>
											<td class="formDeLabel" colspan="2">Select Court(s)</td>
										</tr>
										<tr>
						...
						<table border="0" width="100%">
							<tr>
								<td align="center">
								<html:submit property="submitAction" onclick="return validateConditionSearchForm(this.form) && disableSubmit(this, this.form);"><bean:message key="button.submit" /></html:submit>
								<input type="button" onclick="goNav('/<msp:webapp/>displaySupervisionConditionSearch.do')" value="<bean:message key='button.refresh'/>"/>
