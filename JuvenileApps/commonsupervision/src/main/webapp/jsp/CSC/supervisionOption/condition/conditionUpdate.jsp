...
<!-- 03/05/2010  Richard Young   - ER#64621 make eventType modifiable on the update flow -->
...
<!-- 07/16/2011  R Young  		 - #65585  Display Current Event Types for conditions not in use -->
...
<html:base />
<title>commonSupervision/CSC/supervisionOption/condition/conditionUpdate.jsp</title>
...
<logic:iterate indexId="groupIterIndex" id="groupIter" name="supervisionConditionForm" property="groups">
	groups[<bean:write name="groupIterIndex"/>] = new subgroup("<bean:write name="groupIter" property="groupId" />", "<bean:write name="groupIter" property="name"/>");
...
function setFocus()
{
	var txtFld = document.getElementsByName("conditionName");
...
<body topmargin="0" leftmargin="0" onload="reloadGroup(document.forms[0], '<bean:write name="supervisionConditionForm" property="group2Id"/>', '<bean:write name="supervisionConditionForm" property="group3Id"/>'), setFocus()"  onKeyDown="return checkEnterKeyAndSubmit(event,true)">
<html:form action="/displaySupervisionConditionUpdateTasks" target="content" onsubmit="myTinyMCEFix()">
<div align="center">
											...
											<td>
												<table width="100%" cellpadding="2" cellspacing="1">
														...
														<td colspan="3" class="formDe">
															...
															<logic:notEqual name="supervisionConditionForm" property="action" value="create">
																<logic:empty name="supervisionConditionForm" property="group2">
																	<html:select property="group2Id" disabled="true" onchange="updateGroup3(this.form);checkGroupChange(this, 2, supervisionConditionForm);">
																		<html:option value=""><bean:message key="select.generic" /></html:option>
																	</html:select>
																</logic:empty>
													...
													<tr>
														...
														<td colspan="3" class="formDe">
														<input type="hidden" name="selectedGroup3" value="<bean:write name="supervisionConditionForm" property="group3Id"/>" >
															<logic:equal name="supervisionConditionForm" property="action" value="create">
															...
															<logic:notEqual name="supervisionConditionForm" property="action" value="create">
																<logic:empty name="supervisionConditionForm" property="group3">
																	<logic:empty name="supervisionConditionForm" property="group2">
																		<html:select property="group3Id" disabled="true" onchange="checkGroupChange(this, 3, supervisionConditionForm)">
																			<html:option value=""><bean:message key="select.generic" /></html:option>
																		</html:select>
																	</logic:empty>
																	<logic:notEmpty name="supervisionConditionForm" property="group2">
																		<html:select property="group3Id" onchange="checkGroupChange(this, 3, supervisionConditionForm)">
																			<html:option value=""><bean:message key="select.generic" /></html:option>
																		</html:select>
																	</logic:notEmpty>
																</logic:empty>
																...
																<logic:notEmpty name="supervisionConditionForm" property="group3">
																	<html:select property="group3Id" size="1" onchange="checkGroupChange(this, 3, supervisionConditionForm)">
																		<html:option value=""><bean:message key="select.generic" /></html:option>
													...
													<logic:equal name="supervisionConditionForm" property="specialCondition" value="true">
														<tr>
															<td class="formDeLabel" valign="top" width="1%" nowrap><bean:message key="prompt.spanishLiteral" /><br>(Max Characters: 1000)</td>
															<td colspan="3" class="formDe">
															
															<html:textarea name="supervisionConditionForm" property="conditionSpanishLiteral" style="width:100%" rows="5" onmouseout="textLimit( this, 1000 )" onkeyup="textLimit( this, 1000 )" /></td>
														</tr>
														<tr>
															<td class="formDeLabel" valign="top" width="1%" nowrap><br>(Max Characters: 1000)
																<%--<bean:message key="prompt.4.diamond"/>--%><bean:message key="prompt.details"/></td>
															<td colspan="3" class="formDe" align="center">
																<html:textarea name="supervisionConditionForm" property="conditionLiteral" style="width:100%" rows="5" onmouseout="textLimit( this, 1000 )" onkeyup="textLimit( this, 1000 )" />
													...
													<logic:notEqual name="supervisionConditionForm" property="specialCondition" value="true">																
														<tr>
															<td class="formDeLabel" valign="top" width="1%" nowrap>
																<bean:message key="prompt.spanishLiteral" /><br>(Max Characters: 1000)</td>
															<td colspan="3" class="formDe" align="center">
																<html:textarea name="supervisionConditionForm" property="conditionSpanishLiteral" style="width:100%" rows="5" onmouseout="textLimit( this, 1000 )" onkeyup="textLimit( this, 1000 )" />																
															</td>
														</tr>
													</logic:notEqual>
													...
													<logic:notEqual name="supervisionConditionForm" property="specialCondition" value="true">
														...
														<logic:equal name="supervisionConditionForm" property="action" value="update">
					                                		...
					                                		<tr>
																<td class="formDeLabel" nowrap valign="top"><bean:message key="prompt.currentEventType"/>(s)</td>
																<td colspan="3" class="formDe">
																	<logic:notEqual name="supervisionConditionForm" property="specialCondition" value="true">
					                                		...
					                                		<tr>
																<td class="formDeLabel" nowrap valign="top"><bean:message key="prompt.additionalEventTypes" /></td>
																<td colspan="3" class="formDe">
																<logic:equal name="supervisionConditionForm" property="inUse" value="true">
																	<logic:equal name="supervisionConditionForm" property="specialCondition" value="true">
													...
													<tr>
														...
														<td colspan="3" class="formDe">
															<html:textarea name="supervisionConditionForm" property="notes" rows="3" style="width:100%" onmouseout="textLimit( this, 1000 )" onkeyup="textLimit( this, 1000 )" />
														</td>
													</tr>
												</table>
											</td>
