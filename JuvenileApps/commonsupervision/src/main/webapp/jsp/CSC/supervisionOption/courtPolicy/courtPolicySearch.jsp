...
<!-- 09/12/2006  Hien Rodriguez  defect#34944 change Title -->
...
<html:base />
<title><bean:message key="title.heading" /> - CSC/supervisionOption/courtPolicySearch.jsp</title>

<html:javascript formName="courtPolicySearchForm" />
...
function enableGroups(theForm){
	
	theForm.group1Id.disabled = false;
...
<html:form action="/displayCourtPolicySearchResults" target="content" focus="courtPolicyName">
<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|48">
<div align="center">
			...
			<table width=100% border="0" cellpadding="0" cellspacing="0" class="borderTableBlue">
				...
				<tr>
					<td valign=top align=center>
						...
						<table width=100%>
						  <tr>
							<td align="center" class="header"><bean:message key="<%=courtPolicyTitle%>"/>&nbsp;<bean:message key="prompt.search" /></td>
						  </tr>
							<tr>
						...
						<table width="98%" border="0" cellspacing=0 cellpadding=2 class=borderTableBlue>
							<tr>
								<td class=detailHead><bean:message key="prompt.search" />&nbsp;<bean:message key="<%=courtPolicyTitle%>"/></td>
							</tr>
							<tr>
								<td>
									<table width="100%" border="0" cellspacing=1 cellpadding=2>
										<tr>
											...
											<td class="formDe"><input type=text name="courtPolicyName" size=50></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="formDe">
													<html:select property="courtPolicyStatus" size="1">
						...
						<table border="0" width="100%">
						  <tr>
						    <td align="center">
						    	 <html:submit property="submitAction" onclick="return validateCourtPolicySearchForm(this.form) && enableGroups(this.form) && disableSubmit(this, this.form);"><bean:message key="button.submit"/></html:submit>	
							  	<input type="button" onclick="goNav('/<msp:webapp/>displayCourtPolicySearch.do')" value="<bean:message key='button.refresh'/>"/>
								<input type="button" value='<bean:message key="button.cancel" />' name="return" onclick="javascript:changeFormActionURL(this.form.name, '/<msp:webapp/>globalCancel.do', false) && disableSubmit(this, this.form)"> 
						     </td>
						  </tr>
						</table>
						<!-- END BUTTON TABLE -->
