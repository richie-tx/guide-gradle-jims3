...
<!-- 10/24/2007  Clarence Shimek defect#46036 add cursor set -->
<!-- 11/01/2007  Clarence Shimek defect#39326 removed extra spaces from heading -->
<!-- 07/28/2010  Debbie Williamson ER #55920 Added text counter -->
					...
					<td valign="top" align=center>
						  ...
						  <tr>
							<td align="center" class="header">
								<logic:equal name="courtPolicyForm" property="action" value="copy">
									<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|72">
								...
								<logic:equal name="courtPolicyForm" property="action" value="create">
									<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|53">
								...
								<logic:equal name="courtPolicyForm" property="action" value="update">
									...
									<logic:notEqual name="courtPolicyForm" property="inUse" value="true">
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|61">
									</logic:notEqual>
									<logic:equal name="courtPolicyForm" property="inUse" value="true">
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|62">
						...
						<table width="98%" border="0" cellspacing=1 cellpadding=4>
							...
							<tr>
								...
								<td class="formDe">
									<html:textarea name="courtPolicyForm" property="tasks.subject2" rows="3" style="width:100%" onmouseout="textLimit( this, 50 )" onkeyup="textLimit( this, 50 )" ></html:textarea>
								</td>
							</tr>
							<tr>
