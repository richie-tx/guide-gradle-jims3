...
<!-- 11/02/2009  C Shimek       - #62648 revised button table to only display single Finish button -->
						...
						<table width=98%>
							<tr>
								<td align="center" class="header">
									<input type="hidden" name="helpFile" value="commonsupervision/paso/process_adult_supervision_order.htm#|14">  <!-- create  -->
								<%-- 		<input type="hidden" name="helpFile" value="commonsupervision/paso/process_adult_supervision_order.htm#|20"> --%> <!-- update  -->
														...
														<logic:equal name="conditionSelectedListIndex" property="compareToPreviousVersion" value="" >															
															<tr class="<%out.print((index1.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
																...
																<logic:equal name="conditionSelectedListIndex" property="likeConditionInd" value="true">
																	<%classVal="impactedOrderBold title='This is a Like Condition and Impacts other order(s)'";
																	title=" title='This is a Like Condition and Impacts other order(s)'";
																	%>
																</logic:equal>
						...
						<table align="center" width="98%">
							<tr>
								<td align="center">
									...
									<jims2:if name="supervisionOrderForm" property="likeConditionInd" value="false" op="equal">
										<jims2:or name="supervisionOrderForm" property="compared" value="true" op="equal">
