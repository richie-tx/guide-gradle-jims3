								...
								<tr>
									<td valign="top">
									  <table width="100%" cellpadding="4" cellspacing="1" border="1">
										<!--case numbers-->
											<tr>
												<td width=50% colspan="4" class="formDeLabel" align="center"><bean:message key="prompt.case#" />:<bean:write name="supervisionOrderForm" property="caseNum" /></td>
												<td class="detailHead"><img src="/<msp:webapp/>images/spacer.gif" width="1"></td>
												<td width=50% colspan="4" class="formDeLabelRed" align="center"><bean:message key="prompt.impacted" /> <bean:message key="prompt.case#" />:<bean:write name="supervisionOrderForm" property="impactedOrder.caseNum" /></td>
											</tr>
											<tr>
										<!--current case-->
