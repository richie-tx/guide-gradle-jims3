...
<!-- 10/27/2009	 C Shimek       - #62623 Revised js to load current date in Signed Date if field is blank on initial page entry. -->
	...
	{		
		...
		for (var i = 0; i < theForm.defendantSignature.length; i++) {
	   	...
	   	if(! compareDate1GreaterEqualDate2(getCurrentDate(), theForm.defendantSignedDateAsString.value)){
	   		alert("Signed Date cannot be a future date.");
										...
										<table width=100% cellpadding=2 cellspacing=1 border=0>				                        		
											<tr>				                          	
												...
												<td class="formDe">
													...
													<A HREF="#" onClick="cal1.select(document.forms[0].defendantSignedDateAsString,'anchor1','MM/dd/yyyy'); return false;" NAME="anchor1" ID="anchor1" border="0"><bean:message key="prompt.3.calendar"/></A>
													<script>
											...
											<tr>
												...
												<td class="formDe">
													<html:radio name="supervisionOrderForm" property="defendantSignature" value="Signed"/><bean:message key="prompt.signed" />
													<html:radio name="supervisionOrderForm" property="defendantSignature" value="Not Signed"/><bean:message key="prompt.refusedToSign" />
												</td>
											</tr>
										</table>
									</td>
