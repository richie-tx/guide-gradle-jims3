...
<!-- 04/27/2009  C Shimek       - #59091 revised to displya multiple conditions -->
					...
					<td valign="top" align=center>
						...
						<!-- BEGIN INSTRUCTION TABLE -->
							<table width="98%" border="0">
								<tr>
									<td><ul>
										<li>Please review entries and click Save & Continue With Order. </li>												
									</ul></td>
								</tr>							
							</table>
						...
						<!-- BEGIN SUPERVISION CONDITION TABLE -->                      
							<table width="98%" border="0" cellspacing="0" class="borderTableBlue">
								...
								<tr>
									<td>
							<!-- BEGIN DISPLAY CONDITIONS TABLE -->							 		
							 			<table width="100%" cellpadding="2" cellspacing="1">
							 				<logic:iterate id="conditionEnterIndex" name="supervisionOrderForm" property="outputConditionList">
												<tr>
													<td class="formDeLabel" valign="top" width="1%" nowrap><bean:message key="prompt.condition" /></td>
													<td class="formDe"><bean:write name="conditionEnterIndex" property="description" filter="false"/></td>
												</tr>
												<tr>
													<td class="formDeLabel"><bean:message key="<%=group1Caption%>"/></td>
													<td class="formDe"><bean:write name="conditionEnterIndex" property="group1Name" /></td>
												</tr>
												<tr>
													<td class="formDeLabel" valign="top"><bean:message key="prompt.notes" /></td>
													<td class="formDe"><bean:write name="conditionEnterIndex" property="notes" /></td>
												</tr>
												<tr><td><img src="/<msp:webapp/>images/spacer.gif" height="2"></td></tr>
											</logic:iterate>
										</table>	
						<!-- END DISPLAY CONDITIONS TABLE -->
									</td>
								</tr>  
							 </table>
