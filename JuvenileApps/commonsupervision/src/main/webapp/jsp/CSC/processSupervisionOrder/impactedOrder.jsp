					...
					<td valign="top" align="center">
														...
														<logic:iterate id="conditionSelectedListIndex" name="supervisionOrderForm" property="conditionSelectedList">
															<logic:equal name="conditionSelectedListIndex" property="compareToPreviousVersion" value="" >															
																...
																<logic:equal name="conditionSelectedListIndex" property="likeConditionInd" value="true">
																	<td class=impactedOrder title="This is a Like Condition and Impacts other order(s)"/>														
								...
								<tr>
									<td valign="top">
									  <table width="100%" cellpadding="4" cellspacing="1" border="0">
										<!--case numbers-->
											<tr>
												<td colspan="4" class="formDeLabel" align="center" width="50%"><bean:message key="prompt.case#" />:<bean:write name="supervisionOrderForm" property="caseNum" /></td>
												<td class="detailHead"><img src="/<msp:webapp/>images/spacer.gif" width="1"></td>
												<td colspan="4" class="formDeLabelRed" align="center" width="50%"><bean:message key="prompt.impacted" /> <bean:message key="prompt.case#" />:<bean:write name="supervisionOrderForm" property="impactedOrder.caseNum" /></td>
											</tr>
											<tr>
										<!--current case-->
												...
												<td class="detailHead"><img src="/<msp:webapp/>images/spacer.gif" width="1"></td>
										<!--impacted case-->
												<td class="formDeLabelRed"><bean:message key="prompt.impacted" /> <bean:message key="prompt.orderTitle" /></td>
												<td class="formDe"><bean:write name="supervisionOrderForm" property="impactedOrder.orderTitle" /></td>
												<td class="formDeLabelRed"><bean:message key="prompt.impacted" /> <bean:message key="prompt.version" /></td>
										...
										<!--conditions-->
											...
											<logic:equal name="currentConditionIndex" property="likeConditionInd" value="true">
												...
												<tr>
													...
													<td class="formDe" colspan="3" valign="top"><bean:write name="currentConditionIndex" property="resolvedDescription"  filter="false"/></td>
													<td class="detailHead"><img src="/<msp:webapp/>images/spacer.gif" width="1"></td>
													<td class="formDeLabelRed" valign="top"><bean:message key="prompt.impacted" /> <bean:message key="prompt.conditionLiteral" /></td>
													<td class="formDe" colspan="3" valign="top"><bean:write name="condInnerTag" property="resolvedDescription"  filter="false"/></td>
												</tr>
										...
										<!--variable elements-->
												...
												<logic:equal name="varElemIndex" property="likeConditionInd" value="true">
													...
													<tr>
														...
														<td class="detailHead"><img src="/<msp:webapp/>images/spacer.gif" width="1"></td>
														<td class="formDeLabelRed"><bean:write name="valueInnerTag" property="name" /></td>
											...
											<bean:size id="impactedOrderSize" name="supervisionOrderForm" property="impactedOrderList"/>
											<logic:greaterEqual name="impactedOrderSize" value="2">																					
											<tr>
						...
						<!-- BEGIN BUTTON TABLE -->
							<table border="0" width="100%">											
								<tr>
									<td align="center">										
										<html:submit property="submitAction"><bean:message key="button.updateCurrentOrder"></bean:message></html:submit>&nbsp;  										 								
										<input type=button value="<bean:message key="button.printComparisonOfImpactedOrder"></bean:message>" onclick="openWindow('displaySupervisionOrderCompareImpactedOrder.do?submitAction=<bean:message key="button.printComparisonOfImpactedOrder"></bean:message>')" >
									</td>
								</tr>
								<tr>
									<td align=center>
