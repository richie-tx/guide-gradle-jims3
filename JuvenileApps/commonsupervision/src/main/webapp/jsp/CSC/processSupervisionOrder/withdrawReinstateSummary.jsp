...
<!-- 08/19/2011	 Richard Capestani - DE#68217 Fixed Print Order button that was giving an error -->
...
<script type="text/javascript">
	...
	// noPrintAllowed uses isMigratedOrder value on Form	
		if(document.forms[0].isMigratedOrder.value == 'true'){
						...
						<table width="98%" border="0" cellspacing=0 class=borderTableBlue>
							...
							<tr>
								...
								<tr>
									...
									<input type="hidden" name="isMigratedOrder" value="<bean:write name="supervisionOrderForm" property="isMigratedOrder" />" />
							</tr>
						</table>
					...
					<logic:equal name="supervisionOrderForm" property="action" value="confirmReinstate">
						<tr>
							<td align=center>			  		
								<html:submit property="submitAction" onclick="return disableSubmit(this, this.form);"><bean:message key="button.backToSearch"></bean:message></html:submit>&nbsp;
								<html:submit property="submitAction" onclick="return disableSubmit(this, this.form);"><bean:message key="button.backToCaseOrderSearchResults"></bean:message></html:submit>&nbsp;
								<html:submit property="submitAction" onclick="return checkTitle();"><bean:message key="button.printOrder"></bean:message></html:submit>
							</td>
						</tr>
					</logic:equal>														
				</table>
