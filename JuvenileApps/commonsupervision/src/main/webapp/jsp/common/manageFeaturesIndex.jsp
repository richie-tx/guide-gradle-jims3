...
<!-- 12/27/2005	 Hien Rodriguez - Create JSP -->
...
<html:base />
<title>Common Supervision - common/manageFeaturesIndex.jsp</title>

<script language="JavaScript" src="/<msp:webapp/>js/common_supervision_util.js"></script>

</head>
<body topmargin=0 leftmargin="0">
<html:form action="/displaySupervisionOrderSearch" target="content">
<div align="center">
						...
						<table width=98% border="0" cellpadding="0" cellspacing="0" class="borderTableGreen">
							...
							<tr>
								<td valign=top align=center>		
									<table width=98% border="0" cellpadding="0" cellspacing="0" >								
										<tr>
											<td valign=top align=center class=subHead><br><br><br><br>Welcome To Setup<br><br><br><br><br><br><br><br><br><br><br></td>
										</tr>
									</table>
								</td>
							</tr>
