...
<html:base />
<title><bean:message key="title.heading" /> - manageTasks/positionSearch.jsp</title>
...
<html:form action="/displayTransferPositionSearch" target="content" focus="userId">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Tasks/CSCD_Tasks.htm#|15">
																	...
																	<td>																
																		<table width="100%" cellpadding="2" cellspacing="1">
																			...
																			<tr>
																			  ...
																			  <td class="formDe"><html:text property="positionName" size="30" maxlength="50"/></td>
																		  </tr>
