...
<!-- 01/05/2010	 LDeen - This JSP is not in the struts-config.xml and doesn't appear to be used -->
<!-- 07/13/2010	 C Shimek       - defect#66328 revised criminalCaseId to cdiandCaseNumber to add space between cdi and caes number display -->
<!-- 09/30/2010	 RYoung        - Format  display fields -->
...
<head>
	...
	<html:base />
	<title>CommonSupervision/manageTasks/allocatesuperviseetosupervisor/caseListForAllocateSuperviseeToSupervisor.jsp</title>
...
<body topmargin="0" leftmargin="0">
	<html:form action="/reviewActiveCasesForAllocateSuperviseeToSupervisor" target="content">
									...
									<table width="100%">
										<tr>
											<td align="center" class="header" >
												<bean:message key="title.CSCD"/>&nbsp;-&nbsp;Allocate Supervisee To Supervisor - Review Active Cases
											</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
											...
											<td>
												<table width="100%" border="0" cellpadding="2" cellspacing="1">
													<tr class="formDeLabel">
														<td width="25%"><bean:message key="prompt.case" /></td>
														<td width="15%"><bean:message key="prompt.court" /></td>
														<td width="25%"><bean:message key="prompt.programUnit" /></td>
														<td width="35%"><bean:message key="prompt.officer" /></td>
													</tr>
											...
											<td align="center">
												...
												<logic:notEmpty name="caseAssignmentForm" property="caseToAcknowledge">
													<html:submit property="submitAction"  onclick="return disableSubmit(this, this.form);">
														<bean:message key="button.allocatesuperviseetosupervisor.reviewactivecases.paperfilereceived" />
													</html:submit>
												</logic:notEmpty>
												<html:submit property="submitAction">
