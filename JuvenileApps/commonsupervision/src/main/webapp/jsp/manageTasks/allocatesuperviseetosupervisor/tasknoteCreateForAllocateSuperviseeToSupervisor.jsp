...
<html:base />
<title>CommonSupervision/manageTasks/allocatesuperviseetosupervisor/tasknoteCreateForAllocateSuperviseeToSupervisor.jsp</title>
...
<html:form action="/addcasenoteforsupervisorallocation" target="content">
