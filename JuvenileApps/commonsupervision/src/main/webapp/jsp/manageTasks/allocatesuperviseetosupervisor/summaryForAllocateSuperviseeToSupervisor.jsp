...
<!-- 02/16/2012 Ryoung - Added error table for defect 71700 -->
<!-- 02/24/2012	 Richard Y. - Defect #72613 Change button to send back to task search results  -->
...
<head>
	...
	<html:base />
	<title>CommonSupervision/manageTasks/allocatesuperviseetosupervisor/summaryForAllocateSuperviseeToSupervisor.jsp</title>
...
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true)">
	<html:form action="/summaryforsupervisorallocation" target="content">
		<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assign_Supervisee/Assign_Supervisee.htm#|31">	
		<div align="center">
								...
								<td valign="top" align="center">
									...
									<table width="100%">
										<tr>
											<td align="center" class="header" ><bean:message key="title.CSCD"/>&nbsp;-
													Allocate Supervisee to Supervisor Summary
											</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
									...
									<table width="98%" border="0">
										<tr>
											<td>
												<ul>
													<li>Review Supervisor Allocation. Click Confirm to allocate Supervisee to Supervisor.</li>
												</ul>
											</td>
										</tr>
									</table>
											...
											<td align="center">
												...
												<logic:equal name="caseAssignmentForm" property="taskProcessed" value="false">
													<html:submit property="submitAction" onclick="return disableSubmit(this, this.form);">
														<bean:message key="button.allocatesuperviseetosupervisor.confirmation.confirm" />
													</html:submit> 
												</logic:equal>
												<html:submit property="submitAction">
