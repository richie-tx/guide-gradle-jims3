...
<body topmargin="0" leftmargin="0" onload="hideButton();checkForSingleResult()" onKeyDown="return checkEnterKeyAndSubmit(event,true)" onload="return selectSingleResult()">
		<html:form action="/selectsupervisorforsupervisorreallocation" target="content">
									...
									<table width="98%" border="0" cellpadding="4" cellspacing="1" class="borderTableBlue">
										<tr>
											...
											<td class="formDe">
												...
												<html:link action="/selectProgramUnitForReAssignSuperviseeToProgramUnit" paramId="submitAction" paramName="caseAssignmentForm" paramProperty="reassignDivisionLiteral" > Reassign division </html:link>
											</td>
										</tr>
										<tr>
											<td class="formDeLabel" width="1%" nowrap="nowrap">
