...
<!-- 02/11/2009  CShimek        - Added missing app.js for Back to Top -->
...
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true)">
	<html:form action="/confirmationforsupervisorreallocation" target="content">
							...
							<td valign="top" align="center">
								...
								<table width="100%">
									<tr>
										...
										Reallocate Supervisee to Supervisor Confirmation</td>
									</tr>
								</table>
								<!-- END HEADING TABLE -->
