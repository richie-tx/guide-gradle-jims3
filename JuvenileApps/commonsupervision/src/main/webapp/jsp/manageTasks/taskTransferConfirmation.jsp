...
<html:base />
<title><bean:message key="title.heading" /> - manageTasks/taskTransferConfirmation.jsp</title>
...
<body onKeyDown="checkEnterKeyAndSubmit(event,true)">
	...
	<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Tasks/CSCD_Tasks.htm#|18">
	<div align="center">
...
<!-- BEGIN HEADING TABLE -->
							<table width="100%">
								<tr>
									<td align="center" class="header"><bean:message key="title.CSCD" /> - &nbsp;<bean:message key="prompt.transfer" /> Task Confirmation</td>
								</tr>
							</table>
<!-- END HEADING TABLE --> 
<!-- BEGIN ERROR TABLE -->
...
<!-- BEGIN SELECT SEARCH TABLE -->
                    ...
                    <table width="98%" border="0" cellpadding="2" cellspacing="1" class=borderTableBlue> 
                      <tr> 
                        <td> <br> 
                          <div class=confirm>Task successfully transferred </div> 
                          <br> </td> 
                      </tr> 
                    </table> 
                    <!--end confirmation table--> 
										...
										<table border="0" width="100%">
											<tr>
												<td align="center">
												<html:submit property="submitAction"><bean:message key="button.backToTasks"></bean:message>
												</html:submit> 
											</td>
											</tr>
										</table>
