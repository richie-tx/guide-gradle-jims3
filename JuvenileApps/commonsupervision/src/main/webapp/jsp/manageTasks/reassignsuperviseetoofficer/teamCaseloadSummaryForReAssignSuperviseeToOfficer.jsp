...
<!-- 02/09/2009  CShimek    #56494 Added formatKey to LOS, IND and Workload display values -->
<!-- 03/19/2009  CShimek    #57977 Removed "sss" from case prompt in Caseload Summary block -->
<!-- 06/01/2011  RCapestani #65038 Added Error Table -->
...
<head>
	...
	<html:base />
	<title><bean:message key="title.heading" /> - assignSupervisee/teamCaseloadSummary.jsp</title>
...
<body topmargin="0" leftmargin="0" onload="hideButton(); checkForSingleResult();" onKeyDown="return checkEnterKeyAndSubmit(event,true)">
	<html:form action="/selectofficerforofficerreassignment" target="content">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0" class="borderTableBlue">
							...
							<tr>
								<td valign="top" align="center">
									...
									<table width="100%">
										<tr>
											<td align="center" class="header" >
													Reassign Supervisee to Officer - Caseload Summary
											</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
										...
										<table width="98%" border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
											<tr>
												...
												<td class="formDe">
													...
													<a href="/<msp:webapp/>selectofficerforofficerreassignment.do?submitAction=Link">Return Assignment</a>
												</td>
											...
											<tr>
												<td class="formDeLabel" width="1%" nowrap>
													<bean:message key="prompt.select" /> <bean:message key="prompt.supervisor" />
												</td>
												<td class="formDe">
														<html:select name="caseAssignmentForm" property="supervisorPositionId">	
															<html:optionsCollection 
																name="caseAssignmentForm" 
																property="supervisionStaff" 
																value="staffPositionId" 
																label="assignedName.formattedName"
															/>													
														</html:select>											
												
														<html:submit property="submitAction">
															<bean:message key="button.assignsuperviseetoofficer.selectofficer.viewcaseloadsummary" />
														</html:submit>
												</td>
											</tr>
											...
											<td>
												<table width="100%" cellpadding="2" cellspacing="1" border="0">
													<tr class="formDeLabel">
														...
														<td align="center"><bean:message key="prompt.LOS" />0</td>
														<td align="center"><bean:message key="prompt.LOS" />1</td>
														<td align="center"><bean:message key="prompt.LOS" />2</td>
														<td align="center"><bean:message key="prompt.LOS" />3</td>
														<td align="center"><bean:message key="prompt.LOS" />4</td>
												    ...
												    <logic:iterate id="caseloadIndex" name="caseAssignmentForm" property="caseloads">
							  						<tr class= <% String currentOfficerId = ((CaseloadSummaryTO)caseloadIndex).getOfficerPositionId();
														...
														<td align="center"><bean:write name="caseloadIndex" property="los0" formatKey="currency.format"/></td>
														<td align="center"><bean:write name="caseloadIndex" property="los1" formatKey="currency.format"/></td>
														<td align="center"><bean:write name="caseloadIndex" property="los2" formatKey="currency.format"/></td>
														<td align="center"><bean:write name="caseloadIndex" property="los3" formatKey="currency.format"/></td>
														<td align="center"><bean:write name="caseloadIndex" property="los4" formatKey="currency.format"/></td>
														<td align="center"><bean:write name="caseloadIndex" property="ind" formatKey="currency.format"/></td>
														<td align="center"><bean:write name="caseloadIndex" property="workload" formatKey="currency.format"/></td>	
													</tr>
													<tr>
									...
									<table width="98%" border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
										<tr class="detailHead">
											<td><bean:message key="prompt.position" /> <bean:message key="prompt.assignment" /></td>  
										</tr>
										<tr>
											<td>
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr>
														<td class="formDeLabel" nowrap width="1%"><img src="/<msp:webapp/>images/required.gif" title="required" alt="required image" border="0" width="10" height="9"><bean:message key="prompt.position" /> <bean:message key="prompt.assignmentDate" />  </td>
														<td class="formDe" nowrap width="78%">
															<script type="text/javascript">
															...
															<img border="0" src="/<msp:webapp/>images/calendar2.gif" title="(mm/dd/yyyy)"/></A>
														</td>
														</tr>
													</table>
												</td>
