...
<!-- 06/30/2010  CShimek      #65947 removed onload(), not needed on this page -->
...
<html:form action="/returnReassignedCasesSummary" target="content">
	<div align="center">
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="borderTableBlue">
				...
				<tr>
					...
					<table width="98%" cellpadding="2" cellspacing="1" border="0" class="borderTableBlue">
						...
						<tr>
							<td><bean:write name="caseAssignmentForm" property="assignmentReturnReason" /></td>
						</tr>
					</table>
					<br />
					<!-- END DETAIL TABLE --> 
