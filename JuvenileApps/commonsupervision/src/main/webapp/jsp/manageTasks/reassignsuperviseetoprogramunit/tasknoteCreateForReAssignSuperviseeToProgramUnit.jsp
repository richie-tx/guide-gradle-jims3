...
<script language="javascript" type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
...
<html:form action="/addCasenoteForReAssignSuperviseeToProgramUnit" target="content">
