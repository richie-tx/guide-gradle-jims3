...
<head>
	...
	<html:base />
	<title><bean:message key="title.heading" /> - assignSupervisee/tasknoteConfirmation.jsp</title>
							...
							<tr>
								<td valign="top" align="center">
											...
											<td>
												...
												<%--<script>
													if (location.search=="?new"){
														document.write("Supervisee successfully allocated to Supervisor.")
														}else if (location.search=="?officer"){
															document.write("Supervisee successfully assigned to Officer.")
															}else if (location.search=="?newCase"){
																document.write("Process officer new case assignment successful.")
															}else if (location.search=="?officerCaseload"){
																document.write("Supervisee successfully reassigned to Officer.")
													}
												</script>--%>
												</div>
												<br>
									...
									<table border="0" width="100%">
										<tr>
											<td align="center">
<!-- 											<logic:equal name="caseAssignmentForm" property="<%=CaseloadConstants.SCENARIO%>" value="<%=CaseloadConstants.SC_ASSIGN_NEW_CASE%>">
...
-->							
											<logic:equal name="caseAssignmentForm" property="<%=CaseloadConstants.ACTIVITY_IND%>"
											 ...
											 <span class="hidden" id="caseloadButton">
												<input type="button" value="Back to Caseload" onClick="goNav('../caseload/caseloadList.htm')">
											</span>
										</td>
										</tr>
									</table>
