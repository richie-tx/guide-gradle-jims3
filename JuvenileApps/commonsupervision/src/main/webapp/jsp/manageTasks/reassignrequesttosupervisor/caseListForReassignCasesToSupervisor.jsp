...
<head>
	...
	<html:base />
	<title><bean:message key="title.heading" /> - reassignrequesttosupervisor/caseListForReassignCasesToSupervisor.jsp</title>
...
<body topmargin=0 leftmargin="0">
	<html:form action="/reviewActiveCasesForSuperviseeTransferRequest" target="content">
								...
								<td valign=top align=center>
									...
									<table width=100%>
										<tr>
											...
											Reassign Supervisee Approval Request - Review Active Cases</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
									<!-- BEGIN ERROR TABLE -->
