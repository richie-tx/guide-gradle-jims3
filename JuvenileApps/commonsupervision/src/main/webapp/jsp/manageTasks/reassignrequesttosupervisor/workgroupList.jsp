...
<head>
	...
	<html:base />
	<title><bean:message key="title.heading" /> - reassignrequesttosupervisor/workgroupList.jsp</title>
...
<body topmargin=0 leftmargin="0" onload="hideButton();">
	<html:form action="/approveReassignmentSelectWorkgroupAction" target="content">
		<div align="center">
									...
									<table width=100%>
										<tr>
											<td align="center" class="header" >
												...
												Approve Case Reassignment - Select Workgroup
											</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
