...
<!-- 02/11/2009  CShimek        - add app.js to correct js error for back to top -->
...
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true)">
	<html:form action="/confirmationforreassigncasestonewofficer" target="content">
								...
								<table width="100%">
									<tr>
										<td align="center" class="header" ><bean:message key="title.CSCD"/>&nbsp;-&nbsp;
										 Case Reassignment Confirmation</td>
									</tr>
								</table>
								<!-- END HEADING TABLE -->							
