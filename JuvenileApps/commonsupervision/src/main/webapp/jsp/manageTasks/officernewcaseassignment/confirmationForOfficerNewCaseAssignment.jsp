...
<head>
	...
	<html:base />
	<title><bean:message key="title.heading" /> - manageTasks/officernewcaseassignment/confirmationForOfficerNewCaseAssignment.jsp</title>
...
<body topmargin=0 leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true)">
	<html:form action="/confirmationforprocessofficernewcaseassignment" target="content">
								...
								<table width=100%>
									<tr>
										<td align="center" class="header" ><bean:message key="title.CSCD"/>&nbsp;-&nbsp;
										 New Case Assignment Confirmation</td>
									</tr>
								</table>
								<!-- END HEADING TABLE -->							
