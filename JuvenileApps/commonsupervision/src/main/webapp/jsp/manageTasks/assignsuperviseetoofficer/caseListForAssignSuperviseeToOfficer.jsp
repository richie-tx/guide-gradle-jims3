...
<head>
	...
	<html:base />
	<title><bean:message key="title.heading" /> - manageTasks/assignsuperviseetoofficer/caseListForAssignSuperviseeToOfficer.jsp</title>
...
<body topmargin="0" leftmargin="0">
	<html:form action="/reviewActiveCasesForAssignSuperviseeToOfficer" target="content">
									...
									<table width="100%">
										<tr>
											<td align="center" class="header" > 
												<bean:message key="title.CSCD"/>&nbsp;-&nbsp;Assign Supervisee To Officer - Review Active Cases
											</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
