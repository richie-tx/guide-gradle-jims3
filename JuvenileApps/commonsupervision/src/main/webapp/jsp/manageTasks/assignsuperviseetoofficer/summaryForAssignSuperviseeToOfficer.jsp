...
<head>
	...
	<html:base />
	<title><bean:message key="title.heading" /> - manageTasks/assignsuperviseetoofficer/summaryForAssignSuperviseeToOfficer.jsp</title>
...
<body topmargin=0 leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true)">
	<html:form action="/summaryforofficerallocation" target="content">	
									...
									<table width=100%>
										<tr>
											<td align="center" class="header" ><bean:message key="title.CSCD"/>&nbsp;-
													Assign Supervisee to Officer Summary
											</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
