...
<!-- 12/07/2009 C. Shimek  - #62924 added sortResult to POI -->
<!-- 04/15/2010 C. Shimek  - #64910 added missing error message table -->
...
<head>
	...
	<html:base />
	<title><bean:message key="title.heading" /> - manageTasks/assignsuperviseetoofficer/teamCaseloadSummaryForAssignSuperviseeToOfficer.jsp</title>
...
<body topmargin="0" leftmargin="0" onload="hideButton(); checkForSingleResult();" onKeyDown="return checkEnterKeyAndSubmit(event,true)">
	...
	<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assign_Supervisee/Assign_Supervisee.htm#|5">
		<div align="center">
<!-- BEGIN PAGE TABLE -->		
									...
									<table width="100%">
										<tr>
											<td align="center" class="header" >
													Assign Supervisee to Officer - Caseload Summary
											</td>
										</tr>
									</table>
<!-- END HEADING TABLE -->
										...
										<table width="98%" border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
											<tr>
												...
												<td class="formDe">
													...
													<a href="/<msp:webapp/>selectofficerforofficerassignment.do?submitAction=Link">Return Assignment</a>
												</td>
											</tr>
											<tr>
...
<!-- END PU and SELECT TABLE -->										
										<br>
									</span>
<!-- BEGIN CASELOAD SUMMARY TABLE -->									
											...
											<td>
												<table width="100%" cellpadding="2" cellspacing="1" border="0">
													<tr class="formDeLabel">
														<td width="1%"></td>
														<td>POI<jims2:sortResults beanName="caseAssignmentForm" results="caseloads" primaryPropSort="probationOfficerInd" primarySortType="STRING"  defaultSort="true" defaultSortOrder="ASC" sortId="1" hideMe="true"/></td>
														<td>Position Name</td>
														<td>CJAD</td>
														<td>Officer Name</td>
												    ...
												    <logic:iterate id="caseloadIndex" name="caseAssignmentForm" property="caseloads">
							  							<tr class= <% String currentOfficerId = ((CaseloadSummaryTO)caseloadIndex).getOfficerPositionId();
															...
															<logic:empty name="caseloadIndex" property="officerName">
																<td></td>
															</logic:empty>
															<logic:notEmpty name="caseloadIndex" property="officerName">
...
<!-- END NOTES TABLE -->									
									<br/>
<!-- BEGIN POSITION ASSIGNMENT TABLE -->									
									<table width="98%" border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
										<tr class="detailHead">
