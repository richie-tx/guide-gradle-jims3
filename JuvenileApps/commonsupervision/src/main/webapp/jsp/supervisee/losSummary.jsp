...
<html:base />
<title><bean:message key="title.heading" /> - supervisee/losSummary.jsp</title>
...
<logic:equal name="superviseeForm" property="action" value="<%=UIConstants.UPDATE%>">
	<%
         pageContext.setAttribute("submitURL", "/submitCorrectLOS");
    %>
</logic:equal>

<logic:equal name="superviseeForm" property="action" value="<%=UIConstants.CREATE%>">
	<%
         pageContext.setAttribute("submitURL", "/submitAddLOS");
    %>
</logic:equal>

<logic:equal name="superviseeForm" property="action" value="<%=UIConstants.DELETE%>">
	<%
		pageContext.setAttribute("submitURL", "/submitDeleteLOS");
	%>
</logic:equal>
								...
								<tr>
									<td valign=top align=center>
										...
										<div class=header><bean:message key="title.CSCD" />&nbsp;-
											<logic:equal name="superviseeForm" property="action" value="<%=UIConstants.UPDATE%>">
												<bean:message key="prompt.correct"/><input type="hidden" name="helpFile" value="commonsupervision/CSCD_Supervisee_Search/Supervisee_Search.htm#|8">
											</logic:equal>
											<logic:equal name="superviseeForm" property="action" value="<%=UIConstants.CREATE%>">
												<bean:message key="prompt.add"/><input type="hidden" name="helpFile" value="commonsupervision/CSCD_Supervisee_Search/Supervisee_Search.htm#|6">
											</logic:equal>
                                            <logic:equal name="superviseeForm" property="action" value="<%=UIConstants.DELETE%>">
												<bean:message key="prompt.delete"/><input type="hidden" name="helpFile" value="commonsupervision/CSCD_Supervisee_Search/Supervisee_Search.htm#|9">
											</logic:equal>
										    <bean:message key="prompt.LOS"/>&nbsp;<bean:message key="title.summary"/>
										</div>
                                        <!-- BEGIN ERROR TABLE -->
										...
										<div class=instructions>
											<li>
												<logic:equal name="superviseeForm" property="action" value="<%=UIConstants.DELETE%>">
													Click Finish to Delete the LOS record.
                                                </logic:equal>
												...
												<td>
													<table width="100%" cellpadding="4" cellspacing="1">																	
														<tr>
															...
															<td class=formDe><bean:write name="superviseeForm" property="effectiveDate" formatKey="format.date.mmddyyyy" /></td>
														</tr>
														<tr>
															<td class=formDeLabel width=1% nowrap><bean:message key="prompt.supervisionLevel"/></td>
															<td class=formDe><bean:write name="superviseeForm" property="supervisionLevelDesc" />
															</td>
														</tr>
														<tr>
															<td class=formDeLabel>Comments</td>
															<td class=formDe colspan=2><bean:write name="superviseeForm" property="losComments" /></td>
														</tr>
													</table>
												</td>
											</tr>
