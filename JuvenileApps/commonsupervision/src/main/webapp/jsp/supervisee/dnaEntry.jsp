...
<html:base />
<title><bean:message key="title.heading" /> - supervisee/dnaEntry.jsp</title>
...
<script type="text/javascript">
	...
	function validateField(theForm) {
		...
		if(theForm.dnaCollectedDate.value == "") {
			alert("DNA Collected Date is required.");
		   	theForm.dnaCollectedDate.focus();
		   	return false;			
		} 
		
		if (!isDate(theForm.dnaCollectedDate.value)) {
			alert("DNA Collected Date is invalid. Valid format is mm/dd/yyyy.");
			theForm.dnaCollectedDate.focus();
			return false;
		}
		
		
		if(theForm.dnaFlagInd.value == false) {		
	    	alert("DNA Flag is required.");
	    	theForm.dnaFlagInd.focus();
	    	return false;
	   	}
	}   	
...
<html:form action="/displayAddDNASummary" target="content" focus="dnaCollectedDate">
<input type="hidden" name="helpFile"
		value="commonsupervision/CSCD_Supervisee_Search/Supervisee_Search.htm#|20">
								...
								<tr>
									<td valign="top" align="center">
										...
										<div class="header"><bean:message key="title.CSCD" />&nbsp;-
										    ...
										    <bean:message key="prompt.dna"/></div>
                                            <!-- BEGIN ERROR TABLE -->
											...
											<tr>
												<td>
													<table width="100%" cellpadding="2" cellspacing="1">
														<tr>
															<td class="formDeLabel" nowrap width="15%"><bean:message key="prompt.2.diamond"/><bean:message key="prompt.dnaCollectedDate"/></td>
															<td class="formDe">
                                                             <SCRIPT LANGUAGE="JavaScript" ID="js1">
																var cal1 = new CalendarPopup();
																cal1.showYearNavigation();
															 </SCRIPT>
															 <html:text name="superviseeForm" property="dnaCollectedDate" maxlength="10" size="10" />
															 <A HREF="#" onClick="cal1.select(document.forms[0].dnaCollectedDate,'anchor1','MM/dd/yyyy'); return false;"
