...
<html:base />
<title><bean:message key="title.heading" /> - supervisee/dnaCorrect.jsp</title>
...
<html:form action="/displayCorrectDNASummary" target="content" focus="dnaCollectedDate">
<input type="hidden" name="helpFile"
		value="commonsupervision/CSCD_Supervisee_Search/Supervisee_Search.htm#|23">
								...
								<tr>
									<td valign=top align=center>
										...
										<div class=header><bean:message key="title.CSCD" />&nbsp;-
											<logic:equal name="superviseeForm" property="action" value="update">
