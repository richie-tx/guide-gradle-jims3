...
<html:base />
<title><bean:message key="title.heading" /> - administerSupervisee/displaySuperviseeDataControlSearch.jsp</title>
...
<html:form action="/displaySuperviseeCreditDataControl" target="content" focus="spn" >
			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="borderTableBlue">
				...
				<tr>
					...
					<!-- BEGIN HEADING TABLE -->
						<table width="100%">
							<tr>							
								<td align="center" class="header">CSCD - Supervisee Credit Data Control Search</td>						
							</tr>
						</table>
					<!-- END HEADING TABLE -->
					<!-- BEGIN ERROR TABLE -->
					...
					<!-- BEGIN  TABLE -->																									
					<!--start search by case -->
							<span id="caseSearch" >
								<table align="center" width="98%" border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
									<tr class="detailHead">
										<td colspan="2">Search By SPN</td>
									</tr>
									<tr>
										...
										<td>
											<table width="100%" border="0" cellpadding="2" cellspacing="1">
												<tr>
													<td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="prompt.2.diamond"/>SPN</td>
													<td class="formDe">
														<html:text property="spn" maxlength="8"></html:text>
													</td>
												</tr>
											</table>
										</td>
