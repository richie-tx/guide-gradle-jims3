...
administersupervisee/updateSuperviseeCreditConfirmation.jsp</title>
				...
				<tr>
					...
					<table width="100%">
						<tr>
							...
							Supervisee Credit Confirmation</td>
						</tr>
					</table>
					...
					<table width="98%" border="0" cellpadding="2" cellspacing="1"
						...
						<tr>
							<td><br>
							<div class="confirm">Supervisee Credit successfully updated.</div>
							<br>
							</td>
						</tr>
					</table>
					...
					<div class="spacer4px"><html:submit property="submitAction">Back To Search</html:submit>
					</div>
