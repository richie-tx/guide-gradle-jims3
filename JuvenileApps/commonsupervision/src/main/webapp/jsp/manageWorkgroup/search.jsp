...
<html:base />
<title><bean:message key="title.heading" /> - manageWorkgroup/search.jsp</title>
...
<html:form action="/displayWorkgroupSearchResults" target="content" focus="workgroupName">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Workgroups/Manage_Workgroups.htm#|7">
<div align="center">
								...
								<!-- BEGIN HEADING TABLE -->
									<table width=100%>
										<tr>							
											...
											<bean:message key="title.CSCD" />&nbsp;-&nbsp;<bean:message key="prompt.workgroup" />&nbsp;<bean:message key="title.search" />
										</td>						
						  				</tr>
									</table>
								<!-- END HEADING TABLE -->
									...
									<table border="0" width="100%">
										<tr>
											<td align="center">
												...
												<jims2:isAllowed requiredFeatures="CS-WORKGRP-CREATE">
													<input type="submit" name="submitAction" onclick="return (changeFormActionURL(this.form.name, '/<msp:webapp/>createWorkgroup.do',false) && disableSubmit(this, this.form));" value='<bean:message key="button.createWorkgroup"/>'></input>&nbsp;
												</jims2:isAllowed>
