...
<!-- 03/29/2010 Richard Young - #64601 Print Packet-Select Service Provider -->
							...
							<table width="100%">
								<tr>
									<td align="center" class="header"><bean:message
										key="title.CSCD" />&nbsp;- Print Packet - Select Service Provider
										</td>
								</tr>
							</table>
							<!-- END HEADING TABLE -->
									...
									<table width="100%" cellpadding="2" cellspacing="0"
										...
										<tr>
											...
											<table width="100%" cellpadding="4" cellspacing="1">
												<tr>
													<td class="formDeLabel" nowrap="nowrap" width="1%"><bean:message key="prompt.referralTypes" /></td>
								...
								<tr>
									...
									<table width="100%" cellpadding="2" cellspacing="1"
										...
										<tr class="formDeLabel">
											...
											<td title="Service Provider Name" nowrap="nowrap"><bean:message key="prompt.serviceProviderName" />
											...
											<td nowrap="nowrap" width="5%"><bean:message key="prompt.inHouse" />
										...
										<logic:iterate id="spIndex" name="cscProgRefForm" property="filteredSPList">
											<tr class='<% RecordCounter2++;
													...
													<td class="referralTypeNumber"><bean:write name="spIndex" property="serviceProviderRefTypes" /></td>
