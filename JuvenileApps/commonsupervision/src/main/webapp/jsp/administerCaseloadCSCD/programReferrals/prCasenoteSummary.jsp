...
<html:base />
<title><bean:message key="title.heading" /> - admininsterCaseloadCSCD/programReferrals/prCasenoteSummary.jsp</title>
...
<html:form action="/submitProgRefCasenote" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Program_Referrals/CSCD_Program_Referrals.htm#|19">
<div align="center">
								...
								<td valign="top" align="center">
									...
									<table width="100%">
										<tr>
											...
											<bean:message key="title.create"/>&nbsp;<bean:message key="prompt.programReferral"/>&nbsp;<bean:message key="prompt.casenote"/>&nbsp;<bean:message key="prompt.summary"/></td>
										</tr>
									</table>
									<%-- BEGIN ERROR TABLE --%>
									...
									<table width="98%" cellpadding="4" cellspacing="0" class="borderTableBlue">
										<tr class="detailHead">
											<td><bean:message key="prompt.casenote"/></td>
										</tr>
										<tr>
											<td class="formDe">
												<bean:write name="cscProgRefForm" property="casenoteComments" filter="false"/> 
											</td>
										</tr>
									</table>
									<!-- BEGIN BUTTON TABLE -->
