...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/assessments/scsScreenTwoCreateUpdate.jsp</title>
								...
								<td valign="top" align="center">
									...
									<div class="header"><bean:message key="title.CSCD"/>&nbsp;-
										<logic:equal name="scsAssessmentForm" property="action" value="update">
											<bean:message key="title.update"/><input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assessments/CSCD_Assessments.htm#|34">
										</logic:equal>
										<logic:equal name="scsAssessmentForm" property="action" value="create">
											<bean:message key="prompt.new"/><input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assessments/CSCD_Assessments.htm#|28">
										</logic:equal>
										 <bean:message key="title.SCSInventory"/>&nbsp;Screen 2</div>
										<!-- END HEADING -->
										...
										<tr>
											<td>
												<table width="100%" cellpadding="2" cellspacing="1">
													<jims2:cscquestions name="scsAssessmentForm" property="scsScreenTwoQuestionsList" type="input" columns="2"/>
												</table>
											</td>
										</tr>
									</table>
									...
									<div class="spacer4px"></div>
										...
										<!-- BEGIN BUTTON TABLE -->
									<html:hidden name="scsAssessmentForm" property="scsScreenType" value="screenTwo" />
