...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/assessments/forceFieldDetails.jsp</title>
							...
							<tr>
								<td valign="top" align="center">
									...
									<div class="header">
										...
										<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assessments/CSCD_Assessments.htm#|6">
                                    </div>
									<!-- END HEADING -->
										...
										<tr>
											<td>
												<ul>
						                            ...
						                            <logic:equal name="forceFieldAssessmentForm" property="supervisionPeriod" value="<%= CSCAssessmentConstants.ASSESSMENT_SUPERVISION_PRD_ACTV %>"> 
												...
												<td>
													<table width="100%" cellpadding="4" cellspacing="1">
														...
														<% int RecordCounter= -1; %>	
													  	...
													  	<logic:iterate id="eachAssessmentVersion" name="forceFieldAssessmentForm" property="versionDetailsList">  
								...
								<!--assessment date start-->
									<table width="98%" cellpadding="4" cellspacing="1" class="borderTableBlue">
										<tr>
											...
											<td class="formDe">
												<bean:write name="forceFieldAssessmentForm" property="assessmentDateStr" /><logic:equal name="forceFieldAssessmentForm" property="migrated" value="Y"><logic:notEmpty name="forceFieldAssessmentForm" property="actualAssessmentDate" ><a href="#" title="" class=tooltip230><img src="/<msp:webapp/>images/starGreenIcon.gif" border=0><span><div>Actual Assessment Date: <bean:write name="forceFieldAssessmentForm" property="actualAssessmentDate" formatKey="date.format.mmddyyyy"/></div></span></a></logic:notEmpty></logic:equal>
											</td>
										</tr>
									</table>
								<!--assessment date end-->
									...
									<tr>
										<td align="center">
											<html:submit property="submitAction"> <bean:message key="button.back" /></html:submit>	
										 	...
										 	<logic:equal name="forceFieldAssessmentForm" property="supervisionPeriod" value="<%= CSCAssessmentConstants.ASSESSMENT_SUPERVISION_PRD_ACTV %>">   
										 		<logic:equal name="forceFieldAssessmentForm" property="islatestVersionShown" value="true">  
										 			<jims2:isAllowed requiredFeatures='<%=Features.CSCD_ASSESS_UPDATE_WITH_RESTRC%>'> 
								          			...
								          			<jims2:isAllowed requiredFeatures='<%=Features.CSCD_ASSESS_DELETE_WITH_RESTRC%>'>
								          				<logic:equal name="forceFieldAssessmentForm" property="sentToState" value="false">
															<html:submit property="submitAction"> <bean:message key="button.delete" /></html:submit>
														</logic:equal>	
								          			</jims2:isAllowed>	
								          		</logic:equal> 
