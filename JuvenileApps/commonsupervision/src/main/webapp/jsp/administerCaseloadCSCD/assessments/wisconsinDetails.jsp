...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/assessments/wisconsinDetails.jsp</title>
								...
								<td valign="top" align="center">								
									...
									<div class="header"><bean:message key="title.CSCD"/>&nbsp;-
											<logic:equal name="wisconsinAssessmentForm" property="wisconsinAssessmentType" value="<%= CSCAssessmentConstants.ASSESSMENT_INITIAL_ASSESSMENT %>">
												<bean:message key="prompt.wisconsin"/>&nbsp;<bean:message key="prompt.assessment"/><input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assessments/CSCD_Assessments.htm#|3">
											</logic:equal>
											<logic:notEqual name="wisconsinAssessmentForm" property="wisconsinAssessmentType" value="<%= CSCAssessmentConstants.ASSESSMENT_INITIAL_ASSESSMENT %>">
												<bean:message key="prompt.wisconsin"/>&nbsp;<bean:message key="prompt.reassessment"/><input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assessments/CSCD_Assessments.htm#|16">
											</logic:notEqual>
										...
										<tr>
											<td>
												<ul>
						                            ...
						                            <logic:equal name="wisconsinAssessmentForm" property="supervisionPeriod" value="<%= CSCAssessmentConstants.ASSESSMENT_SUPERVISION_PRD_ACTV %>"> 
												...
												<tr>
													<td>
														<table width="100%" cellpadding="4" cellspacing="1">
														  ...
														  <logic:iterate id="eachAssessmentVersion" name="wisconsinAssessmentForm" property="versionDetailsList">  
											...
											<table width="98%" cellpadding="4" cellspacing="1" class="borderTableBlue">
												<tr>
													...
													<td class="formDe">
														...
														<bean:write name="wisconsinAssessmentForm" property="assessmentDateStr" /><logic:equal name="wisconsinAssessmentForm" property="migrated" value="Y"><logic:notEmpty name="wisconsinAssessmentForm" property="actualAssessmentDate" ><a href="#" title="" class=tooltip230><img src="/<msp:webapp/>images/starGreenIcon.gif" border=0><span><div>Actual Assessment Date: <bean:write name="wisconsinAssessmentForm" property="actualAssessmentDate" formatKey="date.format.mmddyyyy"/></div></span></a></logic:notEmpty></logic:equal>
													</td>
												</tr>
											</table>
										<!--assessment date end-->
												...
												<tr>
													<td align="center">
														<html:submit property="submitAction"> <bean:message key="button.back" /></html:submit>	
													 	...
													 	<logic:equal name="wisconsinAssessmentForm" property="supervisionPeriod" value="<%= CSCAssessmentConstants.ASSESSMENT_SUPERVISION_PRD_ACTV %>">   
													 		<logic:equal name="wisconsinAssessmentForm" property="islatestVersionShown" value="true"> 
													 			<logic:equal name="wisconsinAssessmentForm" property="wisconsinAssessmentType" value="<%= CSCAssessmentConstants.ASSESSMENT_INITIAL_ASSESSMENT %>">
																	<%-- for assessment correct --%>
																...
																<logic:notEqual name="wisconsinAssessmentForm" property="wisconsinAssessmentType" value="<%= CSCAssessmentConstants.ASSESSMENT_INITIAL_ASSESSMENT %>">
											          			...
											          			<jims2:isAllowed requiredFeatures='<%=Features.CSCD_ASSESS_DELETE_WITH_RESTRC%>'>
											          				<logic:equal name="wisconsinAssessmentForm" property="sentToState" value="false">
																		<html:submit property="submitAction"> <bean:message key="button.delete" /></html:submit>
																	</logic:equal>	
											          			</jims2:isAllowed>
											          		</logic:equal> 
