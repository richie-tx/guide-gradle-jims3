...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/assessments/scsScreenFourCreateUpdate.jsp</title>
...
function validateFields(theForm)
{
	...
	addAlphaNumericNoFirstSpacewSymbolsValidation("comments","<bean:message key='errors.alphanumericWSymbols2' arg0='Comments' />");
								...
								<td valign="top" align="center">
									...
									<div class="header"><bean:message key="title.CSCD"/>&nbsp;-
										<logic:equal name="scsAssessmentForm" property="action" value="update">
											<bean:message key="title.update"/><input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assessments/CSCD_Assessments.htm#|36">
										</logic:equal>
										<logic:equal name="scsAssessmentForm" property="action" value="create">
											<bean:message key="prompt.new"/><input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assessments/CSCD_Assessments.htm#|30">
										</logic:equal>
										<bean:message key="title.SCSInventory"/>&nbsp;Screen 4</div>
										<!-- END HEADING -->
										...
										<tr>
											<td>
												<table width="100%" cellpadding="2" cellspacing="1">
													<jims2:cscquestions name="scsAssessmentForm" property="scsScreenFourQuestionsList" type="input" columns="2"/>
												</table>
											</td>
										</tr>
									</table>
									...
									<table width="98%" border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
										...
										<tr class="formDe">
											<td><html:textarea name="scsAssessmentForm" property="comments" rows="5" style="width:100%" onmouseout="textLimit( this, 250 )" onkeyup="textLimit( this, 250 )"/></td>
										</tr>
									</table>
									<!--scs end-->
									...
									<!-- BEGIN BUTTON TABLE -->
									<html:hidden name="scsAssessmentForm" property="scsScreenType" value="screenFour" />
									<table border="0" cellpadding="2" cellspacing="1">
										<tr>
											<td align="center">
											    <html:submit property="submitAction"> <bean:message key="button.back" /></html:submit>
											    <logic:equal name="scsAssessmentForm" property="assessmentIncomplete" value="true">
											    	<html:submit property="submitAction" onclick="return (validateFields(this.form) && disableSubmit(this, this.form));"> <bean:message key="button.saveContinue" /></html:submit>
												</logic:equal> 
