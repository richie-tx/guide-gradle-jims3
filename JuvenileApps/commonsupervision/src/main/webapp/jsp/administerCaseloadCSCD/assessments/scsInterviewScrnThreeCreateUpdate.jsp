...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/assessments/scsInterviewScrnThreeCreateUpdate.jsp</title>
...
<script>
function validateScsScreenThreeForm(theForm)
{
	return true;
}
</script>
								...
								<td valign="top" align="center">
									...
									<div class="header"><bean:message key="title.CSCD"/>&nbsp;-
										<logic:equal name="scsInterviewAssessmentForm" property="action" value="update">
											...
											<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assessments/CSCD_Assessments.htm#|65"></logic:equal>
										<logic:equal name="scsInterviewAssessmentForm" property="action" value="create">
											<bean:message key="prompt.new"/>
											<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assessments/CSCD_Assessments.htm#|60"></logic:equal>
										 <bean:message key="title.SCSInterview"/>&nbsp;Screen 3</div>
										<!-- END HEADING -->
										...
										<tr>
											<td>
												<table width="100%" cellpadding="2" cellspacing="1" border="0">
													<jims2:cscquestions name="scsInterviewAssessmentForm" property="scsIntrvScreenThreeQuestionsList" type="input" columns="1"/>
												</table>
											</td>
										</tr>
									</table>
									...
									<!-- BEGIN BUTTON TABLE -->
									<html:hidden name="scsInterviewAssessmentForm" property="scsScreenType" value="screenThree" />
									<table border="0" cellpadding="2" cellspacing="1">
										<tr>
											<td align="center">
										    	<html:submit property="submitAction"> <bean:message key="button.back" /></html:submit>
											    <logic:equal name="scsInterviewAssessmentForm" property="assessmentIncomplete" value="true">
											    	<html:submit property="submitAction" onclick="return validateScsScreenThreeForm(this.form);"> <bean:message key="button.saveContinue" /></html:submit>
												</logic:equal> 
												<logic:equal name="scsInterviewAssessmentForm" property="assessmentIncomplete" value="false">
													<html:submit property="submitAction" onclick="return validateScsScreenThreeForm(this.form);"> <bean:message key="button.saveContinue" /></html:submit>
										<%--		<html:submit property="submitAction" onclick="return validateScsScreenThreeForm(this.form);"> <bean:message key="button.next" /></html:submit> --%>
												</logic:equal>	
