...
<!-- 01/06/2012   RCapestani defect #72312 added logic to display only 1 Correct initial button -->
...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/assessments/scsInterviewDetails.jsp</title>
<script type="text/javascript" src="/<msp:webapp/>js/case_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>

</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/displaySCSInterviewDetails" target="content">
<div align="center">
<!-- BEGIN MAIN TABLE -->	
							...
							<tr>
								<td valign="top" align="center">
										...
										<div class="header"><bean:message key="title.CSCD"/>&nbsp;-                                        
	                                        <bean:message key="title.SCSInterview"/>&nbsp;<bean:message key="title.details"/>
	                                        <input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assessments/CSCD_Assessments.htm#|57"></logic:equal>
										</div>
										<!-- END HEADING -->
											...
											<tr>
												<td>
													<ul>
							                            ...
							                            <logic:equal name="scsInterviewAssessmentForm" property="supervisionPeriod" value="<%= CSCAssessmentConstants.ASSESSMENT_SUPERVISION_PRD_ACTV %>"> 
														...
														<td>
															<table width="100%" cellpadding="4" cellspacing="1">
																...
																<% int RecordCounter= -1;%>	
															 	...
															 	<logic:iterate id="eachAssessmentVersion" name="scsInterviewAssessmentForm" property="versionDetailsList">  
															  		<bean:define id="selectedVersion" type="java.lang.String" name="scsInterviewAssessmentForm" property="versionId"></bean:define>
															  		<logic:notEqual name="eachAssessmentVersion" property="versionNumber" value="<%=selectedVersion%>">                                                                         
																		...
																		<tr class="<%out.print((RecordCounter % 2 == 1) ? "alternateRow" : "normalRow"); %>">
																			<td align="center"><a href='/<msp:webapp/>displaySCSInterviewDetails.do?submitAction=View+Version&selectedVersionNumber=<bean:write name="eachAssessmentVersion" property="versionNumber"/>'><bean:write name="eachAssessmentVersion" property="versionNumber"/></a></td>
										...
										<!--assessment date start-->
											<table width="98%" cellpadding="4" cellspacing="1" class="borderTableBlue">
												<tr>
													...
													<td class="formDe" nowrap width="25%"><bean:write name="scsInterviewAssessmentForm" property="versionId"/></td>
												
													<td class="formDeLabel" nowrap width="1%"><bean:message key="prompt.assessmentDate" /></td>
													<td class="formDe">
														<bean:write name="scsInterviewAssessmentForm" property="assessmentDateStr" /><logic:equal name="scsInterviewAssessmentForm" property="migrated" value="Y"><logic:notEmpty name="scsInterviewAssessmentForm" property="actualAssessmentDate" ><a href="#" title="" class=tooltip230><img src="/<msp:webapp/>images/starGreenIcon.gif" border=0><span><div>Actual Assessment Date: <bean:write name="scsInterviewAssessmentForm" property="actualAssessmentDate" formatKey="date.format.mmddyyyy"/></div></span></a></logic:notEmpty></logic:equal>
													</td>
												</tr>
											</table>
										<!--assessment date end-->
										...
										<table width="98%" border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
											...
											<tr>
												<td>
													<table width="100%" cellpadding="2" cellspacing="1">  <!-- question formatting in CSCQuestionTag.java -->
														<jims2:cscquestions name="scsInterviewAssessmentForm" property="scsSummaryQuestionsList" type="summary" columns="4"/>
													</table>
												</td>
											</tr>
										</table>
												...
												<tr>
													<td align="center">
														<html:submit property="submitAction"> <bean:message key="button.back" /></html:submit>	
													 	...
													 	<logic:equal name="scsInterviewAssessmentForm" property="supervisionPeriod" value="<%= CSCAssessmentConstants.ASSESSMENT_SUPERVISION_PRD_ACTV %>">   
													 		<logic:equal name="scsInterviewAssessmentForm" property="islatestVersionShown" value="true">  
													 			<jims2:isAllowed requiredFeatures='<%=Features.CSCD_ASSESS_UPDATE_WITH_RESTRC%>'>  
													 				<logic:equal name="scsInterviewAssessmentForm" property="assessmentIncomplete" value="true" >
												       					...
												       					<bean:define id="correctInitialButton"  value="x"></bean:define>
												       				</logic:equal>	
												       			</jims2:isAllowed>
												       			<logic:notPresent name="correctInitialButton">	
												       			...
												       			<logic:equal name="scsInterviewAssessmentForm" property="forceFieldAssessmentStatus" value="<%=CSCAssessmentConstants.ASSESSMENT_NOT_EXIST%>">
												          			...
												          			<jims2:isAllowed requiredFeatures='<%=Features.CSCD_ASSESS_DELETE_WITH_RESTRC%>'>
												          				<logic:equal name="scsInterviewAssessmentForm" property="sentToState" value="false">
																			<html:submit property="submitAction"> <bean:message key="button.delete" /></html:submit>
																		</logic:equal>	
												          			</jims2:isAllowed>	
											          			</logic:equal>
