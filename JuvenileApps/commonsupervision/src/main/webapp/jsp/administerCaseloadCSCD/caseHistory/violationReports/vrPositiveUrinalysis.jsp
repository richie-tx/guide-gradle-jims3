...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/violationReports/vrPositiveUrinalysis.jsp</title>
...
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/violationReports/vrPositiveUrinalysis.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/displayVRPositiveUrinalysisSummary" target="content" focus="totalSpecimensAnalyzed" >
<div align="center">
<!-- BEGIN PAGE TABLE -->
									...
									<table width="100%">
										<tr>
											<td align="center" class="header">
												...
												<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Violation_Reports/CSCD_Violation_Reports.htm#|24">
											</td>
										</tr>
									</table>
<!-- END HEADING TABLE -->
...
<!-- END PU DETAILS TABLE -->												
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr class="formDeLabel">
														...
														<td><html:text name="violationReportsForm" property="totalSpecimensAnalyzed" size="5" maxlength="3" /></td>
													</tr>
												</table>
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr class="formDeLabel">
														...
														<td><bean:message key="prompt.date"/>
															<jims2:sortResults beanName="violationReportsForm" results="create1ElementsList" primaryPropSort="dateTime" primarySortType="DATE" defaultSort="true" defaultSortOrder="ASC" sortId="1" levelDeep="4" hideMe="true"/>  
														</td>
														<td><bean:message key="prompt.substance"/></td>
													</tr>
													<logic:iterate id="puIter" name="violationReportsForm" property="create1ElementsList" indexId="index">
													...
													<logic:equal name="violationReportsForm" property="showAddFields" value="true"> 
														<tr>
															<td width="1%">&nbsp;</td>
															<td>
																<html:text name="violationReportsForm" property="testDateStr" size="10" maxlength="10" />
																	<a href="#" onClick="cal1.select(violationReportsForm.testDateStr,'anchor1','MM/dd/yyyy'); return false;"
																		NAME="anchor1" ID="anchor1"><bean:message key="prompt.4.calendar"/></a> 
															</td>
															<td>
																<html:text name="violationReportsForm" property="substance" size="100" maxlength="100" />
<%-- 																<html:select name="violationReportsForm" property="selectedSubstanceId">
																	<html:option value=""><bean:message key="select.generic"/></html:option>
																	<html:optionsCollection name="violationReportsForm" property="substances" value="substanceId" label="substanceCodeDesc" /> 
																</html:select>  --%>
															</td>	
														</tr>																
													</logic:equal>	
...
<!-- BEGIN TREATMENT ISSUES COMMENTS TABLE -->										
									<table width="98%" cellpadding="2" cellspacing="1" class="borderTableBlue">
										...
										<input type="hidden" name="prevComments" value="<bean:write name='violationReportsForm' property='previousPositiveUrinalysisComments' />" >
									</table>
