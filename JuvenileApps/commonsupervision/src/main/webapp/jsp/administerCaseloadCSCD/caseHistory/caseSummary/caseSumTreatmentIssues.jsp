...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSummary/caseSumTreatmentIssues.jsp</title>
...
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/caseSummary/caseSumTreatmentIssues.js"></script>
<script>
//constructor
...
<html:form action="/displayTreatmentIssuesSummary" target="content">
<input type="hidden" name="cursorPos" value="<bean:write name='caseSummaryForm' property='cursorPosition'/>" >
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|23">
<div align="center">
<!-- BEGIN PAGE TABLE -->
												...
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr class="formDeLabel">
														...
														<td><bean:message key="prompt.referralType"/>
															<jims2:sortResults beanName="caseSummaryForm" results="create1ElementsList" primaryPropSort="referralTypeDesc" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="1" levelDeep="4" hideMe="true"/>  
														</td>
													...
													<logic:equal name="caseSummaryForm" property="showAddFields" value="true"> 
														...
														<tr>
															...
															<td <%= displayClass %>>
			                                                    <html:select styleId="group1" size="1" name="caseSummaryForm" property="programGroupId" onchange="loadPgmTypes(this);">
															...
															<td>
																<html:text name="caseSummaryForm" property="serviceProviderName" size="28" maxlength="100"/>
															</td>																
															<td nowrap>
																<html:text name="caseSummaryForm" property="referralBeginDateStr" size="10" maxlength="10" />
																		<a href="#" onClick="cal1.select(caseSummaryForm.referralBeginDateStr,'anchor1','MM/dd/yyyy'); return false;"
																			NAME="anchor1" ID="anchor1"><bean:message key="prompt.4.calendar"/></a> 
															</td>
															<td nowrap>
																<html:text name="caseSummaryForm" property="referralExitDateStr" size="10" maxlength="10"/>
																		<a href="#" onClick="cal1.select(caseSummaryForm.referralExitDateStr,'anchor2','MM/dd/yyyy'); return false;"
																			NAME="anchor2" ID="anchor2"><bean:message key="prompt.4.calendar"/></a> 
															</td>
															<td>
																<html:select name="caseSummaryForm" property="selectedDischargeReasonId">
																	<html:option value=""><bean:message key="select.generic"/></html:option>
																	<html:optionsCollection name="caseSummaryForm" property="dischargeReasons" value="code" label="description" /> 
																</html:select>
															</td>
														</tr>
														<tr>
															...
															<td <%= displayClass %> colspan="5" >
			                                                    <html:select styleId="group2" size="1" name="caseSummaryForm" property="programTypeId" disabled="true">
																	<html:option value=""><bean:message key="select.generic" /></html:option>
...
<!-- BEGIN TREATMENT ISSUES COMMENTS TABLE -->										
									<table width="98%" cellpadding="2" cellspacing="1" class="borderTableBlue">
										...
										<input type="hidden" name="prevComments" value="<bean:write name='caseSummaryForm' property='previousTreatmentIssuesComments'/>" >
									</table>
