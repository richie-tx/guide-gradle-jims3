...
<!-- 04/07/2009  C Shimek - #58297 added summary of court actions to Others  -->
<!-- 06/01/2009  C Shimek - #59896 remove occurrence time in reporting history -->
<!-- 06/01/2009  C Shimek - #59904 remove start date in employment history -->
<!-- 04/01/2010  C Shimek - #64667 revised PCA block for Type of Court Action comments and removed comments display  -->
<!-- 05/06/2010  C Shimek - added () around comments in PCA block to match PT  -->
<!-- 06/24/2011  R Young  - #70294 Sort Employment History by CLS -->
<!-- 03/12/2013  R Young  - #75066 Add mental health sections -->
...
<!-- BEGIN REASON FOR TRANSFER TABLE -->
 			<table border="0" width="100%" cellpadding="2" cellspacing="1" class="borderTable">
					...
					<td>
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr class="detailHead">
								...
								<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">
									<td width="1%" align="right">
										<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=reasonForTransfer&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
									</td>
								</logic:equal>										
							</tr>
						</table>
				...
				<logic:iterate id="rftIter" name="caseSummaryForm" property="currentReasonForTransferList" indexId="index">
				...
				<tr>
					<td class="formDe">
						<bean:write name="caseSummaryForm" property="isExtended"/>
					</td>
				</tr>
				<%-- 
				<tr class="formDeLabel">
				...
				<tr>
					<td class="formDe">
						<bean:write name="caseSummaryForm" property="currentReasonForTransferComments"/>
					</td>
				</tr>
				--%>
			</table> 
			...
			<table border="0" width="100%" cellpadding="2" cellspacing="1" class="borderTable">
					...
					<td colspan="2">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr class="detailHead">
								...
								<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">								
									<td width="1%" align="right">
										<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=mentalHealth&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
									</td>
								</logic:equal>	
							</tr>
						</table>
				...
				<tr>
					<td colspan="2" class="formDe">
			 			<bean:write name="caseSummaryForm" property="currentMentalHealthDiagnosis"/> 
					</td>
				</tr>	
				<tr class="formDeLabel">
				...
				<tr>
					<td colspan="2" class="formDe">
			 			<bean:write name="caseSummaryForm" property="currentMentalHealthComments"/> 
					</td>
				</tr>
			</table> 
...
<!-- BEGIN LAW VIOLATION TABLE -->
			<table border="0" width="100%" cellpadding="2" cellspacing="1" class="borderTable">
					...
					<td colspan="6">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr class="detailHead">
								...
								<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">
									<td width="1%" align="right">
										<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=lawViolation&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
									</td>
								</logic:equal>
							</tr>
						</table>
				...
				<logic:iterate id="lvIter" name="caseSummaryForm" property="currentLawViolationsList" indexId="index"> 
			    	<% displayClass = ""; %>
				...
				<tr>
					<td class="formDe" colspan="6">
						<bean:write name="caseSummaryForm" property="currentLawViolationsComments"/>
					</td>
				</tr>
			</table>  
...
<!-- BEGIN FEE HISTORY TABLE -->
			<table border="0" width="100%" cellpadding="2" cellspacing="1" class="borderTable">
					...
					<td colspan="4">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr class="detailHead">
								...
								<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">								
									<td width="1%" align="right">
										<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=feeHistory&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
									</td>
								</logic:equal>
							</tr>
						</table>
				...
				<tr class="formDeLabel">
					<td><bean:message key="prompt.payType" /></td>
				...
				<logic:iterate id="fhIter" name="caseSummaryForm" property="currentFeeHistoryList" indexId="index"> 
			    	<% displayClass = ""; %>
				...
				<tr>
					<td class="formDe" colspan="4">
						<bean:write name="caseSummaryForm" property="currentFeeHistoryComments"/>
					</td>
				</tr>
			</table> 
...
<!-- BEGIN REPORTING HISTORY TABLE -->
			<table border="0" width="100%" cellpadding="2" cellspacing="1" class="borderTable">
					...
					<td colspan="3">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr class="detailHead">
								...
								<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">
									<td width="1%" align="right">
										<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=reportingHistory&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
									</td>
								</logic:equal>	
							</tr>
						</table>
				...
				<tr class="formDeLabel">
					<td>
						<bean:message key="prompt.occurrenceDate" />
						<jims2:sortResults beanName="caseSummaryForm" results="currentReportingHistoryList" primaryPropSort="dateTime" primarySortType="DATE" defaultSort="true" defaultSortOrder="DESC" sortId="30" hideMe="true"/> 
					</td>
					<td><bean:message key="prompt.eventType" />(s)</td>
					<td><bean:message key="prompt.details" /></td>
				</tr>
				<logic:iterate id="rhIter" name="caseSummaryForm" property="currentReportingHistoryList" indexId="index"> 
			    	<% displayClass = ""; %>
				...
				<tr>
					<td class="formDe" colspan="3">
						<bean:write name="caseSummaryForm" property="currentReportingHistoryComments"/>
					</td>
				</tr>
			</table> 
...
<!-- BEGIN EMPLOYEMENT HISTORY TABLE -->
			<table border="0" width="100%" cellpadding="2" cellspacing="1" class="borderTable">
					...
					<td colspan="4">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr class="detailHead">
								...
								<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">								
									<td width="1%" align="right">
										<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=employmentHistory&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
									</td>
								</logic:equal>
							</tr>
						</table>
				...
				<logic:iterate id="ehIter" name="caseSummaryForm" property="currentEmploymentHistoryList" indexId="index"> 
			    	<% displayClass = ""; %>
				...
				<tr>
					<td class="formDe" colspan="4">
						<bean:write name="caseSummaryForm" property="currentEmploymentHistoryComments"/>
					</td>
				</tr>
			</table>  
					...
					<td colspan="4">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr class="detailHead">
								...
								<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">								
									<td width="1%" align="right">
										<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=previousCourtActivity&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
									</td>
								</logic:equal>	
							</tr>
						</table>
...
<!-- BEGIN VIOLATION REPORTS DISPLAY -->						
				...
				<logic:iterate id="vrIter" name="caseSummaryForm" property="currentCourtActivityVRList" indexId="index"> 
			    	<% displayClass = ""; %>
			    	<% indexCounter=0; %>
...
<!-- BEGIN MOTIONS DISPLAY -->	
				...
				<logic:iterate id="motIter" name="caseSummaryForm" property="currentMotionsList" indexId="index"> 
			    	<% displayClass = ""; %>
			    	<% indexCounter=0; %>
...
<!-- BEGIN OTHERS DISPLAY -->	
				...
				<logic:iterate id="otherIter" name="caseSummaryForm" property="currentOthersList" indexId="index"> 
			    	<% displayClass = ""; %>
			    	<% indexCounter=0; %>
...
<!-- BEGIN TREATMENT ISSUES TABLE -->	
			<table border="0" width="100%" cellpadding="2" cellspacing="1" class="borderTable">
					...
					<td colspan="5">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr class="detailHead">
								...
								<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">								
									<td width="1%" align="right">
										<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=treatmentIssues&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
									</td>
								</logic:equal>	
							</tr>
						</table>
				...
				<logic:iterate id="tiIter" name="caseSummaryForm" property="currentTreatmentIssuesList" indexId="index"> 
			    	<% displayClass = ""; %>
				...
				<tr>
					<td class="formDe" colspan="5">
						<bean:write name="caseSummaryForm" property="currentTreatmentIssuesComments"/>
					</td>
				</tr>  
			</table> 
...
<!-- BEGIN COMMUNITY SERVICE TABLE -->
			<table border="0" width="100%" cellpadding="2" cellspacing="1" class="borderTable">
					...
					<td colspan="2">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr class="detailHead">
								...
								<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">								
									<td width="1%" align="right">
										<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=communityService&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
									</td>
								</logic:equal>	
							</tr>
						</table>
				...
				<tr>
					...
					<td class="formDe"><bean:write name="caseSummaryForm" property="currentHoursOrdered"/></td>
				</tr>
				<tr>
					<td class="formDeLabel" nowrap><bean:message key="prompt.hoursCompleted" /></td>
					<td class="formDe"><bean:write name="caseSummaryForm" property="currentHoursCompleted"/></td>
				</tr>
				<tr class="formDeLabel">
				...
				<tr>
					<td colspan="2" class="formDe">
						<bean:write name="caseSummaryForm" property="currentCommunityServiceComments"/>
					</td>
				</tr>
			</table> 
...
<!-- BEGIN ALCOHOL/DRUG TESTING TABLE -->	
			<table border="0" width="100%" cellpadding="2" cellspacing="1" class="borderTable">
					...
					<td colspan="2">
						<table width="100%" cellpadding="0" cellspacing="0">
							<tr class="detailHead">
								...
								<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">								
									<td width="1%" align="right">
										<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=positiveUrinalysis&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
									</td>
								</logic:equal>	
							</tr>
						</table>
				...
				<tr>
					...
					<td class="formDe"><bean:write name="caseSummaryForm" property="currentTotalSpecimensAnalyzed"/></td>
				</tr>
				<tr>
				...
				<logic:iterate id="puIter" name="caseSummaryForm" property="currentPositiveUrinalysisList" indexId="index"> 
			    	<% displayClass = ""; %>
				...
				<tr>
					<td colspan="2" class="formDe">
			 			<bean:write name="caseSummaryForm" property="currentPositiveUrinalysisComments"/> 
					</td>
				</tr>
			</table> 
...
<!-- BEGIN RECOMMENDATIONS TABLE -->	
			<table border="0" width="100%" cellpadding="2" cellspacing="1" class="borderTable">
				<tr class="detailHead">
					<td colspan="2">
						<table width="100%" cellpadding="0" cellspacing="0">
							<td class="detailHead"><bean:message key="prompt.suggestedCourtActions" /></td>
							<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">								
								<td width="1%" align="right">
									<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=recommendations&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
								</td>
							</logic:equal>
						</table>
					</td>		
				</tr>
				<logic:iterate id="scaIter" name="caseSummaryForm" property="currentSuggestedCourtActionsList" indexId="index"> 
					<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
				...
				<tr>
					<td class="formDe"><bean:write name="caseSummaryForm" property="currentRecommendations"/></td>
				</tr>
			</table> 
<!-- END RECOMMENDATIONS TABLE -->	
	<logic:equal name="caseSummaryForm" property="statusId" value="FL"> 
	<tr><td ><bean:message key="prompt.rowsManuallyAdded" />
	</logic:equal>
	</td>
</tr>
		...
		<td>
			<logic:equal name="caseSummaryForm" property="statusId" value="FL"> 
				<table width="100%" border="0" cellspacing="1" cellpadding="2" class="borderTable">
						...
						<td colspan="2">
							<table width="100%" cellpadding="0" cellspacing="0">
								<tr class="detailHead">
									...
									<logic:equal name="caseSummaryForm" property="allowUpdate" value="<%=UIConstants.YES%>">								
										<td width="1%" align="right">
											<a href="/<msp:webapp/>handleCaseSummaryUpdates.do?submitAction=Link&type=updateCourtActions&Id=<bean:write name='caseSummaryForm' property='superviseeId'/>" class="editLink"><bean:message key="prompt.update" /></a>
										</td>
									</logic:equal>
								</tr>
							</table>
					...
					<logic:iterate id="caIter" name="caseSummaryForm" property="currentCourtActionsList" indexId="index">
						<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
