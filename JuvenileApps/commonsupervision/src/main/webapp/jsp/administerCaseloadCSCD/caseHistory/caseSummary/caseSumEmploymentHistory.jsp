...
<!--MODIFICATIONS -->
<!-- 02/25/2008 C. Shimek - Converted PT to JSP -->
<!-- 01/13/2009 C. Shimek - #56232 removed extra idxCtr declaration causing HTTP Error Code 500 -->
...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSummary/caseSumEmploymentHistory.jsp</title>
...
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/caseSummary/caseSumEmploymentHistory.js"></script>
</head>
<body topmargin="0" leftmargin="0" onLoad="setAddCursorPos();" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/displayEmploymentHistorySummary" target="content">
<input type="hidden" name="cursorPos" value="<bean:write name='caseSummaryForm' property='cursorPosition'/>" >
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|17">
<div align="center">
<!-- BEGIN PAGE TABLE -->
												   ...
												   String displayClass; %>
													<tr class="formDeLabel">
														...
														<td><bean:message key="prompt.employerName"/>
															<jims2:sortResults beanName="caseSummaryForm" results="create1ElementsList" primaryPropSort="seqNum" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="3" levelDeep="4" hideMe="true"/>  
														</td>
														<td><bean:message key="prompt.jobTitle"/></td>
														<td><bean:message key="prompt.status"/></td>
													</tr>
													<logic:iterate id="create1ElementsList" name="caseSummaryForm" property="create1ElementsList" indexId="index">
													...
													<logic:equal name="caseSummaryForm" property="showAddFields" value="true">
														<tr class="normalRow" >
															<td width="1%">&nbsp;</td>
															<td><html:text name="caseSummaryForm" property="employerName" size="30" maxlength="100" /></td>
															<td><html:text name="caseSummaryForm" property="jobTitle"size="30" maxlength="50" /></td>
															<td>
																<html:select name="caseSummaryForm" property="jobStatusId">
																	<html:option value=""><bean:message key="select.generic"/></html:option>
																	<html:optionsCollection name="caseSummaryForm" property="employmentStatusList" value="codeId" label="description" /> 
																</html:select>
															</td>	
														</tr>	
													</logic:equal>
...
<!-- BEGIN EMPLOYMENT HISTORY COMMENT TABLE -->										
									<table width="98%" cellpadding="2" cellspacing="1" class="borderTableBlue">
										...
										<input type="hidden" name="prevComments" value="<bean:write name='caseSummaryForm' property='previousEmploymentHistoryComments'/>" >
									</table>
