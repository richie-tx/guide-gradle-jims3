...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSummary/caseSumTreatmentIssuesSummary.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/submitTreatmentIssuesCreateUpdate" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|24">
<div align="center">
<!-- BEGIN PAGE TABLE -->
									...
									<table width="100%">
										<tr>
											<td align="center" class="header">
												...
												<bean:message key="prompt.treatmentIssues"/>&nbsp;<bean:message key="prompt.summary"/>
											</td>
										</tr>
									</table>
<!-- END HEADING TABLE -->
...
<!-- BEGIN INSTRUCTION TABLE -->
									<table width="98%" border="0">
										<tr>
											<td>
												<ul>
													<li>Review Treatment Issues.  Click Finish.</li>
												</ul>
											</td>
										</tr>
									</table>
