...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSummary/caseSumMentalHealthSummary.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/submitMentalHealthCreateUpdate" target="content">
<div align="center">
<!-- BEGIN PAGE TABLE -->
...
<!-- BEGIN MENTAL HEALTH DIAGNOSIS TABLE -->
										...
										<tr>
											<td class="formDeLabel"><bean:message key="prompt.diagnosis"/></td>
										</tr>
										<tr>
											<td class="formDe">
...
<!-- BEGIN MENTAL HEALTH COMMENTS TABLE -->
										...
										<tr>
											<td class="formDe">
												<bean:write name="caseSummaryForm" property="create2Comments"/>
											</td>
										</tr>
										</table>
