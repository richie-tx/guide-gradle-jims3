...
<title><bean:message key="title.heading" /> -
	administerCaseloadCSCD/caseHistory/caseSummary/caseSumCommunityService.jsp</title>
...
<script type="text/javascript"
	src="/<msp:webapp/>js/caseHistory/caseSummary/caseSumCommunityService.js"></script>
</head>
<body topmargin="0" leftmargin="0"
	onKeyDown="return checkEnterKeyAndSubmit(event,true);">
	<html:form action="/displayCommunityServiceSummary" target="content"
		focus="create1Comments">
		<input type="hidden" name="helpFile"
			value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|21">
		<div align="center">
			<!-- BEGIN PAGE TABLE -->
			<table width="98%" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td valign="top">
						...
						</table> <!-- END BLUE TABS TABLE --> <!-- BEGIN BLUE BORDER TABLE -->
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								<td valign="top" align="center">
									...
									</table> <!-- END SUPERVISEE TABLE --> <!-- BEGIN GREEN TABS TABLE -->
									<table width="98%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											<td valign="top"><tiles:insert
									...
									</table> <!-- END GREEN TABS TABLE --> <!-- BEGIN GREEN BORDER TABLE -->
									<table width="98%" border="0" cellpadding="0" cellspacing="0"
										...
										<tr>
											<td valign="top" align="center">
												...
												<table width="100%">
													<tr>
														<td align="center" class="header"><bean:message
																...
																key="prompt.communityService" /></td>
													</tr>
												...
												</table> <!-- END INSTRUCTION TABLE --> <br> <!-- BEGIN DETAIL TABLE -->
												<table width="98%" border="0" cellspacing="0"
													cellpadding="2" class="borderTableBlue">
													<tr class="detailHead">
														<td><bean:message key="prompt.communityService" />
														</td>
													</tr>
													<tr>
														<td>
															<table width="100%" cellpadding="2" cellspacing="1">
																<tr>
																	<td class="formDeLabel" width="1%" nowrap><bean:message
																			key="prompt.hoursOrdered" />
																	</td>
																	<td class="formDe"><bean:write
																			name="caseSummaryForm" property="hoursOrdered" />
																	</td>
																</tr>
																<tr>
																	<td class="formDeLabel" nowrap><bean:message
																			key="prompt.hoursCompleted" />
																	</td>
																	<td class="formDe"><bean:write
																			name="caseSummaryForm" property="hoursCompleted" />
																	</td>
																</tr>
															</table></td>
													</tr>
												...
												<table width="98%" cellpadding="2" cellspacing="1"
													...
													<input type="hidden" name="prevComments"
														value="<bean:write name='caseSummaryForm' property='previousCommunityServiceComments'/>">
												</table> <!-- END DETAIL TABLE --> <br> <!-- BEGIN BUTTON TABLE -->
												<table border="0" width="100%">
													<tr>
														<td align="center"><html:submit
																property="submitAction"
																onclick="return validateNextInput(this.form) && disableSubmit(this, this.form)">
																<bean:message key="button.next" />
															</html:submit> <html:submit property="submitAction"
																onclick="return disableSubmit(this, this.form)">
																<bean:message key="button.refreshCommunityService" />
