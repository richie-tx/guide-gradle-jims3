...
<!-- 04/01/2010 C. Shimek - #64667 removed activity and commnets. Added type of court action comments  -->
...
<html:base />
<title>Common Supervision - administerCaseloadCSCD/caseHistory/caseSummary/caseSumPreviousCourtActivity.jsp</title>
...
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/caseSummary/caseSumPreviousCourtActivity.js"></script>
</head>
<body topmargin="0" leftmargin="0" onload="setAddCursorPos();" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/displayPreviousCourtActivitySummary" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|19">
												...
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr class="formDeLabel">
														...
														<td><bean:message key="prompt.date"/>
															<jims2:sortResults beanName="caseSummaryForm" results="create1ElementsList" primaryPropSort="occurenceDate" primarySortType="DATE" defaultSort="true" defaultSortOrder="DESC" sortId="v1" levelDeep="4" hideMe="true" />  
														</td>
														...
														<td width="40%"><bean:message key="prompt.summaryOfCourtActions"/><div>(Max. characters allowed: 250)</td>
													</tr>
													...
													<logic:equal name="caseSummaryForm" property="showVRAddFields" value="true"> 
														<tr>
												 			<td width="1%">&nbsp;</td>
															<td valign="top">
																<html:text name="caseSummaryForm" size="10" maxlength="10" property="courtActivityVRDateStr" />
																	<a href="#" onClick="cal1.select(caseSummaryForm.courtActivityVRDateStr,'anchor1','MM/dd/yyyy'); return false;"
															...
															<td> 
																<html:textarea name="caseSummaryForm" property="courtActivityVRSummaryOfCourtActions" 
...
<!-- BEGIN MOTIONS DETAILS TABLE -->											
												...
												<% displayClass=""; %>
													<tr class="formDeLabel">
														...
														<td width="30%"><bean:message key="prompt.typeOfCourtAction"/> (<bean:message key="prompt.comments"/>)<div>(Max. characters allowed: 50)</td>
														<td width="30%"><bean:message key="prompt.summaryOfCourtActions"/><div>(Max. characters allowed: 250)</td>
														<td><bean:message key="prompt.disposition"/></td>
													</tr>
													<logic:iterate id="motionsIter" name="caseSummaryForm" property="create2ElementsList" indexId="index">
														<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">   
															<td width="1%" valign="top">
													...
													<logic:equal name="caseSummaryForm" property="showMotionAddFields" value="true"> 
														<tr>
															<td width="1%">&nbsp;</td>
															<td valign="top">   
																<html:text name="caseSummaryForm" size="10" maxlength="10" property="motionDateStr" />
																<a href="#" onClick="cal1.select(caseSummaryForm.motionDateStr,'anchorMO','MM/dd/yyyy'); return false;"
															...
															<td> 	
																<html:textarea name="caseSummaryForm" property="motionSummaryOfCourtActions" 
																	onmouseout="textLimit(this, 250);" 
       																onkeyup="textLimit(this, 250);" 
																	style="width:100%" rows="5">
																</html:textarea>
															...
															<td valign="top">
																<html:select name="caseSummaryForm" property="selectedMotionDispositionId">
																	<html:option value=""><bean:message key="select.generic"/></html:option>
																	<html:optionsCollection name="caseSummaryForm" property="motionsDispositions" value="code" label="description" />  
																</html:select>
															</td>
														</tr>	
													</logic:equal>	
...
<!-- BEGIN OTHERS DETAILS TABLE -->											
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr class="formDeLabel">
														<td width="1%"></td>
														<td><bean:message key="prompt.date"/>
															<jims2:sortResults beanName="caseSummaryForm" results="create3ElementsList" primaryPropSort="occurenceDate" primarySortType="DATE" defaultSort="true" defaultSortOrder="ASC" sortId="o1" levelDeep="4" hideMe="true"/>														
														</td>
														<td width="40%"><bean:message key="prompt.typeOfCourtAction"/> (<bean:message key="prompt.comments"/>)<div>(Max. characters allowed: 50)</td>
														<td width="40%"><bean:message key="prompt.summaryOfCourtActions"/><div>(Max. characters allowed: 250)</td>
													</tr>
													<logic:iterate id="otherIter" name="caseSummaryForm" property="create3ElementsList" indexId="index">
														<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
															<td width="1%" valign="top">
													...
													<logic:equal name="caseSummaryForm" property="showAddFields" value="true"> 
														<tr>
															<td width="1%">&nbsp;</td>
															<td valign="top">
																<html:text name="caseSummaryForm" size="10" maxlength="10" property="otherDateStr" />
																	<a href="#" onClick="cal1.select(caseSummaryForm.otherDateStr,'anchorOT','MM/dd/yyyy'); return false;"
																		NAME="anchorOT" ID="anchorOT"><bean:message key="prompt.4.calendar"/></a> 
															</td>
															<td valign="top"> 
																<html:textarea name="caseSummaryForm" property="create3Comments" 
																	onmouseout="textLimit(this, 50);" 
       																onkeyup="textLimit(this, 50);" 
																	style="width:100%" rows="3">
																</html:textarea>
															...
															<td> 
															<html:textarea name="caseSummaryForm" property="otherSummaryOfCourtActions" 
																	onmouseout="textLimit(this, 250);" 
       																onkeyup="textLimit(this, 250);" 
																	style="width:100%" rows="5">
																</html:textarea>
