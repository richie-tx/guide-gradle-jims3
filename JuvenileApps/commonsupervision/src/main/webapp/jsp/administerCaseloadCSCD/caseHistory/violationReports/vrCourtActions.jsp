...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/violationReports/vrCourtActions.jsp</title>
...
<html:form action="/displayFileViolationReportSummary" target="content" focus="courtActionfiledDate">
...
<!-- BEGIN HEADING TABLE -->
									<table width="100%">
										<tr>
											...
											<bean:message key="prompt.present"/>&nbsp;<bean:message key="title.violationReport"/>
											</td>
										</tr>
									</table>
<!-- END HEADING TABLE -->
												...
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr>
														...
														<td class="formDe">
															...
															<html:text name="violationReportsForm" size="10" maxlength="10" property="courtActionfiledDate" />
																	<a href="#" onClick="cal1.select(violationReportsForm.courtActionfiledDate,'anchorX','MM/dd/yyyy'); return false;"
