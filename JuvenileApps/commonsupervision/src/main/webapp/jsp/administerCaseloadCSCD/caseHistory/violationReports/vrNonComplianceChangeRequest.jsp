...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/violationReports/vrNonComplianceChangeRequest.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/caseHistory_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/violationReports/vrNonComplianceChangeRequest.js"></script>

</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/displayVRNonComplianceChangeRequestSummary" target="content" focus="taskText">
<div align="center">
<!-- BEGIN PAGE TABLE -->
									...
									<table width="100%">
										<tr>
											<td align="center" class="header">
												...
												<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Violation_Reports/CSCD_Violation_Reports.htm#|29">
                                            </td>
										</tr>
									</table>	
<!-- END HEADING TABLE -->					
										...
										<tr>
											<td>
												<table width="100%" cellpadding="4" cellspacing="1">
													...
													--%>												
													<tr>
														<td class="formDeLabel" colspan=2><bean:message key="prompt.4.diamond"/><bean:message key="prompt.taskText"/>&nbsp; (Max Characters Allowed: 500)</td>
													</tr>
													<tr>
														<td class="formDe" colspan=2>
															<html:textarea name="violationReportsForm" property="taskText" style="width:100%" rows="5"  onmouseout="textLimit( this, 500 )" onkeyup="textLimit( this, 500 )"></html:textarea>
														</td>
													</tr>		
												</table>
											</td>
