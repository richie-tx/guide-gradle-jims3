...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSummary/caseSumNonComplianceChangeRequest.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/caseHistory_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/caseSummary/caseSumNonComplianceChangeRequest.js"></script>

</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/displayNonComplianceChangeRequestSummary" target="content" focus="taskText">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|35">
<div align="center">
<!-- BEGIN PAGE TABLE -->
									...
									<table width="100%">
										<tr>
											<td align="center" class="header">
												...
												<bean:message key="prompt.caseSummary"/>&nbsp;-&nbsp;<bean:message key="prompt.changeRequest"/>
                                            </td>
										</tr>
									</table>	
<!-- END HEADING TABLE -->					
...
<!-- BEGIN INSTRUCTION TABLE -->
									<table width="98%" border="0">
										<tr>
											<td>
												<ul>
													<li>Enter Task Text.  Click Next.</li>
												</ul>
											</td>
										</tr>
										<tr>
											...
											<td>
												<table width="100%" cellpadding="4" cellspacing="1">
													<tr>
														...
														<td class="formDe"><bean:write name="caseSummaryForm" property="taskTo"/></td>
													</tr>
													<tr>
														<td class="formDeLabel" nowrap width="1%"><bean:message key="prompt.subject" /></td>
														<td class="formDe"><bean:write name="caseSummaryForm" property="taskSubject"/></td>
													</tr>
													<%--<tr>
														<td class="formDeLabel" nowrap width="1%"><bean:message key="prompt.nextAction" /></td>
														<td class="formDe"><bean:write name="caseSummaryForm" property="taskNextAction"/></td>
													</tr> --%>													
													<tr>
														<td class="formDeLabel" colspan=2><bean:message key="prompt.4.diamond"/><bean:message key="prompt.taskText"/></td>
													</tr>
													<tr>
														<td class="formDe" colspan=2>
															<html:textarea name="caseSummaryForm" property="taskText" style="width:100%" rows="5"></html:textarea>
														</td>
													</tr>
												</table>
											</td>
