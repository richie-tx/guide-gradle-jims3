...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/violationReports/vrPositiveUrinalysisSummary.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/submitVRPositiveUrinalysisCreateUpdate" target="content">
<div align="center">
<!-- BEGIN PAGE TABLE -->
									...
									<table width="100%">
										<tr>
											<td align="center" class="header">
												...
												<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Violation_Reports/CSCD_Violation_Reports.htm#|25">
											</td>
										</tr>
									</table>
<!-- END HEADING TABLE -->
...
<!-- BEGIN INSTRUCTION TABLE -->
									<table width="98%" border="0">
										<tr>
											<td>
												<ul>
													<li>Review Positive Urinalysis  Click Finish.</li>
												</ul>
											</td>
										</tr>
									</table>
...
<!-- END TREATMENT ISSUES DETAILS TABLE -->												
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr class="formDeLabel">
														...
														<td class="formDe"><bean:write name="violationReportsForm" property="totalSpecimensAnalyzed" /></td>
													</tr>
												</table>
								 				<table width="100%" cellpadding="2" cellspacing="1">
													<tr class="formDeLabel">
