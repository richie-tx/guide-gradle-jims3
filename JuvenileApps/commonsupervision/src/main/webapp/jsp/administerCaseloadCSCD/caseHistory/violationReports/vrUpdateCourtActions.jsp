...
<!--MODIFICATIONS -->
<!-- 02/26/2008 Debbie Williamson - Converted PT to JSP -->
<!-- 02/20/2009 CShimek           - #57413 corrected selectedCourtActionId to selectedCourtActionsId in column 2 and 3, causing null pointer exception -->
...
<!-- 06/10/2011 RCapestani        - #70357 display first/last name data entry elements for who signed -->
<!-- 08/13/2013 RCapestani        - #75938 set court actions textbox to 3500 characters -->
<!-- 10/03/2013 RCarter           - #76175 new jsp to handle update of court actions instead of file/present scenario -->
...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/violationReports/vrUpdateCourtActions.jsp</title>
...
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/violationReports/vrCourtActions.js"></script>
...
<html:form action="/displayVRUpdateCourtActionSummary" target="content" focus="courtActionfiledDate">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Violation_Reports/CSCD_Violation_Reports.htm#|7">
<input type="hidden" name="presentedbyLogonId" value="<bean:write name="violationReportsForm" property="currentLogonId" />" >
<input type="hidden" name="whoSignedCourtNum" value="<bean:write name="violationReportsForm" property="courtNum" /> " >
<div align="center">
<!-- END PAGE TABLE -->
...
<!-- BEGIN HEADING TABLE -->
									<table width="100%">
										<tr>
											...
											<bean:message key="prompt.update"/>&nbsp;<bean:message key="title.violationReport"/>
											</td>
										</tr>
									</table>
<!-- END HEADING TABLE -->
...
<!-- BEGIN DETAIL TABLE -->
										...
										<tr class="detailHead">
											<td>
												<table width="100%" cellpadding="0" cellspacing="0">
													<tr>
														<td class="detailHead"><bean:message key="prompt.present"/> <bean:message key="prompt.information"/></td>
													</tr>
												</table>
											</td>
										</tr>
										<tr>
											<td>
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr>
														<td class="formDeLabel" nowrap="nowrap" width="1%"><bean:message key="prompt.4.diamond"/><bean:message key="prompt.presentDate"/></td>
														<td class="formDe">
															<SCRIPT LANGUAGE="JavaScript" ID="js1">
																var cal1 = new CalendarPopup();
																cal1.showYearNavigation();
															</SCRIPT>
															<html:text name="violationReportsForm" size="10" maxlength="10" property="courtActionfiledDate" styleId="courtActionfiledDate"/>
																	<a href="#" onClick="cal1.select(document.getElementById('courtActionfiledDate'),'anchorX','MM/dd/yyyy'); return false;"
																		NAME="anchorX" ID="anchorX"><bean:message key="prompt.4.calendar"/></a> 
														</td>
													</tr>
													<tr>
														<td class="formDeLabel" nowrap="nowrap" width="1%"><bean:message key="prompt.4.diamond"/><bean:message key="prompt.presentedBy"/></td>
														<td class="formDe">
															<table cellpadding="0" cellspacing="0" border="0">
																<tr>
																	<td colspan="2">														
																		<html:select name="violationReportsForm" property="presentedById" onchange="checkForOther(this, 'presentedByOther')">
																			<html:option value=""><bean:message key="select.generic"/></html:option>
																		   	<html:optionsCollection name="violationReportsForm" property="presentedByList" value="logonId" label="formattedName" /> 
																...
																<tr id="presentedByOther" class="hidden">
																	<td>
																		<table>
																			...
																			<tr>
																				<td>
																					<html:text name="violationReportsForm" size="25" maxlength="50" property="presentedByFirstName" />
																				</td>
																				<td>
																					<html:text name="violationReportsForm" size="25" maxlength="75" property="presentedByLastName" />
																				</td>
																			</tr>
																		</table>
																	</td>
														...
														<td class="formDeLabel" nowrap="nowrap" width="1%"><bean:message key="prompt.whoSigned?"/></td>
															<td class="formDe">
																<table cellpadding="0" cellspacing="0" border="0">
																	<tr>
																		<td colspan="2">
																			<html:select name="violationReportsForm" property="whoSignedId" onchange="checkForOther(this, 'signedByOther')">
																				<html:option value=""><bean:message key="select.generic"/></html:option>
																				<html:optionsCollection name="violationReportsForm" property="whoSignedList" value="courtNumber" label="formattedName" /> 
																				<html:option value="OTH">OTHER</html:option>
																			</html:select>
																			<input type="hidden" name="whoSignedName" size="130">
																		</td>
																	</tr>
																	<tr id="signedByOther" class="hidden">
																		<td>
																			<table>
																				<tr>
																				...
																				<tr>
																					<td>
																						<html:text name="violationReportsForm" size="25" maxlength="50" property="whoSignedFirstName" />
																					</td>
																					<td>
																						<html:text name="violationReportsForm" size="25" maxlength="75" property="whoSignedLastName" />
																					</td>
																				</tr>
																			</table>
																		</td>
									...
									<table width="98%" border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
										<tr class="formDeLabel">
											<td colspan="6"><bean:message key="prompt.4.diamond"/><bean:message key="prompt.courtActions"/></td>
										</tr>
											<logic:iterate id="caIter" name="violationReportsForm" property="create1ElementsList">
												<%  checkItem = ""; %>
												<logic:equal name="caIter" property="visible" value="true">
												   ...
												   if (bgCtr % 2 == 1){
													...
													orgbgcolor = bgcolor; %>	  
														...
														<td valign="top" class=<%= bgcolor %>>
															<input type="checkbox" name="selectedCourtActionsIds" value="<bean:write name="caIter" property="code" />" <%= checkItem %> >
														</td>
														<td valign="top" class=<%= bgcolor %>>	
										...
										<tr class="formDe">
											<td colspan="6">
												<bean:define id="userAgency" name="violationReportsForm" property="userAgency"/>	
												<html:textarea styleClass="mceEditor" name="violationReportsForm" property="summaryOfCourtActions"
													style="mceEditor"> 
												</html:textarea>
