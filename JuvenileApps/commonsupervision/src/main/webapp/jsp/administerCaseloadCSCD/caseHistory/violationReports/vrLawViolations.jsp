...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/violationReports/caseHistory/vrLawViolations.jsp</title>
...
var degreeSelectValue = "<bean:write name="violationReportsForm" property="offenseDegreeId"/>"
...
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/violationReports/vrLawViolations.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/displayVRLawViolationSummary" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Violation_Reports/CSCD_Violation_Reports.htm#|10">
<div align="center">
<!-- BEGIN PAGE TABLE -->
												...
												<% String displayClass; %>
													<tr class="formDeLabel">
														...
														<td><bean:message key="prompt.case#"/>
															<jims2:sortResults beanName="violationReportsForm" results="create1ElementsList" primaryPropSort="caseId" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="1" levelDeep="4" hideMe="true"/>  
														</td>
										 			...
										 			<logic:equal name="violationReportsForm" property="showAddFields" value="true">  
											 			<tr>	
												 			<td width="1%">&nbsp;</td>
											 				<td><html:text name="violationReportsForm" property="lvCaseNum" size="15" maxlength="15" /></td>
															<td><html:text name="violationReportsForm" property="courtNum" size="3" maxlength="3" /></td>
															<td>
																<html:text name="violationReportsForm" size="10" property="offenseDateStr"/>
																	<a href="#" onClick="cal1.select(violationReportsForm.offenseDateStr,'anchor1','MM/dd/yyyy'); return false;"
																		NAME="anchor1" ID="anchor1"><bean:message key="prompt.4.calendar"/></a> 
															</td>
															<td><html:text name="violationReportsForm" property="offenseLiteral" size="30" maxlength="50" /></td>
															<td>
																<html:select name="violationReportsForm" property="offenseLevelId" onchange="fillSelect(this)">
													...
													<%-- 			<html:optionsCollection name="violationReportsForm" property="offenseLevels" value="offenseLevelId" label="offenseLevelCodeDesc" /> --%>
																</html:select>
															</td>
															<td>	
																<html:select disabled="true" name="violationReportsForm" property="offenseDegreeId" >
...
<!-- BEGIN LAW VIOLATIONS COMMENTS TABLE -->										
									<table width="98%" cellpadding="2" cellspacing="1" class="borderTableBlue">
										...
										<input type="hidden" name="prevComments" value="<bean:write name='violationReportsForm' property='previousLawViolationsComments' />" >
