...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSumReportingHistory.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/submitReportingHistoryCreateUpdate" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|16">
<div align="center">
<!-- BEGIN PAGE TABLE -->
									...
									<table width="100%">
										<tr>
											<td align="center" class="header">
												...
												<bean:message key="prompt.reportingHistory"/>&nbsp;<bean:message key="prompt.summary"/>
											</td>
										</tr>
									</table>
<!-- END HEADING TABLE -->
...
<!-- BEGIN INSTRUCTION TABLE -->
									<table width="98%" border="0">
										<tr>
											<td>
												<ul>
													<li>Review Reporting History.  Click Finish.</li>
												</ul>
											</td>
										</tr>
									</table>
												...
												<% String displayClass; %> 
													<tr class="formDeLabel">
														<td><bean:message key="prompt.occurrenceDate"/>
															<jims2:sortResults beanName="caseSummaryForm" results="create1ElementsList" primaryPropSort="dateTime" primarySortType="DATE" defaultSort="true" defaultSortOrder="DESC" sortId="1" levelDeep="4" hideMe="true"/>
														</td>
														...
														<% displayClass = ""; %>
													 	<logic:equal name="vrIter" property="manualAdded" value="true">
													  	...
													  	<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
															<td <%= displayClass %>>
																<logic:notEqual name="vrIter" property="dateTime" value="">
...
<!-- BEGIN REPORTING HISTORY COMMENTS TABLE -->									
									<table width="98%" cellpadding="2" cellspacing="1" class="borderTableBlue">
										...
										<tr>
											<td class="formDe">
												<bean:write name="caseSummaryForm" property="create1Comments" />
											</td>
										</tr>
									</table>
...
<!-- true when last face to face contanct greater than 90 days -->
									<logic:equal name="caseSummaryForm" property="showAddress" value="true">
										<table width="98%" border="0" cellspacing="0" cellpadding="2" class="borderTableBlue">
											<tr class="detailHead">
											...
											<tr>
												<td>
													<table width="100%" cellpadding="4" cellspacing="1">
														<tr>
															<td class="formDeLabel" width="1%" nowrap><bean:message key="prompt.lastContactDate"/></td>
															<td class="formDe"><bean:write name="caseSummaryForm" property="lastContactDate" formatKey="date.format.mmddyyyy"/></td>
														</tr>
														<tr>
															<td class="formDeLabel" width="1%" nowrap><bean:message key="prompt.addressType"/></td>
															<td class="formDe"><bean:write name="caseSummaryForm" property="addressType"/></td>
														</tr>
														<tr>
															<td class="formDeLabel"><bean:message key="prompt.address"/></td>
															<td class="formDe">
																<bean:write name="caseSummaryForm" property="addressNumber"/>&nbsp;<bean:write name="caseSummaryForm" property="addressName"/>
																<bean:write name="caseSummaryForm" property="addressCity"/>,&nbsp;<bean:write name="caseSummaryForm" property="addressState"/>&nbsp;&nbsp;<bean:write name="caseSummaryForm" property="addressZipCode"/>
															</td>
														</tr>
													</table>
												</td>
