...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSummary/caseSumFeeHistory.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/caseHistory_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/caseSummary/caseSumFeeHistory.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/displayFeeHistorySummary" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|13">
<div align="center">
<!-- BEGIN PAGE TABLE -->
												...
												<% String displayClass; %>
													<tr class="formDeLabel">
														...
														<td><bean:message key="prompt.payType"/>
															<jims2:sortResults beanName="caseSummaryForm" results="create1ElementsList" primaryPropSort="payType" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="1" levelDeep="4" hideMe="true"/>  
														</td>
													...
													<logic:equal name="caseSummaryForm" property="showAddFields" value="true"> 
														<tr class="normalRow" >
															<td width="1%">&nbsp;</td>	
													 		<td>
													 			<html:select name="caseSummaryForm" property="payTypeId">
																	<html:option value=""><bean:message key="select.generic"/></html:option>
																	<html:optionsCollection name="caseSummaryForm" property="payTypes" value="code" label="description" /> 
																</html:select>
													 		</td>
															<td><html:text name="caseSummaryForm" property="amountOrdered" size="15" maxlength="15" /></td>
															<td><html:text name="caseSummaryForm" property="paidToDate" size="15" maxlength="15"/></td>
															<td><html:text name="caseSummaryForm" property="deliquentAmount" size="15" maxlength="15" /></td>
														</tr>
													</logic:equal>  
												</table> 
											</td>
...
<!-- BEGIN FEE HISTORY COMMENT TABLE -->										
									<table width="98%" cellpadding="2" cellspacing="1" class="borderTableBlue">
										...
										<input type="hidden" name="prevComments" value="<bean:write name='caseSummaryForm' property='previousFeeHistoryComments' />" >
									</table>
