...
<html:base />
<title>Common Supervision - administerCaseloadCSCD/caseHistory/violationReports/vrMentalHealth.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/caseHistory_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/violationReports/vrMentalHealth.js"></script>
</head>
<body topmargin="0" leftmargin="0" onload="setAddCursorPos();" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/displayVRMentalHealthSummary" target="content">
...
<!-- END MENTAL HEALTH DIAGNOSIS TABLE -->											
										...
										<input type="hidden" name="prevMentalDiagnosis" value="<bean:write name='violationReportsForm' property='previousMentalHealthDiagnosis' />" >
									</table>
<!-- END MENTAL HEALTH DIAGNOSIS TABLE -->	
									<br>
...
<!-- END MENTAL HEALTH COMMENTS TABLE -->											
										...
										<input type="hidden" name="prevMentalComments" value="<bean:write name='violationReportsForm' property='previousMentalHealthComments' />" >
									</table>
<!-- END MENTAL HEALTH DIAGNOSIS TABLE -->	
									<br>
<!-- BEGIN BUTTON TABLE -->
									<table border="0" width="100%">
										<tr>
											<td align="center">
												...
												<input type="button" name="copyComments" value="<bean:message key="button.copyComments" />" onclick="loadMentalHealthComments('prevMentalComments','create1Comments');loadMentalHealthComments('prevMentalDiagnosis','create2Comments')" />
											</td>
										</tr>
										<tr>
											<td align="center">
