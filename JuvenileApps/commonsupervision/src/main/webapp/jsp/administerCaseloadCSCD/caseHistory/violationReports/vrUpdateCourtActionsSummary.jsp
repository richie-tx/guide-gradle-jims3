...
<html:base />
<title>Common Supervision - administerCaseloadCSCD/caseHistory/violationReports/vrUpdateCourtActionsSummary.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/submitVRUpdateCourtActionsCreateUpdate" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Violation_Reports/CSCD_Violation_Reports.htm#|8">
<div align="center">
<!-- END PAGE TABLE -->
										...
										<tr class="detailHead">
											<td>
												<table width="100%" cellpadding="0" cellspacing="0">
													<tr>
														<td class="detailHead"><bean:message key="prompt.update"/> <bean:message key="prompt.information"/></td>
													</tr>
												</table>
											</td>
										</tr>
										<tr>
											<td>
												<table width="100%" cellpadding="4" cellspacing="1">
													<tr>
														<td class="formDeLabel" width="1%" nowrap><bean:message key="prompt.presentDate"/></td>
														<td class="formDe">
															<bean:write name="violationReportsForm" property="courtActionfiledDate" formatKey="date.format.mmddyyyy"/>
														</td>
													</tr>
													<tr>
														<td class="formDeLabel" width="1%" nowrap><bean:message key="prompt.presentedBy"/></td>
														<td class="formDe"><bean:write name="violationReportsForm" property="presentedByName"/>
														</td>
													</tr>
													<tr>
										...
										<tr class="formDeLabel">
											...
											<td>
												<table width="100%" border="0" cellpadding="2" cellspacing="1">
													<logic:iterate id="caIter" name="violationReportsForm" property="create2ElementsList" indexId="index">
