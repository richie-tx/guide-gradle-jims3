...
<!-- 09/24/2013 R Capestani   	  - #75938 Suggested Court Actions Comments to 255 characters -->
...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/violationReports/vrRecommendations.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/caseHistory_util.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/caseHistory/violationReports/vrRecommendations.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);" onload="setCheckBoxFocus()">
<html:form action="/displayVRRecommendationsSummary" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Violation_Reports/CSCD_Violation_Reports.htm#|26">
<div align="center">
<!-- BEGIN PAGE TABLE -->
									...
									<table width="100%">
										<tr>
											<td align="center" class="header">
												...
												<bean:message key="prompt.recommendations"/></td>
											</tr>
									</table>
<!-- END HEADING TABLE -->
<!-- BEGIN ERROR TABLE -->
...
<!-- END SUGGESTED COURT ACTIONS TABLE -->
									...
									<input type="hidden" name="prevComments" value="<bean:write name='violationReportsForm' property='previousRecommendations' />" >	
									</table>
<!-- END DETAILS TABLE -->
