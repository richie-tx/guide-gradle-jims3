...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSummary/caseSumFeeHistorySummary.jsp</title>
...
<html:form action="/submitFeeHistoryCreateUpdate" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|14">
<div align="center">
<!-- BEGIN DETAIL TABLE -->
									...
									<table width="100%">
										<tr>
											<td align="center" class="header">
												...
												<bean:message key="prompt.feeHistory"/>&nbsp;<bean:message key="prompt.summary"/>
											</td>
										</tr>
									</table>
<!-- END HEADING TABLE -->
												...
												<table width="100%" cellpadding="2" cellspacing="1">
													...
													<logic:iterate id="vrIter" name="caseSummaryForm" property="create1ElementsList" indexId="index">
														...
														<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
															...
															<td <%= displayClass %>><bean:write name="vrIter" property="amountOrdered" formatKey="currency.format"/></td>
															<td <%= displayClass %>><bean:write name="vrIter" property="paidToDate" formatKey="currency.format"/></td>
															<td <%= displayClass %>><bean:write name="vrIter" property="delinquentAmount" formatKey="currency.format"/></td>
														</tr>
				                                    </logic:iterate>
												</table>
											</td>
...
<%-- 									<div style="width:98%; text-align:left;" class=legendSmallText><span class=vrManualAdded>Rows</span> signify manually added rows.</div> --%>
										<tr>
											<td><img src="/<msp:webapp/>images/spacer.gif" height="5"></td>
										</tr>
									</table>
