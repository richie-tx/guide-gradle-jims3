...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSummary/caseSumUpdateCourtActions.jsp</title>
...
<html:form action="/displayCaseSumUpdateCourtActionsSummary" target="content" focus="courtActionfiledDate">
									...
									<table width="100%">
										<tr>
											<td align="center" class="header">
												...
												<bean:message key="prompt.update"/>&nbsp;<bean:message key="prompt.caseSummary"/>
											</td>
										</tr>
									</table>
<!-- END HEADING TABLE -->
												...
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr>
														...
														<td class="formDe">
															...
															<html:text name="caseSummaryForm" size="10" maxlength="10" property="courtActionfiledDate" styleId="courtActionfiledDate"/>
