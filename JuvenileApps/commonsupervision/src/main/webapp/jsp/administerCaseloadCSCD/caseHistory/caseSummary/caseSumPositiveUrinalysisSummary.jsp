...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSummary/caseSumPositiveUrinalysisSummary.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/submitPositiveUrinalysisCreateUpdate" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|26">
<div align="center">
<!-- BEGIN PAGE TABLE -->
...
<!-- END TREATMENT ISSUES DETAILS TABLE -->												
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr class="formDeLabel">
														...
														<td class="formDe"><bean:write name="caseSummaryForm" property="totalSpecimensAnalyzed" /></td>
													</tr>
												</table>
								 				<table width="100%" cellpadding="2" cellspacing="1">
													<tr class="formDeLabel">
