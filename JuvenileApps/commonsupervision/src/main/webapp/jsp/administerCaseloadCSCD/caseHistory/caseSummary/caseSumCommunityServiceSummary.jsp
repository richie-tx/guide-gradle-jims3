...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/caseHistory/caseSummary/caseSumCommunityServiceSummary.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/timeout.js"></script>
<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
</head>
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true);">
<html:form action="/submitCommunityServiceCreateUpdate" target="content">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Case_Summary/CSCD_Case_Summary.htm#|22">
<div align="center">
<!-- BEGIN PAGE TABLE -->
											...
											<td>
												<table width="100%" cellpadding="2" cellspacing="1">
													<tr>
														...
														<td class="formDe"><bean:write name="caseSummaryForm" property="hoursOrdered"/></td>
													</tr>
													<tr>
														<td class="formDeLabel" nowrap><bean:message key="prompt.hoursCompleted"/></td>
														<td class="formDe"><bean:write name="caseSummaryForm" property="hoursCompleted"/></td>
													</tr>
												</table>
											</td>
										</tr>
