...
<html:base />
<title><bean:message key="title.heading" /> - administerCaseloadCSCD/closeCase/closeCaseConfirmOOC.jsp</title>
...
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Close_Supervision/OOC_Case/Close_Supervision_OOC_Case.htm#|4">
<div align="center">
	<!-- START BASE TABLE -->
							...
							<table width="98%" border="0" cellpadding="0" cellspacing="0" class="borderTableGreen">
								...
								<tr>
									<td valign="top" align="center">
										...
										<!-- BEGIN  SUCCESS TABLE -->
										<logic:equal name="outOfCountyCaseForm" property="closeCaseSuccess" value="true">
											<table width="100%" border="0" cellpadding="0" cellspacing="0">
												<tr>
													<td align="center">
														<table border="0" width="98%" cellspacing="1" cellpadding="4">
															...
															<logic:equal name="outOfCountyCaseForm" property="action" value="<%= CloseCaseConstants.OOC_CASE_CLOSE %>">
																<logic:equal name="outOfCountyCaseForm" property="dispositionTypeId" value="<%= PDCodeTableConstants.STRAIGHT_PROBATION %>">
																	<tr>
																		<td class="formDeLabel" width="1%" nowrap><bean:message key="prompt.confinementLength"/></td>
																		<td class="formDe" colspan="3">
								                                  		<bean:write name="outOfCountyCaseForm" property="confinementLengthYear" /> <bean:message key="prompt.years" />&nbsp;
																...
																<logic:notEqual name="outOfCountyCaseForm" property="dispositionTypeId" value="<%= PDCodeTableConstants.PRETRIAL_INTERVENTION %>">
																	<tr>
																		<td class="formDeLabel" ><bean:message key="prompt.supervisionLength"/></td>
																		<td class="formDe" colspan="3">
								                                  		<bean:write name="outOfCountyCaseForm" property="supervisionLengthYear" /> <bean:message key="prompt.years" />&nbsp;
															...
															<logic:equal name="outOfCountyCaseForm" property="action" value="<%= CloseCaseConstants.OOC_CASE_CLOSE %>">
																...
																<logic:equal name="outOfCountyCaseForm" property="dispositionTypeId" value="<%= PDCodeTableConstants.PRETRIAL_INTERVENTION %>">
																	<tr>
																		<td class="formDeLabel" nowrap><bean:message key="prompt.pretrialInterventionBegin"/></td>
																		<td class="formDe"><bean:write name="outOfCountyCaseForm" property="pretrialInterventionBeginAsString" /></td>
																		<td class="formDeLabel" nowrap><bean:message key="prompt.pretrialInterventionEnd"/></td>
													...
													<!-- BEGIN CASE CLOSE FAILURE TABLE -->
													<logic:equal name="outOfCountyCaseForm" property="closeCaseSuccess" value="false">
															...
															<tr>
																<td>
																	<table width="100%" cellpadding="2" cellspacing="1">
																		...
																		<logic:iterate id="eachCase" name="outOfCountyCaseForm" property="closeCasesResultBeanList" indexId="casesIndexId">
																			<tr class=<%= (casesIndexId.intValue() % 2 == 0)?"normalRow":"alternateRow" %>>
