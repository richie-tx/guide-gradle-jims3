									...
									<td align="center" class="header">
										...
										<logic:equal name="courtPolicyForm" property="pageType" value="summary">
											<logic:equal name="courtPolicyForm" property="action" value="copy">
												<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|76">
											...
											<logic:equal name="courtPolicyForm" property="action" value="create">
												<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|57">
											...
											<logic:equal name="courtPolicyForm" property="action" value="update">
												<logic:notEqual name="courtPolicyForm" property="inUse" value="true">
													<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|69">
										...
										<logic:equal name="courtPolicyForm" property="pageType" value="confirm">
											...
											<logic:equal name="courtPolicyForm" property="action" value="create">
												<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|58">
												<bean:message key="prompt.create" />
												<bean:message key="<%=courtPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />
											</logic:equal>
											...
											<logic:equal name="courtPolicyForm" property="action" value="update">
												<logic:notEqual name="courtPolicyForm" property="inUse" value="true">
													<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|70">
													<bean:message key="prompt.update" />
													<bean:message key="<%=courtPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />												
												</logic:notEqual>
												<logic:equal name="courtPolicyForm" property="inUse" value="true">
													<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|115">
													<bean:message key="prompt.update" />
													<bean:message key="prompt.inUse" />
													<bean:message key="<%=courtPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />
												</logic:equal>
											...
											<logic:equal name="courtPolicyForm" property="action" value="delete">
												<logic:equal name="courtPolicyForm" property="inUse" value="true">
													<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|82">
													<bean:message key="prompt.inactivate" />
													<bean:message key="<%=courtPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />													
												</logic:equal>
												<logic:notEqual name="courtPolicyForm" property="inUse" value="true">
													<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|79">
													<bean:message key="prompt.delete" />
													<bean:message key="<%=courtPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />													
												</logic:notEqual>
											</logic:equal>
											...
											<logic:equal name="courtPolicyForm" property="action" value="asscConditions">
												<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|85">
												<bean:message key="prompt.associate" />
												<bean:message key="<%=courtPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />												
											</logic:equal>	
										...
										<table width=100% cellpadding=0 cellspacing=0>
											<tr>
												<td width=1%>
													...
													<img border=0 src="/<msp:webapp/>images/expand.gif" name="courtPolicy"></a></td>
