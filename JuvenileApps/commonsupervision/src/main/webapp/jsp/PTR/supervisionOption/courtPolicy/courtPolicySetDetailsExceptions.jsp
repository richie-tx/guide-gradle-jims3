...
<html:base />
<title><bean:message key="title.heading" /> - courtPolicySetDetailsExceptions.jsp</title>
							...
							<tr>
								<td align="center" class="header">
									<logic:equal name="courtPolicyForm" property="action" value="copy">
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|75">
										<bean:message key="prompt.copy" />
										<bean:message key="<%=courtPolicyTitle%>"/>&nbsp;-&nbsp;<bean:message key="prompt.exceptions" />&nbsp;-&nbsp;<bean:message key="title.setDetails" />
									</logic:equal>
									
									<logic:equal name="courtPolicyForm" property="action" value="create">
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|56">
									...
									<logic:equal name="courtPolicyForm" property="action" value="update">
										<logic:notEqual name="courtPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|67">
											<bean:message key="prompt.update" />
											<bean:message key="<%=courtPolicyTitle%>"/>&nbsp;-&nbsp;<bean:message key="prompt.exceptions" />&nbsp;-&nbsp;<bean:message key="title.setDetails" />
										</logic:notEqual>
										<logic:equal name="courtPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|68">
											<bean:message key="prompt.update" />
							...
							<tr>
								<td colspan=2 class=detailHead>
									<table width=100% cellpadding=0 cellspacing=0>
										<tr>
											<td width=1%>
												<a href="javascript:showHideMulti('courtPolicy', 'sc', 13, '/<msp:webapp/>')" border=0>
												<img border=0 src="/<msp:webapp/>images/expand.gif" name="courtPolicy"></a>
											</td>
...
<logic:equal name="courtPolicyForm" property="agencyJUV" value="false">
						...
						<table width="98%" border="0" cellspacing=1 cellpadding=4>
						  ...
						  <% boolean dateCounter=true; %>
							<nested:iterate name="courtPolicyForm" property="ECVE">
								<tr>
									<td class=boldText colspan=2><nested:write property="courtNumber"/></td>
								</tr>
								<nested:iterate property="variableElements">
								...
								<input type="reset" value="Reset" name="reset">
									...
									<input type=button value='<bean:message key="button.cancel" />' 
										<logic:equal name="courtPolicyForm" property="action" value="<%=UIConstants.CREATE%>"> 
											onclick="javascript:changeFormActionURL(this.form.name, '/<msp:webapp/>displayCourtPolicyCreate.do', false) && disableSubmit(this, this.form)"
										</logic:equal>
										<logic:notEqual name="courtPolicyForm" property="action" value="<%=UIConstants.CREATE%>"> 
											onclick="javascript:changeFormActionURL(this.form.name, '/<msp:webapp/>displayCourtPolicySearch.do', false) && disableSubmit(this, this.form)"
										</logic:notEqual>
									>						    
								</td>
						  </tr>
