...
<html:base />
<title><bean:message key="title.heading" /> - courtPolicySearch.jsp</title>
			...
			<table width=100% border="0" cellpadding="0" cellspacing="0" class="borderTableBlue">
				...
				<tr>
					<td valign="top" align="center">
						...
						<table width=100%>
						  <tr>
							<td align="center" class="header"><bean:message key="prompt.search" />&nbsp;<bean:message key="<%=courtPolicyTitle%>"/></td>
						  </tr>
							<tr>
						...
						<table border="0" width="100%">
						  <tr>
						    <td align="center">
						    	 <html:submit property="submitAction" onclick="return validateCourtPolicySearchForm(this.form) && disableSubmit(this, this.form);"><bean:message key="button.submit"/></html:submit>	
