...
<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|2">
<div align="center">
			...
			<table width=100% border="0" cellpadding="0" cellspacing="0" >
				...
				<table width=100% border="0" cellpadding="0" cellspacing="0" class="borderTableBlue">
					...
					<tr>
						...
						<logic:notEmpty name="supervisionConditionForm" property="group3Name">
							<bean:message key="<%=conditionGroup3Caption%>" />: <bean:write
								name="supervisionConditionForm" property="group3Name" />&nbsp;</logic:notEmpty>
					<%--	&nbsp;Courts: 
							...
							property="selectedCourts"> Selected Courts
								...
								<table width="98%" border="0" cellpadding="2" cellspacing="1" class=borderTableBlue>
									<tr class="detailHead">
										...
										<td><bean:message key="<%=conditionGroup1Caption%>"/></td>
										<td><bean:message key="<%=conditionGroup2Caption%>"/></td>
										<td><bean:message key="<%=conditionGroup3Caption%>"/></td>
									</tr>
									...
									<logic:iterate id="conditionSearchResultsIter" name="supervisionConditionForm" property="conditionSearchResults">
										<tr class= <% RecordCounter++;
											...
											<td><bean:write name="conditionSearchResultsIter" property="group3Name" /></td>
										</tr>
									</logic:iterate>
						  		...
						  		<td align="center">
						  			<jims2:isAllowed requiredFeatures="CS-COND-UPDATE">
						  				<logic:equal name="supervisionConditionForm" property="agencyId" value="<%=UIConstants.CSC%>">
							  				<html:submit property="submitAction" onclick="return isAnySelected(this.form, 'conditionId') && disableSubmit(this, this.form);"><bean:message key="button.updateCourtPolicyAssociations"/></html:submit>
							  			...
							  			<logic:equal name="supervisionConditionForm" property="agencyId" value="<%=UIConstants.PTR%>">
						  					<html:submit property="submitAction" onclick="return isAnySelected(this.form, 'conditionId') && disableSubmit(this, this.form);"><bean:message key="button.updateComplianceStandardsAssociations"/></html:submit>
											<html:submit property="submitAction" onclick="return isAnySelected(this.form, 'conditionId') && disableSubmit(this, this.form);"><bean:message key="button.updateProcedureAssociations"/></html:submit>
							  			</logic:equal>
							  		</jims2:isAllowed>
						  		</td>
						  	</tr>
