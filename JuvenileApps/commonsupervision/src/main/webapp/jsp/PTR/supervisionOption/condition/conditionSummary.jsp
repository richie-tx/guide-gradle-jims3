...
<bean:define id="conditionGroup1Caption" name="supervisionConditionForm"
	property="conditionGroup1Caption" type="java.lang.String" />
<bean:define id="conditionGroup2Caption" name="supervisionConditionForm"
	property="conditionGroup2Caption" type="java.lang.String" />
<bean:define id="conditionGroup3Caption" name="supervisionConditionForm"
...
<bean:define id="deptPolicyTitle" name="supervisionConditionForm" property="deptPolicyTitle" type="java.lang.String"/>
					...
					<TBODY>
						...
						<tr>
											...
											<table width="98%" cellspacing=1 cellpadding=4>
												...
												<TBODY>
													<tr>
														...
														<table width=100% cellpadding=0 cellspacing=0>
															<TBODY>
																<tr>
																	<td width=1%><a
																		href="javascript:showHideMulti('supervisionCondition', 'sc', 17, '/<msp:webapp/>')"><img
																		border=0 src="/<msp:webapp/>images/expand.gif"
																		name="supervisionCondition"></a></td>
																	<td class="detailHead">&nbsp;<bean:message
																		key="title.supervisionCondition" /></td>
																	<td align=right><img
																		src="/<msp:webapp/>images/step_1.gif"></td>
																</tr>
															</TBODY>
														</table>
														</td>
													...
													<tr id="sc0" class="hidden">
														<td width=1% nowrap class="formDeLabel"><bean:message
															key="prompt.name" /></td>
													...
													<tr id="sc1" class="hidden">
														...
														<td class="formDe"><bean:write
															name="supervisionConditionForm" property="group1Name" /></td>
													</tr>
													<tr id="sc2" class="hidden">
														<td class="formDeLabel" width=1% nowrap><bean:message
															key="<%=conditionGroup2Caption%>" /></td>
														<td class="formDe"><bean:write
															name="supervisionConditionForm" property="group2Name" /></td>
													</tr>
													<tr id="sc3" class="hidden">
														<td class="formDeLabel" width=1% nowrap><bean:message
															key="<%=conditionGroup3Caption%>" /></td>
														<td class="formDe"><bean:write
															name="supervisionConditionForm" property="group3Name" /></td>
													</tr>
												...
												Non Standard</logic:notEqual></td>
													...
													<tr id="sc5" class="hidden">
														<td class="formDeLabel" valign="top" width=1% nowrap><bean:message
															key="prompt.literal" /></td>
														<td class="formDe"><bean:write
															name="supervisionConditionForm"
															property="conditionLiteral"  filter="false"/></td>
													</tr>
													<tr id="sc6" class="hidden">
														<td class="formDeLabel" valign="top" width=1% nowrap><bean:message
															key="prompt.spanishLiteral" /></td>
														<td class="formDe"><bean:write
															name="supervisionConditionForm"
															property="conditionSpanishLiteral"  filter="false"/></td>
													</tr>
													<logic:equal name="supervisionConditionForm"
														property="agencyJUV" value="true">
														<tr id="sc7" class="hidden">
															<td class="formDeLabel" nowrap><bean:message
																key="prompt.supervisionType" /></td>
															<td class="formDe"><bean:write
																name="supervisionConditionForm"
																property="dispSelSupTypes" /></td>
														</tr>
													</logic:equal>
													<tr id="sc8" class="hidden">
														<td class="formDeLabel" nowrap><bean:message
															key="prompt.documents" /></td>
														<td class="formDe"><bean:write
															name="supervisionConditionForm" property="selDocuments" /></td>
													</tr>
													<logic:equal name="supervisionConditionForm"
														property="agencyJUV" value="false">
														<tr id="sc9" class="hidden">
															<td class="formDeLabel" nowrap><bean:message
																key="prompt.severityLevel" /></td>
															<td class="formDe"><bean:write
																name="supervisionConditionForm" property="severityLevel" /></td>
														</tr>
														<tr id="sc10" class="hidden">
															<td class="formDeLabel" nowrap><bean:message
																key="prompt.jurisdiction" /></td>
															<td class="formDe"><bean:write
																name="supervisionConditionForm" property="jurisdiction" /></td>
														</tr>
													</logic:equal>
													<tr id="sc11" class="hidden">
														...
														<td class="formDe"><bean:write
															name="supervisionConditionForm" property="effectiveDate" /></td>
													</tr>
													...
													<logic:equal name="supervisionConditionForm"
														...
														<tr id="sc12" class="hidden">
															...
															<td class="formDe"><bean:write
																name="supervisionConditionForm" property="inactiveDate" /></td>
														</tr>
													</logic:equal>
													...
													<logic:equal name="supervisionConditionForm"
														...
														<tr id="sc13" class="hidden">
															<td class="formDeLabel" nowrap><bean:message
																key="prompt.eventType" /></td>
															<td class="formDe"><bean:write
																name="supervisionConditionForm"
																property="selectedEventTypes" /></td>
														</tr>
														<tr id="sc14" class="hidden">
															<td class="formDeLabel" nowrap><bean:message
																key="prompt.eventCount" /></td>
															<td class="formDe"><bean:write
																name="supervisionConditionForm"
																property="eventCountDesc" /></td>
														</tr>
														<tr id="sc15" class="hidden">
															<td class="formDeLabel" nowrap><bean:message
																key="prompt.period" /></td>
															<td class="formDe">
													...
													<tr id="sc16" class="hidden">
														<td class="formDeLabel" nowrap><bean:message
															key="prompt.notes" /></td>
														<td class="formDe"><bean:write
															name="supervisionConditionForm" property="notes" /></td>
													</tr>
							...
							<logic:notEqual name="supervisionConditionForm"
								...
								<table width="98%" border="0" cellspacing=1 cellpadding=4>
									<TBODY>
										...
										<logic:iterate id="exceptionCourtVarElemBeansIter"
											...
											<tr>
												<td class=boldText colspan=2><bean:write
										...
										<TBODY>
											<tr>
												<td><!-- Associations --> <tiles:insert
													page="../../../common/conditionAssociationsView.jsp"
													flush="true">
													<tiles:put name="associatedCourtPolicies"
														beanName="supervisionConditionForm"
														beanProperty="associatedCourtPolicies" />
													<tiles:put name="associatedDepartmentPolicies"
														beanName="supervisionConditionForm"
														beanProperty="associatedDeptPolicies" />
												</tiles:insert></td>
											</tr>
										</TBODY>
									</table>
								...
								<logic:notEmpty name="supervisionConditionForm"
									property="removedAssociations">
									<table width="98%" border="0" cellspacing="0" cellpadding="2">
										<TBODY>
											<tr>
												<td><!-- Associations --> <tiles:insert
													page="../../../common/removedAssociationsView.jsp"
													flush="true">
													<tiles:put name="removedAssociations"
														beanName="supervisionConditionForm"
														beanProperty="removedAssociations" />
													<tiles:put name="associationType" value="condition" />
													<tiles:put name="group2Caption"
														beanName="supervisionConditionForm"
														beanProperty="courtGroup2Caption" />
													<tiles:put name="group3Caption"
														beanName="supervisionConditionForm"
														beanProperty="courtGroup3Caption" />
												</tiles:insert></td>
											</tr>
										</TBODY>
									</table>
							...
							<table border="0" width="100%">
								<TBODY>
									<tr>
										...
										<logic:equal name="supervisionConditionForm"
										...
										</logic:equal> <logic:equal name="supervisionConditionForm"
											property="pageType" value="confirm">
											...
											<logic:equal name="supervisionConditionForm"
												property="pageType" value="confirm">
												<logic:notEqual name="supervisionConditionForm"
													property="action" value="<%=UIConstants.DELETE%>">
													<logic:notEqual name="supervisionConditionForm"
														property="action" value="asscCourtPolicy">
														<jims2:isAllowed requiredFeatures="CS-COND-UPDATE">
															<logic:equal name="supervisionConditionForm" property="agencyId" value="<%=UIConstants.CSC%>">
																<input type="button"
																	value="<bean:message key='button.assocToCourtPolicy'/>"
																	onclick="changeFormActionURL(this.form.name, '/<msp:webapp/>handleSupervisionConditionSelection.do?submitAction=Update Court Policy Associations', false) && disableSubmit(this, this.form);">
															</logic:equal>
															<logic:equal name="supervisionConditionForm" property="agencyId" value="<%=UIConstants.JUV%>">
																<input type="button"
																	value="<bean:message key='button.assocToConsequence'/>"
																	onclick="changeFormActionURL(this.form.name, '/<msp:webapp/>handleSupervisionConditionSelection.do?submitAction=Update Court Policy Associations', false) && disableSubmit(this, this.form);">
															</logic:equal>
															<logic:equal name="supervisionConditionForm" property="agencyId" value="<%=UIConstants.PTR%>">
																<input type="button"
																	value="<bean:message key='button.assocToComplianceStandards'/>"
																	onclick="changeFormActionURL(this.form.name, '/<msp:webapp/>handleSupervisionConditionSelection.do?submitAction=Update Court Policy Associations', false) && disableSubmit(this, this.form);">
															</logic:equal>
														</jims2:isAllowed>
													</logic:notEqual>
													<logic:notEqual name="supervisionConditionForm"
														...
														<jims2:isAllowed requiredFeatures="CS-COND-UPDATE">
															<logic:equal name="supervisionConditionForm" property="agencyId" value="<%=UIConstants.CSC%>">
																<input type="button"
																	value="<bean:message key='button.assocToDeptPolicy'/>"
																	onclick="changeFormActionURL(this.form.name, '/<msp:webapp/>handleSupervisionConditionSelection.do?submitAction=Update Dept Policy Associations', false) && disableSubmit(this, this.form);">
															</logic:equal>
															<logic:equal name="supervisionConditionForm" property="agencyId" value="<%=UIConstants.JUV%>">
																<input type="button"
																	value="<bean:message key='button.assocToDeptPolicy'/>"
															...
															<logic:equal name="supervisionConditionForm" property="agencyId" value="<%=UIConstants.PTR%>">
																<input type="button"
																	value="<bean:message key='button.assocToProcedures'/>"
																	onclick="changeFormActionURL(this.form.name, '/<msp:webapp/>handleSupervisionConditionSelection.do?submitAction=Update Dept Policy Associations', false) && disableSubmit(this, this.form);">
															</logic:equal>
														</jims2:isAllowed>
													</logic:notEqual>
