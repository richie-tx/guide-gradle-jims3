...
<bean:define id="deptPolicyAssoTitle" name="supervisionConditionForm" property="deptPolicyAssoTitle" type="java.lang.String"/>
...
<tiles:insert page="../../../common/associationBody.jsp" flush="true">
	...
	<tiles:put name="group1Caption" beanName="supervisionConditionForm" beanProperty="departmentGroup1Caption"/>
	<tiles:put name="group2Caption" beanName="supervisionConditionForm" beanProperty="departmentGroup2Caption"/>
	<tiles:put name="group3Caption" beanName="supervisionConditionForm" beanProperty="departmentGroup3Caption"/>
