					...
					<td valign="top" align=center>
							...
							<tr>
								<td colspan=2 class=detailHead>
									<table width=100% cellpadding=0 cellspacing=0>
										<tr>
											<td width=1%><a href="javascript:showHideMulti('supervisionCondition', 'sc', 15, '/<msp:webapp/>')" >
												<img border=0 src="/<msp:webapp/>images/expand.gif" name="supervisionCondition"></a>
											</td>
						...
						<tr id="sc3" class="hidden">
							...
							<td class="formDe"><logic:equal name="supervisionConditionForm" property="standard" value="true">
												...
												Non Standard</logic:notEqual></td>	</tr>
						<tr id="sc4" class="hidden">
							<td class="formDeLabel" valign="top" width=1% nowrap><bean:message key="prompt.literal" /></td>
							<td class="formDe"><bean:write name="supervisionConditionForm" property="conditionLiteral"/></td>
						</tr>
						...
						<tr>
							...
							<tr>
								...
								<td class="formDe">
									<html:textarea name="supervisionConditionForm" property="deleteNote" style="width:100%" rows="5"/>
								</td>
							</tr>
							</table>
						<br>
