...
<html:base />
<title><bean:message key="title.heading" /> - courtPolicySelectCourts.jsp</title>
...
<html:form action="/displayCourtPolicyDetails" target="content">
<div align="center">
  	...
  	<tr>
    	<td valign="top">
			<table width=100% border="0" cellpadding="0" cellspacing="0" >
				...
				<tr>
					<td bgcolor=#6699FF><img src=../../../common/images/spacer.gif height=5></td>
				</tr>
			</table>
							...
							<tr>
								<td align="center" class="header">
									<logic:equal name="courtPolicyForm" property="action" value="copy">
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|73">
										<bean:message key="prompt.copy" />
										<bean:message key="<%=courtPolicyTitle%>"/>&nbsp;-&nbsp;<bean:message key="prompt.selectCourts" />																					
									</logic:equal>
									
									<logic:equal name="courtPolicyForm" property="action" value="create">
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|54">
									...
									<logic:equal name="courtPolicyForm" property="action" value="update">
										<logic:notEqual name="courtPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|63">
											<bean:message key="prompt.update" />
											<bean:message key="<%=courtPolicyTitle%>"/>&nbsp;-&nbsp;<bean:message key="prompt.selectCourts" />
										</logic:notEqual>
										<logic:equal name="courtPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|64">
											<bean:message key="prompt.update" />
