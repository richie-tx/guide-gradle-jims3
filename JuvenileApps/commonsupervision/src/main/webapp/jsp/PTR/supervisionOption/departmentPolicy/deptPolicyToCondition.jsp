...
<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|109">
<tiles:insert page="../../../common/associationBody.jsp" flush="true">
	...
	<tiles:put name="group1Caption" beanName="departmentPolicyForm" beanProperty="conditionGroup1Caption"/>
