							...
							<tr>
								<td align="center" class="header">
									<logic:notEqual name="departmentPolicyForm" property="inUse" value="true">
										<input type="hidden" name="helpFile" value="commonsupervision/mso/manage_supervision_options.htm#|106">
								...
								<td>
									<!-- Associations -->
										<tiles:insert page="../../../common/associatedConditionsView.jsp" flush="true">
											...
											<tiles:put name="conditionGroup2Caption" beanName="departmentPolicyForm" beanProperty="departmentGroup2Caption"/>
											<tiles:put name="conditionGroup3Caption" beanName="departmentPolicyForm" beanProperty="departmentGroup3Caption"/>
										</tiles:insert>
								</td>
							</tr>
						</table>
