...
<table width="98%" border="0" cellpadding="2" cellspacing="1" class=borderTableBlue>
	...
	<tr>											
		...
		<td><bean:write name="supervisionOrderForm" property="courtNum" /></td>
		...
		<td><bean:write name="supervisionOrderForm" property="orderFileDate" formatKey="date.format.mmddyyyy" /></td>							
	</tr>					
</table>
