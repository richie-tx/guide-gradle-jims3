...
<!-- 09/07/2006  Hien Rodriguez - Defect#34901 remove DefendantSignatureAcquired button from
     the View Order Versions page -->
								...
								<tr>
									...
									<logic:notEqual name="supervisionOrderForm" property="isHistoricalOrder" value="true">
										...
										<logic:equal name="supervisionOrderForm" property="action" value="confirmCreate">
											...
											<bean:message key="prompt.create" /> <bean:message key="title.supervisionOrder" /> - <bean:message key="prompt.confirmation" />										
											<tr>
												<td class="confirm"><logic:equal name="supervisionOrderForm" property="isHistoricalOrder" value="true">
										Historical
									</logic:equal>
									<logic:notEqual name="supervisionOrderForm" property="isHistoricalOrder" value="true">
										Supervision
									</logic:notEqual>	 Order successfully created.</td>
											</tr>
										</logic:equal>
									...
									<logic:notEqual name="supervisionOrderForm" property="isHistoricalOrder" value="true">
										Supervision
									</logic:notEqual>	 Order successfully activated.</td>
											</tr>
										</logic:equal>
									...
									<logic:notEqual name="supervisionOrderForm" property="isHistoricalOrder" value="true">
										Supervision
									</logic:notEqual>	 Order successfully filed.</td>
											</tr>
										</logic:equal>											
										<logic:equal name="supervisionOrderForm" property="action" value="confirmUpdate">
											...
											<bean:message key="prompt.update" /> <bean:message key="title.supervisionOrder" /> - <bean:message key="prompt.confirmation" />										
											<tr>
												<td class="confirm"><logic:equal name="supervisionOrderForm" property="isHistoricalOrder" value="true">
										Historical
									</logic:equal>
									<logic:notEqual name="supervisionOrderForm" property="isHistoricalOrder" value="true">
										Supervision
									</logic:notEqual>	 Order successfully updated.</td>
											</tr>
										</logic:equal>
									</td>
								 </tr>		
											...
											<table width="100%" cellpadding="2" cellspacing="1">
												...
												<logic:iterate id="orderVersionListIndex" name="supervisionOrderForm" property="orderVersionList">
													...
													class=<%RecordCounter++;
														...
														<td title="View this version's Order"><a href="/<msp:webapp/>handleSupervisionOrderSelection.do?submitAction=<bean:message key="button.compareOrderVersions"/>&orderId=<bean:write name="orderVersionListIndex" property="orderId"/>"><bean:write name="orderVersionListIndex" property="orderVersion" /></a></td>
								...
								<tr>
									...
									<logic:equal name="supervisionOrderForm" property="action" value="view">                        
										...
										<table width=100% cellpadding=4 cellspacing=1 border=0>	
											...
											<logic:equal name="supervisionOrderForm" property="selectedOrderVersion.limitedSupervisionPeriod" value="true">
											<tr>				                          	
												<td class=formDeLabel nowrap width="1%"><bean:message key="prompt.supervisionBeginDate" /></td>
												<td class=formDe><bean:write name="supervisionOrderForm" property="supervisionOrderBeginDate" /></td>		
											</tr>
											<tr>				                          	
												<td class=formDeLabel><bean:message key="prompt.supervisionEndDate" /></td>
												<td class=formDe><bean:write name="supervisionOrderForm" property="supervisionOrderEndDate" /></td>		
											</tr>
										</logic:equal>
										
										
											<%-- Not needed for PTR <tr>
...
<tr>
	...
	<td class=formDe><bean:write name="supervisionOrderForm" property="selectedOrderVersion.caseSupervisionEndDateAsString" /></td>
										...
										<table width="100%" border="0" cellspacing=1 cellpadding=4>
											...
											<tr>				                          	
												<td class=formDeLabel nowrap width="1%"><bean:message key="prompt.supervisionBeginDate" /></td>
												<td class=formDe><bean:write name="supervisionOrderForm" property="selectedOrderVersion.supervisionOrderBeginDate" /></td>		
												<td class=formDeLabel nowrap width="1%"><bean:message key="prompt.supervisionBeginDate" /></td>
												<td class=formDe><bean:write name="supervisionOrderForm" property="previousOrderVersion.supervisionOrderBeginDate" /></td>		
											</tr>
											<tr>				                          	
												<td class=formDeLabel><bean:message key="prompt.supervisionEndDate" /></td>
												<td class=formDe><bean:write name="supervisionOrderForm" property="selectedOrderVersion.supervisionOrderEndDate" /></td>	
												<td class=formDeLabel><bean:message key="prompt.supervisionEndDate" /></td>
												<td class=formDe><bean:write name="supervisionOrderForm" property="previousOrderVersion.supervisionOrderEndDate" /></td>		
											</tr>
								...
								<logic:equal name="supervisionOrderForm" property="action" value="view">
									...
									<tr>
										<td align=center>
											...
											<html:submit property="submitAction" onclick="changeFormSettings(this.form, 'new', this, 'submitSupervisionOrderPrintRequest.do');"><bean:message key="button.printSpanishVersion"></bean:message></html:submit>&nbsp;						
											<html:button property="submitAction" onclick="alert('This will navigate to the Process Other Doccuments Use Case - not available yet')"><bean:message key="button.processOtherDocuments"></bean:message></html:button>&nbsp;
										</td>								
										<%--<logic:equal name="supervisionOrderForm" property="agencyId" value="CSC">
											<logic:equal name="supervisionOrderForm" property="orderStatusId" value="D">
												<td align=center >
													<html:submit property="submitAction" onclick="changeFormSettings(this.form, '', this, 'submitSupervisionOrderCreateUpdate.do');"><bean:message key="button.defendantSignatureAcquired"></bean:message></html:submit>
												</td>	
											</logic:equal>	
										</logic:equal>--%>								
									</tr>	
									...
									<tr>											
										<td align=center>
											<html:submit property="submitAction" onclick="changeFormSettings(this.form, '', this, 'submitSupervisionOrderCreateUpdate.do');"><bean:message key="button.backToSearch"></bean:message></html:submit>&nbsp;
											<html:submit property="submitAction" onclick="changeFormSettings(this.form, '', this, 'submitSupervisionOrderCreateUpdate.do');"><bean:message key="button.backToCaseOrderSearchResults"></bean:message></html:submit>&nbsp;
											<html:submit property="submitAction" onclick="changeFormSettings(this.form, '', this, 'submitSupervisionOrderCreateUpdate.do');"><bean:message key="button.cancel"></bean:message></html:submit>														
										</td>								
									</tr>		
								</logic:equal>
								<logic:equal name="supervisionOrderForm" property="action" value="confirmCreate">
									<tr align="center" id="nodefSigAquired">
										<td>
											<jims2:isAllowed requiredFeatures="CS-PASO-PREPTOFILE">											
												<html:submit property="submitAction" onclick="changeFormSettings(this.form, '', this, 'submitSupervisionOrderCreateUpdate.do');"><bean:message key="button.prepareToFile"></bean:message></html:submit>&nbsp;
											</jims2:isAllowed>
											<html:button property="submitAction" onclick="alert('This will navigate to the Process Other Doccuments Use Case - not available yet')"><bean:message key="button.processOtherDocuments"></bean:message></html:button>
										</td>							
									</tr>
									...
									<tr>
										<td align=center>
											<jims2:isAllowed requiredFeatures="CS-PASO-ACTIVATE">
												<html:submit property="submitAction" onclick="changeFormSettings(this.form, '', this, 'submitSupervisionOrderCreateUpdate.do');"><bean:message key="button.activateOrder"></bean:message></html:submit>&nbsp;
											</jims2:isAllowed>
											<jims2:isAllowed requiredFeatures="CS-PASO-UPDATE">	
												<html:submit property="submitAction" onclick="changeFormSettings(this.form, '', this, 'submitSupervisionOrderCreateUpdate.do');"><bean:message key="button.updateOrder"></bean:message></html:submit>&nbsp;						
											</jims2:isAllowed>
											<logic:notEqual name="supervisionOrderForm" property="isHistoricalOrder" value="true">
											<html:button property="submitAction" onclick="alert('This will navigate to the Process Other Doccuments Use Case - not available yet')"><bean:message key="button.processOtherDocuments"></bean:message></html:button>
											</logic:notEqual>
