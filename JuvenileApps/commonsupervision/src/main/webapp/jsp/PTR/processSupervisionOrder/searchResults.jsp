								...
								<logic:notEmpty name="supervisionOrderSearchForm" property="superviseeList">	
									<logic:iterate id="superviseeListIndex" name="supervisionOrderSearchForm" property="superviseeList">
										...
										class=<%RecordCounter++;
											...
											<td><a href="/party/displayPartyCreateUpdateDetail.do?action=view&secondaryAction=PASO&partyOid=<bean:write name="superviseeListIndex" property="oid"/>">
											...
											<td><bean:write name="superviseeListIndex" property="sex" /></td>							
										</tr>																
									</logic:iterate>
								</logic:notEmpty> 				
							</table>	
