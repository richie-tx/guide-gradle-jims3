						...
						<table width=98%>
							<tr>
								<td align="center" class="header">
									...
									<bean:message key="title.supervisionOrder" />&nbsp;-&nbsp;<bean:message key="prompt.conditionSequence" />
								</td>
							 </tr>					 						  
						</table>
					<!-- END HEADING TABLE -->						
								...
								<td>
									<table border=0 cellpadding=0 cellspacing=0 align=center width=100%>
													...
													<logic:iterate id="conditionSelectedListIndex" name="supervisionOrderForm" property="conditionSelectedList" indexId="condIndexCount">
														...
														<tr	id="node<%RecordCounter++;%>" taskid=<%=RecordCounter%> position="<%=RecordCounter%>" origposition="<%=RecordCounter%>" onmouseover="hoverClassFlip(this, 'on')"  onmouseout="hoverClassFlip(this, 'out')" >															
															<logic:equal name="conditionSelectedListIndex" property="likeConditionInd" value="true">
																<td class=impactedOrderBold width=1% align=center title="This order has Impacted Orders with Like Conditions" width=1%>&nbsp;<%=RecordCounter%>&nbsp;</td>
															</logic:equal>
										...
										<tr>
											...
											<td align=center colspan=2><html:submit property="submitAction" onclick="updateMasterList();changeFormSettings(this.form, 'new', this, 'displaySupervisionOrderPreviewNSample.do')"><bean:message key="button.previewOrder"/></html:submit></td>
										</tr>
									</table>
								</td>
							</tr>
