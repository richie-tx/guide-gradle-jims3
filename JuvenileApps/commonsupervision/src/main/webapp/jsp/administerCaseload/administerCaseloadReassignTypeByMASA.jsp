...
<head>
	...
	<html:base />
	<title>CommonSupervision/administerCaseload/administerCaseloadReassignTypeByMASA.jsp</title>
...
<body topmargin="0" leftmargin="0">
	<html:form action="/superviseeReassignmentTypeByMASAAction" target="content">		
							...
							<tr>
								<td valign="top" align="center">
									...
									<table width="98%" border="0" cellpadding="2" cellspacing="0" class="borderTableBlue">
										<tr class="detailHead">
											<td>Reassign Supervisee Case(s)</td>
										</tr>
										<tr>
											<td>
												<table width="100%" border="0" cellpadding="2" cellspacing="1">
													<tr><td class="formDe">
															<input type="radio" name="reassignmentType" value="off"> to an Officer (outbound)
														</td></tr>
													<tr><td class="formDe">
															<input type="radio" name="reassignmentType" value="clo"> to a Court Liason Officer (inbound)
														</td></tr>
												</table>
												</td>
											</tr>
