...
<html:base />
<title>CommonSupervision/administerCaseload/administerCaseloadSearchByMASA.jsp</title>
...
<html:form action="/superviseeSearchSetupByMASAAction" target="content">
				...
				<tr>
					...
					<table width="100%">
						<tr>
							<td align="center" class="header"><bean:message
								...
								key="prompt.caseload" /> Search - MA / SA</td>
						</tr>
					</table>
					...
					<table border="0" width="100%">
						<tr>
							...
							</html:submit> <input type="button" value="Reports" disabled /></td>
						</tr>
						<tr>
							<td align="center"><html:submit property="submitAction">
