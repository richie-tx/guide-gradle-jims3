...
<!-- 10/15/2008	 C Shimek       - defect#51412 change next button to paperFileReceived button -->
...
<head>
	...
	<html:base />
	<title>CommonSupervision/administerCaseload/caseListForAssignSuperviseeToProgramUnit.jsp</title>
...
<body topmargin=0 leftmargin="0">
	<html:form action="/reviewActiveCasesForAssignSuperviseeToProgramUnit" target="content">
		<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assign_Supervisee/Assign_Supervisee.htm#|3">
		<div align="center">
									...
									<table width="100%">
										<tr>
											<td align="center" class="header" >
												<bean:message key="title.CSCD"/>&nbsp;-&nbsp;Assign Supervisee To Program Unit - Review Active Cases
											</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
