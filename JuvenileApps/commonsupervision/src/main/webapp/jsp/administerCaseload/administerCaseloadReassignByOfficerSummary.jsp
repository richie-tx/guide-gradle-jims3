...
<head>
	...
	<html:base />
	<title>CommonSupervision/administerCaseload/administerCaseloadReassignByOfficerSummary.jsp</title>
	<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
	<script type="text/javascript" src="/<msp:webapp/>js/app.js"></script>
</head>
<body topmargin=0 leftmargin="0">
	<html:form action="/reassignSuperviseeByOfficerSummaryAction" target="content">
		<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assign_Supervisee/Assign_Supervisee.htm#|33">
		<div align="center">
						...
						<table width=100%>
							<tr>
								<td align="center" class="header"><bean:message key="title.CSCD"/>&nbsp;-&nbsp;
									Reassignment Request - Task Summary</td>
							</tr>
						</table>
						<!-- END HEADING TABLE -->
						<!-- BEGIN ERROR TABLE -->
								...
								<td>
									<table width="100%" border="0" cellpadding="4" cellspacing="1">
										<tr>
											...
											<td class=formDe>
												<bean:write name="caseAssignmentForm" property="supervisorName.formattedName"/>
												<%-- <bean:write name="caseAssignmentForm" property="supervisorPositionId"/> --%>												
											</td>
										</tr><tr>
