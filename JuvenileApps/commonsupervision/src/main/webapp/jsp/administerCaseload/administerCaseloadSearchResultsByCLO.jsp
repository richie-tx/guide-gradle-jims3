...
<head>
	...
	<html:base />
	<title>CommonSupervision/administerCaseload/administerCaseloadSearchResultsByCLO.jsp</title>
...
<body topmargin=0 leftmargin="0">
	<html:form action="/handleSuperviseeSearchByCLOAction" target="content">
									...
									<table width=100%>
										<tr>
											<td align="center" class="header"><bean:message key="title.CSCD"/>&nbsp;-&nbsp;
												<bean:message key="prompt.caseload"/>&nbsp;<bean:message key="prompt.searchResults"/> - CLO</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
									<!-- BEGIN ERROR TABLE -->
