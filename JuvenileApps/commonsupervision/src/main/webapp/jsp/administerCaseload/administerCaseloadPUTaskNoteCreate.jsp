...
<!-- 05/26/2010 C Shimek   - #65373 revised to use tinyMCECustomInitCasenote.js -->
...
<html:base />
<title>CommonSupervision/administerCaseload/administerCaseloadPUTaskNoteCreate.jsp</title>
...
<html:form action="/reassignToPUWorkgroupCasenoteAction" target="content">
	<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assign_Supervisee/Assign_Supervisee.htm#|16">
								...
								<table width="100%">
									<tr>
										<td align="center" class="header"><bean:message key="title.CSCD"/>&nbsp;-&nbsp;	
											Reassign Supervisee to Program Unit - Casenote
										</td>
									</tr>
								</table>
								<!-- END HEADING TABLE --> 
