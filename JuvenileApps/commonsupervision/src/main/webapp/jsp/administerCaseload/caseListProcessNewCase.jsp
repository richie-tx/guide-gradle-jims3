...
<head>
	...
	<html:base />
	<title>CommonSupervision/assignSupervisee/caseList.jsp</title>
...
<body topmargin=0 leftmargin="0">
	<html:form action="/handleCaseAssignmentForAssignSupervisee" target="content">
									...
									<table width=100%>
										<tr>
											<td align="center" class="header"><bean:message key="title.CSCD"/>&nbsp;-&nbsp;
												Reassign Supervisee - Review Active Cases</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
