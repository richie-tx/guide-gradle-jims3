...
<head>
	...
	<html:base />
	<title>CommonSupervision/administerCaseload/administerCaseloadReassignByCLO.jsp</title>
	<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
	<script type="text/javascript" src="/<msp:webapp/>js/app.js"></script>
</head>
<body topmargin=0 leftmargin="0">
	<html:form action="/reassignSuperviseeByCLOAction" target="content">
			 <input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Caseload/CSCD_Caseload.htm#|10">
		<div align="center">
								...
								<td>
									<table width="100%" border="0" cellpadding="2" cellspacing="1">
										<tr>
											...
											<td class=formDe>
												<html:select property="workGroupId">
													<html:optionsCollection name="caseAssignmentForm" property="courtServicesWorkGroups" value="workgroupId" label="workgroupName"/>
												</html:select>																										
											</td>
										</tr><tr>
										...
										<%--<tr>
											...
											<td class=formDe>												
												<html:text readonly="true" size="40" property="requestReassignmentTaskNextAction" value="Reassign Supervisee cases to program unit"></html:text>
											</td>
										</tr>--%>
										<tr>
