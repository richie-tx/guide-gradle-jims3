...
<head>
	...
	<html:base />
	<title>CommonSupervision/administerCaseload/administerCaseloadAssignOfficerSummary.jsp</title>
	<script type="text/javascript" src="/<msp:webapp/>js/app.js"></script>
	<script type="text/javascript" src="/<msp:webapp/>js/common_supervision_util.js"></script>
</head>

<body topmargin="0" leftmargin="0">
	<html:form action="/reassignSuperviseeToOfficerSummaryAction" target="content">
								...
								<td valign="top" align="center">
									...
									<table width="100%">
										<tr>
											<td align="center" class="header" ><bean:message key="title.CSCD"/>&nbsp;-&nbsp;
												Reassign Supervisee to Officer <bean:message key="title.summary"/>
											</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
									...
									<table width="98%" border="0">
										<tr>
											<td>
												<ul>
													<li>Review Officer selection, click Finish.</li>
												</ul>
											</td>
										</tr>
									</table>
											...
											<td>
												<table width="100%" cellpadding="4" cellspacing="1">
													...
													<tr>
														...
														<bean:write name="caseAssignmentForm" property="casenoteText" filter="false"/></td>
													</tr>
												</table>
											</td>
										</tr>
