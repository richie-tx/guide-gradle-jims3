...
<head>
	...
	<html:base />
	<title>CommonSupervision/administerCaseload/administerCaseloadSearchByCLO.jsp</title>
...
<body topmargin="0" leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true)" onload="renderSearch(); checkForSingleResult();">
	<html:form action="/superviseeSearchSetupByCLOAction" target="content">
		<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assign_Supervisee/Assign_Supervisee.htm#|1">
		<div align="center">
							...
							<tr>
								<td valign="top" align="center">
									...
									<table width="100%">
										<tr>
											<td align="center" class="header"><bean:message key="title.CSCD"/>&nbsp;-&nbsp;
												<bean:message key="prompt.caseload"/> Search - CLO</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
									<!-- BEGIN ERROR TABLE -->
												...
												<td>
													<table width="100%" cellpadding="2" cellspacing="1">
														<tr>
															...
															<td class="formDe">
																<html:text name="caseAssignmentForm" property="defendantId" styleId="selectedDefendantId" maxlength="8"/>
															</td>
														</tr>
													</table>
												</td>
													...
													<logic:notEmpty name="caseAssignmentForm" property="officerCaseload.divisions">
														<tr id="divisionRow">
															...
															<td class="formDe" colspan="3">
																<html:select name="caseAssignmentForm" property="officerCaseload.selectedDivisionId" onchange="getSupervisorsForDivision(this.form);">
																	<html:option value=""><bean:message key="select.generic" /></html:option>
																	<html:optionsCollection name="caseAssignmentForm" property="officerCaseload.divisions" label="description" value="OID"/>														
																</html:select>
															</td>
														</tr>
													</logic:notEmpty>
													<logic:notEmpty name="caseAssignmentForm" property="officerCaseload.selectedDivisionId">
														<tr id="supervisorRow">
															<td class="formDeLabel" width="1%">Supervisor</td>
															<td class="formDe">
																<html:select name="caseAssignmentForm" property="officerCaseload.selectedSupervisorId">
																	<html:option value=""><bean:message key="select.generic" /></html:option>
															...
															<td class="formDe">
																<html:text name="caseAssignmentForm" property="officerCaseload.courtIdFilter"></html:text>
															</td>
														</tr>
												...
												<td>
													<table width="100%" border="0" cellpadding="2" cellspacing="1">
														<tr class="formDeLabel">
															...
															<td width="1%"></td>
															<td>SuperviseeName
																<jims2:sortResults beanName="caseAssignmentForm" results="officerCaseload.defendantsSupervised" primaryPropSort="defendantName.formattedName" primarySortType="STRING" defaultSort="true" defaultSortOrder="ASC" sortId="1" />																
															</td>
															<td>SPN
														...
														<logic:notEmpty name="caseAssignmentForm" property="officerCaseload.defendantsSupervised">
															<logic:iterate id="supervisee" name="caseAssignmentForm" property="officerCaseload.defendantsSupervised">
																<tr>
																	<td width="1%">
																		<html:radio idName="supervisee" value="defendantId" property="officerCaseload.selectedDefendantId" onclick="selectSupervisee(this);"/>
																	</td>
																	<td width="1%">
																	...
																	<td>
																		<a href="/<msp:webapp/>displaySuperviseeInfo.do?submitAction=Link&superviseeId=<bean:write name="supervisee" property="defendantId"/>">
																			<msp:formatter name="supervisee" property="defendantName" format="L,F"/>
																		</a>
																	</td>
																	...
																	<logic:lessEqual name="supervisee" property="daysLeft" value="90">
																		...
																		<logic:lessThan name="supervisee" property="daysLeft" value="0">
																			<td class="changedRed"><bean:write name="supervisee" property="daysLeft"/></td>
																		</logic:lessThan>
																	</logic:lessEqual>														
																		...
																		<span id="img<bean:write name="supervisee" property="defendantId" />Span" class="hidden">
																			<table width="100%" cellpadding="2" cellspacing="1">
																				...
																				<% int RecordCounter=0;
																				   String bgcolor="";
																				%>																	
																				<logic:iterate id="activeCase" name="supervisee" property="caseAssignments">
									...
									<table border="0" width="100%">
										<tr>
											<td align="center">
												<html:submit property="submitAction" onclick="caseloadSearchSubmit(this.form);" disabled="true" styleId="caseloadSubmitBtnId">
