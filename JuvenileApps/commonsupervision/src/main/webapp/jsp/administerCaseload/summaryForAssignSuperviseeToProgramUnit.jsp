...
<!-- 02/24/2012	Ryoung - Defect #72613 Change button to send back to task search results  -->
...
<head>
	...
	<html:base />
	<title>CommonSupervision/administerCaseload/summaryForAssignSuperviseeToProgramUnit.jsp</title>
...
<body topmargin=0 leftmargin="0" onKeyDown="return checkEnterKeyAndSubmit(event,true)">
	<html:form action="/summaryforprogramunitassignment" target="content">
	<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Caseload/Assign_Supervisee/Assign_Supervisee.htm#|12">	
		<div align="center">
						...
						<table width=100% border="0" cellpadding="0" cellspacing="0" class="borderTableBlue">
							...
							<tr>		
								<td valign=top align=center>
									...
									<bean:message key="prompt.caseload"/> - 
													Assign Supervisee to Program Unit Summary
											</td>
										</tr>
									</table>
									<!-- END HEADING TABLE -->
											...
											<td>
												<table width="100%" cellpadding="4" cellspacing="1">
													<tr>
														...
														<%--	<script>
																var elem1=document.getElementById('casenoteDate');
