...
$(function() {
	...
	if(typeof $("#fromBeginDate")!= "undefined"){			
		datePickerSingle( $("#fromBeginDate"),"From Date", false);		 
	}
	if(typeof $("#toBeginDate")!= "undefined"){			
		datePickerSingle( $("#toBeginDate"),"To Date", false);		 
	}
	
	if(typeof $("#fromCloseDate")!= "undefined"){			
		datePickerSingle( $("#fromCloseDate"),"From Closed Date", false);		 
	}
	if(typeof $("#toCloseDate")!= "undefined"){			
		datePickerSingle( $("#toCloseDate"),"To Closed Date", false);		 
	}
...
function validateForm(tForm)
{
	...
	var forwardURL = "/<msp:webapp/>displayProgramReferralList.do?submitAction=Submit" ;
...
function populateProgramNameList(){
	...
	spinner();
   	...
   	var status = document.forms[0].referralStatusDescription.value;
   	console.log(status);
   
	var forwardURL = "/<msp:webapp/>displaySPProgramReferralSearch.do?submitAction=Program List&status=" + status ;
	document.forms[0].action = forwardURL;
	document.forms[0].submit();
}
...
<input type="hidden" name="helpFile" value="commonsupervision/asp_Program_Referral/Service_Provider_Program_Referral.htm#|193">
            ...
            -->
                ...
                <tr>
                    ...
                    <td class="formDe" colspan="3">
                        <html:select name="programReferralSearchForm"  property="referralStatusDescription" styleId="referralStatusDescription" onchange="populateProgramNameList()">
                ...
                <tr>
                    ...
                    <td class="formDe" width="1%" nowrap="nowrap">
						<html:text name="programReferralSearchForm" property="fromBeginDate" styleId="fromBeginDate" size="10" maxlength="10"  />
						
                    </td>   
                     
                    <td class="formDeLabel" width="1%"><bean:message key="prompt.to" /></td>
                    <td class="formDe">
                        <html:text name="programReferralSearchForm" property="toBeginDate" styleId="toBeginDate" size="10" maxlength="10" />
                 ...
                 <tr><td><img src="/<msp:webapp/>images/spacer.gif" height="5"></td></tr>
                <tr>
                    <td class="detailHead" colspan="4"><bean:message key="prompt.programReferral" />&nbsp;<bean:message key="prompt.endDate" /></td>   
                </tr>
                <tr>
                    <td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="prompt.from" /></td>
                    <td class="formDe" width="1%" nowrap="nowrap">
						<html:text name="programReferralSearchForm" property="fromCloseDate" styleId="fromCloseDate" size="10" maxlength="10"  />
						
                    </td>   
                     
                    <td class="formDeLabel" width="1%"><bean:message key="prompt.to" /></td>
                    <td class="formDe">
                        <html:text name="programReferralSearchForm" property="toCloseDate" styleId="toCloseDate" size="10" maxlength="10" />
