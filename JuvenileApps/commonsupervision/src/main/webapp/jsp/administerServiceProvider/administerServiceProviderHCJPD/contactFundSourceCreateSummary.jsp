...
<title><bean:message key="title.heading"/> - contactFundSourceCreateSummary.jsp</title>
		            		 ...
		            		 <table width='100%'>
			             		 <tr>
				    			      <td class="header" align="center">
				    			      		Create Contact Funding - Summary
				    			      </td>
			    			      </tr>
			    			</table>
            					...
            					<tr>
            						<td>
            							...
            							<table width="100%" border=0 cellpadding="4" cellspacing="1">
                    						...
                    						<tr>
                    							<td class=formDeLabel nowrap width='1%'>Source Fund</td>
                     							<td class=formDe colspan=3 >
                     								<bean:write name="serviceProviderForm" property="fundSource" />	
                     							</td>
                    						</tr>
                    						<tr>
                    							<td class=formDeLabel nowrap width='1%'>Fund Start Date</td>
                     							<td class=formDe ><bean:write name="serviceProviderForm" property="fundStartDate" /></td>
                     							<td class=formDeLabel nowrap width='1%'>Fund End Date</td>
                     							<td class=formDe ><bean:write name="serviceProviderForm" property="fundEndDate" /></td>
                    						</tr>
                    						<tr>
                    							<td class=formDeLabel nowrap width='1%' colspan=4>Comments</td>
                    						</tr>
                    						<tr>
		  						...
		  						<tr>
		  							<td align="center">
		    							<html:submit property="submitAction"><bean:message key="button.back"></bean:message></html:submit>
		   								<html:submit property="submitAction" styleId="saveAndContinue"><bean:message key="button.saveAndContinue"></bean:message></html:submit>
			                              ...
			                              <tr class=formDeLabel>
				                              ...
				                              <logic:iterate name="serviceProviderForm" id="fundsIndex" property="contactFundSourceList">
				                              	 <tr class= <% RecordCounter++;
						                                ...
						                                <td><bean:write name="fundsIndex" property="sourceFund"/></td>
