...
<html:base />
<title><bean:message key="title.heading" /> - administerSuggestedOrder/previewOrder.jsp</title>
...
<table border="0" align="center" width="98%" cellspacing="1" cellpadding="6" class="borderTableBlue">
	<%int RecordCounter = 0;
	String bgcolor = "";%>
	<logic:iterate id="conditionSelectedListIndex" name="suggestedOrderForm" property="previewConditionSelectedList">  
	<tr
		class=<%RecordCounter++;
		...
		<td class="boldText" width="1%"><bean:write name="conditionSelectedListIndex" property="seqNum" /></td>
