...
<!-- 06/25/2008  L Deen		  	Defect #52571 Removed cancel button  -->
<!-- 05/22/2009  D Williamson   Defect #59770 Put Search By options in alphabetical order -->
...
{	
	clearAllValArrays();
		if(!validateRadios(theForm, "supervisionPeriod", "Supervision Period is required", "Contact System Admin- System Error")){
			return false;
		}
...
<html:form action="/displayAdministerCasenotesSearch" target="content" focus="spn">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Casenotes/CSCD_Casenotes.htm#|1">
<div align="center">
				...
				<tr>
							...
							<table width="100%">
								<tr>							
									<td align="center" class="header">
										<bean:message key="prompt.casenotes" />&nbsp;<bean:message key="title.search" />
									</td>						
								</tr>
							</table>
						<!-- END HEADING TABLE -->
								...
								<tr>
									...
									<td class="formDe">
										<html:select property="searchBy" onchange="renderSearch(this)">
										 ...
										 &nbsp;&nbsp;&nbsp;<!--<a href="/<msp:webapp/>displayAdministerCasenotesSearch.do?submitAction=<bean:message key="button.advancedSuperviseeSearch"/>"><bean:message key="button.advancedSuperviseeSearch"/></a>--></td>
				   ...
				   <!-- start search by spn -->
			                ...
			                <table align="center" width="98%" border="0" cellpadding="2" cellspacing="1" class="borderTableBlue">
			                 <tr id="spSearchSPNHeader" >
			                  ...
			                  <tr id="spSearchNameLast">
			                    <td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="prompt.2.diamond"/><bean:message key="prompt.lastName" /></td>
			                    <td class="formDe">
			                      <html:text property="superviseeName.lastName" maxlength="75" size="30"/></td>
			                  </tr>
			                  <tr id="spSearchNameFirst">
			                    <td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="prompt.firstName" /></td>
			                    <td class="formDe">
						    ...
						    <tr id="caseSearchCDI">
			                 ...
			                 <tr>			                 
		                    <td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="prompt.2.diamond"/>Supervision Period</td>
		                    <td class="formDe">
		                    	<html:radio property="supervisionPeriod" value="A"/>Active
			                    	<html:radio property="supervisionPeriod" value="P"/>Previous
		                    </td>
		                  </tr>
