...
<html:base />
<title><bean:message key="title.heading" /> - administerCasenotes/advancedSuperviseeSearch.jsp</title>
...
<html:form action="/displayAdministerCasenotesSearch" target="content" focus="superviseeName.lastName">
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Casenotes/CSCD_Casenotes.htm#|3">
<div align="center">
					...
					<td valign="top" align="center">
							...
							<table width="100%">
								<tr>
									<td align="center" class="header">
										<bean:message key="prompt.casenotes" />&nbsp;<bean:message key="prompt.advancedSearch" /></td>
								</tr>
							</table>
						<!-- END HEADING TABLE -->
						<!-- BEGIN ERROR TABLE -->
						...
						<!-- BEGIN SEARCH TABLE -->
							<table align="center" width="98%" border="0" cellpadding="2" cellspacing="1">
								...
								<tr>
									<td class="detailHead" colspan="4"><bean:message key="prompt.search" />&nbsp;<bean:message key="prompt.supervisee" />&nbsp;&nbsp;<a href="/<msp:webapp/>displayAdministerCasenotesSearch.do?submitAction=Basic Search"><bean:message key="button.basicSearch"/></a></td>
								</tr>
								<tr>
			                    <td class="formDeLabel" width="1%" nowrap><bean:message key="prompt.2.diamond"/>Supervision Period</td>
			                    <td class="formDe">
