...
<input type="hidden" name="helpFile" value="commonsupervision/CSCD_Positions/CSCD_Staff_Position.htm#|22">
										...
										<table width="100%">
											<tr>
												<td align="center" class="header"><bean:message key="title.CSCD" /> - 
													<bean:message key="button.vacatePosition" /> <bean:message key="title.summary" />	
												</td>
											</tr>
										</table>
<!-- END HEADING TABLE -->
...
<!-- BEGIN INSTRUCTION TABLE -->
										<table width="98%" border="0">
											<tr>
												<td>
													<ul>
														<li>Review entries. Click Finish to vacate position.</li>
													</ul>
												</td>
											</tr>
										</table>
										...
										<table width="98%" cellpadding="4" cellspacing="1" class="borderTableBlue">
											<tr>
												<td>
													...
													will no longer be assigned a position.
												</td>
											</tr>
										</table>
<!-- END POSITION INFO TABLE -->
										<br>										
