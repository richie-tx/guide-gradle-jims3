...
<logic:equal name="adminStaffForm" property="action" value="create">
    <input type="hidden" name="helpFile" value="commonsupervision/CSCD_Positions/CSCD_Staff_Position.htm#|4"> 
</logic:equal>
<logic:equal name="adminStaffForm" property="action" value="update">
    <input type="hidden" name="helpFile" value="commonsupervision/CSCD_Positions/CSCD_Staff_Position.htm#|20">
</logic:equal>
							...
							<table width="100%">
								<tr>
									<td align="center" class="header"><bean:message
										...
										<bean:message key="prompt.position" /> <bean:message key="prompt.summary" />	
									</td>
								</tr>
							</table>
															...
															<table width="98%" border="0">
																<tr>
																	<td>
																		<ul>
																			<logic:equal name="adminStaffForm" property="action" value="create">
																			<li>Click Finish to create position .</li>
																			</logic:equal>
																			<logic:equal name="adminStaffForm" property="action" value="update">
																			<li>Click Finish to update position .</li>
																			</logic:equal>
