...
<bean:define id="courtPolicyTitle" type="java.lang.String" value="title.consequence"/>
						...
						<tr>
							<td valign=top align=center><!-- BEGIN HEADING TABLE -->
								<table width=100%>
										...
										<td align="center" class="header">
											...
											<logic:equal name="supervisionConditionForm" property="pageType" value="summary">
												...
												<logic:equal name="supervisionConditionForm" property="action" value="asscCourtPolicy">
													<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|46">
												...
												<logic:equal name="supervisionConditionForm" property="action" value="create">
													<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|12">
													<bean:message key="prompt.create" />
													<bean:message key="title.supervisionCondition" />&nbsp;<bean:message key="title.summary" />													
												</logic:equal>
												
												<logic:equal name="supervisionConditionForm" property="action" value="copy">
													<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|21">
												...
												<logic:equal name="supervisionConditionForm" property="action" value="update">
													...
													<logic:equal name="supervisionConditionForm" property="inUse" value="true">
														<logic:notEqual name="supervisionConditionForm" property="specialCondition" value="true">
															<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|86">
															<bean:message key="prompt.update" />
													...
													<logic:equal name="supervisionConditionForm" property="specialCondition" value="true">
														<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|28">
														<bean:message key="prompt.update" />
												...
												<logic:equal name="supervisionConditionForm" property="action" value="delete">
													<logic:notEqual name="supervisionConditionForm" property="inUse" value="true">
														<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|23">
														<bean:message key="prompt.delete" />
														<bean:message key="title.supervisionCondition" />&nbsp;<bean:message key="title.summary" />														
													</logic:notEqual>
													
													<logic:equal name="supervisionConditionForm" property="inUse" value="true">
												  		<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|90">
											...
											<logic:equal name="supervisionConditionForm" property="pageType" value="confirm">
												...
												<logic:equal name="supervisionConditionForm" property="action" value="asscCourtPolicy">
													<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|47">
													<bean:message key="prompt.associate" />
												...
												<logic:equal name="supervisionConditionForm" property="action" value="create">
													<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|13">
													<bean:message key="prompt.create" />
													<bean:message key="title.supervisionCondition" />&nbsp;<bean:message key="title.confirmation" />
												</logic:equal>
												
												<logic:equal name="supervisionConditionForm" property="action" value="copy">
													<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|22">
													<bean:message key="prompt.copy" />
													<bean:message key="title.supervisionCondition" />&nbsp;<bean:message key="title.confirmation" />													
												</logic:equal>
												...
												<logic:equal name="supervisionConditionForm" property="action" value="update">
													<logic:notEqual name="supervisionConditionForm" property="inUse" value="true">
														<logic:notEqual name="supervisionConditionForm" property="specialCondition" value="true">
															<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|17">
															<bean:message key="prompt.update" />
															<bean:message key="title.supervisionCondition" />&nbsp;<bean:message key="title.confirmation" />
														</logic:notEqual>
													</logic:notEqual>
													...
													<logic:equal name="supervisionConditionForm" property="inUse" value="true">
														<logic:notEqual name="supervisionConditionForm" property="specialCondition" value="true">
															<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|87">
															<bean:message key="prompt.update" />
															<bean:message key="prompt.inUse" />
															<bean:message key="title.supervisionCondition" />&nbsp;<bean:message key="title.confirmation" />
														</logic:notEqual>
													...
													<logic:equal name="supervisionConditionForm" property="specialCondition" value="true">
														<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|30">
														<bean:message key="prompt.update" />
														<bean:message key="prompt.special" />
														<bean:message key="title.supervisionCondition" />&nbsp;<bean:message key="title.confirmation" />
													</logic:equal>
												...
												<logic:equal name="supervisionConditionForm" property="action" value="delete">
													<logic:notEqual name="supervisionConditionForm" property="inUse" value="true">
														<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|24">
														<bean:message key="prompt.delete" />
														<bean:message key="title.supervisionCondition" />&nbsp;<bean:message key="title.confirmation" />
													</logic:notEqual>
													
													<logic:equal name="supervisionConditionForm" property="inUse" value="true">
												  		<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|91">
												  		<bean:message key="prompt.inactivate" />
														<bean:message key="title.supervisionCondition" />&nbsp;<bean:message key="title.confirmation" />
													</logic:equal>
												</logic:equal>
									...
									<logic:present name="<%=ActionErrors.GLOBAL_MESSAGE%>">
										<tr>
									...
									<logic:equal name="supervisionConditionForm"
										...
										<logic:notPresent name="<%=ActionErrors.GLOBAL_MESSAGE%>">
											<tr>
							...
							<!-- END HEADING TABLE --> <logic:equal
								...
								property="specialCondition" value="true">
											...
											<!--task info start--> 
											<%-- not needed for agency JUV but don't delete in case they want it back 
											<tiles:insert
							...
							<logic:notEqual name="supervisionConditionForm"
								property="specialCondition" value="true">
								 <bean:size id="totalSize" name="supervisionConditionForm" property="exceptionCourtVarElemBeans"/>
						 
						  <logic:greaterThan name="totalSize" value="0">
								<table width="98%" border="0" cellspacing=1 cellpadding=4>
									<TBODY>
										<tr>
											<td colspan=2 class=detailHead>
