...
function validateDept(theForm){
	...
	<logic:equal name="departmentPolicyForm" property="action" value="copy">
		return validateDeptPolicyCopyJUV(theForm);
	</logic:equal>
	<logic:equal name="departmentPolicyForm" property="action" value="update">
		return validateDeptPolicyUpdateJUV(theForm);
	</logic:equal>
	<logic:equal name="departmentPolicyForm" property="action" value="create">
		return validateDeptPolicyCreateJUV(theForm);
	</logic:equal>
}
...
<html:form action="/displayDepartmentPolicyName" target="content" onsubmit="return (myTinyMCEFix() && validateSelectedCourts(this))" focus="group1Id">
<div align="center">
						...
						<table width="100%">
							<tr>
								<td align="center" class="header">
									<logic:equal name="departmentPolicyForm" property="action" value="copy">
										<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|74">
										<bean:message key="prompt.copy" />
										<bean:message key="<%=deptPolicyTitle%>"/>
									</logic:equal>
									
									<logic:equal name="departmentPolicyForm" property="action" value="create">
										<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|64">
									...
									<logic:equal name="departmentPolicyForm" property="action" value="update">
										<logic:notEqual name="departmentPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|71">
											<bean:message key="prompt.update" />
											<bean:message key="<%=deptPolicyTitle%>"/>										</logic:notEqual>
										<logic:equal name="departmentPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|97">
											<bean:message key="prompt.update" />
							...
							<tr>
								<td>
									...
									<logic:equal name="departmentPolicyForm" property="action" value="<%=UIConstants.UPDATE%>"> 
										...
										<tr>
											<td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="prompt.4.diamond"/><bean:message key="<%=departmentGroup1Caption%>"/></td>
											<td class="formDe">
												...
												<logic:notEqual name="departmentPolicyForm" property="action" value="create">
													<html:select property="group1Id" size="1" onchange="updateGroup2(this.form);checkCategoryChange(this, 1, departmentPolicyForm);">
														<html:option value=""><bean:message key="select.generic" /></html:option>
														<html:optionsCollection property="groups" value="groupId" label="name" /> 
													</html:select>
												</logic:notEqual>
										...
										<tr>
											<td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="<%=departmentGroup2Caption%>"/></td>
											<td class="formDe">
													...
													<logic:notEqual name="departmentPolicyForm" property="action" value="create">
														...
														<logic:notEmpty name="departmentPolicyForm" property="group2">
															<html:select property="group2Id" size="1" onchange="updateGroup3(this.form);checkCategoryChange(this, 2, departmentPolicyForm);">
																<html:option value=""><bean:message key="select.generic" /></html:option>
										...
										<tr>
											<td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="<%=departmentGroup3Caption%>"/></td>
											<td class="formDe">
												<logic:equal name="departmentPolicyForm" property="action" value="create">
										...
										<tr>
											<td class="formDeLabel" width="1%" nowrap="nowrap" valign="top"><bean:message key="prompt.4.diamond"/><bean:message key="<%=departmentPolicyLiteralCaption%>" /></td>
											<td class="formDe">
											<logic:notEqual name="departmentPolicyForm" property="inUse" value="true">	
												<html:textarea styleClass="mceEditor" name="departmentPolicyForm" property="departmentPolicy" style="width:100%" rows="5" ondblclick="myReverseTinyMCEFix(this)"/>
												<script>
											...
											<html:hidden name="departmentPolicyForm" property="departmentPolicy"/>
																<bean:write name="departmentPolicyForm" property="departmentPolicy" filter="false"/>
															</logic:equal>
											</td>
										</tr>
										...
										<tr>
											<td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="prompt.4.diamond"/><bean:message key="prompt.effectiveDate" /></td>
											<td class="formDe">
										...
										<logic:equal name="departmentPolicyForm" property="action" value="update">
											<tr>
												<td class="formDeLabel" width="1%" nowrap="nowrap"><bean:message key="prompt.inactiveDate" /></td>
												<td class="formDe">
										...
										<tr>
											<td class="formDeLabel" valign="top" width="1%" nowrap="nowrap"><bean:message key="prompt.notes" /></td>
											<td class="formDe"><html:textarea name="departmentPolicyForm" property="notes" style="width:100%" rows="3" onkeydown="alertTextAreaToLarge(this,255,'Notes')"/></td>
										</tr>
										<tr>
							...
							<tr>
								...
								<logic:notEqual name="departmentPolicyForm" property="action" value="<%=UIConstants.CREATE%>"> 
									...
									<input type="reset" onclick="return customCourtReset(this.form)"/>
										<input type="button" value='<bean:message key="button.cancel" />' <%-- && return disableSubmit(this, this.form) --%>
