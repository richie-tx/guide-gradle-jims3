								...
								<td align="center" class="header">
									...
									<logic:equal name="departmentPolicyForm" property="pageType" value="summary">
										<logic:equal name="departmentPolicyForm" property="action" value="asscConditions">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|69">
										...
										<logic:equal name="departmentPolicyForm" property="action" value="copy">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|76">
											<bean:message key="prompt.copy" />
											<bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="title.summary" />
										</logic:equal>
										
										<logic:equal name="departmentPolicyForm" property="action" value="create">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|66">
										...
										<logic:equal name="departmentPolicyForm" property="action" value="update">
											<logic:notEqual name="departmentPolicyForm" property="inUse" value="true">
												<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|72">
												<bean:message key="prompt.update" />
												<bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="title.summary" />
											</logic:notEqual>
											<logic:equal name="departmentPolicyForm" property="inUse" value="true">
												<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|99">
												<bean:message key="prompt.update" />
										...
										<logic:equal name="departmentPolicyForm" property="action" value="delete">
											<logic:notEqual name="departmentPolicyForm" property="inUse" value="true">
												<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|78">
												<bean:message key="prompt.delete" />
												<bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="title.summary" />
											</logic:notEqual>
											<logic:equal name="departmentPolicyForm" property="inUse" value="true">
												<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|101">
									...
									<logic:equal name="departmentPolicyForm" property="pageType" value="confirm">
										<logic:equal name="departmentPolicyForm" property="action" value="asscConditions">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|70">
											<bean:message key="prompt.associate" />
											<bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />
										</logic:equal>
										
										<logic:equal name="departmentPolicyForm" property="action" value="copy">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|77">
											<bean:message key="prompt.copy" />
											<bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />
										</logic:equal>
										
										<logic:equal name="departmentPolicyForm" property="action" value="create">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|67">
											<bean:message key="prompt.create" />
											<bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />
										</logic:equal>
										...
										<logic:equal name="departmentPolicyForm" property="action" value="update">
											<logic:notEqual name="departmentPolicyForm" property="inUse" value="true">
												<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|73">
												<bean:message key="prompt.update" />
												<bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />
											</logic:notEqual>
											<logic:equal name="departmentPolicyForm" property="inUse" value="true">
												<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|100">
												<bean:message key="prompt.update" />
												<bean:message key="prompt.inUse" />
												<bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />
											</logic:equal>
										...
										<logic:equal name="departmentPolicyForm" property="action" value="delete">
											<logic:notEqual name="departmentPolicyForm" property="inUse" value="true">
												<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|79">
												<bean:message key="prompt.delete" />
												<bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />
											</logic:notEqual>
											<logic:equal name="departmentPolicyForm" property="inUse" value="true">
												<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|102">
												<bean:message key="prompt.inactivate" />
												<bean:message key="<%=deptPolicyTitle%>"/>&nbsp;<bean:message key="title.confirmation" />
											</logic:equal>
										</logic:equal>
