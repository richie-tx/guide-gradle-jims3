...
<logic:equal name="courtPolicyForm" property="action" value="update">
	<html:javascript formName="courtPolicyUpdateJUV" />
</logic:equal>
<logic:notEqual name="courtPolicyForm" property="action" value="update">
 	<html:javascript formName="courtPolicyCreateJUV" />
</logic:notEqual>
...
function checkTarget(theForm)
{
	...
	<logic:equal name="courtPolicyForm" property="action" value="update">
		return validateCourtPolicyUpdateJUV(theForm);
	</logic:equal>
	<logic:notEqual name="courtPolicyForm" property="action" value="update">
	 	return validateCourtPolicyCreateJUV(theForm);
	</logic:notEqual>
}
...
<html:form action="/displayCourtPolicyCreateTasks" target="content" onsubmit="myTinyMCEFix()" focus="group1Id">
<div align="center">
							...
							<tr>
								<td align="center" class="header">
									<logic:equal name="courtPolicyForm" property="action" value="copy">
										<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|52">
									...
									<logic:equal name="courtPolicyForm" property="action" value="update">
										<logic:notEqual name="courtPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|38">
											<bean:message key="prompt.update" />
											<bean:message key="<%=courtPolicyTitle%>"/>									
										</logic:notEqual>
										<logic:equal name="courtPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|39">
											<bean:message key="prompt.update" />
											...
											<td>
													...
													<tr>
														...
														<td colspan=3 class="formDe">
															...
															<logic:notEqual name="courtPolicyForm" property="action" value="create">
																<html:select property="group1Id" size="1" onchange="updateGroup2(this.form);checkCategoryChange(this, 1, courtPolicyForm);">
																	<html:option value=""><bean:message key="select.generic" /></html:option>
																	<html:optionsCollection property="groups" value="groupId" label="name" /> 
																</html:select>
															</logic:notEqual>
														...
														<td colspan=3 class="formDe">
															...
															<%--<logic:notEqual name="courtPolicyForm" property="action" value="create">--%>
																...
																<logic:notEmpty name="courtPolicyForm" property="group2">
																	<html:select property="group2Id" size="1" onchange="updateGroup3(this.form);checkCategoryChange(this, 2, courtPolicyForm);">
																		<html:option value=""><bean:message key="select.generic" /></html:option>
												...
												<tr>
													...
													<tr>
														...
														<td class="formDe" colspan=3>
															<html:textarea name="courtPolicyForm" property="notes" rows="3" style="width:100%" onkeydown="alertTextAreaToLarge(this,255,'Notes')"/>
														</td>
													</tr>
												</table>
											</td>
