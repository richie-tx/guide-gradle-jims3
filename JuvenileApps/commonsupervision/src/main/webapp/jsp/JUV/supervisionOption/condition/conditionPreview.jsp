...
<table width="98%" border="0" cellpadding="4" cellspacing="1" >
  <tr>
  	 <td valign=top class=formDeLabel><bean:message key="prompt.literal"/></td>
 	</tr>
  <tr>  
    <td valign=top class=formDe>
		<bean:write name="supervisionConditionForm" property="conditionLiteral"  filter="false"/>
	</td>
  </tr>
</table>
...
<table width="98%" border="0" cellpadding="4" cellspacing="1" >
  <tr>
  	 <td valign=top class=formDeLabel><bean:message key="prompt.example"/>&nbsp;<bean:message key="prompt.condition"/></td>
 	</tr>
  <tr>    
    <td valign=top class=formDe><bean:write name="supervisionConditionForm" property="conditionLiteralPreview"  filter="false"/> </td>
  </tr>
</table>
