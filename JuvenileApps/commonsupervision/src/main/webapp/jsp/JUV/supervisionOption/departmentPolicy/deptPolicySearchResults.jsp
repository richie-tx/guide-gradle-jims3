...
<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|62">
	<div align="center">
						...
						<table width="98%" border="0" cellpadding="2" cellspacing="1"
							...
							<tr class="detailHead">
								...
								<td><bean:message key="prompt.policyTableTitle" />&nbsp;<bean:message
									key="prompt.name" /></td>
								<td><bean:message key="<%=departmentGroup1Caption%>" /></td>
								<td><bean:message key="<%=departmentGroup2Caption%>" /></td>
								<td><bean:message key="<%=departmentGroup3Caption%>" /></td>
							</tr>
...
out.print(bgcolor);%>>
					...
					</logic:notEmpty> <!-- BEGIN BUTTON TABLE --> <br>
