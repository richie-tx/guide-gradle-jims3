...
<table width="100%" cellspacing=1 cellpadding=4>
	<tr>
		<td colspan=2 class=detailHead>
			<table width=100% cellpadding=0 cellspacing=0>
				<tr>
					<td width=1%><a href="javascript:showHideMulti('supervisionCondition', 'sc', 14, '/<msp:webapp/>')" border=0><img border=0 src="/<msp:webapp/>images/expand.gif" name="supervisionCondition"></a></td>
	...
	<tr id="sc16" class="hidden" width=1% nowrap><td class=formDeLabel><bean:message key="<%=conditionGroup3Caption%>"/></td>
