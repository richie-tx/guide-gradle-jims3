							...
							<tr>
								<td align="center" class="header">
									<logic:equal name="departmentPolicyForm" property="action" value="copy">
										<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|75">
										<bean:message key="prompt.copy" />
									</logic:equal>
									
									<logic:equal name="departmentPolicyForm" property="action" value="create">
										<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|65">
									...
									<logic:equal name="departmentPolicyForm" property="action" value="update">
										...
										<logic:notEqual name="departmentPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|96">
										</logic:notEqual>
										<logic:equal name="departmentPolicyForm" property="inUse" value="true">
											<input type="hidden" name="helpFile" value="commonsupervision/mso_juvenile/mso_juvenile.htm#|98">
						  ...
						  <tr>
							 <td align="center">
								...
								<input type=button value='<bean:message key="button.cancel" />' 
									<logic:equal name="departmentPolicyForm" property="action" value="<%=UIConstants.CREATE%>"> 
										onclick="return changeFormActionURL(this.form.name, '/<msp:webapp/>displayDepartmentPolicyCreate.do', false) && disableSubmit(this, this.form)"
									</logic:equal>
									<logic:notEqual name="departmentPolicyForm" property="action" value="<%=UIConstants.CREATE%>"> 
