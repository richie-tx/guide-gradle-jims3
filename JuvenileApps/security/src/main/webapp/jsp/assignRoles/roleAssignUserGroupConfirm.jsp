...
<html:base />
<title><bean:message key="title.heading"/> - roleAssignUserGroupConfirm.jsp</title>
...
function nogo(){
  alert("Role detials display is a future feature.");
  return false;
}
</script>
</head>
...
<input type="hidden" name="helpFile" value="jims2security/jims2_security.htm#|18">	
<!-- BEGIN HEADING TABLE -->
<table width="100%">
	<tr>
		<td align="center" class="header" valign="top"><bean:message key="title.assignUserGroupRoles" />&nbsp;<bean:message key="title.confirmation"/></td>
	</tr>
</table>
<!-- END HEADING TABLE -->
<br>
