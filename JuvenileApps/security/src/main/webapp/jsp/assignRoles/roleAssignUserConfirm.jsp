...
<html:base />
<title><bean:message key="title.heading"/> - roleAssignUserConfirm.jsp</title>
...
<input type="hidden" name="helpFile" value="jims2security/jims2_security.htm#|23">	
<!-- HEADING TABLE -->
<table width="100%">
	<tr>
		<td align="center" class="header" valign="top"><bean:message key="title.assignUserRoles" />&nbsp;<bean:message key="title.confirmation"/></td>
	</tr>
</table>
<!-- END HEADING TABLE -->
<!-- BEGIN ERROR TABLE -->
...
<table align="center" width="98%" border="0">
   <tr>
     <td class="confirm">
	  <bean:message key="title.rolesAssigned"/>
	</td>
  </tr>
</table>
					...
					<td colspan="2" align="center">
						...
						<thead>
							...
							<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">
								<td>
								<%-- <a href="../site2/roleConfirmSA.html?view"><bean:write name="currentRolesIndex" property="roleName"/></a> --%>
