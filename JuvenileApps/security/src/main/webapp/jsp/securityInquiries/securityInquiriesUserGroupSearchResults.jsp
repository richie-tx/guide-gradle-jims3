...
<html:base />
<title><bean:message key="title.heading" /> - securityInquiriesUserGroupSearchResults.jsp</title>
<script type='text/javascript' src="/<msp:webapp/>js/app.js"></script>
</head>

<body>
<html:form action="/displaySecurityInquiriesUserGroupDetails" target="content">
<input type="hidden" name="helpFile" value="jims2security/jims2_security.htm#|132">
<!-- BEGIN HEADING TABLE -->
<table width="100%">
	<tr>
		<td align="center" class="header"><bean:message key="title.inquiries"/> <bean:message key="prompt.userGroup"/> <bean:message key="title.searchResults"/></td>
	</tr>
</table>
<!-- END HEADING TABLE -->
<!-- BEGIN ERROR TABLE -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td align="center">
			...
			<bean:message key="prompt.searchResultsFoundFor"/> <bean:message key="prompt.userGroup"/>
		</td>
	</tr>
	<tr>
		...
		<td>
			<table cellpadding="2" cellspacing="1" width="100%">
				<tr class="detailHead" id="firstRow">
					<td><bean:message key="prompt.userGroupName"/>
					    <jims:sortResults beanName="securityInquiriesForm" results="userGroups" 
					...
					<td><bean:message key="prompt.description"/>
					    <jims:sortResults beanName="securityInquiriesForm" results="userGroups" 
                                 primaryPropSort="description" primarySortType="STRING" defaultSort="false" 
			 	...
			 	<logic:iterate id="userGroupIterator" name="securityInquiriesForm" property="userGroups" indexId="index" > 
				<pg:item>
				<tr class="<%out.print((index.intValue() % 2 == 1) ? "alternateRow" : "normalRow"); %>">	
                    ...
                    <td>
                       	<bean:write name="userGroupIterator" property="description"/>                       	
				 	</td>
                       <td>
                       	<bean:write name="userGroupIterator" property="agencyId"/>  
				 	</td>
				</tr>
				</pg:item>
				</logic:iterate> 
