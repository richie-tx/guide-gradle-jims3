...
<html:base />
<title><bean:message key="title.heading" /> - securityInquiriesAgencyDetails.jsp</title>
					...
					<tr bgcolor="#cccccc">
					    ...
					    <jims:then>
					        <td class="boldText2px" bgcolor="#cccccc" width="1%" nowrap valign="top">
								<a href="javascript:showHide('users<%out.print(ctr); %>', 'row','/<msp:webapp/>')" border='0'><img border='0' src="/<msp:webapp/>images/expand.gif" name="users<%out.print(ctr); %>"></a> 								
							</td>
						</jims:then>
						</jims:if>
