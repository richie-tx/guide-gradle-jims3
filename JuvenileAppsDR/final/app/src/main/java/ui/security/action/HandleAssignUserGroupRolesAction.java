//Source file: C:\\views\\archproduction\\app\\src\\ui\\security\\action\\HandleAssignUserGroupRolesAction.java
 ...
 * It also handle addition of roles to the user group's current roles list.
 *
 * To change the template for this generated type comment go to
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class HandleAssignUserGroupRolesAction extends LookupDispatchAction
{

	/**
	 * description public constructor
	 * @roseuid 4297202202C0
	 */
	public HandleAssignUserGroupRolesAction()
	{
		...
		HttpServletResponse aResponse)
	{
		...
		//getting roles of CREATED_BY_SA role type because they have to be shown
		//for both SA/MA users
		...
		{
			String agencyName = assignRolesForm.getUserGroupAgencyName();			
			if (agencyName != null)
			{
		...
		//MA also is able to view roles of CREATED_BY_MA role type
		...
		return aMapping.findForward(UIConstants.ASSIGN_USER_GROUP_ROLES_FIND_SUCCESS);
	}
