//Source file: C:\\views\\dev\\app\\src\\ui\\supervision\\SupervisionOptions\\action\\HandleConditionAssociateToDepartmentPolicyAction.java
...
public class HandleConditionAssociateToDepartmentPolicyAction extends LookupDispatchAction
{
   
   /**
    * @roseuid 42F7C49903C8
    */
   public HandleConditionAssociateToDepartmentPolicyAction() 
   {
   ...
   {
   	SupervisionConditionForm form = (SupervisionConditionForm)aForm;
		AssociationHelper.addSelectedConditionDepartmentPolicies( (SupervisionConditionForm)aForm );
