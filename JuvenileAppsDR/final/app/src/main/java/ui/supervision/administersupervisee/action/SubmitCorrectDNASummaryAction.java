 ...
 *
 */
public class SubmitCorrectDNASummaryAction extends JIMSBaseAction {
	 ...
	 * 
	 */
	public SubmitCorrectDNASummaryAction() {
	...
	public ActionForward finish(ActionMapping aMapping,
        ...
        if (er != null){
        	...
        	aRequest.setAttribute("confirmMessage", "DNA Information successfully corrected.");
