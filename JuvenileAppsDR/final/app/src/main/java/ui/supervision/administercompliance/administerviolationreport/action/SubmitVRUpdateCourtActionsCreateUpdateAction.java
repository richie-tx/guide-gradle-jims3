...
public class SubmitVRUpdateCourtActionsCreateUpdateAction extends JIMSBaseAction {

	/**
	 * @roseuid 47DA9D4402B6
	 */
	public SubmitVRUpdateCourtActionsCreateUpdateAction() {
	...
	public ActionForward finish(ActionMapping aMapping, ActionForm aForm, HttpServletRequest aRequest,
    	...
    	event.setPositionIdOfSignedBy(vrForm.getWhoSignedId());
    	...
    	vrForm.setConfirmationMessage("Violation Report successfully updated.");
    	vrForm.setStatusDesc("Updated");
