...
public class SubmitProgramReferralAction extends JIMSBaseAction
{
   
   /**
    * @roseuid 463F6823009B
    */
   public SubmitProgramReferralAction() 
   {
    
   }
   
	public ActionForward goBackToScheduleEvent(
	...
	public ActionForward showSummaryScreen(
			ActionMapping aMapping,
			ActionForm aForm,
			HttpServletRequest aRequest,
			HttpServletResponse aResponse)
