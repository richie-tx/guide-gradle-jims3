...
public class ViewJuvenileSealQueryAction extends Action {
	private Logger log = Logger.getLogger("ViewJuvenileSealQueryAction");
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		log.info("Juvenile Seal Query - JuvID: " + juvenileId + " LogonId: " + SecurityUIHelper.getLogonId());
