...
/**
 */
public class ProgramReferralClosedState extends ProgramReferralState{
		 ...
		 * 
		 */
		public ProgramReferralClosedState() {
			this.setStatus(ProgramReferralConstants.CLOSED);
		}
		/**
		...
		private List getJPOActions(){
			 ...
			 if (this.getSubStatus().equals(ProgramReferralConstants.CANCELLED)||
				 	 this.getSubStatus().equals(ProgramReferralConstants.WITHDRAWN)||
				 	 this.getSubStatus().equals(ProgramReferralConstants.COMPLETED)||
					 this.getSubStatus().equals(ProgramReferralConstants.REJECTED)||
					 this.getSubStatus().equals(ProgramReferralConstants.ACCEPTED)){	
