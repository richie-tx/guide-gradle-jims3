...
public class DeleteDistrictCourtCalendarRecordQueryAction extends Action
{
	...
	if ( regform.getOriginalJuvDistCourtRecords() != null 
		&& regform.getOriginalJuvDistCourtRecords().size()  > 1
		&& (docketId == null 
			|| docketId.equals("")) ) {
	    regform.setJuvDistCourtRecords( regform.getOriginalJuvDistCourtRecords() );
	    regform.setJuvcourtDocketsCount( regform.getOriginalJuvDistCourtRecords().size() );
