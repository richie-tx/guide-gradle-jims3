 ...
 * @author jims2
 * 
 * Takes in juvenile number, referral number (optional), or jcmaysidetail_id are used to display JCMAYSIDETAIL records
 */

public class DeleteMaysiDetailQueryAction extends Action {

	private Logger log = Logger.getLogger("DeleteMaysiDetailQueryAction");
	public ActionForward execute(ActionMapping mapping, ActionForm form,
		...
		/** Redirect if this comes from deleteMaysiDetailQuery2.jsp **/
		...
		if (editFlag != null && editFlag.equalsIgnoreCase("Y")) {
			...
			if (detailId != null && detailId.equals("") == false) 
			{
				...
				ArrayList details = retrieveSingleDetail(detailId, SecurityUIHelper.getLogonId());
				regform.setMaysidetails(details);
				...
				regform.setMsg("MaysiDetailID didn't pass through to the Action. DeleteMaysiDetailQueryAction.java");
				return mapping.findForward("error");
			}
		...
		if (maysidetails != null) {
			...
			regform.setMsg("No MAYSI details found for JuvenileID "
