 ...
 */
public class DisplayDetentionNotificationAction extends LookupDispatchAction
{
	...
	public ActionForward backToSocialHistoryData(ActionMapping aMapping, ActionForm aForm, 
			HttpServletRequest aRequest, HttpServletResponse aResponse)
	{
	...
	protected Map getKeyMethodMap()
	{
		...
		keyMap.put("button.backToSocialHistoryData", "backToSocialHistoryData");
		return keyMap;
	}
}