 ...
 * @author jjose
 *
 * This class contains helper methods used by both SimpleCodeTableHelper and ComplexCodeTableHelper and should not
 * be added to unless there is a valid reason.
 */
