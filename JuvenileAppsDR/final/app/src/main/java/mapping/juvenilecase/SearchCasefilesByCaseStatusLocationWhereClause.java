...
public class SearchCasefilesByCaseStatusLocationWhereClause
{

    public String getSearchCasefilesClause(IEvent anEvent)
    {

    	SearchJuvenileCasefileByLocationsEvent mev = (SearchJuvenileCasefileByLocationsEvent) anEvent;
        StringBuffer buf = new StringBuffer(300);

        /*buf.append("CASESTATUSCD = '");
        buf.append(mev.getCaseStatusId()); //commented for US 156271
        buf.append("' ");*/ //commented for US 156271
        
        //US 156271 changes STARTS 
