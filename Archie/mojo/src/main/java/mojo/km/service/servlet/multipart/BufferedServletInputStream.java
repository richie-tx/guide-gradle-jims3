 ...
 * @modelguid {9F640103-0BB2-4EA1-8D1E-F3B100BEC521}
 */
public class BufferedServletInputStream extends ServletInputStream {
  
  /** input stream we are filtering 
   * @modelguid {52C82E00-349B-4805-B014-177DE6E6E794}
   */
  private ServletInputStream in;
  
  /** our buffer 
   * @modelguid {B7E0F754-6E1F-449D-B9D1-4FD65DD9D35B}
   */
  private byte[] buf = new byte[64*1024];  // 64k
  
  /** number of bytes we've read into the buffer 
   * @modelguid {E885DF59-3944-4C27-BDB7-156DCFB05B39}
   */
  private int count; 
  
  /** current position in the buffer 
   * @modelguid {EC7BF14A-C07D-4E35-8C78-62F8F20B0881}
   */
  private int pos;
   ...
   * @modelguid {77D64671-5877-401B-8554-D882F71D98E6}
   */
   ...
   * @modelguid {76FDDE6E-F650-42ED-B04D-C07F1E708C6D}
   */
   ...
   * @exception  IOException  if an I/O error occurs.
   * @modelguid {758E172A-DA82-495F-92DD-8FBE39FEB6D4}
   */
   ...
   * @modelguid {58B2A410-213B-48ED-A574-0FBEDCBC3BCD}
   */
   ...
   *             stream is reached.
   * @exception  IOException  if an I/O error occurs.
   * @modelguid {575CA007-4E75-4BCD-A31F-0EF09332042B}
   */
   ...
   * @exception  IOException  if an I/O error occurs.
   * @modelguid {96CC9950-4185-4CD1-ACA2-5FB1F2BD6A3A}
   */
