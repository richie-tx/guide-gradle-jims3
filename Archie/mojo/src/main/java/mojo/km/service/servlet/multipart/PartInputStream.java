 ...
 * @modelguid {BEF84845-7578-4E54-8EE9-6A85C9E1E401}
 */
public class PartInputStream extends FilterInputStream {
  /** boundary which "ends" the stream 
   * @modelguid {78EA8218-AAFC-4B40-A348-686766671071}
   */
  private String boundary;
  
  /** our buffer 
   * @modelguid {0BB54F3E-A920-4616-AE57-A7B3C6ADBA40}
   */
  private byte [] buf = new byte[64*1024];  // 64k
  
  /** number of bytes we've read into the buffer 
   * @modelguid {48EA140E-8AE9-4808-ADBE-0D8521D70D69}
   */
  private int count; 
  
  /** current position in the buffer 
   * @modelguid {86450802-69AF-4C27-8522-8A3A6EBB72B5}
   */
  private int pos;
  
  /** flag that indicates if we have encountered the boundary 
   * @modelguid {09BD8A8E-7274-496A-8E80-8E19438D1161}
   */
  private boolean eof;
   ...
   * @modelguid {37C80B05-D20C-4BF7-8F27-26BFCA4B0658}
   */
   ...
   * @modelguid {B8E3CD3A-7A2D-4901-BCA2-38E1F05A9CAA}
   */
   ...
   *             stream is reached.
   * @exception  IOException  if an I/O error occurs.
   * @modelguid {D4157C35-B136-42FE-8E11-19ABD2B5E703}
   */
   ...
   * @exception  IOException  if an I/O error occurs.
   * @modelguid {BF7F3179-C381-4539-82EA-B62618CF2164}
   */
   ...
   *             of the stream has been reached.
   * @exception  IOException  if an I/O error occurs.
   * @modelguid {A444F7BA-DB5B-4304-AFB3-8C6B4802BBB9}
   */
   ...
   *             without blocking.
   * @exception  IOException  if an I/O error occurs.
   * @modelguid {800EB5B5-56AB-4000-B207-E0D1BD70FE81}
   */
   ...
   *
   * @exception  IOException  if an I/O error occurs.
   * @modelguid {684342BF-A37E-41CE-8002-FBFA47443DF5}
   */
