 ...
 * access data (such as a linked list), <tt>AbstractSequentialList</tt> should be used in preference to this class.<p>
 * To implement an unmodifiable list, the programmer needs only to extend this
 * class and provide implementations for the <tt>get(int index)</tt> and <tt>size()</tt> methods.<p>
 ...
 * element)</tt> and <tt>remove(int index)</tt> methods.<p> The programmer should generally provide a void (no argument) and
 * collection constructor, as per the recommendation in the <tt>Collection</tt> interface specification.<p>
 ...
 * <tt>set(int index, Object element)</tt>, <tt>add(int index, Object element)</tt> and <tt>remove(int index)</tt>.<p>
 ...
 * @since 1.2
 * @modelguid {D717CC5D-A584-4BAA-B38D-2FEDE7562DB5}
 */
public abstract class AbstractList extends AbstractCollection implements List {
    /** Sole constructor.  (For invocation by subclass constructors, typically implicit.) 
     * @modelguid {3A191243-483A-46F4-A7E2-C020824246EA}
     */
     ...
     * This implementation calls <tt>add(size(), o)</tt>.<p> Note that this implementation throws an
     * <tt>UnsupportedOperationException</tt> unless <tt>add(int, Object)</tt> is overridden.
     * @param o element to be appended to this list.
     * @return <tt>true</tt> (as per the general contract of <tt>Collection.add</tt>).
     * @throws UnsupportedOperationException if the <tt>add</tt> method is not supported by this Set.
     ...
     * @modelguid {A8F80F04-389E-443B-991E-D9B65D2F2370}
     */
     ...
     * @modelguid {20CA29C9-AAFB-4BFB-BF74-C83EC961356A}
     */
     ...
     * @modelguid {FD61C529-C200-4D7C-BCFB-E985E31ACB2C}
     */
     ...
     * (if any) and any subsequent elements to the right (adds one to their indices).<p>
     ...
     * @modelguid {1AB49CE9-7809-4BA3-9030-7DE035B9B39E}
     */
     ...
     * from their indices).  Returns the element that was removed from the list.<p> This implementation always throws an
     * <tt>UnsupportedOperationException</tt>.
     * @param index the index of the element to remove.
     * @return the element previously at the specified position.
     * @throws UnsupportedOperationException if the <tt>remove</tt> method is not supported by this list.
     * @throws IndexOutOfBoundsException if the specified index is out of range (<tt>index &lt; 0 || index &gt;= size()</tt>). 
     * @modelguid {42A788BD-AFC4-41C9-A761-AE685BB6CC07}
     */
     ...
     * get(i)==null : o.equals(get(i)))</tt>, or -1 if there is no such index.<p>
     * This implementation first gets a list iterator (with <tt>listIterator()</tt>).  Then, it iterates over the list until the
     * specified element is found or the end of the list is reached.
     * @param o element to search for.
     * @return the index in this List of the first occurence of the specified
     * element, or -1 if the List does not contain this element.
     * @modelguid {893DFB68-C378-4C03-9AA1-F9BF3CB27F05}
     */
     ...
     * over the list until the specified element is found, or the beginning of the list is reached.
     * @param o element to search for.
     * @return the index in this list of the last occurence of the specified
     * element, or -1 if the list does not contain this element.
     * @modelguid {BB7A1015-7B70-4798-B6CA-CABE4D60934F}
     */
     ...
     * The collection will be empty after this call returns (unless it throws an exception).<p>
     * This implementation calls <tt>removeRange(0, size())</tt>.<p> Note that this implementation throws an
     * <tt>UnsupportedOperationException</tt> unless <tt>remove(int
     * index)</tt> or <tt>removeRange(int fromIndex, int toIndex)</tt> is overridden.
     * @throws UnsupportedOperationException if the <tt>clear</tt> method is not supported by this Collection. 
     * @modelguid {505E4BA4-895C-4814-AEB4-BEEBA547601D}
     */
    public void clear() {
        markModified();
        removeRange(0, size());
     ...
     * <tt>add(int, Object)</tt>.  Many implementations will override this method for efficiency.<p>
     * Note that this implementation throws an <tt>UnsupportedOperationException</tt> unless <tt>add(int,
     * Object)</tt> is overridden.
     ...
     * @modelguid {3EAFF048-827C-462E-9B80-C800B23F0E57}
     */
     ...
     * <tt>get(int)</tt>, and <tt>remove(int)</tt> methods.<p> Note that the iterator returned by this method will throw an
     * <tt>UnsupportedOperationException</tt> in response to its <tt>remove</tt> method unless the list's <tt>remove(int)</tt>
     * method is overridden.<p> This implementation can be made to throw runtime exceptions in the face
     * of concurrent modification, as described in the specification for the (protected) <tt>modCount</tt> field.
     * @return an iterator over the elements in this list in proper sequence.
     * @see #modCount
     * @modelguid {0395343D-3A78-4BBC-B604-6337B89A4ADE}
     */
     ...
     * @modelguid {626F259A-4E94-42D9-B30C-CAEEE7AB43EC}
     */
     ...
     * the <tt>previous</tt> method would return the element with the specified index minus one.<p>
     * This implementation returns a straightforward implementation of the
     ...
     * <tt>get(int)</tt>, <tt>set(int, Object)</tt>, <tt>add(int, Object)</tt> and <tt>remove(int)</tt> methods.<p>
     ...
     * list's <tt>remove(int)</tt>, <tt>set(int, Object)</tt>, and <tt>add(int, Object)</tt> methods are overridden.<p>
     * This implementation can be made to throw runtime exceptions in the
     * face of concurrent modification, as described in the specification for the (protected) <tt>modCount</tt> field.
     ...
     * @throws IndexOutOfBoundsException if the specified index is out of range (<tt>index &lt; 0 || index &gt; size()</tt>).
     * @see #modCount 
     * @modelguid {63BEF4B7-C255-4FC0-89B1-9D36DE40CE8E}
     */
	...
	/** @modelguid {59096C42-5663-41B2-8068-D47184207A77} */
    private class Itr implements Iterator {
        /** Index of element to be returned by subsequent call to next. 
         * @modelguid {5E68CFCF-FC86-4E37-801F-C053EDBBC949}
         */
        int cursor = 0;

        /**
         * Index of element returned by most recent call to next or
         * previous.  Reset to -1 if this element is deleted by a call to remove.
         * @modelguid {0A439320-B5E9-47C8-AF25-23240494351C}
         */
        int lastRet = -1;

        /**
         * The modCount value that the iterator believes that the backing
         * List should have.  If this expectation is violated, the iterator has detected concurrent modification.
         * @modelguid {2A52013A-F1B3-4567-9CF6-53AAC3CABCCE}
         */
        int expectedModCount = modCount;

		/** @modelguid {75DF108E-4292-4790-A951-73AA55DE2FFD} */
        public boolean hasNext() {
            return cursor != size();
        }

        
		/** @modelguid {820DA27C-74D6-4AC0-8FC7-1043CA5C76E0} */
        public Object next() {
            try {
		...
		/** @modelguid {8FB6AAE0-9738-4294-B242-30B8A10F725E} */
        public void remove() {
            if (lastRet == -1)
		...
		/** @modelguid {5C0D0D87-A2A2-4E3B-85AA-750911D0A871} */
	...
	/** @modelguid {83CD8293-5149-44EC-8CFA-23B53399F3BB} */
    private class ListItr extends Itr implements ListIterator {
		/** @modelguid {1C3B3EB0-9835-4CBE-BB30-79FF4E81FCB6} */
        ListItr(int index) {
            cursor = index;
        }

		/** @modelguid {12D4B43A-22F1-4B72-B229-8AEA1204EE55} */
        public boolean hasPrevious() {
            return cursor != 0;
        }

        
		/** @modelguid {A4B385D2-7CEA-4957-BFCE-023C67C980E7} */
		...
		/** @modelguid {608E001D-7564-4EB8-8162-38439660D5EA} */
        public int nextIndex() {
            return cursor;
        }

		/** @modelguid {43296755-D2D0-4BF1-8633-36ACFB6DF08F} */
        public int previousIndex() {
            return cursor - 1;
        }

        
		/** @modelguid {487EAAA0-CD5F-41A3-9314-F440AFBA1129} */
		...
		/** @modelguid {8BF02E01-C22D-451F-A02D-4951ECC27C73} */
     ...
     * This implementation returns a list that subclasses <tt>AbstractList</tt>.  The subclass stores, in private fields, the
     * offset of the subList within the backing list, the size of the subList
     * (which can change over its lifetime), and the expected <tt>modCount</tt> value of the backing list.<p>
     ...
     * <tt>addAll(Collection c)</tt> method merely returns <tt>addAll(size, c)</tt>.<p>
     ...
     * merely returns the subclass's <tt>size</tt> field.<p> All methods first check to see if the actual <tt>modCount</tt> of
     * the backing list is equal to its expected value, and throw a <tt>ConcurrentModificationException</tt> if it is not.
     ...
     * @modelguid {E82640EA-965E-4123-A75F-533F3360270F}
     */
     ...
     * @modelguid {9DBC5C44-48EB-4593-9368-AC81F0196DE1}
     */
    ...
    /**
     * Returns the hash code value for this list. <p> This implementation uses exactly the code that is used to define the
     * list hash function in the documentation for the <tt>List.hashCode</tt> method.
     * @return the hash code value for this list.
     * @modelguid {AAD60193-E684-417C-ACD2-5BC21E2CAC2D}
     */
    public int hashCode() {
        fetch();
        int hashCode = 1;
     ...
     * elements.  (If <tt>toIndex==fromIndex</tt>, this operation has no effect.)<p>
     * This method is called by the <tt>clear</tt> operation on this list
     * and its subLists.  Overriding this method to take advantage of
     * the internals of the list implementation can <i>substantially</i>
     * improve the performance of the <tt>clear</tt> operation on this list and its subLists.<p>
     ...
     * @modelguid {C04B7312-405D-401E-879E-90A5D9F5C351}
     */
     ...
     * list, or otherwise perturb it in such a fashion that iterations in progress may yield incorrect results.<p>
     ...
     * @modelguid {D4DBEC1F-848E-48EF-834F-743730BEAF4C}
     */
    protected transient int modCount = 0;
}


/** @modelguid {FD607AAF-B9D7-44C6-BAF8-2947FDFB1E8E} */
class SubList extends AbstractList {
	/** @modelguid {AA41B103-1817-4FBB-A2DA-2FBE534E5390} */
    private AbstractList l;
	/** @modelguid {BD3310BB-C6C2-42DA-B503-E069843CF16B} */
    private int offset;
	/** @modelguid {12C9C04A-B6A1-4376-9749-A0C6B6276734} */
    private int size;
	/** @modelguid {734C0C90-2416-434C-A556-64F185647AC6} */
    private int expectedModCount;

	/** @modelguid {A2521560-0BB4-42F4-B842-8F25614F35AC} */
	...
	/** @modelguid {5F9A4F65-7958-445D-B4D6-5D502AB358E1} */
    public Object set(int index, Object element) {
        rangeCheck(index);
        checkForComodification();
	...
	/** @modelguid {405CAEB8-8466-4DF4-A97A-CD50469440DE} */
	...
	/** @modelguid {7F15B82B-6F76-4B9C-B199-64FE91913616} */
    public int size() {
        checkForComodification();
        return size;
    }
	...
	/** @modelguid {C01C2E2A-E510-4488-9D1C-EA589A9BCD18} */
    public void add(int index, Object element) {
        if (index < 0 || index > size)
	...
	/** @modelguid {44B4F340-D2B7-40C5-8FA3-3B8FB307DBDB} */
    public Object remove(int index) {
        rangeCheck(index);
        checkForComodification();
	...
	/** @modelguid {EDEA9B10-3C14-461C-8D60-77A5081869FB} */
    protected void removeRange(int fromIndex, int toIndex) {
        checkForComodification();
	...
	/** @modelguid {19276477-144A-4239-B2BA-BE2C3385EE60} */
    public boolean addAll(Collection c) {
        return addAll(size, c);
    }

    
	/** @modelguid {9293E344-6C29-4132-B728-CFC417A29A20} */
    public boolean addAll(int index, Collection c) {
        if (index < 0 || index > size)
	...
	/** @modelguid {54D9B50A-0D1A-4FB8-8146-3400DDB0098F} */
    public Iterator iterator() {
        return listIterator();
    }

    
	/** @modelguid {FE4B69EB-158E-4043-9EDA-649413D18636} */
    public ListIterator listIterator(final int index) {
        checkForComodification();
        if (index < 0 || index > size)
            throw new IndexOutOfBoundsException("Index: " + index + ", Size: " + size);
	...
	/** @modelguid {A2A49A0D-AC46-43F9-BADB-47CD3471A5FC} */
    public List subList(int fromIndex, int toIndex) {
        fetch();
        return new SubList(this, fromIndex, toIndex);
    }

	/** @modelguid {92773C2E-4FEE-4E03-ADAF-0A580A63A9B5} */
	...
	/** @modelguid {2B6F1D15-CD49-4E9D-8CE7-7BB3E0B98BCE} */
