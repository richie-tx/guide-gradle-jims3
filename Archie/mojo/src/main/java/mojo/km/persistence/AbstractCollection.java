 ...
 * <tt>iterator</tt> method must additionally implement its <tt>remove</tt> method.<p>
 * The programmer should generally provide a void (no argument) and
 * <tt>Collection</tt> constructor, as per the recommendation in the <tt>Collection</tt> interface specification.<p>
...
public abstract class AbstractCollection extends PersistentObject implements Collection {
     ...
     * @modelguid {3E0A3AF9-331D-4305-AA81-803B25DAED2A}
     */
     ...
     * @modelguid {72FCBCE5-2651-4040-8779-7079B01616B9}
     */
    public abstract int size();

    /**
     * Returns <tt>true</tt> if this collection contains no elements.<p> This implementation returns <tt>size() == 0</tt>.
     * @return <tt>true</tt> if this collection contains no elements.
     * @modelguid {D97A5F58-0E18-4D16-8D2B-4377A4138B3B}
     */
     ...
     * collection contains at least one element <tt>e</tt> such that <tt>(o==null ? e==null : o.equals(e))</tt>.<p>
     * This implementation iterates over the elements in the collection,
     * checking each element in turn for equality with the specified element.
     * @param o object to be checked for containment in this collection.
     * @return <tt>true</tt> if this collection contains the specified element.
     * @modelguid {7D649F0B-99B9-4BAA-8939-2AAE38EBF84D}
     */
     ...
     * The caller is thus free to modify the returned array.<p> This implementation allocates the array to be returned, and
     * iterates over the elements in the collection, storing each object reference in
     * the next consecutive element of the array, starting with element 0.
     * @return an array containing all of the elements in this collection.
     * @modelguid {D776FF7E-3E61-4289-A96F-180891AD16D6}
     */
     ...
     * Otherwise, a new array is allocated with the runtime type of the specified array and the size of this collection.<p>
     ...
     * collection <i>only</i> if the caller knows that the collection does not contain any <tt>null</tt> elements.)<p>
     * If this collection makes any guarantees as to what order its elements
     * are returned by its iterator, this method must return the elements in the same order. <p>
     ...
     * @modelguid {EFFFD22D-949A-4EA4-80A8-4A8392F19002}
     */
     ...
     * <tt>null</tt> elements, and the specified element is <tt>null</tt>.
     ...
     * @modelguid {461A0709-AE90-45AF-8C33-840CA0262EB0}
     */
     ...
     * specified element (or equivalently, if the collection changed as a result of the call).<p>
     * This implementation iterates over the collection looking for the
     * specified element.  If it finds the element, it removes the element
     * from the collection using the iterator's remove method.<p> Note that this implementation throws an
     ...
     * @modelguid {DC74AAC6-9317-4A32-9D6B-004C40736603}
     */
    ...
    /**
     * Returns <tt>true</tt> if this collection contains all of the elements in the specified collection. <p>
     ...
     * @see #contains(Object)
     * @modelguid {CFDE76C3-B0F3-4B30-8EFA-6D97B1D499AF}
     */
     ...
     * the specified collection is this collection, and this collection is nonempty.) <p>
     * This implementation iterates over the specified collection, and adds
     * each object returned by the iterator to this collection, in turn.<p> Note that this implementation will throw an
     * <tt>UnsupportedOperationException</tt> unless <tt>add</tt> is overridden.
     * @param c collection whose elements are to be added to this collection.
     * @return <tt>true</tt> if this collection changed as a result of the call.
     * @throws UnsupportedOperationException if the <tt>addAll</tt> method is not supported by this collection.
     * @see #add(Object) 
     * @modelguid {FA74CD48-3D28-4671-9A6F-2F4578D856C5}
     */
     ...
     * the specified collection (optional operation). <p> This implementation iterates over this collection, checking each
     * element returned by the iterator in turn to see if it's contained
     * in the specified collection.  If it's so contained, it's removed from
     * this collection with the iterator's <tt>remove</tt> method.<p> Note that this implementation will throw an
     * <tt>UnsupportedOperationException</tt> if the iterator returned by the
     * <tt>iterator</tt> method does not implement the <tt>remove</tt> method.
     * @param c elements to be removed from this collection.
     * @return <tt>true</tt> if this collection changed as a result of the call.
     * @throws UnsupportedOperationException removeAll is not supported by this collection.
     * @see #remove(Object)
     * @see #contains(Object) 
     * @modelguid {2C53FA58-98C6-40ED-B47E-5ADC682FBE93}
     */
     ...
     * from this collection all of its elements that are not contained in the specified collection. <p>
     * This implementation iterates over this collection, checking each
     * element returned by the iterator in turn to see if it's contained
     * in the specified collection.  If it's not so contained, it's removed
     * from this collection with the iterator's <tt>remove</tt> method.<p> Note that this implementation will throw an
     * <tt>UnsupportedOperationException</tt> if the iterator returned by the
     ...
     * @see #remove(Object)
     * @see #contains(Object) 
     * @modelguid {91FDBFC6-CBF9-45FE-BACD-5A5892A5EB40}
     */
     ...
     * Note that this implementation will throw an <tt>UnsupportedOperationException</tt> if the iterator returned by this
     * collection's <tt>iterator</tt> method does not implement the <tt>remove</tt> method.
     * @throws UnsupportedOperationException if the <tt>remove</tt> method is not supported by this collection. 
     * @modelguid {9FF4D981-D30F-46A9-9C09-8A034ACBCFE2}
     */
    public void clear() {
        markModified();
        Iterator e = iterator();
     ...
     * <tt>", "</tt> (comma and space).  Elements are converted to strings as by <tt>String.valueOf(Object)</tt>.<p>
     ...
     * @modelguid {D5D8C55D-6AC9-47CA-99E6-02941DE25889}
     */
