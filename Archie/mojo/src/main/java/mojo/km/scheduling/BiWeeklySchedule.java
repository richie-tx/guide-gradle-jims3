...
import java.util.*;
/**
*  BiWeeklySchedule calculates the next run date based on the FIRST run date.
...
*  THEN 2 Week is added to the date.
*
...
public class BiWeeklySchedule implements ISchedule {
    public Date getNextRunDate(Date firstNotificationDate) {
		...
		currentDateCalendar.add(Calendar.WEEK_OF_YEAR, 2);
