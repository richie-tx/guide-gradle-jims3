...
import java.util.*;
/**
*  YearlySchedule calculates the next run date based on the FIRST run date.
...
*  THEN 1 Year is added to the date.
*
...
public class YearlySchedule implements ISchedule {
    public Date getNextRunDate(Date firstNotificationDate) {
		...
		currentDateCalendar.add(Calendar.YEAR, 1);
