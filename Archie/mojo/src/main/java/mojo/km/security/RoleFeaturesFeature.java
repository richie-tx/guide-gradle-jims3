...
public class RoleFeaturesFeature extends mojo.km.persistence.PersistentObject {
	/*Role parent;
	...
	*//*
	private void initChild() {
		if (child == null) {
			try {
				child = (mojo.km.security.Feature) new mojo.km.persistence.Reference(childId, mojo.km.security.Feature.class).getObject();
			} catch (Throwable t) {
				t.printStackTrace();
			}
		}
	...
	*//*
	public mojo.km.security.Feature getChild() {
		fetch();
		initChild();
		return child;
	}
	...
	*//*
	public void setChild(mojo.km.security.Feature child) {
		...
		this.child = (mojo.km.security.Feature) new mojo.km.persistence.Reference(child).getObject();
	}
	*//**
