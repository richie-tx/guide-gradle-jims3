...
public class RoleUserGroupsUserGroup extends mojo.km.persistence.PersistentObject {
	/*Role parent;
	...
	*//*
	private void initChild() {
		if (child == null) {
			try {
				child = (mojo.km.security.UserGroup) new mojo.km.persistence.Reference(childId, mojo.km.security.UserGroup.class).getObject();
			} catch (Throwable t) {
				t.printStackTrace();
			}
		}
	...
	*//*
	public void setChild(mojo.km.security.UserGroup child) {
		...
		this.child = (mojo.km.security.UserGroup) new mojo.km.persistence.Reference(child).getObject();
	}
	*//**
