...
class Guard
{
     ...
     */
    Guard(final boolean aAllow, final boolean aLocalOnly, final String aPkgName, final boolean aExactMatch)
    {
        mAllowed = aAllow;
     ...
     */
    Guard(final boolean aAllow, final boolean aLocalOnly, final String aClassName)
    {
        mAllowed = aAllow;
        mLocalOnly = aLocalOnly;
        mPkgName = null;
